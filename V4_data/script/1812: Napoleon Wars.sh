...
#
# TESTED Editions: october 2019, version unknown (1.0 ?).
#
# Middlewares used by this software : vcrun2013 ? (MSVCR120).
#
# CHANGELOG
# [Dadu042] (2019-10-18)
#   First script. A serious jerkiness issue make the game uncomfortable to play.
# [Dadu042] (2020-08-15)
#   [CHANGED] Wine 4.0.2 -> 4.0.4
#   [NEW] support downloading the Gametop's free release (adware).
#
# KNOWN ISSUES:
#  - Wine amd64 4.0.2, 4.0.4, 4.15, 5.0.1, 5.12: the game is 2D but suffer of jerkiness. Tried: install vcrun2015, msxml4, xmllite, vcrun2013, disabling DLSL then OpenGL, riched30, msxml6.
...
PREFIX="1812_Napoleon_Wars"
EDITOR="First Games Interactive"
GAME_URL="https://store.steampowered.com/app/1166230/1812_Napoleon_Wars/"
AUTHOR="Dadu042"
STEAM_ID="1166230"
WORKING_WINE_VERSION="4.0.4"
GAME_VMS="256"
SHORTCUT_FILENAME="1812.exe"
...
POL_SetupWindow_InstallMethod "LOCAL,STEAM,DOWNLOAD"
...
if [ "$INSTALL_METHOD" == "STEAM" ]; then
 ...
 #       POL_Shortcut_InsertBeforeWine "$SHORTCUT" "trap 'xrandr -s 0' EXIT"
        ...
        cd "$HOME"
        POL_Download "https://cdn.gametop.com/free-games-download/1812-Napoleon-Wars.exe"
        POL_Wine "1812-Napoleon-Wars.exe" "/SILENT"
        POL_Wine_WaitBefore "$TITLE"
        # POL_Shortcut "$SHORTCUT_FILENAME" "$TITLE" "" "" "$SOFTWARE_CATEGORIES"
           
        POL_Shortcut "1812.exe" "$TITLE" "" "" "$SOFTWARE_CATEGORIES"
...
if [ "$APP_ANSWER" == ".EXE" ]; then
        ...
        # Restore screen resolution (game's default is 800x600)
        # Note: Aliens versus Predator 2 v1.0 does not restore the resolution, but once patched (v1.0.9.6) it does.
        # POL_Shortcut_InsertBeforeWine "$SHORTCUT" "trap 'xrandr -s 0' EXIT"
...
# Set memory size of the graphic card
...
iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCXzflwAAKCRDlMfrJqhPK
R5N7AJ4wEh17py2HLNSSJD74vR2sblt0aQCgna/4sAQ8ZX+W5U4ByyyqJxHAtxw=
=PN82
-----END PGP SIGNATURE-----
