...
#
# KNOWN ISSUES
#  - Wine amd64 4.21, 5.0, 5.0.2, 5.2, 5.12, 5.17: 'Options' button does not display anything.
#
#
#
# KNOWN ISSUES (FIXED):
...
TITLE="A PR Problem"
PREFIX="A_PR_Problem"
EDITOR="Ryan Bowen, Matthew Kingston, Samuel Weir"
GAME_URL="https://globalgamejam.org/2020/games/pr-problem-4"
AUTHOR="Dadu042"
STEAM_ID=""
GAME_VMS="128"
SHORTCUT_FILENAME="Repair Game.exe"
...
if [ "$INSTALL_METHOD" == "STEAM" ]; then
        ...
        POL_Download "https://ggj.s3.amazonaws.com/games/2020/02/216426/src/QAuUU/A%20PR%20Problem.zip"
        ...
        POL_System_unzip "A%20PR%20Problem.zip" -d "$WINEPREFIX/drive_c/game/"
...
iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCYkOM/AAKCRDlMfrJqhPK
R2PmAJ0aPyvhaPvdbHT3FVVh5TlMpmD4PwCbBWsUNICUgQix7dipDJNMJWnASHE=
=rGfi
-----END PGP SIGNATURE-----
