...
#
# TESTED Editions: Client1.20.0.810463.7z .
#
# Middlewares used by this software : DotNet 4.0, vcrun2012, Easy anti-cheat, KB893803 (Windows installer).
#                                     Files also included: vcrun2005, vcrun2008, vcrun2010.
#  Unreal engine 3 ?
#
# Note: the 'installer' (APB_Reloaded_Downloader.exe) does download 2 files: APB_Reloaded_Installer.exe and Client1.20.0.810463.7z
#       Once downloaded, only these 2 files are required to install the game.
#
# CHANGELOG
# [Dadu042] (2020-05-19 16-00)
#   Initial script.
# [Dadu042] (2020-05-20 16-00)
#   Can now reach the game's main screen (and see credits intros).
#
# KNOWN ISSUES :
#  - Wine amd64 5.0, 5.7: as soon as 'APBLauncher.exe' is launched, it shows a update window then it crash. Tried: Gecko, vcrun2012, mono481_64b, crypt32.
#  - Wine x86 5.7: once installed, as soon as 'APBLauncher.exe' is launched, it shows a update window then it crashes. Tried: vcrun2012, wininet, xmllite. Error log seems related to ODBC.    Note: running 'APB.exe' can load game, but login in is impossible because the client is (a bit) outdated.
#    Fix: dotnet461
#
#
# KNOWN ISSUES (FIXED):
#  - Wine amd64 5.0, 4.21: X
...
PREFIX="APB_Reloaded"
EDITOR="GamersFirst"
GAME_URL="https://www.gamersfirst.com/apb/"
AUTHOR="Dadu042"
STEAM_ID=""
GAME_VMS="256"
SHORTCUT_FILENAME="APBLauncher.exe"
...
# Seems useful about ODBC issues (in the debug log)
...
iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCXylg3QAKCRDlMfrJqhPK
Rz9LAJ9Ep+rzN8uie4m2xkrmDrt/t5iFfACffnNYZvrZNR+2dUbOhQKkzZDTVuc=
=Szhv
-----END PGP SIGNATURE-----
