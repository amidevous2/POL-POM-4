...
#
# TESTED Editions: v3.03 2005 .
#
# Middlewares used by this software : .
#
# CHANGELOG
# [Dadu042] (2020-01-14 13-30)
#   Initial script.
# [Dadu042] (2020-01-15 07-30)
#   Disable music by default, because it (seems to) block the keyboard.
#
# KNOWN ISSUES:
#  - Wine amd64 3.0.3, 3.20, 4.0.3, 4.21, 5.0-rc5: keys up and down does not work on the main menu. Fix: disable music in 'config.txt'.
#             Note: directmusic fix also but after exiting, the game let a process open. Tried: dsound.
#
# KNOWN ISSUES (FIXED):
#  - Wine amd64 3.0.3: X
...
PREFIX="adagio"
EDITOR="David Grace"
GAME_URL="https://www.allegro.cc/depot/Adagio"
AUTHOR="Dadu042"
STEAM_ID=""
GAME_VMS="64"
SHORTCUT_FILENAME="adagio.exe"
...
if [ "$INSTALL_METHOD" == "STEAM" ]; then
        ...
        POL_Wine start /unix "$CDROM/setup.exe" "/s"
        ...
        # POL_SetupWindow_message "$(eval_gettext '\n\nNote: this script will download the v2.08i (2012).')" "$TITLE"
        POL_Download "https://d1cxvcw9gjxu2x.cloudfront.net/projects/1440#adagio_v303.exe"

        # POL_SetupWindow_wait_next_signal "$(eval_gettext 'Extracting the archive...')" "$TITLE"
        # POL_System_unzip "hquest2.zip" -d "$WINEPREFIX/drive_c/game/"
                 
 
        # POL_SetupWindow_message "$(eval_gettext 'Note: we recommend you to uncheck all the checkboxes:\n[x] -> [ ]')" "$TITLE"
 
        POL_Wine "1440#adagio_v303.exe" "/SILENT"
...
# Disable music because it disable the keyboard from the main menu.
sed -e 's/nomusic: 0/nomusic: 1/' -i "$WINEPREFIX/drive_c/Games/Adagio/config.txt"
...
iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCXh61CwAKCRDlMfrJqhPK
R1PiAJwM7yYakACSZDhPqVZW9cWFEfsdxACfYHUjgJzXOE/sgP8+7OANSyMMBec=
=CbnN
-----END PGP SIGNATURE-----
