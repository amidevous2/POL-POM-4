#!/bin/bash
# Date : (08-05-2017)
# Distribution used to test : Ubuntu 17.04 64-bit
...
#
# CHANGELOG
# [Jose A Garcia] (2017-05-08)
#   First script.
# [Dadu042] (2019-12-30)
#   Wine version 2.13 -> 3.0.3
...
# Create Shortcuts
POL_Shortcut "illustrator.exe" "$TITLE" "" "" "Graphics;"
...
iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCXgswkgAKCRDlMfrJqhPK
R8moAJ9qU2rInhv2ucxbBFg4aEJNJBZ+FACdHtuZ+Fxc5XVbtRvvEuLpu1IK18w=
=eivd
-----END PGP SIGNATURE-----
