...
#
# TESTED Editions: 2007 edition (first was in 2005).
#
# Middlewares used by this software : ?.
#
# CHANGELOG
# [Dadu042] (2020-01-21 21:30)
#   Initial script.
#
#
# KNOWN ISSUES:
#  - Wine x86 3.0.3, 3.20: X
#
# KNOWN ISSUES (FIXED):
#  - Wine amd64 4.0.3: X
...
TITLE="Alien Breed Obliteration"
PREFIX="alien_breed_obliteration"
EDITOR="Flash Jester Punk"
GAME_URL=""
AUTHOR="Dadu042"
STEAM_ID=""
GAME_VMS="32"
SHORTCUT_FILENAME="AlienBreed2005_Obliteration_NEW.exe"
...
if [ "$INSTALL_METHOD" == "STEAM" ]; then
        ...
        POL_Download "https://archive.org/download/Alien_Breed_Obliteration/alienbreed.zip"
 
        POL_SetupWindow_wait_next_signal "$(eval_gettext 'Extracting the archive...')" "$TITLE"
        POL_System_unzip "alienbreed.zip" -d "$WINEPREFIX/drive_c/game/"
...
iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCXidhBgAKCRDlMfrJqhPK
R+BcAJ9ub9x86uHmlYb5z4vyQyBwujle9gCfYXhIj16+pUySlgyih6/qnOVkAIE=
=J7AP
-----END PGP SIGNATURE-----
