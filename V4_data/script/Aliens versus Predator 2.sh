...
#
# TESTED Edition: 'DDV' installable v1.0 and v1.0.9.6 (1.0 patched).
#
# Middlewares used by this software : DirectX 7 ?, Bink videos.
#
# CHANGELOG
# [Dadu042] (2019-09-22)
#   First script.
...
#   Add comments.
# [Dadu042] (2019-09-29)
#   Fix end message (unused).
#
# KNOWN ISSUES:
#  - Wine amd64 4.0.2, 4.8 with game v1.0 (and v1.0.9.6): crash after the line: 004d:fixme:dmime:IDirectMusicPerformance8Impl_GetNotificationPMsg (0x213148,0x339fea0): stub
#    Workraround: from the launcher, button Options disable Music.   To try: install directmusic.
#
# Ideas to improve this script: select archive, then decide if extension is RAR or ZIP or 7Z...
#
#
# Forcing a resolution unknown by the game (example: 1368x768):
# Edit the text file: Autoexec.cfg
#   "GameScreenWidth" "1368"
#   "SCREENWIDTH" "1368"
#   "GameScreenHeight" "768"
#   "SCREENHEIGHT" "768"
#
#
# Max details ? = "DetailLevel" "4"
...
PREFIX="AliensVP2"
EDITOR="Fox"
GAME_URL="https://en.wikipedia.org/wiki/Aliens_versus_Predator_2"
AUTHOR="Dadu042"
STEAM_ID=""
WORKING_WINE_VERSION="4.0.2"
GAME_VMS="256"
SHORTCUT_FILENAME="AVP2.exe"
...
POL_SetupWindow_message "$(eval_gettext 'WARNING: if the game crash after the launcher screen, you must disable the 'Music' (in button Options).')" "$TITLE"
...
iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCXZD7RAAKCRDlMfrJqhPK
R523AJ9c+Chs8oDGbms2duCOqLP0efGTLgCfV0Mq4xwKNJ6n76oFy6YtA5Df0fw=
=wcgV
-----END PGP SIGNATURE-----
