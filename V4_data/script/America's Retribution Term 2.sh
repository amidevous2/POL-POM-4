...
#
# TESTED Edition: unofficial DDV v1.1 (displayed on the main menu).
#
# Middlewares used by this software : DirectX 11, HTML5, Chromium, NWJS.
#
# CHANGELOG
# [Dadu042] (2019-11-05)
#   First script.
# [Dadu042] (2019-11-06 00:08)
#   Fix STEAM_ID
#
# KNOWN ISSUES:
#  - Wine amd64 3.0.3, 4.0.2: no sound/music, game freeze.
#  - Wine amd64 4.19: no sound/music. Tried: install d3dx11, gecko. Fix: alsa.
#  - Wine amd64 4.19: gamepad not detected (#1, USB ID: 0079:0006), or working bad (#2: 044f:b315, does only fire and jump). Tried: install xinput, dinput, dinput8. directplay.
#  - Wine amd64 4.19: mouse cursor should hide but does not. 
#
...
TITLE="America's Retribution Term 2"
PREFIX="Americas_Retribution_2"
EDITOR="Ed Findlay"
GAME_URL="https://store.steampowered.com/app/1072350/Americas_Retribution_Term_2/"
AUTHOR="Dadu042"
STEAM_ID="1072350"
WORKING_WINE_VERSION="4.19"
GAME_VMS="256"
SHORTCUT_FILENAME="nw.exe"
...
if [ "$INSTALL_METHOD" == "STEAM" ]; then
 ...
 #       POL_Shortcut_InsertBeforeWine "$SHORTCUT" "trap 'xrandr -s 0' EXIT"
        ...
        POL_Wine "Hospice.exe"  "/SILENT"
        POL_Wine_WaitBefore "$TITLE"
        POL_Shortcut "$SHORTCUT_FILENAME" "$TITLE" "" "" "$SOFTWARE_CATEGORIES"
        POL_Shortcut_Document "$TITLE" "README_OR_DIE.txt"
...
iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCXcIBeAAKCRDlMfrJqhPK
R6zaAJ4qXfDbsTbi451nuE2JkckohhUSJACgj6gLB6EGfvDXsEg89MhVxRq/N/Y=
=B9NO
-----END PGP SIGNATURE-----
