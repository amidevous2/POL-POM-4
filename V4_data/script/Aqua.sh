...
#
# TESTED Editions: v1.02 2005.
#
# Middlewares used by this software : ?.
#
# CHANGELOG
# [Dadu042] (2020-01-23 13:50)
#   Initial script.
#
#
# KNOWN ISSUES:
#  - Wine x86 3.0.3, 4.0.3: movements of the mouse cursor is often inacurate. Fix: Wine 3.0.5 (Wine 2.22 is OK also but makes larger log).
#  - Wine x86 3.20: mouse cursor and keyboard does freeze as soon the game level starts.
#
# KNOWN ISSUES (FIXED):
#  - Wine amd64 4.0.3: X
...
PREFIX="aqua"
EDITOR=""
GAME_URL="https://nexus23.com/warfare2/pipe-mania-remake/"
AUTHOR="Dadu042"
STEAM_ID=""
GAME_VMS="32"
SHORTCUT_FILENAME="Aq*.exe"
...
if [ "$INSTALL_METHOD" == "STEAM" ]; then
        ...
        POL_Download "https://web.archive.org/web/20051124195916if_/http://www.nebelwade.de:80/download/aqua102.zip"
 
        POL_SetupWindow_wait_next_signal "$(eval_gettext 'Extracting the archive...')" "$TITLE"
        POL_System_unzip "aqua102.zip" -d "$WINEPREFIX/drive_c/game/"
...
iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCXimYdwAKCRDlMfrJqhPK
RwgTAKCzB21/RYZd0FPAO6ckCtnb2qjpcACfYU5EmMAgW/dFVIq2Kl619XMH+XA=
=sL97
-----END PGP SIGNATURE-----
