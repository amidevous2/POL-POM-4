...
#
# Editions TESTED: v1.34 (2013).
#
# Middlewares used by this software : .
#
#
# CHANGELOG
# [Dadu042] (2020-02-06 13:00)
#   Initial script.
#
#
# KNOWN ISSUES:
...
#
# KNOWN ISSUES (FIXED):
#  - Wine amd64 3.20: unzip error 1 when unzipping the update file ('updated licence') because of the file names, however this work.
#  - Wine x86 3.0.3, 3.20: no sounds nor music. Tried: directmusic (does some lag when each sound is played). Fix: directmusic + dsound  
  
[ "$PLAYONLINUX" = "" ] && exit 0
source "$PLAYONLINUX/lib/sources"
  
TITLE="Arcade Game Studio"
PREFIX="Arcade_Game_Studio"
EDITOR="Bruno R.Marcos (alias Bruneras)"
GAME_URL="https://firecat.itch.io/arcade-game-studio"
AUTHOR="Dadu042"
STEAM_ID=""
GAME_VMS="128"
SHORTCUT_FILENAME="Arc*.exe"
...
if [ "$INSTALL_METHOD" == "STEAM" ]; then
        ...
        POL_Download "http://ftp.vector.co.jp/53/02/3042/giganticarmy_trial.zip"

	# mv MWLL-Installer.exe GameInstaller.exe

        POL_SetupWindow_wait_next_signal "$(eval_gettext 'Extracting the archive...')" "$TITLE"
        POL_System_unzip "giganticarmy_trial.zip" -d "$WINEPREFIX/drive_c/game/"
...
if [ "$APP_ANSWER" == ".EXE" ]; then
        ...
        POL_SetupWindow_wait_next_signal "$(eval_gettext 'Extracting the archive...')" "$TITLE"
        POL_System_unzip "$APP_ANSWER" -d "$WINEPREFIX/drive_c/AGS/"
...
iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCXjwGVQAKCRDlMfrJqhPK
R1omAJ4okfGJtbTaJmmnW1kVHc41d97CswCdGRDaCdL9lNs4GMo2ziA7cbOFUlk=
=D0Pd
-----END PGP SIGNATURE-----
