...
#
# TESTED Editions: first released in 2006 or 2007.
#
...
#
# CHANGELOG
# [Dadu042] (2020-07-15 11-00)
#   Initial script.
#
# KNOWN ISSUES :
#  - Wine amd64 4.0.4: on the main menu the game crashes after clicking 'Quick race'. Tried: quartz, xact, directmusic + dsound. Fix: Wine 3.20 + directmusic and dsound.
#
# KNOWN ISSUES (FIXED):
#  - Wine amd64 4.0.4: X
#
...
TITLE="Armageddon Racers"
PREFIX="Armageddon_Racers"
EDITOR=""
GAME_URL="http://www.gamehitzone.com/download-free-games/armageddon-racers/"
AUTHOR="Dadu042"
STEAM_ID=""
GAME_VMS="256"
SHORTCUT_FILENAME="ArmageddonRacers.exe"
...
if [ "$INSTALL_METHOD" == "STEAM" ]; then
        ...
        POL_Download "http://www.gamehitzone.com/dl/ArmageddonRacers.exe"
          
        mv ArmageddonRacers.exe GameInstaller.exe
...
iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCXw76/wAKCRDlMfrJqhPK
RybdAJ9So0ucKmumTB17dSKaTnuI2279WwCfYjNzj3QHoaEuMdtis5PmcPxKemM=
=LX4t
-----END PGP SIGNATURE-----
