...
# Distribution used to test : XUbuntu 18.04 64 bits (Linux kernel v5.3), GPU: Intel HD 4000.
# Author : Dadu042
# Licence : Retail
...
# TESTED Editions: 
#
# Middlewares used by this software : UE4, vcrun2015
#
#
#
# CHANGELOG
# [Dadu042] (2020-07-26 10-00)
#   Initial script.
# [Dadu042] (2020-07-26 16-00)
#   Add d3dx9_47 to fix the incomplete graphics issue (black on the borders).
#
# KNOWN ISSUES :
#  - Wine amd64 5.0.1: some parts of the moutains are black. Fix: DXVK_161
#  - Wine amd64 5.0.1: when showing new units, there is the text but not the picture of the new unit.
#
# KNOWN ISSUES (FIXED):
#  - Wine amd64 4.0.4: crash when loading ('LogWindows: Error: [Callstack]'). Fix: Wine 5.0.1
#  - Wine amd64 5.0.1: game background is black, making the game unplayable. Tried: DXVK161. IGP used is Intel HD 4000.
#               On a AMGPU Vega 11, I get a crash as soon I try to launch a 'endless game' from the main menu. Fix : DXVK_161.
       
[ "$PLAYONLINUX" = "" ] && exit 0
source "$PLAYONLINUX/lib/sources"
              
TITLE="Armoured Onslaught"
PREFIX="Armoured_Onslaught"
EDITOR=""
GAME_URL="http://teamhotstuff.net/"
AUTHOR="Dadu042"
STEAM_ID="1236000"
GAME_VMS="512"
SHORTCUT_FILENAME="SSTD.exe"
...
iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCXyMK5gAKCRDlMfrJqhPK
R7VvAJ917zV60v6aG0CH1tSt9IXZJRppWgCfWuHIrbHBMmvm1JwVTUnmxdZjajQ=
=O1D/
-----END PGP SIGNATURE-----
