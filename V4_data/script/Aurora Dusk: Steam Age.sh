...
#
# TESTED Editions: DDV, 2019-05 (.EXE file date).
#
# Middlewares used by this software : Adobe Air v32.
#
# CHANGELOG
...
#
# KNOWN ISSUES:
#  - Wine amd64 4.0.3: Adobe Air does not recognize a suitable version. Fix: run Aurora.exe instead of 'Aur*.exe'.*
#  - Wine amd64 4.0.3: on launching, the elf laying on the ground does appear, but nothing more. Fix: Wine 4.21
#
# KNOWN ISSUES (FIXED):
#  - Wine amd64 4.0.3: X
...
TITLE="Aurora Dusk: Steam Age"
PREFIX="aurora_dusk_steam_age"
EDITOR="Sylvain Harlaut"
GAME_URL="http://www.aurora-dusk.com/"
AUTHOR="Dadu042"
STEAM_ID="397160"
GAME_VMS="128"
SHORTCUT_FILENAME="Aurora.exe"
...
iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCYBXMhQAKCRDlMfrJqhPK
Rws6AJwOJR8CpPcuxAM7EsExFUNnuc1+pgCgqwvDYJm2ZpSps8mW3kjdkGYup8Q=
=fZaI
-----END PGP SIGNATURE-----
