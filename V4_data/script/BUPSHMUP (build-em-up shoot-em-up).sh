...
#
# TESTED Editions: v0.21 alpha (2020)
#
# Middlewares used by this software : Unity 2019.2, DirectX 11.
#
#
#
# CHANGELOG
...
#
# KNOWN ISSUES :
#  - Wine amd 64 4.0.4: crash after showing a Unity warning message ('!'). Fix: Wine 4.21
# 
#
# KNOWN ISSUES (FIXED):
#  - Wine amd64 4.0.4: X
...
TITLE="BUPSHMUP (build-em-up shoot-em-up)"
PREFIX="BUPSHMUP"
EDITOR=""
GAME_URL=""
AUTHOR="Dadu042"
...
if [ "$INSTALL_METHOD" == "STEAM" ]; then
        ...
        POL_Download "https://bankie.com/downloads/BUPSHMUPa0-21.zip"
...
iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCX2orIgAKCRDlMfrJqhPK
R3tlAJ4+WAHZbw9DvNxn6z/idjmimJ0G2QCcDw9/YiJ/dlJt8KOuL7xNtp+Xows=
=UNlp
-----END PGP SIGNATURE-----
