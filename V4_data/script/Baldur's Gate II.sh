...
PREFIX="BaldursGate2"
EDITOR="BioWare"
GAME_URL="http://www.bioware.com/games/shadows_amn/"
AUTHOR="GNU_Raziel"
...
if [ "$INSTALL_METHOD" == "CD" ]; then
	...
	POL_SetupWindow_cdrom
	POL_SetupWindow_check_cdrom "baldur.exe"
	POL_Wine start /unix "$CDROM/Setup.exe"
	POL_Wine_WaitExit "$TITLE"
else
...
iEYEABECAAYFAk+UMS8ACgkQ5TH6yaoTyke4NgCghF3Wis/2bGFmRua+2sWfmUoq
nPAAoJWYfUdYEGlPqhC9qKpSRqvNVYOh
=Y5Q1
-----END PGP SIGNATURE-----
