...
#
# TESTED Editions: DDV (setup_balls_of_steel_2.0.0.16.exe, game is v1.3 displayed on the main menu).
#
...
#   Brand new script.
#   Allow install from CD and from local .EXE file.
#   Wine 1.5.10 -> 3.0.3
#
#
# KNOWN ISSUES:
#  - Wine amd64 3.0.3: game runes too fast (CPU used: Intel I5-3210M).
#
# KNOWN ISSUES (FIXED):
#  - Wine amd64 4.0.3: X
...
PREFIX="balls_steel"
EDITOR=""
GAME_URL="https://en.wikipedia.org/wiki/Balls_of_Steel_(video_game)"
AUTHOR="Dadu042"
STEAM_ID=""
GAME_VMS="128"
SHORTCUT_FILENAME="ba*.exe"
...
iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCXiwaVQAKCRDlMfrJqhPK
R4cxAJ9A+85iCFoTWUH2JCxKg11qqMFBgQCfYVrssUKt5CEx5thDmAQB7yS/AkU=
=A118
-----END PGP SIGNATURE-----
