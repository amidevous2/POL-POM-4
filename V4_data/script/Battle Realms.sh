...
#
# TESTED Editions: GOG.com v1.0.0.8 (game v1.50q, readable in Options -> Game options).
#
# Middlewares used by this software : ?.
#
# CHANGELOG
# [Dadu042] (2019-11-27 11:00)
#   First script.
# [Dadu042] (2019-11-27 11:20)
#   Wine 4.0.2 -> System. Note: Does also run with Wine 3.0.3
# [Dadu042] (2019-11-27 21:20)
#   Fix music (force Alsa).
#
# KNOWN ISSUES:
#  - Wine x86 4.0.2: crash when fighing the 'first queen' (Mistress Yvaine), happened 1 time.
#  - Wine x86 3.0.3, 4.0.2: crash when launched. Tried: disable OpenGL, GLSL. Fix: create virtual desktop (1024x768).
#  - Wine x86 2.22: 'Could not find supported display mode.'
#  - Wine x86 4.19: desktop disturbed (KDE) 
#
...
TITLE="Battle Realms"
PREFIX="battle_realms"
EDITOR="Ubisoft"
GAME_URL="https://en.wikipedia.org/wiki/Battle_Realms"
AUTHOR="Dadu042"
STEAM_ID=""
WORKING_WINE_VERSION=""
GAME_VMS="256"
SHORTCUT_FILENAME="Battle_Realms_F.exe"
...
iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCXd7bfAAKCRDlMfrJqhPK
R2CaAJ9P0I/EK4QgcLEmyvodSZNyvZMCXwCfSZCt1JwhQihMOFDmaFxeFSba7PA=
=kda8
-----END PGP SIGNATURE-----
