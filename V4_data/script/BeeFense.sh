...
#
# TESTED (with succcess): v1.4 (version visible in the Settings menu)
#
# Game based on : Mono, Unity, d3d9.
#
# CHANGELOG
# [Dadu042] (2019-08-12)
#   First script.
...
GAME_URL="https://byterockers.games"
AUTHOR="Dadu042"
STEAM_ID="609990"
...
if [ "$INSTALL_METHOD" == "STEAM" ]; then
        ...
        POL_Shortcut "BeeFense.exe" "$TITLE" "$TITLE.png" ""  "Game;ArcadeGame"
...
if [ "$APP_ANSWER" == ".EXE" ]; then
        ...
        POL_Shortcut "BeeFense.exe" "$TITLE" "$TITLE.png" ""
...
iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCYBXTDgAKCRDlMfrJqhPK
R1LlAKCgIC8/VTWgx77IZR9DldJfQos9HwCgj71GIGncEuDDpiHxVZwIuxkFpOg=
=uS0k
-----END PGP SIGNATURE-----
