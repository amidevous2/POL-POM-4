...
#
# TESTED Editions: Demo.
#
# Middlewares used by this software : DirectX 9, 10.
#
#
# CHANGELOG
# [Dadu042] (2020-04-21 23-50)
#   Initial script.
#
# KNOWN ISSUES :
#  - Wine amd64 5.0: when launching the game something does crash, but the game continues to load.
#  - Wine amd64 5.0: when playing the mouse view does sometimes lock (known issue on Appdb.winehq.org: 'Mouse axes confined to 360° zones').
#
# KNOWN ISSUES (FIXED):
#  - Wine x865.0: X
# 
...
TITLE="BioShock (demo)"
PREFIX="BioShock_demo"
EDITOR=""
GAME_URL="https://en.wikipedia.org/wiki/BioShock"
AUTHOR="Dadu042"
STEAM_ID=""
GAME_VMS="256"
SHORTCUT_FILENAME="Bio*.exe"
...
iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCYkOPxAAKCRDlMfrJqhPK
R4b6AKCvyiyFzEhB/ygGBfP+Hcitt8pRGgCgsmqNUNMvRjZeZtczKLjKtW+vAW8=
=9/8M
-----END PGP SIGNATURE-----
