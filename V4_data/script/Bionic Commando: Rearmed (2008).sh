...
#
# TESTED Editions: unofficial .ISO (july 2009).
#
...
#
# KNOWN ISSUES:
#  - Wine x86 4.0.2: the game edition I tried required Physx installation in order to launch.
#  - Wine x86 4.0.2: music is OK (in spite the content of the log).
#  - Wine x86 4.0.2: Game does crash after exiting: 0033:fixme:d3d:state_linepattern_w Setting line patterns is not supported in OpenGL core contexts.
...
TITLE="Bionic Commando: Rearmed (2008)"
PREFIX="Bionic_Commando_Rearmed_2008"
EDITOR="Capcom"
GAME_URL="https://en.wikipedia.org/wiki/Bionic_Commando_Rearmed"
AUTHOR="Dadu042"
STEAM_ID="21680"
WORKING_WINE_VERSION="4.0.2"
GAME_VMS="256"
SHORTCUT_FILENAME="bcr.exe"
...
if [ "$INSTALL_METHOD" == "STEAM" ]; then
 ...
 #       POL_Shortcut_InsertBeforeWine "$SHORTCUT" "trap 'xrandr -s 0' EXIT"
        ...
        POL_Download "http://files.myplaycity.com/files_downloader_temp/soldiervsaliens_setup.exe"
        POL_Wine "soldiervsaliens_setup.exe" "/SILENT"
...
iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCXad6lAAKCRDlMfrJqhPK
RxIaAJ489X/yGCRQufT0nFeE24w1feOkewCdFs+VKARJLYEwGZ0FKcG6DMoZD60=
=GdzL
-----END PGP SIGNATURE-----
