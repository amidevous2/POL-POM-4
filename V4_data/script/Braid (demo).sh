...
#
# TESTED Editions: - OK: demo v1.015, 2009-04 (Braid.exe)
# 
...
if [ "$INSTALL_METHOD" == "STEAM" ]; then
        ...
        POL_Download "https://archive.org/download/Braid_demo/Braid_demo.zip"

        POL_SetupWindow_wait_next_signal "$(eval_gettext 'Extracting the archive...')" "$TITLE"
        POL_System_unzip "Braid_demo.zip" -d "$WINEPREFIX/drive_c/"

        POL_Wine "braid_demo.exe" # "/SILENT"
        ...
        POL_Shortcut "braid.exe" "$TITLE" "" "" "$SOFTWARE_CATEGORIES"
        POL_Shortcut_Document "$TITLE" "READ_ME.txt"
...
iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCXbr5lQAKCRDlMfrJqhPK
R6UfAJ4w4T8fnUujv5myQq6SacFS29IxrQCfZu7DneICVwRLlStBohsql6JYNYg=
=bDqh
-----END PGP SIGNATURE-----
