...
#
# CHANGELOG
# [tef ?] (2009-09-11 13-00)
#   Initial script.
# [Danny-POL] (2015-05-30 01-17)
#   ...
# [Dadu042] (2020-01-22 21:30)
#   Wine 1.6.2 -> 3.0.3
#   Improve POL_Shortcut
#   Standardize POL_Function_NoCDWarning
# [Dadu042] (2020-02-22 22:30)
#   Brand new script (allows install from local file). 
#
#
# KNOWN ISSUES
#  - Wine x86 3.0.3, 3.20: the installer of the demo does never end. Fix: Wine 4.0.3 and 4.21
#
# KNOWN ISSUES (FIXED):
#  - Wine amd64 3.0.3: X
...
PREFIX="COD2"
EDITOR="Activision"
GAME_URL="https://en.wikipedia.org/wiki/Call_of_Duty_2"
AUTHOR="Dadu042"
STEAM_ID=""
GAME_VMS="64"
SHORTCUT_FILENAME="COD2SP_s.exe"
...
if [ "$INSTALL_METHOD" == "STEAM" ]; then
        ...
        POL_Shortcut "$SHORTCUT_FILENAME" "$TITLE - Singleplayer" "" "" "$SOFTWARE_CATEGORIES"
        POL_Shortcut_Document "$TITLE" "$DOCUMENT_FILE"

        POL_Shortcut "CoD2MP_s.exe" "$TITLE - Multiplayer" "" "" "$SOFTWARE_CATEGORIES"
...
iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCXlGSnAAKCRDlMfrJqhPK
Rxg3AKCNqO26f9CF7B+fziF3vH4wNwRobgCcCqjJm2a6qNdWXh/aA7rRa3EHMAc=
=Ki1l
-----END PGP SIGNATURE-----
