...
#
# TESTED Editions:  DVD-ROM (latest files: 2007-09-21)
#
# Middlewares used by this software : Physx .
#
# CHANGELOG
# CHANGELOG
# [otty] (2011-08-12 17:15)
#   Initial script (forked from GNU_Raziel's).
# [Dadu042] (2020-01-27 17:00)
#   Wine 1.2.3 -> 2.22
# [Dadu042] (2020-01-28 19:00)
#   New script.
#   Wine 2.22 -> 3.0.3
#
#
# KNOWN ISSUES:
#  - Wine x86 4.0.3: DRM prevent the game to run (DVD not detected). Fix: NoCD.
#  - Wine x86 2.22: Azerty keyboard not detected. Fix: Wine 3.0.3
#  - Wine x86 3.20: micro freezes, big log file (fixme:d3d:wined3d_texture_add_dirty_region Ignoring dirty_region ...).
#
# KNOWN ISSUES (FIXED):
#  - Wine amd64 4.0.3: X
...
PREFIX="Jericho"
EDITOR="Codemasters"
GAME_URL="https://en.wikipedia.org/wiki/Clive_Barker%27s_Jericho"
AUTHOR="Dadu042"
STEAM_ID="11420"
GAME_VMS="256"
SHORTCUT_FILENAME="Jer*.exe"
...
POL_SetupWindow_InstallMethod "LOCAL,DVD,STEAM,STEAM_DEMO"
...
if [ "$INSTALL_METHOD" == "STEAM" ]; then
        ...
        # POL_SetupWindow_check_cdrom jericho.css"
...
iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCXjKZrgAKCRDlMfrJqhPK
R+iqAJ46GkuMljjx2VLAhf70ISsHyCsEIwCgscEl4Bia5kUodTW1cFTSfiIWZBk=
=oTkL
-----END PGP SIGNATURE-----
