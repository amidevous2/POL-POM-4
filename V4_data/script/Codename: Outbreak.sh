...
#
# TESTED Editions: - retail CD-ROM (v1.0 or v1.0 patched, folders date: 2002-09-02).
#                  - GOG's v2.0.0.6
#
# Middlewares used by this software : Vital engine, DirectX 8.
#
# CHANGELOG
# [Dadu042] (2020-02-15 17:33)
#   Initial script.
#
#
# KNOWN ISSUES:
#  - Wine amd64 4.0.3, 5.0, 5.1: launching not reliable (black screen window). Tried: patch v2.1, UseVideoTextures=0 (in Game.ini).
#  - Wine amd64 4.0.3, 5.0: hard to set right resolution (no more than 800x600). Workaround: once selected in the Config, press the key Enter to close the black window.
#  - Wine amd64 4.0.3, 5.0, 5.1: looping sound on main menu. Tried: patch v2.1. Seems to be related to the mouse click.
#  - Wine amd64 5.0, 5.1, 4.0.3: the CD's setup does crash as soon as launched. Cause: Alsa (not enabled in my previous tests). 
#
# KNOWN ISSUES (FIXED):
#  - Wine amd64 3.0.3: X
...
TITLE="Codename: Outbreak"
PREFIX="Codename_Outbreak"
EDITOR="GSC Game World"
GAME_URL="https://en.wikipedia.org/wiki/Codename:_Outbreak"
AUTHOR="Dadu042"
STEAM_ID=""
GAME_VMS="128"
SHORTCUT_FILENAME="OutBreak.exe"
...
POL_SetupWindow_message "Warning, do not install the softwares provided by the game: Gamespy, Indeo, DirectX." "$TITLE"
...
if [ "$INSTALL_METHOD" == "STEAM" ]; then
        ...
        POL_SetupWindow_check_cdrom "OutbreakSetup.exe"
        POL_Wine start /unix "$CDROM/OutbreakSetup.exe"
        ...
        POL_Shortcut "Config.exe" "$TITLE - Config" "" "" "$SOFTWARE_CATEGORIES"
...
iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCXkhrRAAKCRDlMfrJqhPK
R0bxAJwIpSiqRVrMKwpMzMOsrG+xSGD49gCfUZ8bhx3qM/G7eaiDRSiYLn/4Ubc=
=HfDM
-----END PGP SIGNATURE-----
