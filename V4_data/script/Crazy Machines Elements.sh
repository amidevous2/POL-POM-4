...
#
# TESTED Edition: local v1.01, 2011.
#
...
#
# KNOWN ISSUES:
#  - Wine amd64 4.0.2: some unusual reports in the log (AL lib: (EE) ReleaseThreadCtx: Context 0x7c318090 current for thread being destroyed, possible leak!).
#  - Wine amd64 4.9: crash when loading.
#
...
TITLE="Crazy Machines Elements"
PREFIX="CrazyCrazy_Machines_Elements"
EDITOR="Viva Media"
GAME_URL=""
AUTHOR="Dadu042"
STEAM_ID="206410"
...
GAME_VMS="256"
SHORTCUT_FILENAME="cmElements.exe"
...
iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCXfDt8gAKCRDlMfrJqhPK
R8UwAKCiJOqvsrJv6smKETPEZXH5aYM+SgCglbrO/M4ljZLCU24ZyDymShItkz0=
=1/3c
-----END PGP SIGNATURE-----
