...
#
# TESTED EDITION: v1.0.0-96902 (displayed on main menu).  2019-09-07 ?.
#
# Middlewares used by this software : Unreal engine 4, FMOD, Physx, DirectX 9.
#
# CHANGELOG
# [Dadu042] (2019-09-12)
#   First script.
...
#
# KNOWN ISSUES:
#  - Wine amd64 4.0.2, 3.0.5: main menu (and Options menu) is very laggy, almost impossible to use. Fix: in the Options menu decrease the FPS (images per second) and decrese the video Quality.
#  - Wine amd64 4.0.2, 3.0.5: low FPS on a iGPU 'Intel HD Graphics 530'.
#  - Wine amd64 4.0.2: installing d3dx9_43 does not increase FPS and makes more graphic rendering trouble.
#  - Wine amd64 4.15, 4.8: game does crash when loading (perhaps because of X3DAudio/libFAudio on my PC).
#
...
PREFIX="CreatureintheWell"
EDITOR="Flight School Studio"
GAME_URL="https://www.creatureinthewell.com"
AUTHOR="Dadu042"
STEAM_ID="852300"
WORKING_WINE_VERSION="4.15"
GAME_VMS="256"
SHORTCUT_FILENAME="CITW.exe"
...
iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCXXpQRwAKCRDlMfrJqhPK
R6oYAKCzHAqpLROPOeFL278mOHJW8Ue8aQCcDUyUYyl2ZzmJV9sw2xaJDHbimyA=
=XQuD
-----END PGP SIGNATURE-----
