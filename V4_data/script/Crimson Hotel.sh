...
# TESTED (with success): 
#
# Middlewares used by this software : Unity 2018.3, Mono.
#
# CHANGELOG
# [Dadu042] (2019-09-02)
#   First script.
...
#
# KNOWN ISSUES:
#  - Wine amd64 4.0.2: does crash when launching (Unhandled exception: page fault on read access to 0xc00088fa8 in 64-bit code (0x000000007bca06dd)). Fix: Wine 4.15
#  - Wine amd64 4.15: after the intro credit screen ('Spire Interactive'), the background reappears, and the music, but the game freeze there (after lots of '0045:fixme:d3d_shader:shader_sm4_read_instruction_modifier Unhandled modifier'). Tried: force-d3d10, Install_d3dx11, install_mono210. GPU used: Intel HD Graphics 4400.
#  - Wine amd64 4.15: when doing alt+tab, the mouse cursor gets inactive. Fix?: virtual desktop.
...
TITLE="Crimson Hotel"
PREFIX="Crimson_Hotel"
EDITOR="Spire Interactive"
GAME_URL="https://store.steampowered.com/app/1140500/Crimson_Hotel/"
AUTHOR="Dadu042"
STEAM_ID="1140500"
WORKING_WINE_VERSION="4.15"
GAME_VMS="512"
SHORTCUT_FILENAME="Crimson Hotel.exe"
...
iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCXY3COAAKCRDlMfrJqhPK
R/cbAJ9MIlgcbEXO5oYOmal99NmjVHv+hACeNaIPy3Bhxg/WdoJBJIxY0zfyjSw=
=wEkZ
-----END PGP SIGNATURE-----
