...
#
# CHANGELOG
# [Dadu042] (2020-01-14 20-40)
#   Initial script.
#
# KNOWN ISSUES:
#  - Wine amd64 3.0.3, 3.20: X
#
# KNOWN ISSUES (FIXED):
#  - Wine amd64 3.0.3: X
...
PREFIX="cybernoid2"
EDITOR=""
GAME_URL="http://retrospec.sgn.net/game-links.php?link=cybernoid2"
AUTHOR="Dadu042"
STEAM_ID=""
GAME_VMS="64"
SHORTCUT_FILENAME="cybernoid2.exe"
...
if [ "$INSTALL_METHOD" == "STEAM" ]; then
        ...
        POL_Download "http://retrospec.sgn.net/users/ggoring/cybernoid2v1001.zip"

        POL_SetupWindow_wait_next_signal "$(eval_gettext 'Extracting the archive...')" "$TITLE"
        POL_System_unzip "cybernoid2v1001.zip" -d "$WINEPREFIX/drive_c/game/"
...
iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCXh4b+QAKCRDlMfrJqhPK
RxbgAJ9t4b2cTx6FXX/OSalJ95+lu9hvMgCeOAjWVMreNkyJth4jyJeCa3kWhL8=
=bJ/+
-----END PGP SIGNATURE-----
