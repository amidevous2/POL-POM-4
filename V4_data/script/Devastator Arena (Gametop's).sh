...
#
# KNOWN ISSUES :
#  - Wine amd64 5.0: huge debug log file (d3d:wined3d_device_resolve_sub_resource Multisample resolve is not fully supported for typeless formats). Shorter with Wine 5.7
#
#
# KNOWN ISSUES (FIXED):
#  - Wine amd64 4.0.4, 5.0, 5.7: X
#
...
PREFIX="Devastator_Arena"
EDITOR="Gametop.com"
GAME_URL="https://www.gametop.com/download-free-games/devastator-arena/"
AUTHOR="Dadu042"
STEAM_ID=""
GAME_VMS="512"
SHORTCUT_FILENAME="DevastatorArena.exe"
...
if [ "$INSTALL_METHOD" == "STEAM" ]; then
        ...
        POL_Download "https://cdn.gametop.com/free-games-download/Devastator-Arena.exe"
         
        mv Devastator-Arena.exe GameInstaller.exe
...
iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCXtAvRwAKCRDlMfrJqhPK
R5QGAJ40TqwtusXaMrhN7RoW3td2w7JEpACfddg+kxwHfn2K7AwyvqFFPAzD61k=
=Q9iW
-----END PGP SIGNATURE-----
