...
#
# TESTED Editions: v1.1
#
# Middlewares used by this software : Unreal.
#
#
#
# CHANGELOG
# [Dadu042] (2020-06-05 15-00)
#   Initial script.
# [Dadu042] (2020-06-09 15-00)
#   Wine 5.0 -> 5.0.1
#
# KNOWN ISSUES :
#
# KNOWN ISSUES (FIXED):
#  - Wine amd64 4.0.4: crash at the end of installation (and when launched from UDK.exe). Tried: dotnet40. workaround: Wine 5.0 (without dotnet40).
#  - Wine amd64 5.0 (+ dotnet40): installation does start but freeze on the Unreal splash window (AMD GPU). Fix: do not install POL_Install_dotnet40 
#  - Wine amd64 5.0 (+ dotnet40): after the Unreal full screen logo, the screen is black but the game does run (music), only some text does appear ('Console events'). Fix: DXVK_161
#
   
[ "$PLAYONLINUX" = "" ] && exit 0
source "$PLAYONLINUX/lib/sources"
          
TITLE="Dream of the Blood Moon"
PREFIX="Dream_Blood_Moon"
EDITOR="TheUnbeholden"
GAME_URL="https://www.indiedb.com/games/dream-of-the-blood-moon"
AUTHOR="Dadu042"
STEAM_ID=""
GAME_VMS="512"
SHORTCUT_FILENAME="UDK.exe"
...
iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCXt/CSwAKCRDlMfrJqhPK
R+pZAJ48P9p8e+lJO+NMEt7Hop8Rz4lvpQCfZwSlKYoRJzNGQyZHexNc0U64aME=
=fjBg
-----END PGP SIGNATURE-----
