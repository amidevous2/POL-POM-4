...
TITLE="DroneSwam (2007)"
PREFIX="DroneSwam_2007"
EDITOR="Conor O'Kane"
GAME_URL="http://www.cokane.com/games.html"
AUTHOR="Dadu042"
STEAM_ID=""
GAME_VMS="128"
SHORTCUT_FILENAME="DroneSwarm.exe"
...
if [ "$INSTALL_METHOD" == "STEAM" ]; then
        ...
        # POL_SetupWindow_message "$(eval_gettext '\n\nNote: this script will download the beta .')" "$TITLE"
        POL_Download "http://droneswarm.com/files/DroneSwarm_0.1.9.zip"
...
iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCXkRgSQAKCRDlMfrJqhPK
R5LrAJ9ABXkX9belJ0B5YeeCZtXyET0PEQCcDsNd6JcEeX7YwLYkAYjRIqK6dvs=
=oCFA
-----END PGP SIGNATURE-----
