...
#
# TESTED Editions: dune4full.zip  '2018' (patched).
#
# Middlewares used by this software : ?.
#
# CHANGELOG
# [Dadu042] (2020-01-24 11:30)
#   Initial script.
#
#
# KNOWN ISSUES:
...
TITLE="DUNE IV (by V.D.)"
PREFIX="dune_IV"
EDITOR="Vladislav Demjanishin"
GAME_URL="http://sulfurzona.com/index.php?art=32"
AUTHOR="Dadu042"
STEAM_ID=""
GAME_VMS="32"
SHORTCUT_FILENAME="DuneRun.exe"
...
if [ "$INSTALL_METHOD" == "STEAM" ]; then
        ...
        POL_Download "https://archive.org/download/DuneIV/DuneIV.zip"
 
        POL_SetupWindow_wait_next_signal "$(eval_gettext 'Extracting the archive...')" "$TITLE"
        POL_System_unzip "DuneIV.zip" -d "$WINEPREFIX/drive_c/game/"
...
POL_SetupWindow_menu "$(eval_gettext 'Do you have a patch-update ?')" "$TITLE" "$(eval_gettext 'Yes')~$(eval_gettext 'No')" "~"      
...
iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCXirNvwAKCRDlMfrJqhPK
R6ADAJ959C/izGz43lxusrs1RjVW11pd5wCfQFCCcpc3QzqxevT28Hu+/FnlfdM=
=9u/j
-----END PGP SIGNATURE-----
