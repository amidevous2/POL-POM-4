...
#
# TESTED Editions: 2010 (game.exe) DDV from MyPlayCity.com
#
...
#
# KNOWN ISSUES:
#  - Wine amd64 3.0.3: crash after playing 10 min:
#     0009:fixme:win:EnumDisplayDevicesW ((null),0,0x33f3e8,0x00000000), stub!
#     0009:fixme:d3d:swapchain_gl_present WINED3D_SWAP_EFFECT_FLIP not implemented.
#     wine: Unhandled page fault on write access to 0x025bea30 at address 0x1678741 (thread 0030), starting debugger...
#     To try: disable GLSL (POL/POM: setup -> Display)
...
if [ "$INSTALL_METHOD" == "STEAM" ]; then
        ...
        POL_Download "http://files.myplaycity.com/files_downloader_temp/evoly_setup.exe"
        POL_SetupWindow_message "$(eval_gettext 'Note: we recommend you to uncheck all the checkboxes:\n[x] -> [ ]')" "$TITLE"
        POL_Wine "evoly_setup.exe" # "/SILENT"
...
iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCXcRTFQAKCRDlMfrJqhPK
R0OMAKCzA3ZbR5pwPrAXuDBPzXxZJc2xwgCeN9fAmjWzsRjEGPkAD7r16Y5gs0c=
=jb9m
-----END PGP SIGNATURE-----
