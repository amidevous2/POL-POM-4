...
#
# TESTED Editions: local ZIP fceux-2.2.3-win32.zip
#
...
PREFIX="FCEUX"
EDITOR=""
GAME_URL="https://en.wikipedia.org/wiki/FCEUX"
AUTHOR="Dadu042"
STEAM_ID=""
WORKING_WINE_VERSION="4.0.3"
GAME_VMS="256"
SHORTCUT_FILENAME="fceux.exe"
...
if [ "$INSTALL_METHOD" == "STEAM" ]; then
        ...
        POL_SetupWindow_message "$(eval_gettext '\nNote: this script will download the v1.29 (2019-11).')" "$TITLE"

        cd "$WINEPREFIX/drive_c"
        POL_Download "https://github.com/AppleWin/AppleWin/releases/download/v1.29.6.0/AppleWin1.29.6.0.zip"

        POL_SetupWindow_wait_next_signal "$(eval_gettext 'Extracting the archive...')" "$TITLE"
        POL_System_unzip "AppleWin1.29.6.0.zip" -d "$WINEPREFIX/drive_c/applewin/"
...
if [ "$APP_ANSWER" == ".EXE" ]; then
        ...
        POL_SetupWindow_wait_next_signal "$(eval_gettext 'Extracting the archive...')" "$TITLE"
        POL_System_unzip "$APP_ANSWER" -d "$WINEPREFIX/drive_c/fceux/"
        POL_Shortcut "$SHORTCUT_FILENAME" "$TITLE" "" "" "$SOFTWARE_CATEGORIES"
...
iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCXfO7zQAKCRDlMfrJqhPK
R7Z4AJ9vK1dnAF9DKlsctmkc3do265cS4QCdESv28ys6TaupG23QBdBrXGbMXxw=
=8afv
-----END PGP SIGNATURE-----
