...
#
# TESTED Editions: v1.02.
#
# Middlewares used by this software : .
#
#
# CHANGELOG
# [Dadu042] (2020-02-20 15:30)
#   First script. 
# [Dadu042] (2020-03-03 09:30)
#   Wine 3.0.3 -> 3.20 (this display a few japanese characters).
#   Fix doc link.
#
#
# KNOWN ISSUES
#  - Wine x86 3.0.3, 3.20: full screen option (in the game) does not work.
#
# KNOWN ISSUES (FIXED):
#  - Wine amd64 3.0.3: X
...
PREFIX="G-Type"
EDITOR="CnC Darkside"
GAME_URL="http://www.acid-play.com/download/g-type"
AUTHOR="Dadu042"
STEAM_ID=""
GAME_VMS="128"
SHORTCUT_FILENAME="G-TYPE.exe"
...
if [ "$INSTALL_METHOD" == "STEAM" ]; then
        ...
        POL_SetupWindow_message "$(eval_gettext '\n\nNote: this script will download the v1.02 .')" "$TITLE"
        POL_Download "https://archive.org/download/gtype102_201608/gtype102.exe"

        mv gtype102.exe GameInstaller.exe
        POL_SetupWindow_message "$(eval_gettext '\n\nSelect this path for extraction: .playonlinux/wineprefix/g-type/drive_c/ ')" "$TITLE"
...
iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCXl4XgQAKCRDlMfrJqhPK
Ryi3AJwNxrehLdgrkmw5+JXlvmPjX6tGJACgo9LGonKuLKlIlA/pCy9wHzeyaM8=
=Ro/t
-----END PGP SIGNATURE-----
