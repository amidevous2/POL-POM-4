...
#
# TESTED Editions: GOG release v2.0.0.3
#
#
# Middlewares used by this software : QuickTime .
#
#
# CHANGELOG
...
#
# KNOWN ISSUES :
#  - Wine x86 5.11: no sound nor music. Tried: amstream
#
#
# KNOWN ISSUES (FIXED):
#  - Wine x86 4.0.4, 5.0.1: launcher.exe does set the resolution to 800x600 then crash. Fix: Wine 5.11

[ "$PLAYONLINUX" = "" ] && exit 0
source "$PLAYONLINUX/lib/sources"

TITLE="Bad Mojo Redux (GOG)"
PREFIX="Bad_Mojo_redux_GOG"
EDITOR=""
GAME_URL="https://en.wikipedia.org/wiki/Bad_Mojo"
AUTHOR="Dadu042"
STEAM_ID=""
GAME_VMS="128"
...
iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCXwc4yAAKCRDlMfrJqhPK
R0mQAJ47cOpgvSkut4o/eLtn+3F9UR5J1wCffrtK35bRQFQU9w3nsvTNduXZLuk=
=DKlA
-----END PGP SIGNATURE-----
