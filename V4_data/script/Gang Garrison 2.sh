...
#
# TESTED Editions: v2.9.2 (.ZIP).
#
# Middlewares used by this software : GameMaker 8.
#
# CHANGELOG
# [Dadu042] (2020-01-10 14-13)
#   Initial script (Wine 3.0.3).
# [Dadu042] (2020-01-11 23-30)
#   Add support for download (even if the link will break on next game release).
# [Dadu042] (2020-01-12 18-00)
#   Disable sound because of the jerkiness issue.
#   Arch: 64bits -> 32bits.
#
# KNOWN ISSUES:
#  - Wine x86 3.0.3 + dsound or directmusic : 'No sound device detected. Sounds might not play.' (when game is launching).
#  - Wine x86 3.0.3, 4.0.4, 5.0.3, + dsound: jerkiness when shooting (because of the sound). Note: Crossover v20 (+ directmusic) does not have the jerkiness issue.
#
# KNOWN ISSUES (FIXED):
#  - Wine amd64 3.0.3: no sound nor music. Tried: alsa, xact, quartz. Fix: dsound (it seems to do the same job as Directmusic).
...
PREFIX="gang_garrison_2"
EDITOR=""
GAME_URL="https://en.wikipedia.org/wiki/Gang_Garrison_2"
AUTHOR="Dadu042"
STEAM_ID=""
GAME_VMS="64"
SHORTCUT_FILENAME="Gang*.exe"
...
if [ "$INSTALL_METHOD" == "STEAM" ]; then
        ...
        POL_SetupWindow_message "$(eval_gettext '\n\nNote: this script can only download v2.9.2 (2019).')" "$TITLE"
        POL_Download "http://static.ganggarrison.com/Gang%20Garrison%202%20v2.9.2.zip"
        cp Gang%20Garrison%202%20v2.9.2.zip gang_garrison.zip
 
        POL_SetupWindow_wait_next_signal "$(eval_gettext 'Extracting the archive...')" "$TITLE"
        POL_System_unzip "gang_garrison.zip" -d "$WINEPREFIX/drive_c/game/"
...
iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCX+osmwAKCRDlMfrJqhPK
RyDkAJ47nh8IkXKbEa/JAkaGFFgC/Qr9lwCeLtkaAmSlPyPb45uapeEpIvTL+/4=
=ZzpL
-----END PGP SIGNATURE-----
