...
#
# CHANGELOG
# [Dadu042] (2020-01-19 12:20)
#   Initial script.
#
# KNOWN ISSUES:
#  - Wine x86 3.0.3: it runs too fast.
#
#
# KNOWN ISSUES (FIXED):
#  - Wine amd64 4.0.3: X
...
TITLE="Guimo"
PREFIX="guimo"
EDITOR="Southlogic Studios (Jack In The Box Computing)"
GAME_URL="http://southlogic.com/sl/sl_language_1.html"
AUTHOR="Dadu042"
STEAM_ID=""
GAME_VMS="32"
SHORTCUT_FILENAME="WinGuimo.exe"
...
if [ "$INSTALL_METHOD" == "STEAM" ]; then
        ...
        POL_Download "https://archive.org/download/WinGuimo1.0b/WinGuimo1.0b.zip"

        POL_SetupWindow_wait_next_signal "$(eval_gettext 'Extracting the archive...')" "$TITLE"
        POL_System_unzip "WinGuimo1.0b.zip" -d "$WINEPREFIX/drive_c/game/"
...
iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCXiQ9+AAKCRDlMfrJqhPK
RybdAJ9bTcX67zS6yPpUyNX765A5KQqbxgCgq7+l8TEcYfSok5bhUDw40bQ9Cdk=
=1Ck5
-----END PGP SIGNATURE-----
