...
#
# TESTED Editions: 2000
#
# Middlewares used by this software : Visual basic 5, ACKNEX 3D.
#
#
#
# CHANGELOG
# [Dadu042] (2020-06-01 11-00)
#   Initial script.
#
# KNOWN ISSUES :
#  - Wine amd64 4.0.4, 5.0: warning messages about audio music (MIDI). Tried: Alsa (worse: no sound).
#  - Wine amd64 4.21: game does crash after the first window (the screen size selector).
#
# KNOWN ISSUES (FIXED):
#  - Wine amd64 4.0.4: crash when exit (freeze). Fix: vbrun6.
#
...
TITLE="Hades 2"
PREFIX="Hades_2"
EDITOR="Espaço Informática"
GAME_URL="http://www.espacoinf.com/hades2-i.htm"
AUTHOR="Dadu042"
STEAM_ID=""
GAME_VMS="128"
SHORTCUT_FILENAME="Hades2.exe"
...
iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCXtUY5gAKCRDlMfrJqhPK
R3xyAJ9AHhfkjxDlfss8Kw1tPNzKDsWYMwCdEGl4E6anRN5aZ4Df0VAGDGa4vBU=
=1quy
-----END PGP SIGNATURE-----
