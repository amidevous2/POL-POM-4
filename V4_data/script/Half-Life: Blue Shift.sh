...
#
# TESTED Editions: retail CD-ROM, v1.0.0.0 (displayed by the installer).
#
# Middlewares used by this software : DirectX 9 ?.
#
# CHANGELOG
# [Dadu042] (2013-01-22)
#   Initial script for Steam (+ Wine 1.5.10).
# [Dadu042] (2020-01-07)
#   New script (tested with Wine 4.0.3 and retail CD-ROM v1.0.0.0).
#   Can install from CD and local DDV.
# [Dadu042] (2020-01-07 19:00)
#   Add Steam (not tested).
#
#
#
# KNOWN ISSUES:
#  - Wine x86 3.0.3: intro and cutscenes not displayed. Game training does not display. Fix: Wine 4.0.3 or game's settings -> display -> software to OpenGL.
#  - Wine x86 4.0.3: intro videos not displayed.
#  - Wine x86 4.0.3: X
#
# KNOWN ISSUES (FIXED):
#  - Wine x86 3.0.3, 4.0.3: X
...
PREFIX="hl_blue_shift"
EDITOR="Sierra"
GAME_URL="https://en.wikipedia.org/wiki/Half-Life:_Blue_Shift"
AUTHOR="Dadu042"
STEAM_ID="130"
GAME_VMS="128"
SHORTCUT_FILENAME="bshift.exe"
...
if [ "$INSTALL_METHOD" == "STEAM" ]; then
        ...
        POL_SetupWindow_check_cdrom "bsinstall.EXE"
...
iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCXhTTEgAKCRDlMfrJqhPK
RwF9AJ9P+7SsbGwyCEayosbAmU/F2eMOnACgrO7BQydCTXUkzMugnKVoLv6gPH0=
=rIWe
-----END PGP SIGNATURE-----
