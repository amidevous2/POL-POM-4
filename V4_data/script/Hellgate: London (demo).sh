...
#
# CHANGELOG
# [Dadu042] (2020-04-10 21-00)
#   Initial script.
#
# KNOWN ISSUES :
#  - Wine amd64 5.0: when installing the game (demo), Steam should update but it stalls.
#
# KNOWN ISSUES (FIXED):
#  - Wine x865.0: X
# 
...
TITLE="Hellgate: London (demo)"
PREFIX="Hellgate_London_demo"
EDITOR=""
GAME_URL="https://en.wikipedia.org/wiki/Hellgate:_London"
AUTHOR="Dadu042"
STEAM_ID=""
GAME_VMS="256"
...
iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCXpDSjQAKCRDlMfrJqhPK
R7ztAJ4guEMmycNNiEIEOwtO0JsNjWhY9gCeOvI99mjQCH+bE1cw+CYYAzRbvyw=
=hEVI
-----END PGP SIGNATURE-----
