...
#
# KNOWN ISSUES:
#  - Wine amd64 3.0.3, 3.21, 4.03: music but no sound.
#
#
...
TITLE="Hydorah"
PREFIX="Hydorah"
EDITOR="https://www.locomalito.com/hydorah.php"
GAME_URL="Locomalito"
AUTHOR="Dadu042"
STEAM_ID=""
WORKING_WINE_VERSION="3.0.3"
GAME_VMS="256"
SHORTCUT_FILENAME="Hydorah.exe"
...
if [ "$INSTALL_METHOD" == "STEAM" ]; then
        ...
        POL_Download "https://www.locomalito.com/juegos/Hydorah.zip"

        POL_SetupWindow_wait_next_signal "$(eval_gettext 'Extracting the archive...')" "$TITLE"
        POL_System_unzip "Hydorah.zip" -d "$WINEPREFIX/drive_c/game/"
...
iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCXff+8wAKCRDlMfrJqhPK
R68tAKCgrbK+AiqzDsAaR+hwp8uHAyv5nwCdHJGD/NChc3NLeKOmD265dteqrNs=
=Y8bP
-----END PGP SIGNATURE-----
