...
#
# Middlewares used by this software : vcrun2008, Bink.
#
# CHANGELOG
# [Dadu042] (2020-01-11 13:07)
#   Initial script.
# [Dadu042] (2020-01-14 16:00)
#   Fix setup.exe (failed to launch because of "/SILENT").
#   Add vcrun2008 (useless ?)
# [Dadu042] (2020-01-14 16:30)
#   Remove vcrun2008.
#   Fix shortcut name.
#   Restore resolution when exiting.
# [Dadu042] (2020-01-14 16:15)
#   Fix VMS location.
#   Disable Alsa sound.
#
# KNOWN ISSUES:
#  - Wine amd64 4.0.3: when installing the background is black.
#
# KNOWN ISSUES (FIXED):
#  - Wine amd64 4.0.3: setup.exe installer crashes as soon as launched (it seems to fail to launch 'BloodStone.msi'). Fix: remove my "/SILENT" argument.
...
PREFIX="jb_007_blood_stone"
EDITOR="Activision"
GAME_URL="https://en.wikipedia.org/wiki/James_Bond_007:_Blood_Stone"
AUTHOR="Dadu042"
STEAM_ID=""
GAME_VMS="64"
SHORTCUT_FILENAME="Bond.exe"
...
if [ "$INSTALL_METHOD" == "STEAM" ]; then
        ...
        POL_SetupWindow_check_cdrom "BloodStone.msi"
...
iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCX5lGFAAKCRDlMfrJqhPK
Rw4MAJ9a4j4BhdaD+g+18RzUGUPWDxPEPgCfRIntRePSDVciEI5QYOEG9W6ie1w=
=2dTd
-----END PGP SIGNATURE-----
