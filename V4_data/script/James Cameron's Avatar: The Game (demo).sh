...
# TESTED Editions: 
#
# Middlewares used by this software : DirectX 9, vcrun2005.
#
#
# CHANGELOG
# [Dadu042] (2020-04-10 11-50)
#   Initial script.
#
# KNOWN ISSUES :
#  - Wine amd64 5.0: sound and music are sometime jerky.
#
# KNOWN ISSUES (FIXED):
#  - Wine x865.0: X
# 
...
TITLE="James Cameron's Avatar: The Game (demo)"
PREFIX="JC_Avatar"
EDITOR=""
GAME_URL="https://en.wikipedia.org/wiki/James_Cameron%27s_Avatar:_The_Game"
AUTHOR="Dadu042"
STEAM_ID=""
GAME_VMS="256"
SHORTCUT_FILENAME="Avata*.exe"
...
if [ "$INSTALL_METHOD" == "STEAM" ]; then
        ...
        POL_Download "http://download.nvidia.com/downloads/nZone/demos/nzd_Avatar_TheGame_Demo.exe"
      
        mv nzd_Avatar_TheGame_Demo.exe GameInstaller.exe
...
iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCXpCVpQAKCRDlMfrJqhPK
R6nMAJ46NWmklLKMiCKLnYtRlh7nyQVRFQCdHXgI0JPCh0sO2rC8SHQlsH8c8Zw=
=r9kh
-----END PGP SIGNATURE-----
