...
#
# CHANGELOG
# [Dadu042] (2020-02-17 16:50)
#   First script. 
#
#
# KNOWN ISSUES
#  - Wine x86 5.0, 5.2: when using game mode 'Vault defence', the game crash as soon the player reach the first weapon.
#
# KNOWN ISSUES (FIXED):
#  - Wine amd64 3.0.3: X
...
PREFIX="Kill_all_zombies_Gametop"
EDITOR="GameTop"
GAME_URL="https://www.gametop.com/download-free-games/kill-all-zombies/"
AUTHOR="Dadu042"
STEAM_ID=""
GAME_VMS="128"
SHORTCUT_FILENAME="killallzombies.exe"
...
if [ "$INSTALL_METHOD" == "STEAM" ]; then
        ...
        POL_Download "https://cdn.gametop.com/free-games-download/Kill-All-Zombies.exe"
   
        mv Kill-All-Zombies.exe GameInstaller.exe
...
iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCX581fgAKCRDlMfrJqhPK
R47tAJ4onlSDAYSVGuthBJwfYoYpFWkc0gCbBog3vxvLfH9vATv62osM16CGZas=
=r858
-----END PGP SIGNATURE-----
