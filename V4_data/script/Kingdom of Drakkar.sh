...
#
# TESTED Editions: v1.47.2 (as of 2020-10).
#
...
#
# KNOWN ISSUES :
#  - Wine amd64 5.20, 5.0.2, 3.0.3: no music (MIDI). Tried: Quartz, amstream, Xact, DirectMusic, Alsa driver (Wine 5.0.2, 3.0.3).
#
# KNOWN ISSUES (FIXED):
#  - Wine amd64 5.0.2: X
...
TITLE="Kingdom of Drakkar"
PREFIX="Kingdom_Drakkar"
EDITOR="Drakkar"
GAME_URL="https://www.kingdomofdrakkar.com/"
AUTHOR="Dadu042"
STEAM_ID=""
GAME_VMS="256"
SHORTCUT_FILENAME="DrakkarLobby.exe"
...
if [ "$INSTALL_METHOD" == "STEAM" ]; then
        ...
        POL_Download "https://www.kingdomofdrakkar.com/downloads/DrakkarLobbyInstaller.exe"
           
        mv DrakkarLobbyInstaller.exe GameInstaller.exe
...
iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCX5coXwAKCRDlMfrJqhPK
R9SlAJ9NhyYmKjAup98yA+pebC0di1rOYgCfSmIzY0IC5bia5V3GoLdE4JmEN/g=
=Y0FP
-----END PGP SIGNATURE-----
