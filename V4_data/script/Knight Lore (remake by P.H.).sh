...
#
# TESTED Editions: v1.0 (2010).
#
# Middlewares used by this software : .
#
# CHANGELOG
# [Dadu042] (2020-01-13 20-00)
#   Initial script.
#
# KNOWN ISSUES:
#  - Wine amd64 3.0.3: when doing ALT+TAB the game does close.
#
# KNOWN ISSUES (FIXED):
#  - Wine amd64 3.0.3: X
...
TITLE="Knight Lore (remake by P.H.)"
PREFIX="knight-lore-remake-ph"
EDITOR="Peter Hanratty"
GAME_URL="http://retrospec.sgn.net/game-links.php?link=kl"
AUTHOR="Dadu042"
STEAM_ID=""
GAME_VMS="64"
SHORTCUT_FILENAME="KnightLore.exe"
...
if [ "$INSTALL_METHOD" == "STEAM" ]; then
        ...
        POL_Download "http://retrospec.sgn.net/download/files/KnightLoreSetup.exe"
	...
	# mv gridrunner.exe gridrunner_remake.exe
        ...
        POL_Wine "KnightLoreSetup.exe" # "/SILENT"
...
iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCXhzDVAAKCRDlMfrJqhPK
R25oAKCJo/rl5I2THdN65cIgD/k/1HZozACgr2ipWeiNmBXRgs6MW1iGcWqzT4g=
=/XSE
-----END PGP SIGNATURE-----
