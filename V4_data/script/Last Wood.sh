...
#
# TESTED (with success): 'v0.8(1) Built on 22/08/2019'.
#
...
#
# KNOWN ISSUES:
#  - Wine 4.0.2 amd64 (LastWood.exe): Unity logo appears, then a mouse cursor (looking as a hand), then crash. Fix: run 'LAUNCHER_x64.exe'
#  - Wine 4.0.2 amd64 (1280x1024 monitor): wrong screen resolution (848x480). The game seems to support only 4 resolutions.
#
...
PREFIX="last_wood"
EDITOR="Just Us"
GAME_URL="https://just-us.itch.io/last-wood"
AUTHOR="Dadu042"
STEAM_ID="767490"
WORKING_WINE_VERSION="4.0.2"
GAME_VMS="512"
SHORTCUT_FILENAME="LAUNCHER_x64.exe"
...
POL_SetupWindow_message "$(eval_gettext 'WARNING: to avoid to have a big useless POL/POM log file, you should type into 'Debug flags': 'fixme-all'.')" "$TITLE"

POL_SetupWindow_Close
exit 0
-----BEGIN PGP SIGNATURE-----

iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCXWz5TwAKCRDlMfrJqhPK
RxKWAKCWFweW8gP/715vY84aCRV17ebb4gCdGO6IeHmJkYgYiRmrYwTDT75L1fw=
=TSwW
-----END PGP SIGNATURE-----
