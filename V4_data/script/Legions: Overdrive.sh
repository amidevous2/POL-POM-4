...
# [pdq ? robz ?] (2013)
#   First script
# [SuperPlumus] (2013-06-21 21-26)
#   Clean code
# [Dadu042] (2019-11-02 14-30)
#   Wine 1.5.23 -> 3.0.3
#   Add POL_RequiredVersion
#   Disable POL_Install_dxfullsetup
#   I could not test the game because I can't register.
# [Dadu042] (2020-02-05 23:30)
#   Improve shortcut category.
#   Force arch x86.
#   NOTE: The download function download a 2010 EXE file, while the latest is 2016.
# [Dadu042] (2020-02-05 23:40)
#   Brand new script.
#
#
# KNOWN ISSUES:
#  - Wine amd64 4.0.3, 5.0: rendering issue (mountains are black, while sky and falling snow are OK). Tried: d3dx9_43.
#  - Wine amd64 4.0.3, 5.0: game (local) does crash when exit.
#
# KNOWN ISSUES (FIXED):
#  - Wine amd64 4.0.3: X
...
TITLE="Legions: Overdrive NEW SCRIPT"
PREFIX="Legions_Overdrive"
EDITOR=""
GAME_URL="http://www.legionsoverdrive.com/"
AUTHOR="Dadu042"
STEAM_ID=""
GAME_VMS="128"
SHORTCUT_FILENAME="Launch*.exe"
...
if [ "$INSTALL_METHOD" == "STEAM" ]; then
        ...
        POL_Download "https://www.legionsoverdrive.com/launcher/Legions.exe"
        cp Legions.exe GameInstaller.exe
...
iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCXjtMmwAKCRDlMfrJqhPK
R2gSAJ4ioaU//WfKoHauVurS6Dw2TJhU+gCfa5WrLzuIrEf5a4zL7+h9VhH99ec=
=aItN
-----END PGP SIGNATURE-----
