...
#
# TESTED Editions: v5.21 (2019-12) up to the login window.
#
...
# [Dadu042] (2019-12-30)
#   Script rewrote, mainly to allow install from local file.
#
# KNOWN ISSUES:
#  - Wine x86 4.0.3: .
...
PREFIX="Line_nhnlin"
EDITOR="Line"
GAME_URL="https://en.wikipedia.org/wiki/Line_(software)"
AUTHOR="rlarjsdn122"
STEAM_ID=""
WORKING_WINE_VERSION=""
GAME_VMS="32"
SHORTCUT_FILENAME="LineLauncher.exe"
SOFTWARE_CATEGORIES="InstantMessaging;Chat;"
...
POL_SetupWindow_message "$(eval_gettext 'Warning: the installation script will not end until you close the app and its system tray icon.')" "$TITLE"
...
iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCXgs3xwAKCRDlMfrJqhPK
R/L+AJ9hfwXVa9FFqVBYQLJG4VWoJibw+gCffI1KWB1TQO8OCC3SZy/hFFvG+PE=
=eVc/
-----END PGP SIGNATURE-----
