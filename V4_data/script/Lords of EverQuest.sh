...
#
# TESTED Editions: - retail CD-ROM (folders date: 2004-01) v1.3.0 (main menu: Options -> tab Infos).
#
...
TITLE="Lords of Everquest"
PREFIX="Lords_of_Everquest"
EDITOR="Rapid Eye Entertainment"
GAME_URL="https://en.wikipedia.org/wiki/Lords_of_EverQuest"
AUTHOR="Dadu042"
STEAM_ID=""
GAME_VMS="128"
SHORTCUT_FILENAME="Lords.exe"
...
DOCUMENT_FILE="KeyboardLayout.pdf"
...
if [ "$INSTALL_METHOD" == "STEAM" ]; then
        ...
        POL_SetupWindow_check_cdrom "LOE.exe"
...
iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCXkiAIQAKCRDlMfrJqhPK
R9GZAJ9+y7owCbdVbUFH9d0FBtdz4OQ8PgCgpaM5ZKrUtEG5vtPHpx1Yvc+nrHI=
=90B7
-----END PGP SIGNATURE-----
