...
#
# TESTED Editions:  - v3.0 (2004), filename: Mario Forever Remake v3.0.zip
#                   - v7.02 (2016) from Softendo, filename: Mario Forever Remake v3.0.zip
#                   - (trojan inside ?) v3.5 (2007), filename: install-mfr-3-5-01.exe .
#                   - (trojan inside ?) v3.7 (2017), filename: MFRemake v3.7.rar .
#
# Middlewares used by this software : .
#
# CHANGELOG
# [Dadu042] (2020-01-25 14:40)
#   Initial script.
# [Dadu042] (2020-01-26 12:50)
#   Add link to read me.
#   Improve shortcut to the .EXE
#
#
# KNOWN ISSUES:
#  - Wine x86 4.0.3: v3.5 does crash when launching (in 'stdrt.exe').
#  - Wine x86 3.0.3, 4.0.3, 5.0: v3.7 does crash when launching (in 'stdrt.exe' or 'kcactivex.mfx'). Tried: dsound.
#  - Wine x86 3.0.3 : v7.02 Beta does crash when launching ('unimplemented function user32.dll.GetProcessDpiAwarenessInternal'). Fix: Wine 4.0.3, but crash later when launching a game level (stdrt.exe).
#
# KNOWN ISSUES (FIXED):
#  - Wine amd64 4.0.3: X
...
TITLE="Mario Forever"
PREFIX="mario_forever"
EDITOR="Buziol Games"
GAME_URL="https://themariovariable.altervista.org/mario-forever-projects/?doing_wp_cron=1579995340.9476320743560791015625"
AUTHOR="Dadu042"
STEAM_ID=""
GAME_VMS="128"
SHORTCUT_FILENAME="MarioFor*.exe"
...
iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCXi2pYgAKCRDlMfrJqhPK
RzxGAKCb9AgKvdIYM5QZCdxSOVfbx4GGJACcDpXkyxOIjBmCRWeg08dRlZkbhI8=
=QYFn
-----END PGP SIGNATURE-----
