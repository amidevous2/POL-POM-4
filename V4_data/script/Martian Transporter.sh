...
#
# TESTED Editions: DDV from MyPlayCity.com (game.exe: 2016, Version=1.0.0.2 found in file Game.ini).
#
...
#
# KNOWN ISSUES:
#  - Wine amd64 3.0.3: lots of log lines about DirectMusic. Tried: install directmusic (problem: this prevent the game to run).
#
...
TITLE="Martian Transporter"
PREFIX="Martian_Transporter"
EDITOR="Alawar"
GAME_URL="https://www.myplaycity.com/martian_transporter/"
AUTHOR="Dadu042"
STEAM_ID=""
...
if [ "$INSTALL_METHOD" == "STEAM" ]; then
        ...
        POL_Download "http://files.myplaycity.com/files_downloader_temp/martiantransporter_setup.exe"
        POL_SetupWindow_message "$(eval_gettext 'Note: we recommend you to uncheck all the checkboxes:\n[x] -> [ ]')" "$TITLE"
        POL_Wine "martiantransporter_setup.exe"  "/SILENT"
...
iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCXgqOWAAKCRDlMfrJqhPK
Rz8sAKCcctdWRrulWd2SSOiK4OYK/WOwtQCfTkJIom2aTptFSrjGiP7lOGTVf6M=
=3a/N
-----END PGP SIGNATURE-----
