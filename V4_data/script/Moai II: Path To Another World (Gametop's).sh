...
#
# TESTED Editions: Gametop.com release (v2.0, 2016 ).
#
...
TITLE="Moai II: Path To Another World"
PREFIX="moai2"
EDITOR="Alawar Entertainment, Toyman Interactive"
GAME_URL="https://www.myplaycity.com/moai_2/"
AUTHOR="Dadu042"
STEAM_ID=""
GAME_VMS="128"
...
if [ "$INSTALL_METHOD" == "STEAM" ]; then
        ...
        POL_Download "http://files.myplaycity.com/files_downloader_temp/moai2_setup.exe"
        # Also hosted on: https://archive.org/details/eternalwar_201612
       
        mv moai2_setup.exe GameInstaller.exe
...
iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCXnqIYwAKCRDlMfrJqhPK
R1IvAJoC2C/4SXFO57L+Mh5kdAvOTFCzRwCggy6xPFglDxjdsAckq8ZWEs2E+Rw=
=4FL8
-----END PGP SIGNATURE-----
