...
#   First script.
# [Dadu042] (2019-12-28)
#   POL_RequiredVersion 4.3.4 -> 4.0.0
#   Software category (roleplaying -> shooter).
#
# KNOWN ISSUES:
#  - Wine x86 4.0.3: no sound/music.
#
...
TITLE="Orbital Sniper"
PREFIX="Orbital_Sniper"
EDITOR="Jari Komppa (Sol)"
GAME_URL="http://sol.gfxile.net/ld48hpm.html"
AUTHOR="Dadu042"
STEAM_ID=""
WORKING_WINE_VERSION="3.0.3"
GAME_VMS="256"
SHORTCUT_FILENAME="OrbitalSniper.exe"
...
if [ "$INSTALL_METHOD" == "STEAM" ]; then
        ...
        POL_Download "http://sol.gfxile.net/files/OrbitalSniper120.zip"
        # POL_SetupWindow_message "$(eval_gettext 'Note: we recommend you to uncheck all the checkboxes:\n[x] -> [ ]')" "$TITLE"

        POL_SetupWindow_wait_next_signal "$(eval_gettext 'Extracting the archive...')" "$TITLE"
        POL_System_unzip "OrbitalSniper120.zip" -d "$WINEPREFIX/drive_c/"
...
iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCXgdIWgAKCRDlMfrJqhPK
R2b4AJ4h0wsTVrwvm2SQc4/ObXnP4pTRNwCcC98qfA94kM3MOZgwI3aFSVGoc5M=
=w8hh
-----END PGP SIGNATURE-----
