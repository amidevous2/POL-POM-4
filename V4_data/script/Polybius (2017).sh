...
#
# TESTED EDITION: 2017 ?, version displayed (when launching) on the screen 'Autosave Warning': 'Version 22122018A'.
#
# Middlewares used by this software : DirectX 11 ?, D3DCOMPILER_47, d3d11.dll, XAudio2_8.dll, Steam, VC++ (2013 ?).
#
# CHANGELOG
# [Dadu042] (2019-09-28)
#   First script.
# [Dadu042] (2019-09-20)
#   Add 'virtual desktop' (the menu bar still appear...)
#
#
# KNOWN ISSUES:
#  - Wine amd64 4.0.2, 4.4, 4.15: game launch up to main screen, but is windowed. Tried: create virtual desktop (but the menu bar still appear).
#  - Wine amd64 4.0.2, 4.4: on main screen, game does crash when Esc is pressed. Workaround: Wine 4.15-staging.
#  - Wine amd64 4.15: when launched, several Visual C++ error windows telling 'Assertion failed!'. Tried: vcrun2015, vcrun2013. Workaround: click button 'Ignore' many times.
#
#
# KNOWN ISSUES FIXED:
#  - Wine amd64 4.15, 4.4: game does crash when launching (nothing displayed). Tried: mono210. Fix was to install libFaudio (from terminal).
#
...
PREFIX="Polybius"
EDITOR="Llamasoft"
GAME_URL="https://en.wikipedia.org/wiki/Polybius_(2017_video_game)"
AUTHOR="Dadu042"
STEAM_ID="906120"
WORKING_WINE_VERSION="4.15"
GAME_VMS="256"
SHORTCUT_FILENAME="Polybius.exe"
...
POL_SetupWindow_message "$(eval_gettext 'This game seems not playable with the keyboard nor mouse, a gamepad is required.')" "$TITLE"
...
iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCXZCqlQAKCRDlMfrJqhPK
R0mXAJsHRer2nkD5JWSz7lT0gtAuDiX9RQCfUY+p452MpMzhFq1fmjU53sZCiY4=
=Bu8K
-----END PGP SIGNATURE-----
