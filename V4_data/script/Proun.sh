...
#
# TESTED Editions: v109
#
# Middlewares used by this software : DirectX 9.
#
# CHANGELOG

# [Python] (2011-07-17 19-09)
#   First script
# [Dadu042] (2019-11-10)
#   New script (now can install from .ZIP or .RAR)
#   Wine 1.3.24 -> 3.0.3
#
...
#
# KNOWN ISSUES:
#  - Wine amd64 3.0.3: crash after exit.
#
...
TITLE="Proun"
PREFIX="Proun"
EDITOR="Joost Van Dongen"
GAME_URL="http://blog.oogst3d.net/"
AUTHOR="Dadu042"
STEAM_ID=""
WORKING_WINE_VERSION="3.0.3"
GAME_VMS="256"
SHORTCUT_FILENAME="Proun.exe"
...
if [ "$INSTALL_METHOD" == "STEAM" ]; then
        ...
        POL_Download "http://files.myplaycity.com/files_downloader_temp/bengal_setup.exe"
        POL_SetupWindow_message "$(eval_gettext 'Note: we recommend you to uncheck all the checkboxes:\n[x] -> [ ]')" "$TITLE"
        POL_Wine "bengal_setup.exe" # "/SILENT"
...
iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCXcf/9AAKCRDlMfrJqhPK
R8WsAJ9C0CW0zmdgTb77McVO7AenohmyqQCfQwIBZqdi0r/uoQhfOgAuqW6fFG4=
=28xd
-----END PGP SIGNATURE-----
