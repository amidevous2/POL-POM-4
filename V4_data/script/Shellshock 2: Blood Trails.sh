...
#
# TESTED Editions: 'Version 1.0' (displayed on the main menu), but v1.1 wrote in the readme file (readme*.rtf).
#
# Middlewares used by this software : DirectX 9.
#
#
# CHANGELOG
# [Dadu042] (2020-06-24 19-00)
#   Initial script.
#
# KNOWN ISSUES :
#  - Wine x86 4.0.4, 5.0.1: some sounds does lag or are muted. Tried: xact, quartz. Fix: dsound
#
#
# KNOWN ISSUES (FIXED):
#  - Wine amd64 5.0.1: X
...
GAME_URL="https://en.wikipedia.org/wiki/Shellshock_2:_Blood_Trails"
AUTHOR="Dadu042"
STEAM_ID=""
GAME_VMS="256"
SHORTCUT_FILENAME="Shellshock 2.exe"
...
iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCYFkSTwAKCRDlMfrJqhPK
RwVOAKCYnOvzBLsnS6yDQbfRXWqOLU5hZgCeONVFzwcWmLJJHwFOx3W2dscRFx0=
=BEPD
-----END PGP SIGNATURE-----
