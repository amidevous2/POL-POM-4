...
#
# TESTED Editions: demo (602 MB EXE file).
#
# Middlewares used by this software : DirectX 9, Physx, vcrun2005
#
#
# CHANGELOG
# [Dadu042] (2020-08-01 20:00)
#   Initial script.
#
# KNOWN ISSUES:
#  - Wine amd64 (and x86) 5.0.1, 5.12: the splash window appears then a crash (QuestViewer.exe. Log: fixme:d3dcompiler:compile_shader Compilation target "fx_2_0" not yet supported).
#
#
# KNOWN ISSUES (FIXED):
#  - 
...
TITLE="Ship Simulator Extreme - Demo"
PREFIX="ShipSimulatorExtremeDemo"
EDITOR="Vstep"
GAME_URL="http://www.shipsim.com/"
AUTHOR="Dadu042"
STEAM_ID=""
GAME_VMS="256"
SHORTCUT_FILENAME="SSE.exe"
...
if [ "$INSTALL_METHOD" == "STEAM" ]; then
        ...
        POL_Download "http://www.ccgr.org/files/ewfullsetup.exe"
        # Also hosted on: https://archive.org/details/eternalwar_201612
      
        mv ewfullsetup.exe GameInstaller.exe
...
iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCX5nk3wAKCRDlMfrJqhPK
RzJ+AKCS+VS0xTVzk2VCckbHk3KpmYl/jwCgnCylQC3Ca1vIeN8ULyNWqGDa43Y=
=a9Vl
-----END PGP SIGNATURE-----
