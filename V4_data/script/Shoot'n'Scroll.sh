...
#
# TESTED Editions: 2019's DDV from gametop.com (it's a 2013 game).
#
...
TITLE="Shoot'n'Scroll"
PREFIX="ShootnScroll"
EDITOR="Gametop"
GAME_URL="https://www.gametop.com/download-free-games/shoot-n-scroll/"
AUTHOR="Dadu042"
STEAM_ID=""
GAME_VMS="128"
SHORTCUT_FILENAME="Shoot*.exe"
...
if [ "$INSTALL_METHOD" == "STEAM" ]; then
        ...
        POL_Download "https://cdn.gametop.com/free-games-download/Shoot-n-Scroll.exe"
   
        mv Shoot-n-Scroll.exe GameInstaller.exe
...
iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCXlaMHgAKCRDlMfrJqhPK
R4WVAJ42k4+8wbn3OHYTTxd4vtkgdN52jwCfRx3a4h/dc/LC1BaDE66zeCnIhd4=
=4Ou0
-----END PGP SIGNATURE-----
