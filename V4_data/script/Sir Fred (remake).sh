...
#
# KNOWN ISSUES (FIXED):
#  - Wine amd64 3.0.3: when doing ALT+TAB the game does lost some graphics. Fix: disable OpenGL for GDI.
...
TITLE="Sir Fred"
PREFIX="sir_fred"
EDITOR="CEZ RD (Computer Emuzone Games Studio)"
GAME_URL="http://computeremuzone.com/ficha.php?id=8&l=en"
AUTHOR="Dadu042"
STEAM_ID=""
GAME_VMS="128"
SHORTCUT_FILENAME="Sir Fred el*.exe"
...
if [ "$INSTALL_METHOD" == "STEAM" ]; then
        ...
        POL_Download "https://archive.org/download/SirFred/SirFred.exe"
...
iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCXiM8MwAKCRDlMfrJqhPK
Rz/vAKCgepLfO/1a/KytFWmr/SAZlK/uDACePfqkgzl1DR8t0Dpr+GuAO34bS8c=
=NXIk
-----END PGP SIGNATURE-----
