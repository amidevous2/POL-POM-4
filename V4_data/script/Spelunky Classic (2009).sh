...
# [Petch ? Python ?] (2016 ?)
#   Initial script.
# [Dadu042] (2019-05-23 01-53)
#   Wine 1.3.24 -> 3.0
# [Dadu042] (2020-03-07 12:00)
#   Wine 3.0 -> 3.20
#   New script (to allow install from local file).
#   Add shortcut to user guide (readme.txt).
#
# KNOWN ISSUES
#  - Wine amd64 3.0, 3.20: game does crash when exit and keep running in background task.
#
# KNOWN ISSUES (FIXED):
#  - Wine amd64 3.0.3: X.
...
TITLE="Spelunky Classic (2009)"
PREFIX="spelunky_Classic_2009"
EDITOR="MossMouth"
GAME_URL="http://www.mossmouth.com/"
AUTHOR="Dadu042"
STEAM_ID=""
GAME_VMS="64"
SHORTCUT_FILENAME="Spelunky.exe"
...
iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCXmOlUAAKCRDlMfrJqhPK
R3EcAJsFkq3mBIcEMcKOrOtW4y5LY38vRQCeL+QEIhjMEGQjnBx+ksqACsT8PYc=
=R4iZ
-----END PGP SIGNATURE-----
