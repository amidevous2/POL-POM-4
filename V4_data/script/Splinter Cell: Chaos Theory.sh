...
#
# TESTED Editions: retail DVD-ROM, v1.05 displayed on the main menu.
#
...
#
# KNOWN ISSUES:
#  - Wine x86 4.0.3: The top menu of the Linux desktop (XFCE) stays visible. Fix?: virtual desktop.
#  - Wine x86 4.0.3: The versus mode (from SCCT_Versus.exe) does fail to launch.
#
# KNOWN ISSUES (FIXED):
#  - Wine x86 4.0.3: X
...
PREFIX="splinter_cell_ct"
EDITOR="Ubisoft"
GAME_URL="https://en.wikipedia.org/wiki/Tom_Clancy%27s_Splinter_Cell:_Chaos_Theory"
AUTHOR="Dadu042"
STEAM_ID=""
GAME_VMS="64"
SHORTCUT_FILENAME="splintercell3.exe"
...
if [ "$INSTALL_METHOD" == "STEAM" ]; then
        ...
        POL_SetupWindow_check_cdrom "Bin/SplinterCell.ico"
...
iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCXhM5EAAKCRDlMfrJqhPK
RzzoAKCpNoB/odIxwwEi0YQTLL4U/sS+VwCeNAqrNOsgFIDsz6Y0ztSw9Dh1HZQ=
=KsRy
-----END PGP SIGNATURE-----
