...
#
# TESTED Editions: V.3.3 Notes (1/6/2014).
#
# Middlewares used by this software : RPG Maker.
#
#
# CHANGELOG
# [Dadu042] (2020-02-09 22:30)
#   Initial script.
#
#
# KNOWN ISSUES:
#  - Wine x86 3.0.3, 3.20, 4.0.3: X.
#
# KNOWN ISSUES (FIXED):
#  - Wine amd64 4.0.3: X
...
if [ "$INSTALL_METHOD" == "STEAM" ]; then
        ...
        POL_Download "https://s3.amazonaws.com/prodcartassets/31416/star-stealing-prince.zip"
 

 
        POL_SetupWindow_wait_next_signal "$(eval_gettext 'Extracting the archive...')" "$TITLE"
        POL_System_unzip "star-stealing-prince.zip" -d "$WINEPREFIX/drive_c/"

	rm "star-stealing-prince.zip"
...
iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCXkB/7QAKCRDlMfrJqhPK
R0ZnAJ9WSx05GJ8rCnpJ06jsSsDQR0nWQQCfUIHX5ZdkSuS54zt2YNs6OT4GPhk=
=C0Os
-----END PGP SIGNATURE-----
