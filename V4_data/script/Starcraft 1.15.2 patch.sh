...
cd "$REPERTOIRE/tmp"
POL_SetupWindow_download "$LNG_DOWNLOAD_RUN" "$TITLE" "http://ftp.blizzard.com/pub/starcraft/patches/PC/SC-1152.exe"
POL_SetupWindow_wait_next_signal "$LNG_INSTALL_RUN" "$TITLE"
wine "SC-1152.exe"
POL_SetupWindow_detect_exit
POL_SetupWindow_message "$LNG_WAIT_END" "$TITLE"
rm "$REPERTOIRE/tmp/SC-1152.exe"
...
cp "$CDROM/install.exe" "$WINEPREFIX/drive_c/$PROGRAMFILES/Starcraft/Starcraft.mpq"
POL_SetupWindow_detect_exit
...
iEYEABECAAYFAk1cJEMACgkQ5TH6yaoTykdtbgCff9L4rQpQ/+RrtCle2WNFtShV
sgMAnjBNBkhjgu9wjEEXgDgr87pSUDQm
=+GpU
-----END PGP SIGNATURE-----
