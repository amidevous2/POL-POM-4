#!/bin/bash
# Date : (????-??-?? ??-??)
# Last revision : (2011-01-20 04-29)
# Wine version used : -
...
TITLE="Starcraft : Brood War - Patch 1.15"
...
cd "$REPERTOIRE/tmp"
POL_SetupWindow_download "$LNG_DOWNLOAD_RUN" "$TITLE" "http://ftp.blizzard.com/pub/broodwar/patches/PC/BW-115.exe"
POL_SetupWindow_wait_next_signal "$LNG_INSTALL_RUN" "$TITLE"
wine "BW-115.exe"
POL_SetupWindow_detect_exit
POL_SetupWindow_message "$LNG_WAIT_END" "$TITLE"
rm "$REPERTOIRE/tmp/BW-115.exe"
...
iEYEABECAAYFAk1cJDwACgkQ5TH6yaoTykdtnACeJxDweB/Spc/kEv7XLX7ZXv9e
cUcAoK9TOefeqKhy0k1mg7V9/P23piSP
=JaQu
-----END PGP SIGNATURE-----
