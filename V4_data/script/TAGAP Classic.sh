...
#
# TESTED Editions: v3.1 (2019).
#
# Middlewares used by this software : .
#
#
# CHANGELOG
# [Dadu042] (2020-02-19 20:50)
#   First script. 
#
#
# KNOWN ISSUES
...
TITLE="TAGAP Classic - TAGAP #1"
PREFIX="TAGAP_Classic"
EDITOR="Pengiun DT"
GAME_URL="http://www.tagap.net"
AUTHOR="Dadu042"
STEAM_ID=""
GAME_VMS="128"
SHORTCUT_FILENAME="TAGAP.exe"
...
DOCUMENT_FILE="The Player's Handbook (TAGAP).pdf"
...
if [ "$INSTALL_METHOD" == "STEAM" ]; then
        ...
        POL_SetupWindow_message "$(eval_gettext '\n\nNote: this script will download the beta v1.03 .')" "$TITLE"
        POL_Download "http://downloads.gameborder.com/u/o/uou34745419y78562895453/PrivateerGold1.03.exe"
   
        mv PrivateerGold1.03.exe GameInstaller.exe
        ...
        POL_Shortcut "TAGAP2.EXE" "TAGAP Classic - TAGAP #2" "" "" "$SOFTWARE_CATEGORIES"
        POL_Shortcut_Document "TAGAP Classic - TAGAP #2" "The Player's Handbook (TAGAP 2).pdf"
...
iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCXk2dbQAKCRDlMfrJqhPK
R82vAJ45jBHF/crpgocajfSX+rsSg/HrvACfW8hPwlHhN96MieP1B56cLALgdEg=
=r+pN
-----END PGP SIGNATURE-----
