...
#
# TESTED Editions: demo 2006
#
# Middlewares used by this software : DirectX 9, vcrun2003.
#
#
# CHANGELOG
# [Dadu042] (2020-04-23 13-00)
#   Initial script.
#
# KNOWN ISSUES :
#  - Wine amd64 5.0, 5.2: the splash screen does appear, then freeze, then quit.
#  - Wine amd64 3.0.3, 4.21: the splash screen does appear, then freeze, then error window about VC++ runtime (game.dat: abnormal program termination).
#    Tried: dsound, override msvcp71 and msvcr71, audio driver not Alsa, d3dx9_43 + compiler, GLSL, FBO.
#    Tried 32 bits: dotnet40, vcrun2005
#    The fix: create the file 'options.ini'. Trick found (and tested) on Pcgamingwiki.com https://www.pcgamingwiki.com/wiki/The_Lord_of_the_Rings:_The_Battle_for_Middle-earth_II
#
# KNOWN ISSUES (FIXED):
#  - Wine x86 5.0: X
# 
...
PREFIX="battlefor_ME_II"
EDITOR=""
GAME_URL="https://en.wikipedia.org/wiki/The_Lord_of_the_Rings:_The_Battle_for_Middle-earth_II"
AUTHOR="Dadu042"
STEAM_ID=""
GAME_VMS="256"
SHORTCUT_FILENAME="lotrbfme*.exe"
...
###############################################################################
# Patch to workaround the 'freeze-crash after the first splash window' issue' #
###############################################################################

# code to write ... (some ideas: https://www.playonlinux.com/fr/app-430-Supreme_Commander.html )
...
iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCXqHefgAKCRDlMfrJqhPK
RxuuAJwKArdpsYFLdz40dqT2jx5/N8kT/gCdFDjJ5nMM7nnrvAk3rGXPtCHtqRk=
=600o
-----END PGP SIGNATURE-----
