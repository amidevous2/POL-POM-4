...
if [ "$GAME_MEDIAVERSION" == "DVD" ]; then
	...
	POL_SetupWindow_check_cdrom "Sims3SP01Setup.exe"
	wine start /unix "$CDROM/Sims3SP01Setup.exe"
...
#making shortcut
POL_SetupWindow_auto_shortcut "$PREFIX" "TS3SP01.exe" "$TITLE" "" ""
...
iEYEABECAAYFAk6HCV8ACgkQ5TH6yaoTykcu/gCghva3ap0VOc3d2Lf1tnRtuWtz
NSMAmwWkIe3slrOfN/PNTI/bKwc9JmrQ
=lIFQ
-----END PGP SIGNATURE-----
