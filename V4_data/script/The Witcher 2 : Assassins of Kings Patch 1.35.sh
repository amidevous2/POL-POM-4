...
if [ "$INSTALL_METHOD" == "LOCAL" ]; then
	...
	if [ "$POL_LANG" == "ru" ]; then
		PATCH_URL="http://wpc.4d7d.edgecastcdn.net/004D7D/files/Patch0/Patcher_RU.exe"
		PATCH_EXE="Patcher_RU.exe"
	elif [ "$POL_LANG" == "jp" ]; then
		PATCH_URL="http://wpc.4d7d.edgecastcdn.net/004D7D/files/Patch0/Patcher_0JP.exe"
		PATCH_EXE="Patcher_0JP.exe"
	else
		PATCH_URL="http://wpc.4d7d.edgecastcdn.net/004D7D/files/Patch0/patcher.exe"
		PATCH_EXE="patcher.exe"
	fi
...
iEYEABECAAYFAk+jzw4ACgkQ5TH6yaoTykc54ACghnb9vBk8M215pCABOu4AExc9
QMMAoIDHYq7kHE359Co6AhSbJlvaDQpq
=baJJ
-----END PGP SIGNATURE-----
