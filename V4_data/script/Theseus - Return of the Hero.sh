...
TITLE="Theseus - Return of the Hero"
PREFIX="Theseus_Return_of_the_Hero"
EDITOR="Sigma Team"
GAME_URL="http://www.sigma-team.net"
AUTHOR="Dadu042"
STEAM_ID=""
GAME_VMS="16"
SHORTCUT_FILENAME="Theseus.exe"
...
if [ "$INSTALL_METHOD" == "STEAM" ]; then
        ...
        POL_SetupWindow_message "$(eval_gettext '\n\nNote: please uncheck all checkboxes (mainly DirectX).')" "$TITLE"
        POL_Download "http://downloads.sigma-team.net/theseus.exe"
        # Also hosted on: https://archive.org/details/eternalwar_201612
      
        mv theseus.exe GameInstaller.exe
...
iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCXnKMvQAKCRDlMfrJqhPK
R/AJAJ9hw5CwyHKEVd08+GOMX01HwTsW+gCgk4MHiCdjn4fgs8eYRKaPw/RJP8E=
=wubI
-----END PGP SIGNATURE-----
