...
#   First script.
# [Dadu042] (2019-10-28)
#   Default .EXE: game.exe -> engine.exe (right ICON, no website launched when exiting).
# [Dadu042] (2019-11-10)
#   Fix download.
#
# KNOWN ISSUES:
...
TITLE="Toy Defense"
PREFIX="Toy_Defense"
EDITOR="Alawar" # developped by Melesta Games
GAME_URL=""
AUTHOR="Dadu042"
STEAM_ID=""
...
if [ "$INSTALL_METHOD" == "STEAM" ]; then
        ...
        POL_Download "http://files.myplaycity.com/files_downloader_temp/toydefense_setup.exe"
        POL_Wine "toydefense_setup.exe" # "/SILENT"
...
iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCXceM9AAKCRDlMfrJqhPK
RyZZAJsHfZAUKgLrwlRP4yG0RVnDfFrFRgCeLRfFA3ZGqGQm4i6JfV0t9ruhWjc=
=SElI
-----END PGP SIGNATURE-----
