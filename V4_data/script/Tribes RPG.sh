...
#
# TESTED Editions: v1.30 full install file from http://tribesrpg.org/ (2010-01-08).
#
...
TITLE="Tribes RPG (Starsiege: Tribes)"
PREFIX="tribes_rpg"
EDITOR="Dynamix"
GAME_URL="http://tribesrpg.org"
AUTHOR="Dadu042"
STEAM_ID=""
GAME_VMS="64"
...
if [ "$INSTALL_METHOD" == "STEAM" ]; then
        ...
        POL_Download "http://tribesrpg.org/files/Tribes-Repack.exe"
        # POL_SetupWindow_message "$(eval_gettext 'Note: we recommend you to uncheck all the checkboxes:\n[x] -> [ ]')" "$TITLE"
 
        POL_Wine "Tribes-Repack.exe" # "/SILENT"
...
iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCXhXmrwAKCRDlMfrJqhPK
RzQWAKCylTPMN/iVwgS/Er3LG2fj1MPOKQCfYiRCHe7GQykDy55I9MMGlPGYa+E=
=bUz8
-----END PGP SIGNATURE-----
