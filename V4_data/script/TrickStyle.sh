...
#
# TESTED Editions: free edition in a 2005 computer magazine (PC Gamer) CD-ROM 2000-12.
#
# Middlewares used by this software : DirectX 7.
#
#
# CHANGELOG
# [Dadu042] (2020-03-01 22:30)
#   First script. 
#
#
# KNOWN ISSUES
#  - Wine amd64 3.0.3: no music.
#  - Wine amd64 3.0.3, 3.20, 4.21, 5.0: lots of these log lines: fixme:d3d:surface_cpu_blt Filter WINED3D_TEXF_LINEAR not supported in software blit.
#
#
# KNOWN ISSUES (FIXED):
#  - Wine amd64 3.0.3: installer refuse to continue when the OS is winxp. Fix: win98.
...
GAME_URL="https://en.wikipedia.org/wiki/TrickStyle"
AUTHOR="Dadu042"
STEAM_ID=""
GAME_VMS="64"
SHORTCUT_FILENAME="TS_D3D.exe"
...
if [ "$INSTALL_METHOD" == "STEAM" ]; then
        ...
        POL_SetupWindow_check_cdrom "stunts.pak"
...
iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCXlw+EQAKCRDlMfrJqhPK
Rw8cAJ9rXCHAV1iQesVt5rG/DVLBMcZmBgCeLqYqs8HCEExl3CNiwu6DMhQotBA=
=fSv3
-----END PGP SIGNATURE-----
