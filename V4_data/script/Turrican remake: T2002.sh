...
#
# TESTED Editions: 2016, T2002-all-included.zip .
#
# Middlewares used by this software : .
#
# CHANGELOG
# [Dadu042] (2020-01-13 21-50)
#   Initial script.
# [Dadu042] (2020-01-14 09-10)
#   Fix prefix name.
#
# KNOWN ISSUES:
#  - Wine amd64 3.0.3: X
...
TITLE="T2002 (Turrican remake)"
PREFIX="t2002"
EDITOR="Pekaro Software"
GAME_URL="https://gamesnostalgia.com/game/turrican-2002"
AUTHOR="Dadu042"
STEAM_ID=""
GAME_VMS="64"
SHORTCUT_FILENAME="T2002.exe"
...
if [ "$INSTALL_METHOD" == "STEAM" ]; then
        ...
        POL_Download "http://static.turricanforever.de/download/Games/T2002-all-included.zip"

        POL_SetupWindow_wait_next_signal "$(eval_gettext 'Extracting the archive...')" "$TITLE"
        POL_System_unzip "T2002-all-included.zip" -d "$WINEPREFIX/drive_c/game/"
	...
	POL_Shortcut "T Starter.exe" "$TITLE - T Starter" "" "" "$SOFTWARE_CATEGORIES"
...
iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCXh15HgAKCRDlMfrJqhPK
R6MwAJ93wNmgzOCWH8lcFB4fYOnwPRjLAACeLpYNPMw1bA42lAjbeC+ZSdOYSqI=
=xUoK
-----END PGP SIGNATURE-----
