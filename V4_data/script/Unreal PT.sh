...
# Distribution used to test : XUbuntu 18.04 64 bits (Linux kernel v5.4) + IGP AMD (Vega 11).
# Author : Dadu042
# Licence : Retail
# Only For : http://www.playonlinux.com
#
# TESTED Editions: v0.9.2 (2018-07, PT.EXE)
#                  v1.0.7 (2019-01, PT_2.EXE)
#
# Middlewares used by this software : Unreal engine 4, DirectX 11
#
#
#
# CHANGELOG
...
#
# KNOWN ISSUES :
#  - Wine amd64 5.12: crash as soon it start launching 'Fatal error'.
#
#
# KNOWN ISSUES (FIXED):
#  - Game v0.9.2 + Wine amd64 4.0.4, 4.21, 5.0.1, 5.8, 5.12: only the lights are visible (ceiling lights, radioclock, ...), all the rest is black. Fix: DXVK_170. Notre: (AMD GPU): did occurs with game v0.9.2, not with v1.0.7.
#  - Game v1.0.7 + Wine amd64 5.0.1: display is very dark, making the game almost unplayable. Fix: DXVK_170
...
iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCX5L95QAKCRDlMfrJqhPK
R0iuAJwOFbDmRQT8t5s4AejDf18W+FA04gCgprJEaHqVbsXIOgaGF8VQXvADP9k=
=toGq
-----END PGP SIGNATURE-----
