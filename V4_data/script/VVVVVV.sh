...
#
# TESTED Editions: demo file from the author's website.
#
# Middlewares used by this software : Flash player.
#
# CHANGELOG
# [Dadu042] (2020-10-24 23-00).
#   Initial script.
#
# KNOWN ISSUES :
#
...
GAME_URL="https://thelettervsixtim.es"
AUTHOR="Dadu042"
STEAM_ID="70300"
GAME_VMS="256"
SHORTCUT_FILENAME="vvv*.exe"
...
POL_SetupWindow_message "Warning: this script is only tested with the demo of the game, and is only able to download the demo of the game." "$TITLE"
...
if [ "$INSTALL_METHOD" == "STEAM" ]; then
        ...
        POL_Download "http://lemming.ceri.se/mirror/terry/vvvvvv/vvvvvv_demo.exe"
...
iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCX5ShpgAKCRDlMfrJqhPK
R6o8AJ42ezz52iCqqmXkFEZ3IB6CZgOUawCfZlM5vplGpGLNGrHOpS7N7YfVNRU=
=Hcgu
-----END PGP SIGNATURE-----
