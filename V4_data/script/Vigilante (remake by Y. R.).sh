...
#
# KNOWN ISSUES:
#  - Wine x86 3.0.3: the text of the main menu does not display.
#  - Wine x86 3.20, 4.0.3: the text of the main menu does not display, just sometimes a second when pressing Esc. Tried: fbo, backbuffer, pbuffer, gdiplus.
#
# KNOWN ISSUES (FIXED):
#  - Wine amd64 4.0.3: X
...
PREFIX="vigilante"
EDITOR="Yves Rizoud"
GAME_URL="http://vigilante.free.fr/"
AUTHOR="Dadu042"
STEAM_ID=""
GAME_VMS="32"
SHORTCUT_FILENAME="vig.exe"
...
if [ "$INSTALL_METHOD" == "STEAM" ]; then
        ...
        POL_Download "http://vigilante.free.fr/files/VIGW112_FULL.ZIP"
 
        POL_SetupWindow_wait_next_signal "$(eval_gettext 'Extracting the archive...')" "$TITLE"
        POL_System_unzip "VIGW112_FULL.ZIP" -d "$WINEPREFIX/drive_c/game/"
        ...
        # POL_Wine "acespeeder2origin.exe" # "/SILENT"
        # POL_Wine_WaitBefore "$TITLE"
        # rm acespeeder2origin.exe
...
iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCXihQVwAKCRDlMfrJqhPK
R+ZeAJ94d4F7adR5peKmJOdEUkFoJ12aWwCgkTTS7ZvOQa7xgpmUVh8tqfoIkQE=
=5Zlq
-----END PGP SIGNATURE-----
