...
# CHANGELOG
# [Dadu042] (2020-01-06)
#   First script (Wine 3.0.3).
#
# KNOWN ISSUES:
#  - Wine amd64 3.0.3: in AceLauncher.exe impossible to add a server manually (by typing).
...
GAME_VMS="128"
SHORTCUT_FILENAME="AceLauncher.exe"
...
if [ "$INSTALL_METHOD" == "STEAM" ]; then
        ...
        POL_Download "http://www.spadille.net/aos076install_rc10.msi"
        # POL_SetupWindow_message "$(eval_gettext 'Note: we recommend you to uncheck all the checkboxes:\n[x] -> [ ]')" "$TITLE"
 
        # POL_Wine "aos076install_rc10.msi" # "/SILENT"
	POL_AutoWine "aos076install_rc10.msi"
...
if [ "$APP_ANSWER" == ".EXE" ]; then
        ...
        cd "$HOME"
        POL_SetupWindow_browse "$(eval_gettext 'Please select the setup file .MSI to run')" "$TITLE"
        SETUP_EXE="$APP_ANSWER"
	POL_AutoWine "APP_ANSWER"
        POL_Wine_WaitExit "$TITLE"
...
iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCXhISRwAKCRDlMfrJqhPK
R1JUAJ4724UVw7ZcRCnG3vXObWvni0UHUwCfaGUEsSWd/cqBwIyml5gymc1Q3ig=
=x8ed
-----END PGP SIGNATURE-----
