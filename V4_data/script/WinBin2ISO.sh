...
#
# TESTED Editions: v3.51 (2020).
#
# Middlewares used by this software : .
#
#
# CHANGELOG
# [Dadu042] (2020-03-31 10-00)
#   Initial script.
#
# KNOWN ISSUES:
...
TITLE="WinBin2ISO"
PREFIX="WinBin2ISO"
EDITOR="SoftwareOK.com"
GAME_URL="http://www.softwareok.com/?seite=Freeware/WinBin2Iso"
AUTHOR="Dadu042"
STEAM_ID=""
GAME_VMS="128"
SHORTCUT_FILENAME="W*.exe"
...
if [ "$INSTALL_METHOD" == "STEAM" ]; then
        ...
        POL_Download "https://www.softwareok.com/Download/WinBin2Iso_Portable.zip"
      
        # mv Mystery-of-Unicorn-Castle-the-Beastmaster.exe GameInstaller.exe
	# mv Teacher%20Simulator.rar gameinstaller.rar	
	mv WinBin2Iso_Portable.zip gameinstaller.zip
...
iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCXrp5XAAKCRDlMfrJqhPK
Rw4XAJ9THyvOJAq/7/5rggyi+4KMICmi5wCfaF0D8oZWnyDQcfvSlcB6+2ICg3c=
=ThPY
-----END PGP SIGNATURE-----
