...
#
# TESTED Editions: CD v1.0 (2011)
#
#
# Middlewares used by this software : DirectX 8 and OpenGL.
#
#
# CHANGELOG
# [Dadu042] (2020-06-29 16-00)
#   Initial script.
...
#
# KNOWN ISSUES (FIXED):
#  - Wine x86 4.0.4: can not pass the Setup window (once the screen resolution tested, OK button does not work). Tried: amstream, mdac28, mfc42, gdiplus (it crash), disable GLSL
#  log: 002c:fixme:dpvoice:dpvtest_CheckAudioSetup 0021FEF8 {def00002-9c6d-47ed-aaf1-4dda8f2b5c03} {def00003-9c6d-47ed-aaf1-4dda8f2b5c03} 00000000 2
#  Tried: devenum, xact, quartz, dsound, d3d9, directx9, dxfullsetup.  Fix: game's patch v1.2

[ "$PLAYONLINUX" = "" ] && exit 0
source "$PLAYONLINUX/lib/sources"

TITLE="World War III - Black Gold"
PREFIX="WW_III_Black_Gold"
EDITOR=""
GAME_URL=""
AUTHOR="Dadu042"
STEAM_ID=""
GAME_VMS="128"
SHORTCUT_FILENAME="WW3.exe"
...
iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCXvtD3AAKCRDlMfrJqhPK
R2VvAJ4urNWXr5hdaMv7DRl51i+MDC9CfwCeKtKkAKilX1CrbF21BqQBYvH7vRA=
=VrPT
-----END PGP SIGNATURE-----
