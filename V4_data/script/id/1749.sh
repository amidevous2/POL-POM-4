...
#
# TESTED (with success): DVD release (GOTY) + NoCD. Without success: retail DVD-ROM (september 2014).
#
# Middlewares used by this software : Unreal, DirectX 9, Bink, VC++ 2008.
#
# CHANGELOG
# [Dadu042] (2019-08-21)
#   First script. Game (DDV, not the DVD-ROM) does run with Wine x86 4.0.2 and 3.0.3
# [Dadu042] (2019-08-21)
#   Add comments.
#
# KNOWN ISSUES:
# - Wine amd64 4.0.1, 4.0.2, 4.15: retail DVD-ROM installation fail, because Steam can not update (it start updating, then in a second window fail at ~60 MB when downloading ~312 MB update ('Steam needs to be online to update.').
#
#
#
...
GAME_URL="https://en.wikipedia.org/wiki/Dishonored"
AUTHOR="Dadu042"
STEAM_ID="205100"
WORKING_WINE_VERSION="3.0.3"
GAME_VMS="512"
SHORTCUT_FILENAME="Dishonored.exe"
...
iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCXW/ahwAKCRDlMfrJqhPK
R4ufAKConRfsy8t/3OEmmsTQOMFZ7Gq2iACgg9Y5PqfLDyED3kAhWPCbY8zV6Eg=
=Eu2x
-----END PGP SIGNATURE-----
