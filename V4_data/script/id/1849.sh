#!/bin/bash
# Date : (2013-03-01)
# Last revision : (2013-10-25 18:54)
...
TITLE="Sono Hanabira ni Kuchizuke wo 04 - Aishisa no Photograph"
PREFIX="SonoHana_04"
WINEVERSION="1.3.4"
EDITOR="Fuguriya"
...
SONOHANA="$WINEPREFIX/drive_c/$PROGRAMFILES/ふぐり屋/その花びらにくちづけを　愛しさのフォトグラフ/"
...
then
	...
	POL_Shortcut "HANABIRA4.EXE" "その花びらにくちづけを 04　愛しさのフォトグラフ"
	# Insert a command to run as a Japanese application
	POL_Shortcut_InsertBeforeWine "その花びらにくちづけを 04　愛しさのフォトグラフ" "LANG=ja_JP.UTF-8"
...
then
	...
	# Create a shortcut for easy access
	POL_Shortcut "HANABIRA4.EXE" "A Kiss for the Petals 04 - Beloved Photograph"
	# Insert a command to run as a Japanese application/fix font issues
	POL_Shortcut_InsertBeforeWine "A Kiss for the Petals 04 - Beloved Photograph" "LANG=ja_JP.UTF-8"
fi
...
iEYEABECAAYFAlJqo8EACgkQ5TH6yaoTykc2+ACfVImriIsrn+q8Q/3jY/sJsYce
MocAnjFJ03hyVWGVHI2pwGgy05o5D3qr
=lRol
-----END PGP SIGNATURE-----
