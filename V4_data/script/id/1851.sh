#!/bin/bash
# Date : (2013-03-01)
# Last revision : (2013-10-25 18:53)
...
TITLE="Sono Hanabira ni Kuchizuke wo 05 - Anata wo Suki na Shiawase"
PREFIX="SonoHana_05"
WINEVERSION="1.3.4"
EDITOR="Fuguriya"
...
SONOHANA="$WINEPREFIX/drive_c/$PROGRAMFILES/ふぐり屋/その花びらにくちづけを　あなたを好きな幸せ/"
...
then
	...
	POL_Shortcut "HANABIRA5.EXE" "その花びらにくちづけを 05　あなたを好きな幸せ"
	# Insert a command to run as a Japanese application
	POL_Shortcut_InsertBeforeWine "その花びらにくちづけを 05　あなたを好きな幸せ" "LANG=ja_JP.UTF-8"
...
then
	...
	# Create a shortcut for easy access
	POL_Shortcut "HANABIRA5.EXE" "A Kiss for the Petals 05 - The Joy Of Loving You"
	# Insert a command to run as a Japanese application/fix font issues
	POL_Shortcut_InsertBeforeWine "A Kiss for the Petals 05 - The Joy Of Loving You" "LANG=ja_JP.UTF-8"
fi
...
iEYEABECAAYFAlJqo+MACgkQ5TH6yaoTykeGvQCfQRuS3DhuVlL05KJClpipgxL6
paEAoJEynkgavHfRXZ8nSF6xsbzfqcTo
=VWfe
-----END PGP SIGNATURE-----
