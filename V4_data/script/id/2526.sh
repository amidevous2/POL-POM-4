...
#
# TESTED Editions: Setup Project64 v2.3.2-202-g57a221e.exe
#
# Middlewares used by this software : Visual Studio 14 (VC 2015), Direct3D 8.
#
# CHANGELOG
# [mauriciofauth] (2015-05-20)
#   First script.
# [Dadu042] (2019-11-17 18:30)
#   Fix broken URL (by removing Download feature).
#   Brand new script.
#   Wine 1.7.43 -> 3.0.3
# [Dadu042] (2019-11-17 19:20)
#   Little improvements.
#
# KNOWN ISSUES:
#  - Wine amd64 4.0.2 (and x86 4.0.2): crash when exiting.
#  - Wine amd64 3.0.3, 4.0.2, 4.19: in Options -> Settings, the right part stay empty of any text (grey). Tried: install corefonts, mono210, mfc42, gdiplus, vcrun2015.
#  - Wine x86 4.0.2: same as above (missing text in Settings). Tried: install dinput8, d3dx9_43 + d3dcompiler_43, dotnet40, gecko.
...
TITLE="Project64"
PREFIX="project64"
EDITOR="Project64 Team"
GAME_URL="http://www.pj64-emu.com/"
AUTHOR="Dadu042"
STEAM_ID=""
WORKING_WINE_VERSION="4.0.2"
GAME_VMS="256"
SHORTCUT_FILENAME="Project64.exe"
SOFTWARE_CATEGORIES="Emulator;"
...
if [ "$INSTALL_METHOD" == "STEAM" ]; then
        ...
        POL_Download "http://files.myplaycity.com/files_downloader_temp/jigsawboom3_setup.exe"
        POL_SetupWindow_message "$(eval_gettext 'Note: we recommend you to uncheck all the checkboxes:\n[x] -> [ ]')" "$TITLE"
        POL_Wine "jigsawboom3_setup.exe" # "/SILENT"
...
iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCXdGUmgAKCRDlMfrJqhPK
Rx0vAKCjv32r+ZebCd5RAwfILFfuWQijOwCgsgb0Se9lwko6gXCdrjVpXI9fNB0=
=Ztdn
-----END PGP SIGNATURE-----
