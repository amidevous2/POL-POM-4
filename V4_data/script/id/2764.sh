...
PREFIX="EmBitz"
EDITOR=""
GAME_URL="https://www.embitz.org/"
AUTHOR="Dadu042"
STEAM_ID=""
# WORKING_WINE_VERSION=""
GAME_VMS="128"
SHORTCUT_FILENAME="Embitz.exe"
...
if [ "$INSTALL_METHOD" == "STEAM" ]; then
        ...
        POL_SetupWindow_message "$(eval_gettext '\nNote: this script will download the v1.10 (2019).')" "$TITLE"

        POL_Download "https://www.embitz.org/EmBitz_1.11.zip"  
  
        POL_SetupWindow_wait_next_signal "$(eval_gettext 'Extracting the archive...')" "$TITLE"
        POL_System_unzip "EmBitz_1.11.zip" -d "$WINEPREFIX/drive_c/EmBitz/"
...
iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCXg8RMwAKCRDlMfrJqhPK
R7GfAKCLjFLaKfpx6kAmAnTeGG3eUeYQfgCfVDF3ROSNWDPBY78VRL3iEG5jspk=
=5WEe
-----END PGP SIGNATURE-----
