...
POL_GetSetupImages "http://files.playonlinux.com/resources/setups/top.jpg" "http://files.playonlinux.com/resources/setups/pop2008/left.jpg" "$TITLE"
POL_SetupWindow_InitWithImages
 
POL_SetupWindow_presentation "$TITLE" "Ubisoft" "http://prince-of-persia.us.ubi.com/home.php" "GNU_Raziel" "$PREFIX" 
...
iEYEABECAAYFAk4llq4ACgkQ5TH6yaoTyke+1gCeM/fUpi0IGJRuHx5WGRUc0e1s
tqQAniy63SzPrbP1LlSuq29dRNwd2bfM
=mjVO
-----END PGP SIGNATURE-----
