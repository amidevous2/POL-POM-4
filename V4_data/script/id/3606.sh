...
#
# TESTED (with success): Local, 2017, version unknown.
#
...
#
# KNOWN ISSUES:
#  - Wine amd64 4.0.1, 4.11, 4.0.2: No music nor sounds. Fix: install dsound. Tried: amstream, directmusic, quartz.
#  - Wine amd64 4.0.1, 4.11, 4.0.2: Pressing the ESC key does crash the game ('Access violation'). Fix: install directmusic.
#
#
...
PREFIX="Eroico"
EDITOR="kyrieru"
GAME_URL="https://kyrieru.itch.io/eroico"
AUTHOR="Dadu042"
STEAM_ID="947600"
WORKING_WINE_VERSION="4.0.1"
GAME_VMS="256"
SHORTCUT_FILENAME="Eroico_Re.exe"
...
iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCXWZK2QAKCRDlMfrJqhPK
R8QMAKCpGzB3U0gBqwEPQjVntVK+puWu8QCgkR7ObuNyYigFd8H4ejca4UI+fHA=
=wy/i
-----END PGP SIGNATURE-----
