...
#
# TESTED (with success): august 2019.
#
# Middlewares used by this software : DirectX 9 or 11 (selectable via Config.exe (manually: edit 'Game.ini', string 'Old_DirectX_Use=1'). 
# Game engine used : 
#
# CHANGELOG
# [Dadu042] (2019-08-29)
...
#
# KNOWN ISSUES:
#  - Wine amd64 4.0.2: game's window is only ~640x480 (possible other settings in config.exe but unreadable texts). Fix: F4 key (Fullscreen).
#  - Wine amd64 4.0.2: when set to fullscreen, the left border is dirty (not black).
#
#
...
TITLE="Touhou Shoujo Tale of Beautiful Memories"
PREFIX="Touhou_Shoujo_Tale"
EDITOR="DLsite"
GAME_URL=""
AUTHOR="Dadu042"
STEAM_ID="1124060"
...
GAME_VMS="256"
SHORTCUT_FILENAME="kisoutan.exe"
...
iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCXWgA/AAKCRDlMfrJqhPK
R597AJ9+4sA1NK68buEyHn4JFhaLtKtfkwCePJTtpu71rwy/SPVF1ZaRl6kpLFA=
=PGUk
-----END PGP SIGNATURE-----
