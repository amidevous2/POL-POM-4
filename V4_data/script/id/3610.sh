...
#
# TESTED (with success): v1.0.0829 Alpha (early access)
#
...
#
# KNOWN ISSUES:
#  - Wine 4.0.2 amd64 : When trying to play, the game interface is visible, but not the game graphics below (all black).?
...
iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCXW7FKwAKCRDlMfrJqhPK
Rwq9AJwM1335+Xz8epqxe501z7UeD+hbwQCfShxjW4bvlqZK8oLk3ykeL64QIJY=
=+hbI
-----END PGP SIGNATURE-----
