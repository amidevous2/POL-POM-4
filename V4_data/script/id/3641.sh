...
#
# TESTED Edition: demo v1.05 (2009).
#
# Middlewares used by this software : DirectX 9 v40.
#
# CHANGELOG
# [Dadu042] (2019-09-29)
#   First script.
#
# KNOWN ISSUES:
#  - Wine amd64 4.0.2: crash when loading (button 'Try demo' -> 'SpaceGiraffe NUXX' -> crash). Fix: Wine 3.03 and 4.15.
#
...
TITLE="Space Giraffe (demo)"
PREFIX="Space_Giraffe_demo"
EDITOR="Llamasoft"
GAME_URL="https://en.wikipedia.org/wiki/Space_Giraffe"
AUTHOR="Dadu042"
STEAM_ID=""
WORKING_WINE_VERSION="3.0.3"
GAME_VMS="256"
SHORTCUT_FILENAME="SpaceGiraffePC.exe"
...
if [ "$INSTALL_METHOD" == "STEAM" ]; then
 ...
 #       POL_Shortcut_InsertBeforeWine "$SHORTCUT" "trap 'xrandr -s 0' EXIT"
        ...
        POL_Download "http://minotaurproject.co.uk/downloads/SpaceGiraffeSetup105.zip"
        # SETUP_EXE="$APP_ANSWER"
        # cd "$POL_System_TmpDir"
        POL_SetupWindow_wait_next_signal "$(eval_gettext 'Extracting the archive...')" "$TITLE"
        POL_System_unzip "SpaceGiraffeSetup105.zip" -d "$WINEPREFIX/drive_c/"
        
        POL_Wine "SpaceGiraffeSetup.exe" "/SILENT"
        ...
        POL_SetupWindow_menu "$(eval_gettext 'What is the type of the file?.')" "$TITLE" "$(eval_gettext '.EXE')" "~"
...
iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCXZDQMgAKCRDlMfrJqhPK
R4x/AJsFoRKqDbXNwK+sIWlMcst80fAgqQCgjTEzaogmqiYhs0QpBRSFyvjPE/Q=
=ukpf
-----END PGP SIGNATURE-----
