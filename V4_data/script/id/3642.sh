...
TITLE="Raiden Legacy"
PREFIX="Raiden_Legacy"
EDITOR="DotEmu"
GAME_URL="http://www.dotemu.com/game/raiden-legacy/"
AUTHOR="Dadu042"
STEAM_ID="407600"
WORKING_WINE_VERSION="4.0.2"
GAME_VMS="256"
SHORTCUT_FILENAME="raidenlegacy.exe"
...
if [ "$APP_ANSWER" == ".EXE" ]; then
        ...
        # Restore screen resolution (game's default is X)
        # POL_Shortcut_InsertBeforeWine "$SHORTCUT" "trap 'xrandr -s 0' EXIT"
...
iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCXZEHsgAKCRDlMfrJqhPK
R0J+AKCeyICocyQdZLDXOqOm2d41nA1/kwCglYoH9aJRDq1myOlz+Z/W2LWKEVQ=
=tHJG
-----END PGP SIGNATURE-----
