...
#   First script.
#
# F9 to exit, F1 for help.
#
# KNOWN ISSUES:
#  - Wine amd64 3.0.3 : miss MIDI music.
...
TITLE="Moraff's MoreJongg 6"
PREFIX="MoraffsMoreJongg6"
EDITOR="MoraffWare"
GAME_URL=""
AUTHOR="Dadu042"
STEAM_ID=""
...
GAME_VMS="256"
SHORTCUT_FILENAME="MOREJONG.EXE"
...
if [ "$INSTALL_METHOD" == "STEAM" ]; then
 ...
 #       POL_Shortcut_InsertBeforeWine "$SHORTCUT" "trap 'xrandr -s 0' EXIT"
        ...
        POL_Download "https://archive.org/download/MJONGG/MJONGG.zip"
        # SETUP_EXE="$APP_ANSWER"
        # cd "$POL_System_TmpDir"
        POL_SetupWindow_wait_next_signal "$(eval_gettext 'Extracting the archive...')" "$TITLE"
        POL_System_unzip "MJONGG.zip" -d "$WINEPREFIX/drive_c/"
         
#        POL_Wine "MOREJONG.EXE" "/SILENT"
...
iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCXZhvvQAKCRDlMfrJqhPK
R4EhAKCwgjDf4s7j6R47R0ARM+bfXt9DBgCeLUX0ZldR9h7rOzVMcL+VT7z1my0=
=XDbs
-----END PGP SIGNATURE-----
