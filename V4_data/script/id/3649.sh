...
TITLE="Star Defender 2"
PREFIX="Star_Defender_2"
EDITOR="Zylom ?"
GAME_URL="https://www.myplaycity.com/star-defender-2-download-free-alien-games/"
AUTHOR="Dadu042"
STEAM_ID=""
WORKING_WINE_VERSION="4.0.2"
GAME_VMS="256"
SHORTCUT_FILENAME="Star Defender 2.exe"
...
if [ "$INSTALL_METHOD" == "STEAM" ]; then
 ...
 #       POL_Shortcut_InsertBeforeWine "$SHORTCUT" "trap 'xrandr -s 0' EXIT"
        ...
        POL_Download "http://files.myplaycity.com/files_downloader_temp/stardefender2_setup.exe"
        POL_Wine "stardefender2_setup.exe" "/SILENT"
...
POL_SetupWindow_message "$(eval_gettext 'WARNING: to avoid to get a huge (debug) log file, you should type \ninto Debug flags : fixme-all')" "$TITLE"
...
iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCXceQaQAKCRDlMfrJqhPK
R4bVAJ9rLHAeQE8b9FMxGJHSRgOO84RU0gCgsmCsXT4Xr3r+H1Oj0nwlEy3gWpg=
=2Bk/
-----END PGP SIGNATURE-----
