...
#
# TESTED Editions: game.exe year is 2013.
#
...
TITLE="Royal Defense"
PREFIX="Royal_Defense"
EDITOR="8 Floor Games"
GAME_URL="https://www.myplaycity.com/royal_defense/"
AUTHOR="Dadu042"
STEAM_ID=""
WORKING_WINE_VERSION="3.0.3"
GAME_VMS="256"
SHORTCUT_FILENAME="royal defense.exe"
...
if [ "$INSTALL_METHOD" == "STEAM" ]; then
 ...
 #       POL_Shortcut_InsertBeforeWine "$SHORTCUT" "trap 'xrandr -s 0' EXIT"
        ...
        POL_Download "http://files.myplaycity.com/files_downloader_temp/royaldefense_setup.exe"
        POL_Wine "royaldefense_setup.exe" # "/SILENT"
        POL_Wine_WaitExit "$TITLE"
...
iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCXceQFgAKCRDlMfrJqhPK
R195AJwNwNJIJLsAHt0ncaCpahbpeU9hBACdGrr2yxqfogdFBhQLPvBD9wnVMDg=
=GCVG
-----END PGP SIGNATURE-----
