...
#
# TESTED Editions: game.exe year is 2001.
#
...
#
# KNOWN ISSUES:
#  - Wine amd64 3.0.3: after installing mfc42, the game can not find the file "3Impact DLL".
#  - Wine amd64 3.0.3: full screen mode does not work (black window).

#  - Wine amd64 4.0.2: Not tested.
...
PREFIX="Freak_World"
EDITOR="MyPlayCity"
GAME_URL="https://www.myplaycity.com/freak_world/"
AUTHOR="Dadu042"
STEAM_ID=""
WORKING_WINE_VERSION="3.0.3"
GAME_VMS="256"
SHORTCUT_FILENAME="Freak World.exe"
...
if [ "$INSTALL_METHOD" == "STEAM" ]; then
 ...
 #       POL_Shortcut_InsertBeforeWine "$SHORTCUT" "trap 'xrandr -s 0' EXIT"
        ...
        POL_Download "http://files.myplaycity.com/files_downloader_temp/freakworld_setup.exe"
        POL_Wine "freakworld_setup.exe" # "/SILENT"
        POL_Wine_WaitExit "$TITLE"
...
iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCXcePwQAKCRDlMfrJqhPK
R3UbAJwLDttdNYDVIN8IQXDpNU33d2SIDACfUkUCJtMGbXFtyedx639aCV6X/QM=
=JrAc
-----END PGP SIGNATURE-----
