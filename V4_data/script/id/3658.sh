...
#
# TESTED Editions: game.exe year is 2015.
#
...
#   Fix download.
# [Dadu042] (2019-12-26)
#   game.exe -> engine.exe (less adds, and bring game icon).
#   Disable POL_Wine_SetVideoDriver because this game is 2D.
#   Disable fixme-all (useless because the log is small).
#
# KNOWN ISSUES:
#  - Wine amd64 3.0.3: nothing noticed after 5 min played.
...
GAME_URL="https://www.myplaycity.com/sleep_attack/"
AUTHOR="Dadu042"
STEAM_ID="366210"
WORKING_WINE_VERSION="3.0.3"
GAME_VMS="256"
SHORTCUT_FILENAME="Sleep Attack.exe"
...
if [ "$INSTALL_METHOD" == "STEAM" ]; then
 ...
 #       POL_Shortcut_InsertBeforeWine "$SHORTCUT" "trap 'xrandr -s 0' EXIT"
        ...
        POL_Download "http://files.myplaycity.com/files_downloader_temp/sleepattack_setup.exe"
        POL_Wine "sleepattack_setup.exe" # "/SILENT"
        POL_Wine_WaitExit "$TITLE"
...
iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCXgSkxAAKCRDlMfrJqhPK
RwEHAJ9bpAa7Q54oGY2FzOhj2NCzZLH92gCgsx+m7uAyLc+7sEAPDSPB7KEVhjk=
=aoMz
-----END PGP SIGNATURE-----
