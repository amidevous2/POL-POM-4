...
#
# TESTED Editions: DDV from MyPlayCity.com . v2.0 (2015. Found in readme.txt).
#
...
TITLE="Goblin Defenders: Steel‘n’ Wood"
PREFIX="Goblin_Defenders_SW"
EDITOR="Alawar"
GAME_URL="https://store.steampowered.com/app/416310/Goblin_Defenders_Steeln_Wood/"
AUTHOR="Dadu042"
STEAM_ID="416310"
...
if [ "$INSTALL_METHOD" == "STEAM" ]; then
 ...
 #       POL_Shortcut_InsertBeforeWine "$SHORTCUT" "trap 'xrandr -s 0' EXIT"
        ...
        POL_Download "http://files.myplaycity.com/files_downloader_temp/goblindefenders_setup.exe"
        POL_Wine "goblindefenders_setup.exe" # "/SILENT"
        POL_Wine_WaitExit "$TITLE"
...
iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCXcePYgAKCRDlMfrJqhPK
R+8BAKCsNg2rC5rMQCryiJuESjsR4WH/ZgCfXtq7/89aSHRs81cyUjlU9wEUqB4=
=+A9A
-----END PGP SIGNATURE-----
