...
#
# TESTED Editions: 2012, DDV from MyPlayCity.com
#
...
TITLE="Farm Frenzy 3"
PREFIX="FarmFrenzy3"
EDITOR="Alawar Entertainment"
GAME_URL="https://en.wikipedia.org/wiki/Farm_Frenzy"
AUTHOR="Dadu042"
STEAM_ID=""
...
if [ "$INSTALL_METHOD" == "STEAM" ]; then
 ...
 #       POL_Shortcut_InsertBeforeWine "$SHORTCUT" "trap 'xrandr -s 0' EXIT"
        ...
        POL_Download "http://files.myplaycity.com/files_downloader_temp/farmfrenzy3_setup.exe"
        POL_Wine "farmfrenzy3_setup.exe" "/SILENT"
...
iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCXcePOAAKCRDlMfrJqhPK
R+VOAJ9rUFZs3JgyNAfeCPBGWHwW6kQgeQCgpuqXlLPzdhhjnsN6d8rBU6srXhE=
=XhL9
-----END PGP SIGNATURE-----
