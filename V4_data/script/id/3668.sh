...
GAME_VMS="256"
SHORTCUT_FILENAME="Rescue Team.exe"
...
if [ "$INSTALL_METHOD" == "STEAM" ]; then
        ...
        POL_Download "http://files.myplaycity.com/files_downloader_temp/rescueteam_setup.exe"
        POL_Wine "rescueteam_setup.exe" # "/SILENT"
...
iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCXceOYwAKCRDlMfrJqhPK
Rwz2AJsHox5xtF8eRYJlgBlChPu5LHBwGQCdGWaXAzwv5ptVLUiU0ZHocDP85e4=
=CSN8
-----END PGP SIGNATURE-----
