...
#
# TESTED Editions: 2015 (DDV from MyPlayCity.com)
#
...
#
# KNOWN ISSUES:
#  - Wine amd64 3.0.3, 3.21, 4.0.2: no music nor sounds. Tried: 'Sound problem fix - pulseaudio related' POL_Install_directmusic, devenum, d3dx9_43. Fix: POL_Install_dsound + dmusic.
#  - Wine amd64 3.0.3: sounds seems not perfect.
...
PREFIX="City_Racing"
EDITOR="MyPlayCity"
GAME_URL="https://www.myplaycity.com/city_racing/"
AUTHOR="Dadu042"
STEAM_ID=""
...
if [ "$INSTALL_METHOD" == "STEAM" ]; then
        ...
        POL_Download "http://files.myplaycity.com/files_downloader_temp/cityracing_setup.exe"
        POL_Wine "cityracing_setup.exe" # "/SILENT"
...
iFwEABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCXceLzAAKCRDlMfrJqhPK
R006AJ9OeVbyLHQ31OH+U3/mDEAmZtit0QCYvC5jDg3ggVxKPGsQ0GaPL+xNnw==
=BE99
-----END PGP SIGNATURE-----
