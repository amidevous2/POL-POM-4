...
#
# TESTED Editions: 2006, DDV from MyPlayCity.com
#
...
#
# KNOWN ISSUES:
#  - Wine amd64 3.0.3: game does crash as soon as launched. Fix: Wine 4.0.2
#  - Wine amd64 4.0.2, 4.15: game does crash when exit.
#  - Wine amd64 4.0.2, 4.15: log file is shorter when d3dx9_43 is installed.
...
if [ "$INSTALL_METHOD" == "STEAM" ]; then
        ...
        POL_Download "http://files.myplaycity.com/files_downloader_temp/aquaball_setup.exe"
        POL_SetupWindow_message "$(eval_gettext 'Note: we recommend you to uncheck all the checkboxes:\n[x] -> [ ]')" "$TITLE"
        POL_Wine "aquaball_setup.exe" # "/SILENT"
...
iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCXceLZgAKCRDlMfrJqhPK
RyNLAJ9JkWcCqKChAZWGR6LRugClcuV+bQCdE9s796++kJMrV9MDzSAXVM+0HOE=
=AHep
-----END PGP SIGNATURE-----
