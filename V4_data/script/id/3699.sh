...
#
# TESTED Editions: v2.043 (credits screen) 2011 (engine.exe) DDV from MyPlayCity.com
#
...
TITLE="FBI: Paranormal Case Extended Edition"
PREFIX="FBI_Paranormal_case"
EDITOR="Alawar"
GAME_URL=""
AUTHOR="Dadu042"
STEAM_ID=""
...
if [ "$INSTALL_METHOD" == "STEAM" ]; then
        ...
        POL_Download "http://files.myplaycity.com/files_downloader_temp/fbiextended_setup.exe"
        # POL_SetupWindow_message "$(eval_gettext 'Note: we recommend you to uncheck all the checkboxes:\n[x] -> [ ]')" "$TITLE"
        POL_Wine "fbiextended_setup.exe"  "/SILENT"
...
iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCXceKfgAKCRDlMfrJqhPK
R+CXAJ4vtLLpf3/Lj84gyIvPbgaRz5otOQCfUCPzAogd0ZSOgxsMCSL9cwHMQRw=
=+hfh
-----END PGP SIGNATURE-----
