...
GAME_VMS="256"
SHORTCUT_FILENAME="PhotoFiltre7.exe"
...
if [ "$INSTALL_METHOD" == "STEAM" ]; then
        ...
        POL_Download "http://static.infomaniak.ch/photofiltre/utils/pf7/pf7-setup-fr-7.2.1.exe"
        # POL_SetupWindow_message "$(eval_gettext 'Note: we recommend you to uncheck all the checkboxes:\n[x] -> [ ]')" "$TITLE"
        POL_Wine "pf7-setup-fr-7.2.1.exe" # "/SILENT"
        ...
        POL_Shortcut_Document "$TITLE" "PhotoFiltre7.htm"
...
iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCXceIVwAKCRDlMfrJqhPK
R6VsAJwJ+ABHx4XpWICCSk0J1IT0jX8+vgCffoGsP1jKpp7mkljPhje0VO3XMMk=
=04oe
-----END PGP SIGNATURE-----
