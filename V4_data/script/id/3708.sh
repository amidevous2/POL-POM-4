...
#
# TESTED Editions: 2014, v1.0 ? (nothing displayed on the main menu).
#
...
#
# KNOWN ISSUES:
#  - Wine amd64 3.0.3, 4.0.2: installer seeems to never exit.
#
...
TITLE="Cemetery Warrior 3"
PREFIX="CemeteryWarrior3"
...
GAME_VMS="256"
SHORTCUT_FILENAME="CemeteryWarrior3.exe"
...
if [ "$INSTALL_METHOD" == "STEAM" ]; then
        ...
        POL_Download "http://falcogames.com/rk-distributives/CemeteryWarrior3Setup.exe"
        # POL_SetupWindow_message "$(eval_gettext 'Note: we recommend you to uncheck all the checkboxes:\n[x] -> [ ]')" "$TITLE"
        POL_Wine "CemeteryWarrior3Setup.exe" # "/SILENT"
...
iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCXciEHgAKCRDlMfrJqhPK
R8zRAKCBDj8STEOT4i+Ot36jMvc+MNO8AwCcCUt1Le2ewCE8RzisIcEK/sWBSdo=
=0zGK
-----END PGP SIGNATURE-----
