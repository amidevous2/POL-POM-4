...
#
# TESTED Editions: 2017 Windows release from GOG.com
#
...
#
# KNOWN ISSUES:
#  - Wine amd64 3.0.3: only the mouse cursor does appear (background is black). Fix: Wine 4.0.2
#  - Wine amd64 4.0.2: huge log file with lines: fixme:d3d:wined3d_device_resolve_sub_resource Multisample resolve is not fully supported for typeless formats (dst_format WINED3DFMT_R8G8B8A8_TYPELESS, src_format WINED3DFMT_R8G8B8A8_TYPELESS, format WINED3DFMT_R8G8B8A8_UNORM).
#
...
PREFIX="reigns-her_majesty"
EDITOR="Devolver Digital"
GAME_URL="https://en.wikipedia.org/wiki/Reigns:_Her_Majesty"
AUTHOR="Dadu042"
STEAM_ID="717640"
WORKING_WINE_VERSION="4.0.2"
GAME_VMS="256"
SHORTCUT_FILENAME="Reigns2.exe"
...
iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCXd7yfgAKCRDlMfrJqhPK
Ryj1AJ9HU1c5b/DapFuAfKXHJ7wI8eioGACfbGNn6kCLMEw3mRRdQDQlzT+XFjI=
=mMtS
-----END PGP SIGNATURE-----
