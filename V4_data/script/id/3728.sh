...
#
# TESTED Editions: 2016 (DDV from MyPlayCity.com)
#
...
TITLE="1001 Jigsaw. Earth Chronicles 3"
PREFIX="1001_Jigsaw-EC3"
EDITOR="MyPlayCity"
GAME_URL="https://www.myplaycity.com/earth_chronicles_3/"
AUTHOR="Dadu042"
STEAM_ID=""
...
if [ "$INSTALL_METHOD" == "STEAM" ]; then
        ...
        POL_Download "http://files.myplaycity.com/files_downloader_temp/earthchronicles3_setup.exe"
        POL_SetupWindow_message "$(eval_gettext 'Note: we recommend you to uncheck all the checkboxes:\n[x] -> [ ]')" "$TITLE"
        POL_Wine "earthchronicles3_setup.exe" # "/SILENT"
...
iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCXd/iVQAKCRDlMfrJqhPK
Rx2QAKCi7ujYcRE4PpUVmlYLOnrnq2nn+QCgoTJmtOCCn01+IVUfkTTZWG/IDSU=
=lypn
-----END PGP SIGNATURE-----
