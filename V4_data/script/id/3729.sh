...
#
# KNOWN ISSUES:
#  - Wine amd64 3.0.3, 4.0.2: some lines in the debug log ('fixme:d3d:wined3d_check_device_format_conversion wined3d ...').
...
PREFIX="tutula_legend_volcano"
EDITOR="MyPlayCity"
GAME_URL="https://www.myplaycity.com/tulula/"
AUTHOR="Dadu042"
STEAM_ID=""
...
if [ "$INSTALL_METHOD" == "STEAM" ]; then
        ...
        POL_Download "http://files.myplaycity.com/files_downloader_temp/tulula_setup.exe"
        POL_SetupWindow_message "$(eval_gettext 'Note: we recommend you to uncheck all the checkboxes:\n[x] -> [ ]')" "$TITLE"
        POL_Wine "tulula_setup.exe" # "/SILENT"
...
iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCXeAvEgAKCRDlMfrJqhPK
RxB+AJ9UhDxAQenLQC7dG2SyXEk2Eh4A+gCcC9NJw1dRX6RFGlFfyJzlViWq7Ho=
=Q2/Q
-----END PGP SIGNATURE-----
