...
PREFIX="ColorPic"
EDITOR="Iconico"
GAME_URL="http://www.iconico.com/"
AUTHOR="Dadu042"
STEAM_ID=""
WORKING_WINE_VERSION="4.0.3"
GAME_VMS="256"
SHORTCUT_FILENAME="colorpic.exe"
...
if [ "$INSTALL_METHOD" == "STEAM" ]; then
        ...
        POL_Download "http://iconicoblob.blob.core.windows.net/ico/colorpic/ColorPic.exe"
        # POL_SetupWindow_message "$(eval_gettext 'Note: we recommend you to uncheck all the checkboxes:\n[x] -> [ ]')" "$TITLE"
        mv "ColorPic.exe" "ColorPic_install.exe"
        POL_Wine  --ignore-errors  "ColorPic_install.exe" # "/SILENT"
...
iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCXfVBPwAKCRDlMfrJqhPK
R/mgAJ9kk2CT/tNwDlg/KEPQHugcggjGPgCghVGR8zNzC+vLpx5QxLUbsPeMmf8=
=FwOS
-----END PGP SIGNATURE-----
