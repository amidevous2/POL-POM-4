...
#
# KNOWN ISSUES:
#  - Wine x86 4.0.3: The app does crash when exit. Tried: dotnet40.
#
#
...
TITLE="GSplit"
PREFIX="GSplit"
EDITOR="https://www.gdgsoft.com/"
GAME_URL="G.D.G. Software"
AUTHOR="Dadu042"
STEAM_ID=""
WORKING_WINE_VERSION="4.0.3"
GAME_VMS="256"
SHORTCUT_FILENAME="GSplit.exe"
SOFTWARE_CATEGORIES="FileTools;"
...
if [ "$INSTALL_METHOD" == "STEAM" ]; then
        ...
        POL_Download "https://download.gdgsoft.com/gsplitp.zip"

        POL_SetupWindow_wait_next_signal "$(eval_gettext 'Extracting the archive...')" "$TITLE"
        POL_System_unzip "gsplitp.zip" -d "$WINEPREFIX/drive_c/gsplit/"
...
if [ "$APP_ANSWER" == ".EXE" ]; then
        ...
        POL_SetupWindow_wait_next_signal "$(eval_gettext 'Extracting the archive...')" "$TITLE"
        POL_System_unzip "$APP_ANSWER" -d "$WINEPREFIX/drive_c/gsplit/"
        POL_Shortcut "$SHORTCUT_FILENAME" "$TITLE" "" "" "$SOFTWARE_CATEGORIES"
        POL_Shortcut_Document "$TITLE" "Readme.txt"
...
iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCXfVTsAAKCRDlMfrJqhPK
R3nlAJ9LlW58PU9vNcl6RlBX9e5eKreElACfRbPTtHSevHeVCgiDsrsQWQn4TCY=
=5RXY
-----END PGP SIGNATURE-----
