...
#
# KNOWN ISSUES:
#  - Wine amd64 3.0.3, 3.21: no sound nor music. Fix: install dsound + directmusic.
#  - Wine amd64 3.0.3: 'ole:CoGetClassObject class {efca3d92-dfd8-4672-a603-7420894bad98} not registered'. Tried: mdac28, quartz.
#
#
...
TITLE="Verminest"
PREFIX="Verminest"
EDITOR="https://www.locomalito.com/verminest.php"
GAME_URL="Locomalito"
AUTHOR="Dadu042"
STEAM_ID=""
WORKING_WINE_VERSION="3.0.3"
GAME_VMS="256"
SHORTCUT_FILENAME="Verminest.exe"
...
if [ "$INSTALL_METHOD" == "STEAM" ]; then
        ...
        POL_Download "https://www.locomalito.com/juegos/Verminest.zip"

        POL_SetupWindow_wait_next_signal "$(eval_gettext 'Extracting the archive...')" "$TITLE"
        POL_System_unzip "Verminest.zip" -d "$WINEPREFIX/drive_c/game/"
...
iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCXffz+QAKCRDlMfrJqhPK
RxMCAJ0RUvFwEOD3al7iza+B/TVmhM4wWACeNMHxcR+ArbSHM6j0gE2PyCo/eac=
=X5SX
-----END PGP SIGNATURE-----
