...
#
# TESTED Editions: v1.3.7 2O19.
#
# Middlewares used by this software : Adventure Game Studio.
#
# CHANGELOG
# [Dadu042] (2019-12-17)
#   First script.
...
GAME_URL="https://en.wikipedia.org/wiki/TORCS"
AUTHOR="Dadu042"
STEAM_ID=""
WORKING_WINE_VERSION="4.0.3"
GAME_VMS="256"
SHORTCUT_FILENAME="wtorcs.exe"
SOFTWARE_CATEGORIES="Game;RacingGame;"
...
if [ "$INSTALL_METHOD" == "STEAM" ]; then
        ...
        POL_Download "https://ia801903.us.archive.org/33/items/cart-life-v1.6/cartlife_1_6.zip"

        POL_SetupWindow_wait_next_signal "$(eval_gettext 'Extracting the archive...')" "$TITLE"
        POL_System_unzip "cartlife_1_6.zip" -d "$WINEPREFIX/drive_c/game/"
        ...
        # POL_SetupWindow_menu "$(eval_gettext 'What is the type of the file?.')" "$TITLE" "$(eval_gettext '.7Z')~$(eval_gettext '.ZIP')~$(eval_gettext '.RAR')" "~"
        APP_ANSWER=".EXE"
...
iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCXflO+wAKCRDlMfrJqhPK
R+7LAJ93fMXDmOINl/+x7oZchNDFh8c7BwCfW7h5txxFea0zfHR0w9EF6B31qiw=
=Xnrm
-----END PGP SIGNATURE-----
