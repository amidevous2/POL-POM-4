...
#
# TESTED Editions: local ZIP v1.3.11.
#
# Middlewares used by this software : Blitz Basic.
#
# CHANGELOG
# [Dadu042] (2019-12-20)
#   First script.
...
#   Game VMS required 256 -> 128
#
# KNOWN ISSUES:
#  - User guide's shortcut (from POL) does link to a wrong 'readme.txt'
#  - Wine amd64 3.0.3 fullscreen: crash after 5 sec (intro video), but works windowed. Cause: Quartz when installed, I decide to only ask to hide messages in the log (fixme-all).
#  - Wine amd64 3.0.3: some text fonts appear blurred (issue occurs from the launcher screen). Tried: corefonts, FontsSmoothGrayScale, RegisterFonts.
#  - Wine amd64 3.0.3: in the log lots of messages about Quartz. Fix: install Quartz.
#  - Wine amd64 3.0.3: black window, sound 15 sec, then crash ('Memory Access Violation'). Fix: winetricks ffdshow.
#
...
PREFIX="SCP-CB"
EDITOR="SCP Team"
GAME_URL="https://en.wikipedia.org/wiki/SCP_–_Containment_Breach"
AUTHOR="Dadu042"
STEAM_ID=""
WORKING_WINE_VERSION="3.0.3"
GAME_VMS="128"
SHORTCUT_FILENAME="SCP - Containment Breach.exe"
...
iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCXgqURQAKCRDlMfrJqhPK
R+jCAJ0axFN0gKWCfBlWpZhagQ2QMPGiJwCfa2YEX6VT9PIjfrvXJ+CFFq1ODYw=
=5xDH
-----END PGP SIGNATURE-----
