...
#
# TESTED Editions: 2010 edition, local file 'mechwarrior4merc.all.to.51.03.01.0017.rar' renamed to .ZIP. 
#                  ( Downloaded from: https://www.fileplanet.com/archive/p-33886/MechWarrior-4-Mercenaries )
#
# Middlewares used by this software : DirectX 8.1, .MPG video files.
#
# CHANGELOG
...
#
# KNOWN ISSUES:
#  - Wine amd64 4.0.3, 4.21: crash when launching (STOP: FAILED (0x887602eb - D3DERR_SURFACENOTINVIDMEM) - CreateDevice(BLADE from 0x1e4fd08)). Workaround: disable fullscreen (command line '-window').
#  - Wine amd64 4.0.3, 4.21: fail to read mpeg videos (error window). Tried: ffdshow, amstream. Workaround: disable with command line '/gosnovideo'.
#  - Wine amd64 4.0.3: crash after clicking 'Instant action' in the main menu. Tried: vcrun2005, '/gosusehw', quartz. Fix: in file 'options.ini' change 'ShadowMode=2' to 'ShadowMode=1'.
#  - Wine amd64/x86 4.0.3: crash when game does exit. Workaround: POL_Shortcut_QuietDebug
#
...
PREFIX="MechWarrior_4_Mercenaries"
EDITOR="Studio MekTek"
GAME_URL="https://en.wikipedia.org/wiki/MechWarrior_4:_Mercenaries"
AUTHOR="Dadu042"
STEAM_ID=""
WORKING_WINE_VERSION="4.0.4"
GAME_VMS="256"
SHORTCUT_FILENAME="MW4Mercs.exe"
...
if [ "$INSTALL_METHOD" == "STEAM" ]; then
        ...
        POL_Download "http://undertowgames.com/file/scp/SCP%20-%20Containment%20Breach%20v1.3.11.zip"
 
        POL_SetupWindow_wait_next_signal "$(eval_gettext 'Extracting the archive...')" "$TITLE"
        POL_System_unzip "SCP%20-%20Containment%20Breach%20v1.3.11.zip" -d "$WINEPREFIX/drive_c/game/"
...
if [ "$APP_ANSWER" == ".EXE" ]; then
        ...
        POL_Shortcut "$SHORTCUT_FILENAME" "$TITLE" "" "-noautoconfig -window /gosnoblade /gosnodialogs /gosnovideo" "$SOFTWARE_CATEGORIES"
...
POL_SetupWindow_message "$(eval_gettext 'TO DO !: please edit the file options.ini in order to change ShadowMode=2 to ShadowMode=1\nthen click the <Next> button. ')" "$TITLE"
...
iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCX9hybQAKCRDlMfrJqhPK
R+EYAJ9Yd1yOFavuWyGcKLxFycq3NwdOjwCghGeU5linEzcsugFw8gJBX/b9HcQ=
=QnxF
-----END PGP SIGNATURE-----
