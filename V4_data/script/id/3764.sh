...
# [Dadu042] (2019-12-22)
#   First script.
# [Dadu042] (2019-12-25 O3:30)
#   Wine 4.0.3 -> 3.0.3 (to make it playable from POL 4.2.12)
# [Dadu042] (2019-12-25 O3:50)
#   Wine 3.0.3 -> 3.20 (fix the blue rectangle issue, and seems to let the game use the 2 cores of the CPU).
#
# KNOWN ISSUES:
#  - Wine amd64 4.0.3: X
#  - Wine amd64 3.0.3: a blue rectangle appear 1 second between each levels. Fix: Wine 3.20 and 4.0.3
...
TITLE="God Of Light"
PREFIX="God_Of_Light"
EDITOR="Playmous & Eon games"
GAME_URL="https://www.myplaycity.com/god_of_light/"
AUTHOR="Dadu042"
STEAM_ID=""
...
iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCXgLOPQAKCRDlMfrJqhPK
R2McAKCQ+/4MLYeSVcQS5ClbhBQbd/LELwCgnSIL4C6skmyfS4r8uPpCs5AXQLY=
=0ued
-----END PGP SIGNATURE-----
