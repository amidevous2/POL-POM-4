...
#
# TESTED Editions: europe CD-ROM v1.0.1.3 (version displayed on the game's Launcher window).
#
# Middlewares used by this software : Dotnet, DirectX 9.0c, Shockwave.
#
# CHANGELOG
# [Dadu042] (2019-12-30)
#   First script.
#
# KNOWN ISSUES:
#  - Wine x86 4.0.3: patch file v1.1.0.5 (TCNY-EUROPE-PATCH.EXE) does not want to install ('invalid') over my v1.0.1.3 French.
...
PREFIX="Tycoon_City_NY"
EDITOR="Atari"
GAME_URL="https://en.wikipedia.org/wiki/Tycoon_City:_New_York"
AUTHOR="Dadu042"
STEAM_ID=""
WORKING_WINE_VERSION="4.0.3"
GAME_VMS="64"
SHORTCUT_FILENAME="TycoonCity.exe"
...
if [ "$INSTALL_METHOD" == "STEAM" ]; then
	...
	# POL_Call POL_Function_NoCDWarning
        ...
        POL_SetupWindow_check_cdrom "TCNY.ico"
...
iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCXgoFBgAKCRDlMfrJqhPK
R7P1AKCaKQxEQopWgTblFk7F63RYOajWOQCfVRQaMcx2f4BVRqqUzK/sxbccKf8=
=uBTM
-----END PGP SIGNATURE-----
