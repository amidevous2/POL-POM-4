...
#
# TESTED Editions:  2013 (engine.exe) DDV from MyPlayCity.com
#
...
TITLE="Garfield Kart"
PREFIX="Garfield_Kart"
EDITOR="Alawar"
GAME_URL="https://www.myplaycity.com/garfield_kart/"
AUTHOR="Dadu042"
STEAM_ID=""
...
if [ "$INSTALL_METHOD" == "STEAM" ]; then
        ...
        POL_Download "http://files.myplaycity.com/files_downloader_temp/garfieldkart_setup.exe"
        POL_SetupWindow_message "$(eval_gettext 'Note: we recommend you to uncheck all the checkboxes:\n[x] -> [ ]')" "$TITLE"
        POL_Wine "garfieldkart_setup.exe"  "/SILENT"
...
iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCXgqNSAAKCRDlMfrJqhPK
Rz+mAKCNpzmq+AFyssNq+fh8rgn8DvO3ugCgq9/ytcwptKqxoDZYZhXfa+2H5FM=
=aUpx
-----END PGP SIGNATURE-----
