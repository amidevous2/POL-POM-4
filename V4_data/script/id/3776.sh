...
#
# TESTED Editions: EU DVD-ROM v1.0, DirectX 8.
#
# Middlewares used by this software : MS Visual C++ 2003.
#
# CHANGELOG
# [rlarjsdn122] (2017-12-31)
#   First script.
# [Dadu042] (2020-01-01)
#   New script.
# [Dadu042] (2020-01-01)
#   DVD: Add POL_Function_NoCDWarning
#
# KNOWN ISSUES:
#  - Wine amd64 3.0.3, 2.22: crash immediately when launching. Tried: mdac28
#  - Wine amd64 4.0.3, 4.21, 5.0, 5.7: When trying to launch the game, nothing appear and a process (Fahrenheit.exe) is using 100% of one CPU core.
#               Tried: virtual desktop, override: mfc70.dll msvcp70.dll msvcr70.dll . Fix: NoCD (ie: for v1.1).
...
PREFIX="Fahrenheit_IP"
EDITOR="Atari"
GAME_URL="https://en.wikipedia.org/wiki/Fahrenheit_(2005_video_game)"
AUTHOR="Dadu042"
STEAM_ID=""
WORKING_WINE_VERSION=""
GAME_VMS="128"
SHORTCUT_FILENAME="Fahrenheit.exe"
...
# POL_SetupWindow_message "Warning: the installation script will not end until you close the app and its system tray icon." "$TITLE"
...
if [ "$INSTALL_METHOD" == "STEAM" ]; then
        ...
        POL_SetupWindow_check_cdrom "Fahrenheit.msi"
...
iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCXtjxfAAKCRDlMfrJqhPK
R4tPAJ9LB4ppI6hwDGqpwMVISY6TCFICJACeM0SxQ4OjAlcIMJZIEx8B8UpZaQ4=
=Wjot
-----END PGP SIGNATURE-----
