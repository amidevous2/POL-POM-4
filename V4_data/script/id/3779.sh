...
#
# TESTED Editions: CD-ROM english (folders date: december 1999) with patch file v1.2 included.
#
# Middlewares used by this software : DirectDraw 5 ?, Quicktime v3.0.2.
#
# CHANGELOG
# [Dadu042] (2020-01-01)
#   First script (tested with Wine 4.0.3).
#
# KNOWN ISSUES:
#  - Wine amd64 4.0.3: Doing ALT+TAB does lost the game visuals.
...
PREFIX="Quest_for_Glory_V_DragonFire"
EDITOR=""
GAME_URL="https://en.wikipedia.org/wiki/Quest_for_Glory_V:_Dragon_Fire"
AUTHOR="Dadu042"
STEAM_ID=""
WORKING_WINE_VERSION=""
GAME_VMS="128"
SHORTCUT_FILENAME="QFG5.exe"
...
if [ "$INSTALL_METHOD" == "STEAM" ]; then
        ...
        POL_SetupWindow_check_cdrom "QFG.ICO"
...
iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCXg0jlAAKCRDlMfrJqhPK
R3ErAKCVgxLxeCvRezcjCaVPY3/0aAq3qgCgq4mQ4TsxhqXjZaVjOImRSm2O81M=
=H0Mb
-----END PGP SIGNATURE-----
