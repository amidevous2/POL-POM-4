...
#
# TESTED Editions: v1.0.0.6 japanese 2004.
#
...
PREFIX="Cave_Story"
EDITOR="?"
GAME_URL="https://en.wikipedia.org/wiki/Cave_Story"
AUTHOR="Dadu042"
STEAM_ID=""
WORKING_WINE_VERSION=""
GAME_VMS="128"
SHORTCUT_FILENAME="Doukutsu.exe"
...
if [ "$INSTALL_METHOD" == "STEAM" ]; then
        ...
        POL_Download "https://archive.org/download/CaveStory/dou_1006.zip"  
  
        POL_SetupWindow_wait_next_signal "$(eval_gettext 'Extracting the archive...')" "$TITLE"
        POL_System_unzip "dou_1006.zip" -d "$WINEPREFIX/drive_c/game/"
	...
	POL_Shortcut_QuietDebug "$SHORTCUT_FILENAME"
        ...
        POL_Shortcut "doconfig.exe" "$TITLE - Config" "" "" "$SOFTWARE_CATEGORIES"


        POL_Download "https://archive.org/download/CaveStory/cavestory-englishpatch.zip"  
  
        POL_SetupWindow_wait_next_signal "$(eval_gettext 'Extracting the english translation archive...')" "$TITLE"
        POL_System_unzip "cavestory-englishpatch.zip" -d "$WINEPREFIX/drive_c/game/"

	cd "$WINEPREFIX/drive_c/game/"
        POL_Wine start /unix "Cave Story Translation Installer.exe"
        POL_Wine_WaitExit "$TITLE"
...
iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCXg3UOgAKCRDlMfrJqhPK
R7FvAJ95l8+YhgkwhihPAWHKG/5wsIEPsQCeMLA5tJeWHm4ewTKqB2XKEYLuIGQ=
=bK45
-----END PGP SIGNATURE-----
