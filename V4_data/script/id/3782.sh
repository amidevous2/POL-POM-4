...
#
# TESTED Editions: DVD multi5 Europe (july 2005 is the latest files date).
#
# Middlewares used by this software : Dotnet, DirectX 9, MIDI musics.
#
# CHANGELOG
# [Dadu042] (2020-01-03)
...
#
# KNOWN ISSUES:
#  - Wine amd64 4.0.3, 4.21, 5.0-rc3: No musics, but sound OK. Tried: directmusic, alsa, quartz, dsound, xact.
#  - Wine amd64 4.0.3, 4.21, 5.0-rc3: No intro videos (is there some ?).
#  - Wine amd64 4.0.3, 4.21, 5.0-rc3: some 3D jerkiness when moving the view with the Mouse (GPU Intel HD 4400).
#
# KNOWN ISSUES (FIXED):
#  - Wine amd64 4.0.3, 4.21, 5.0-rc3: Mouse does not work at all. Tried: dinput. Fix: run 'PDLauncher_f.exe' instead of 'BEL.exe'.
...
PREFIX="Pilot_Down"
EDITOR="Oxygen"
GAME_URL="https://en.wikipedia.org/wiki/Oxygen_Games"
AUTHOR="Dadu042"
STEAM_ID=""
# WORKING_WINE_VERSION=""
GAME_VMS="256"
SHORTCUT_FILENAME="PDLauncher*.exe"
...
if [ "$INSTALL_METHOD" == "STEAM" ]; then
        ...
        POL_SetupWindow_check_cdrom "PD.ico"
        ...
        POL_Download "http://launcher.buildandshoot.com/Build%20and%20Shoot%201.2%20Setup.exe"
        # POL_SetupWindow_message "$(eval_gettext 'Note: we recommend you to uncheck all the checkboxes:\n[x] -> [ ]')" "$TITLE"

        POL_Wine "Build and Shoot 1.2 Setup.exe" # "/SILENT"
...
iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCXg8ltwAKCRDlMfrJqhPK
R4BoAKCDl0O8yk5WoZ/E5tvBYvp6FymDSQCfaSEifE8S7hzQZPMFfrIUzEHcnD0=
=lqUN
-----END PGP SIGNATURE-----
