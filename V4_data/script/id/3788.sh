...
#
# TESTED Editions: retail CD-ROM (x2), the date of Setup.exe (515 MB) is 2001-11-27.
#
...
#
# KNOWN ISSUES:
#  - Wine x86 4.0.3, 3.20: the installer (setup.exe) does only open a kind of Wine file manager, then stall.
#
# KNOWN ISSUES (FIXED):
#  - Wine amd64 4.0.3: X.
...
PREFIX="panzer_elite"
EDITOR="JoWood"
GAME_URL="https://en.wikipedia.org/wiki/Panzer_Elite"
AUTHOR="Dadu042"
STEAM_ID=""
GAME_VMS="128"
SHORTCUT_FILENAME="panzer*.exe"
...
iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCXhMf1AAKCRDlMfrJqhPK
R1teAJ4y4XiTNwp2IS1mj9osEeP9WrqxuwCgrY6IhSgHB3c+56Lhg+c0c1scWbM=
=A71+
-----END PGP SIGNATURE-----
