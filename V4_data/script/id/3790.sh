...
#
# TESTED Editions: retail DVD-ROM, v1.20 (displayed on the main menu).
#
...
#
# KNOWN ISSUES (FIXED):
#  - Wine x86 3.0.3, 4.0.3: After installing ~80% of the files (up to 'SceneryGreece.arc') the installer ask for 'CD0' and does not see the DVD. Fix: clean the DVD (very dirty).
...
PREFIX="titan_quest"
EDITOR="THQ"
GAME_URL="https://en.wikipedia.org/wiki/Titan_Quest"
AUTHOR="Dadu042"
STEAM_ID=""
GAME_VMS="128"
SHORTCUT_FILENAME="titan quest.exe"
...
iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCXhRZ4gAKCRDlMfrJqhPK
R6qQAKCGFRqmhJKDswqhmxP9zIVI8ywYfwCaAoQZ0cAAq28MZ5x256lBXOj5Wmo=
=ZRuv
-----END PGP SIGNATURE-----
