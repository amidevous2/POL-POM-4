...
#
# TESTED Editions: v1.5.5.1
#
# Middlewares used by this software : .
#
# CHANGELOG
# [Dadu042] (2020-01-10 13-01)
#   Initial script (Wine 3.0.3).
#
# KNOWN ISSUES:
#  - Wine x86 3.0.3: error message when launched 'Inside was outside the bounds of the array', however the game does work.
#  - Wine x86 3.0.3: the shortcut icon in POL (yellow) is different from the icon on the desktop (blue).
#
# KNOWN ISSUES (FIXED):
...
PREFIX="mega_man_maker"
EDITOR=""
GAME_URL="https://en.wikipedia.org/wiki/Mega_Man_Maker"
AUTHOR="Dadu042"
STEAM_ID=""
GAME_VMS="64"
SHORTCUT_FILENAME="MegaMaker.exe"
...
iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCXhhpmgAKCRDlMfrJqhPK
R7NtAKCYDZvSchgSKe4++WjgFClIee+4mwCfTUINkRvEE2/1m1/0ExCgyaCALDw=
=2FUW
-----END PGP SIGNATURE-----
