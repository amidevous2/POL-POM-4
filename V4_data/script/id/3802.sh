...
TITLE="Starship Hector: The Next Generation"
PREFIX="starship_hector"
EDITOR="Ingo V."
GAME_URL="https://archive.org/details/starshiphector"
AUTHOR="Dadu042"
STEAM_ID=""
GAME_VMS="64"
SHORTCUT_FILENAME="StarshipHector.exe"
...
if [ "$INSTALL_METHOD" == "STEAM" ]; then
        ...
        POL_Download "https://archive.org/download/starshiphector/starshiphector.zip"

        POL_SetupWindow_wait_next_signal "$(eval_gettext 'Extracting the archive...')" "$TITLE"
        POL_System_unzip "starshiphector.zip" -d "$WINEPREFIX/drive_c/game/"
...
iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCXjdbpgAKCRDlMfrJqhPK
R690AKCWRB+0gM34vwNDT1o4EqqCA6CulQCfUJYIk3mR4aLtCtF3Ih24zZVAqJs=
=eBNm
-----END PGP SIGNATURE-----
