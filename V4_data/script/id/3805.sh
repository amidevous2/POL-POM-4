...
#
# TESTED Editions: 2006-03.
#
# Middlewares used by this software : .
#
# CHANGELOG
# [Dadu042] (2020-01-13 11-40)
#   Initial script.
#
# KNOWN ISSUES:
#  - Wine amd64 3.0.3: X
...
TITLE="R-Type remake ProtoType"
PREFIX="rtype_prototype"
EDITOR=""
GAME_URL="https://www.classic-retro-games.com/games/shooters/r-type-361"
AUTHOR="Dadu042"
STEAM_ID=""
GAME_VMS="64"
SHORTCUT_FILENAME="ProtoType.exe"
...
if [ "$INSTALL_METHOD" == "STEAM" ]; then
        ...
        POL_Download "https://mirror.classic-retro-games.com/ProtoType.zip"

        POL_SetupWindow_wait_next_signal "$(eval_gettext 'Extracting the archive...')" "$TITLE"
        POL_System_unzip "ProtoType.zip" -d "$WINEPREFIX/drive_c/game/"
...
iFwEABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCXhxLlQAKCRDlMfrJqhPK
RwJOAJdcDmTV/ISg9OLwYAOfv3iNqPr7AJ0Y3BZ6N6F1wbjEDbtXq1A3PHooUA==
=4Q95
-----END PGP SIGNATURE-----
