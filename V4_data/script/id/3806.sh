...
#
# TESTED Editions: 2006.
#
# Middlewares used by this software : .
#
# CHANGELOG
# [Dadu042] (2020-01-13 15-20)
#   Initial script.
#
# KNOWN ISSUES:
#  - Wine amd64 3.0.3: X
...
PREFIX="deflektor-x4"
EDITOR=""
GAME_URL="http://retrospec.sgn.net/game-links.php?link=deflektorx4"
AUTHOR="Dadu042"
STEAM_ID=""
GAME_VMS="64"
SHORTCUT_FILENAME="DeflektorX4.exe"
...
if [ "$INSTALL_METHOD" == "STEAM" ]; then
        ...
        POL_Download "http://retrospec.sgn.net/download/files/DeflektorX4.zip"

        POL_SetupWindow_wait_next_signal "$(eval_gettext 'Extracting the archive...')" "$TITLE"
        POL_System_unzip "DeflektorX4.zip" -d "$WINEPREFIX/drive_c/game/"
	...
	POL_Shortcut_QuietDebug "$TITLE"
        ...
        POL_Shortcut "DeflektorX4_windowed.exe" "$TITLE windowed" "" "" "$SOFTWARE_CATEGORIES"
...
iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCXhx/LwAKCRDlMfrJqhPK
R3FbAJ9cD7EtqpD2maWbVaQd7f+sclbs3wCfRAoTP33KeYD5i2ieFxJiP6v9KIY=
=+aX0
-----END PGP SIGNATURE-----
