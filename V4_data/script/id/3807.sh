...
#
# TESTED Editions: 2000 v0.99 .
#
# Middlewares used by this software : .
#
# CHANGELOG
# [Dadu042] (2020-02-15 06:00)
#   First script. 
# [Dadu042] (2020-02-26 08:00)
#   Disable GLSL and OpenGL in order to make the game slower (and playable).
#
# KNOWN ISSUES:
#  - Wine amd64 3.0.3: the game launch does often freeze on the first screen (elephant logo). Fix: Alt+TAB then come back to the game window. 
#
# KNOWN ISSUES (FIXED):
#  - Wine amd64 3.0.3: X
...
TITLE="Attack of the Mutant Camels (remake 2000)"
PREFIX="attack-mutant-camels-remake2000"
EDITOR=""
GAME_URL="http://retrospec.sgn.net/game/amc"
AUTHOR="Dadu042"
STEAM_ID=""
GAME_VMS="64"
SHORTCUT_FILENAME="yakattack.exe"
...
if [ "$INSTALL_METHOD" == "STEAM" ]; then
        ...
        POL_Download "http://retrospec.sgn.net/users/jdow/games/AttackOfTheMutantCamels2-YakAttack.zip"
 
        POL_SetupWindow_wait_next_signal "$(eval_gettext 'Extracting the archive...')" "$TITLE"
        # POL_System_unzip "AttackOfTheMutantCamels2-YakAttack.zip" -j -d "$WINEPREFIX/drive_c/"
        unzip -j "AttackOfTheMutantCamels2-YakAttack.zip"
        
  
        # POL_SetupWindow_message "$(eval_gettext 'Note: we recommend you to uncheck all the checkboxes:\n[x] -> [ ]')" "$TITLE"
  
        POL_Wine "yakattack-setup.exe" # "/SILENT"
...
iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCXlYbawAKCRDlMfrJqhPK
Rw7KAJ9H5aKnXN184AsD8+5kCL5u93W61wCfYvyEY4tgmYucOf/6V8CtKomrXzk=
=fLt8
-----END PGP SIGNATURE-----
