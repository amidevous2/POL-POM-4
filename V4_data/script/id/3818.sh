...
#
# TESTED Editions: retail DVD-ROM x2 (French) (2004, build 151 is display on the main menu).
#
...
#
# KNOWN ISSUES:
#  - Wine amd64 3.0.3: on the main menu the characters color is pink. Tried: patch to v161.
#
# KNOWN ISSUES (FIXED):
#  - Wine amd64 4.0.3: X
...
PREFIX="the_longest_journey"
EDITOR="FunCom"
GAME_URL="https://en.wikipedia.org/wiki/The_Longest_Journey"
AUTHOR="Dadu042"
STEAM_ID=""
GAME_VMS="4"
...
iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCXh+VjwAKCRDlMfrJqhPK
R6YyAJ9YEaN0ByHdKR9AJK8fO3Thzhv8bQCgkdYyXs7IbjZ/aKob6TBb5x92Oaw=
=mUzu
-----END PGP SIGNATURE-----
