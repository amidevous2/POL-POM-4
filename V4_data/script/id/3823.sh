...
#
# TESTED Editions: 1998-02 (piebill.exe) .
#
...
TITLE="Pie Bill!"
PREFIX="pie_bill"
EDITOR="Dan Finkelstein"
GAME_URL=""
AUTHOR="Dadu042"
STEAM_ID=""
GAME_VMS="32"
SHORTCUT_FILENAME="piebill.exe"
...
if [ "$INSTALL_METHOD" == "STEAM" ]; then
        ...
        POL_Download "https://archive.org/download/PIEBILL/PIEBILL.zip"

        POL_SetupWindow_wait_next_signal "$(eval_gettext 'Extracting the archive...')" "$TITLE"
        POL_System_unzip "PIEBILL.zip" -d "$WINEPREFIX/drive_c/game/"
...
iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCXiIPdgAKCRDlMfrJqhPK
R0uaAJ0QdrNMxESfqbf5JgBqw+958OSfOwCff3lDzy9bORs9MrmN0rVBKdp1BC4=
=eKtt
-----END PGP SIGNATURE-----
