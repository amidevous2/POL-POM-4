...
#
# TESTED Editions: Gateway Remake v11.zip
#
# Middlewares used by this software : Adventure Game Studio.
#
# CHANGELOG
# [Dadu042] (2020-01-18 14:20)
#   Initial script.
# 
#
# KNOWN ISSUES:
...
#
# KNOWN ISSUES (FIXED):
#  - Wine x86 3.20: Mouse cursor is jerky. Fix: Wine 3.0.3


[ "$PLAYONLINUX" = "" ] && exit 0
source "$PLAYONLINUX/lib/sources"
         
TITLE="Gateway Remake"
PREFIX="gateway_remake"
EDITOR="HandsFree"
GAME_URL="https://www.adventuregamestudio.co.uk/site/games/game/2130-gateway-remake/"
AUTHOR="Dadu042"
STEAM_ID=""
GAME_VMS="128"
SHORTCUT_FILENAME="Gateway Remake.exe"
...
DOCUMENT_FILE="Gateway Remake*.txt"
...
if [ "$APP_ANSWER" == ".EXE" ]; then
	...
	POL_Shortcut_QuietDebug "$TITLE"
        ...
        POL_Shortcut "winsetup.exe" "$TITLE - Settings (winsetup.exe)" "" "" "$SOFTWARE_CATEGORIES"
...
iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCXiMG+gAKCRDlMfrJqhPK
R/0vAKChQl8zt3NfWCSxbNan3IPmSmpl3QCcDX3FgkHDY8KvYoRpdrQ9K2VnY8M=
=di/X
-----END PGP SIGNATURE-----
