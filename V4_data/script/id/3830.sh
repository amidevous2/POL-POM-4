...
#
# TESTED Editions: DVD (folders date: 2005-08-11), main menu shows 'v1.06-6'.
#
# Middlewares used by this software : DirectX 9, DotNet, WMP.
#
# CHANGELOG
# [Dadu042] (2020-01-19 00:30)
#   Initial script.
# 
#
# KNOWN ISSUES:
#  - Wine x86 4.0.3: mouse cursor hard to see (because sometimes blinking, hidden).
#  - Wine x86 4.0.3: no videos shown.
#
#
# KNOWN ISSUES (FIXED):
#  - Wine amd64 3.0.3: X.
...
PREFIX="act_of_war_DA"
EDITOR="Atari Inc."
GAME_URL="https://en.wikipedia.org/wiki/Act_of_War:_Direct_Action"
AUTHOR="Dadu042"
STEAM_ID=""
GAME_VMS="128"
SHORTCUT_FILENAME="Act*.exe"
SOFTWARE_CATEGORIES="Game;StategyGame;"
# http://wiki.playonlinux.com/index.php/Scripting_-_Chapter_9:_Standardization#Advanced_Standardization
DOCUMENT_FILE="AOW*.pdf"
...
if [ "$INSTALL_METHOD" == "STEAM" ]; then
        ...
        POL_SetupWindow_check_cdrom "ActOfWar.dat"
...
iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCXiOfGgAKCRDlMfrJqhPK
R6iPAJ9pEXFTyDqt/4mPz+b0jzRMIdZsjQCdGx29J9fcjI0ZXim7/Pxi2kC5u3s=
=NvVl
-----END PGP SIGNATURE-----
