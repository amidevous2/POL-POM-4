...
#
# TESTED Editions: v1.3
#
# Middlewares used by this software : Adobe Flash 10.
#
# CHANGELOG
# [Hacksaurus_Babu] (2016-05-30)
#   First script.
# [Dadu042] (2020-01-02)
#   New script (tested with Wine 4.0.3).
#
# KNOWN ISSUES:
#  - Wine amd64 4.0.3:.
...
TITLE="SuperFighters"
PREFIX="SuperFighters"
EDITOR=""
GAME_URL="https://mythologicinteractive.com"
AUTHOR="Dadu042"
STEAM_ID=""
# WORKING_WINE_VERSION=""
GAME_VMS="128"
SHORTCUT_FILENAME="SuperFighters.exe"
...
if [ "$INSTALL_METHOD" == "STEAM" ]; then
        ...
        POL_Download "https://mythologicinteractive.com/Content/Downloads/Superfighters.exe"
        # POL_SetupWindow_message "$(eval_gettext 'Note: we recommend you to uncheck all the checkboxes:\n[x] -> [ ]')" "$TITLE"
        # POL_Wine "Superfighters.exe" # "/SILENT"
...
iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCXiQhYAAKCRDlMfrJqhPK
RxbpAJwM5Zm9bENZjI9Auip66kwBHmoo7ACfTDsbxCagSYefsASfqtMRYcnLehQ=
=4TRj
-----END PGP SIGNATURE-----
