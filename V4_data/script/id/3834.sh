...
TITLE="RAM Ghost"
PREFIX="ram_ghost"
EDITOR="Björn 'Ghost' Ludwig."
GAME_URL="http://southlogic.com/sl/sl_language_1.html"
AUTHOR="Dadu042"
STEAM_ID=""
GAME_VMS="32"
SHORTCUT_FILENAME="RAM*.exe"
...
if [ "$INSTALL_METHOD" == "STEAM" ]; then
        ...
        POL_Download "https://archive.org/download/ram-ghost/RAM_Ghost_Freeware.zip"

        POL_SetupWindow_wait_next_signal "$(eval_gettext 'Extracting the archive...')" "$TITLE"
        POL_System_unzip "RAM_Ghost_Freeware.zip" -d "$WINEPREFIX/drive_c/game/"
...
iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCXiRQYQAKCRDlMfrJqhPK
R++dAJ9NHfVzk6Ukg/6Q6X/Ib2akduEqeACfVpsW7azaEk9dx2YbMFTUwdPkHFU=
=bdBC
-----END PGP SIGNATURE-----
