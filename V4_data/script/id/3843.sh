...
#
# KNOWN ISSUES:
#  - Wine x86 3.0.3: music OK, sound NOK (no sounds). Fix: dsound (+ directmusic).
#
# KNOWN ISSUES (FIXED):
#  - Wine amd64 4.0.3: X
...
TITLE="Shadow of the Beast Remake"
PREFIX="shadow_beast_remake"
EDITOR=""
GAME_URL="https://nexus23.com/warfare2/shadow-beast-remake/#more-4037"
AUTHOR="Dadu042"
STEAM_ID=""
GAME_VMS="32"
SHORTCUT_FILENAME="SOTB*.exe"
...
if [ "$INSTALL_METHOD" == "STEAM" ]; then
        ...
        POL_Download "https://www.locomalito.com/juegos/8bit_killer.zip"
 
        POL_SetupWindow_wait_next_signal "$(eval_gettext 'Extracting the archive...')" "$TITLE"
        POL_System_unzip "8bit_killer.zip" -d "$WINEPREFIX/drive_c/game/"
...
iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCXijPwAAKCRDlMfrJqhPK
R7mLAJsGM3O2JwKv60mmMwhVhtxLP+6M8ACglJAjJoY+Ycb8mYfu3Sfc1Adgrpg=
=T3cl
-----END PGP SIGNATURE-----
