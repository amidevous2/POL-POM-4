...
#
# TESTED Editions: v1.0 I think, because on the CD-ROM IGI.exe date is 2000-16-12 (2005-02 is the date of the folders on the CD, because it's a re-release named 'Hits collection').
#
...
#
# KNOWN ISSUES:
#  - Wine x86 4.0.3, 3.0.3, 5.0-rc3: the installer does closes after selecting the language to use (I tried french and english).
#
# KNOWN ISSUES (FIXED):
#  - Wine amd64 4.0.3: X.
...
TITLE="Project I.G.I. 2"
PREFIX="project_igi_2"
EDITOR=""
GAME_URL="https://en.wikipedia.org/wiki/Project_I.G.I.2"
AUTHOR="Dadu042"
STEAM_ID=""
GAME_VMS="128"
SHORTCUT_FILENAME="IGI2.exe"
...
if [ "$INSTALL_METHOD" == "STEAM" ]; then
        ...
        POL_SetupWindow_check_cdrom "pc/IGI2.exe"
        POL_Wine start /unix "$CDROM/setup2.exe" "/SILENT"
...
iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCXj8EVQAKCRDlMfrJqhPK
R0/zAKCffmewr+2Ish/tdzcmI+Y9Db2f2ACgslPVjcQ3z4k2rrhqgUd47YZ5iaM=
=XVRK
-----END PGP SIGNATURE-----
