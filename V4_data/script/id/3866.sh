...
#
# TESTED Editions: DVD-ROM 2007 v1.0 .
#
# Middlewares used by this software : DirectX 9 and 10, vcrun2005 or 2008 .
#
# CHANGELOG
...
#
# KNOWN ISSUES:
#  - Wine amd64 4.0.3: after installing all the files (without Punkbuster nor Gamespy) the installer seems to freeze, however after 20 min it end.
#
# KNOWN ISSUES (FIXED):
#  - Wine amd64 4.0.3: X
...
GAME_URL="https://en.wikipedia.org/wiki/Crysis"
AUTHOR="Dadu042"
STEAM_ID=""
GAME_VMS="256"
SHORTCUT_FILENAME="Crysis.exe"
...
DOCUMENT_FILE="Electronic_Arts_Technical_Support.htm"
...
POL_SetupWindow_message "Warning: do not Punkbuster nor GameSpy." "$TITLE"
...
if [ "$INSTALL_METHOD" == "STEAM" ]; then
        ...
        POL_SetupWindow_check_cdrom "Crysis.msi"
        ...
        POL_Shortcut "$SHORTCUT_FILENAME" "$TITLE" "" "-dx9" "$SOFTWARE_CATEGORIES"
	...
	# 2008 (first release ?): https://archive.org/download/3kungfu2Garygasko1/3kungfu2_garygasko1.zip
	# 2009 'v1.0': https://archive.org/download/Kung_Fu_II/kungfu2.zip
	# 2012 'v1.52W':
        POL_Download "https://archive.org/download/Kung_Fu_II/kungfu2.zip"
 
        POL_SetupWindow_wait_next_signal "$(eval_gettext 'Extracting the archive...')" "$TITLE"
        POL_System_unzip "kungfu2.zip" -d "$WINEPREFIX/drive_c/game/"
...
iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCXjCcNgAKCRDlMfrJqhPK
R7LGAJ4j6YgG2BM9gS15rGejWOjDJHHIRACeKacy9oIjBv5LhRxdD+CY8/UY89A=
=Un8V
-----END PGP SIGNATURE-----
