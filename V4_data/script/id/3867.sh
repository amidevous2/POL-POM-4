...
TITLE="Chuck Rock Dance"
PREFIX="Chuck_Rock_Dance"
EDITOR="Park Productions"
GAME_URL="http://www.parkproductions.co.uk/"
AUTHOR="Dadu042"
STEAM_ID=""
GAME_VMS="64"
SHORTCUT_FILENAME="ChuckRockDance.exe"
...
if [ "$APP_ANSWER" == ".EXE" ]; then
        ...
        POL_SetupWindow_browse "$(eval_gettext 'Please select the file ParkGamesVol1.zip')" "$TITLE"
        SETUP_EXE="$APP_ANSWER"
        cd "$POL_System_TmpDir"
        POL_SetupWindow_wait_next_signal "$(eval_gettext 'Extracting the archive...')" "$TITLE"
        POL_System_unzip "$APP_ANSWER" "ParkGamesVol1/ChuckRock/*" -d "$WINEPREFIX/drive_c/game/" 
        POL_Shortcut "$SHORTCUT_FILENAME" "$TITLE" "" "" "$SOFTWARE_CATEGORIES"
...
iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCXjCvfwAKCRDlMfrJqhPK
RwZIAJ4+uoaWy02xhzwWwggRUj/oJ9GQLQCfYenf+PyGfo3LvYSOzfSd55Mhnj4=
=FnaJ
-----END PGP SIGNATURE-----
