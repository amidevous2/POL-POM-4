...
PREFIX="Aggelos_demo"
EDITOR=""
GAME_URL="https://forzapedro.itch.io/aggelos"
AUTHOR="Dadu042"
STEAM_ID=""
GAME_VMS="256"
SHORTCUT_FILENAME="Agg*.exe"
...
if [ "$APP_ANSWER" == ".EXE" ]; then
 	...
 	mkdir "$WINEPREFIX/drive_c/game/"        
	cp "$APP_ANSWER" "$WINEPREFIX/drive_c/game/"
...
iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCXjGrHwAKCRDlMfrJqhPK
R6EBAJ9XgKzicruv3FsjCBW5iBfActo3kgCfdOJ7T6Jxd+vbv3KJr78IRySp4Xw=
=APTG
-----END PGP SIGNATURE-----
