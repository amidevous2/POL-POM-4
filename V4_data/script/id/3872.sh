...
#
# TESTED Editions: v5.1 (2011).
#
# Middlewares used by this software : .
#
# CHANGELOG
# [Dadu042] (2020-01-30 18:40)
#   Initial script.
# [Dadu042] (2020-02-16 13:40)
#   Enable install from ZIP (does now work, I don't know why).
#   Fix SHORTCUT_FILENAME (made some issues on POL v4.3.4 by launching the editor instead of the game).
#
#
# KNOWN ISSUES:
#  - Wine x86 3.0.3: 'SorMaker.exe' does crash on the first screen ('Unlock sormaker first'). Fix: Must launch the game first (SorR.exe).
#
# KNOWN ISSUES (FIXED):
#  - Wine amd64 4.0.3: X
...
PREFIX="Streets_Rage_Remake"
EDITOR="Bomber Games"
GAME_URL="http://www.bombergames.net"
AUTHOR="Dadu042"
STEAM_ID=""
GAME_VMS="128"
SHORTCUT_FILENAME="SorR.exe"
...
if [ "$INSTALL_METHOD" == "STEAM" ]; then
        ...
        POL_Download "https://archive.org/download/SORRv5.1_20190209/SORRv5.1.zip"
  
        POL_SetupWindow_wait_next_signal "$(eval_gettext 'Extracting the archive...')" "$TITLE"
        POL_System_unzip "SORRv5.1.zip" -d "$WINEPREFIX/drive_c/game/"
        ...
        POL_Shortcut "SorMaker.exe" "$TITLE - Level editor" "" "" "$SOFTWARE_CATEGORIES"
...
iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCXkk6OwAKCRDlMfrJqhPK
R/EuAJ95d3VmvcCcFZhm2prQRvrdZMDKZgCeMI0MhKfxXyAeWETEmEugo4hiiOw=
=zv69
-----END PGP SIGNATURE-----
