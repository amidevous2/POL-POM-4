...
#
# TESTED Editions: v1.0 (2010). Note: the game had a Linux native release that does not run anymore on Ubuntu 19.04 (because of SDL).
#
# Middlewares used by this software : SDL.
#
# CHANGELOG
# [Dadu042] (2020-02-01 12:40)
#   Initial script.
#
#
# KNOWN ISSUES:
#  - Wine x86 4.0.3, 4.21: X
#
# KNOWN ISSUES (FIXED):
#  - Wine amd64 4.0.3: X
...
PREFIX="The_Goonies_remake"
EDITOR="Sloth Games"
GAME_URL=""
AUTHOR="Dadu042"
STEAM_ID=""
GAME_VMS="128"
SHORTCUT_FILENAME="GooniesRM.exe"
...
if [ "$INSTALL_METHOD" == "STEAM" ]; then
        ...
        POL_Download "http://computeremuzone.com/contador.php?f_ad=TheGoonies.exe&f=810&sis=win"
	cp "contador.php?f_ad=TheGoonies.exe&f=810&sis=win" TheGoonies.exe
        ...
        POL_Wine "TheGoonies.exe" # "/SILENT"
...
iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCXjXFPgAKCRDlMfrJqhPK
R4cGAKCSkk1PnuFyZJc2/kUPacYRP/8JagCfZJVEnDAbdkbKo/zkIekqj4EdALw=
=Kxv8
-----END PGP SIGNATURE-----
