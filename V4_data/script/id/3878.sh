...
#
# TESTED Editions: .EXE = 2019-07-24.
#
# Middlewares used by this software : .
#
# CHANGELOG
# [Dadu042] (2020-02-02 11:40)
#   Initial script.
#
#
# KNOWN ISSUES:
#  - Wine x86 3.0.3, 3.20: keyboard seems freeze on main menu. Workaround: doing ALT+TAB.
#  - Wine x86 3.0.3, 3.20: keyboard seems freeze when the player is killed. Fix: Wine 4.0.3
#
# KNOWN ISSUES (FIXED):
#  - Wine amd64 4.0.3: X
...
TITLE="Shinobi ANSI"
PREFIX="Shinobi_ANSI"
EDITOR="Lucky_Strikez"
GAME_URL="https://mfraley6.itch.io/ansi-shinobi"
AUTHOR="Dadu042"
STEAM_ID=""
GAME_VMS="128"
SHORTCUT_FILENAME="ANSI*.exe"
...
iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCXjavbwAKCRDlMfrJqhPK
R0ixAJ9GfEXLNISD2QVKHM6+8UiYVChyJQCgiQ28eyHcJxRTLs8LohY/dvhBSfk=
=t5Nm
-----END PGP SIGNATURE-----
