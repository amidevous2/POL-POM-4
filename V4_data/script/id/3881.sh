...
#
# CHANGELOG
# [Dadu042] (2020-02-03 11:45)
#   Initial script.
#
#
# KNOWN ISSUES:
#  - Wine x86 3.0.3, 3.20, 4.0.3: quite long log file. Tried: install directmusic (does fix the log but it disable the sound !).
#
# KNOWN ISSUES (FIXED):
#  - Wine amd64 4.0.3: X
...
TITLE="Sonic Ironstorm: Fatal Attack"
PREFIX="Sonic_Ironstorm_Fatal_Attack"
EDITOR="Astro Port"
GAME_URL="http://www.interq.or.jp/saturn/takuhama/dhc.html"
AUTHOR="Dadu042"
STEAM_ID=""
GAME_VMS="256"
SHORTCUT_FILENAME="sonic_fa.exe"
...
if [ "$INSTALL_METHOD" == "STEAM" ]; then
        ...
        POL_Download "http://ftp.vector.co.jp/43/90/3472/sonic_fa.zip"

	# mv MWLL-Installer.exe GameInstaller.exe

        POL_SetupWindow_wait_next_signal "$(eval_gettext 'Extracting the archive...')" "$TITLE"
        POL_System_unzip "sonic_fa.zip" -d "$WINEPREFIX/drive_c/game/"
...
iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCXjf2oQAKCRDlMfrJqhPK
R5ytAKCUv2PBJgB3XA7qAPwT1EMBCsj0BQCePGx44OgBQzRQ4Nvvna2r9JfNEis=
=2n75
-----END PGP SIGNATURE-----
