...
#
# TESTED Editions: 2013 (.EXE).
#
# Middlewares used by this software : .
#
#
# CHANGELOG
# [Dadu042] (2020-02-05 13:45)
#   Initial script.
#
#
# KNOWN ISSUES:
...
TITLE="Steel Strider (trial)"
PREFIX="Steel_Strider_trial"
EDITOR="Astro Port"
GAME_URL="http://www.interq.or.jp/saturn/takuhama/dhc.html"
AUTHOR="Dadu042"
STEAM_ID=""
GAME_VMS="256"
SHORTCUT_FILENAME="steel*.exe"
...
if [ "$INSTALL_METHOD" == "STEAM" ]; then
        ...
        POL_Download "http://ftp.vector.co.jp/61/62/3042/steel_strider_trial.zip"

	mv steel_strider_trial.zip game.zip
	# mv MWLL-Installer.exe GameInstaller.exe

        POL_SetupWindow_wait_next_signal "$(eval_gettext 'Extracting the archive...')" "$TITLE"
        POL_System_unzip "game.zip" -d "$WINEPREFIX/drive_c/game/"
...
iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCXjq+iAAKCRDlMfrJqhPK
RzD2AKCfGiAlxBVjCteYs4SXjfM7IpS84wCgko529KyPym2SUBHzKqeeEB8yOmg=
=heLJ
-----END PGP SIGNATURE-----
