...
#
# TESTED Editions: 2013.
#
# Middlewares used by this software : RPG Maker.
#
#
# CHANGELOG
# [Dadu042] (2020-02-09 20:25)
#   Initial script.
#
#
# KNOWN ISSUES:
...
TITLE="In Search of Immortality"
PREFIX="In_Search_of_Immortality"
EDITOR="Indrah and Fomar0153"
...
if [ "$INSTALL_METHOD" == "STEAM" ]; then
        ...
        POL_Download "https://s3.amazonaws.com/prodcartassets/31416/in-search-of-immortality.zip"
 

 
        POL_SetupWindow_wait_next_signal "$(eval_gettext 'Extracting the archive...')" "$TITLE"
        # POL_System_unzip "in-search-of-immortality.zip" -d "$WINEPREFIX/drive_c/game/"

	cd "$WINEPREFIX/drive_c"
        
	# Extract without sub-folder.
        unzip -j "in-search-of-immortality.zip" -d "$WINEPREFIX/drive_c/" || POL_Debug_Fatal "$(eval_gettext 'Error while extracting archive')"

        mv "In Search of Immortality.exe" "GameInstaller.exe"
	mkdir Game
...
iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCXkB0+QAKCRDlMfrJqhPK
R5zxAKClhCQJyTmN2Gi6xNvMyJPcxO2pAgCfYU61RKaErDEHxQkS+lpFL+wlZYg=
=sBXQ
-----END PGP SIGNATURE-----
