...
#
# TESTED Editions: 2019-06-10.
#
# Middlewares used by this software : .
#
#
# CHANGELOG
# [Dadu042] (2020-02-10 10:25)
#   Initial script.
#
#
# KNOWN ISSUES:
...
PREFIX="Darkula"
EDITOR="Locomalito"
GAME_URL="https://www.locomalito.com/"
AUTHOR="Dadu042"
STEAM_ID=""
GAME_VMS="256"
SHORTCUT_FILENAME="Dark*.exe"
...
if [ "$INSTALL_METHOD" == "STEAM" ]; then
        ...
        POL_Download "https://www.locomalito.com/juegos/Darkula.zip"

	# mv MWLL-Installer.exe GameInstaller.exe

        POL_SetupWindow_wait_next_signal "$(eval_gettext 'Extracting the archive...')" "$TITLE"
        POL_System_unzip "Darkula.zip" -d "$WINEPREFIX/drive_c/game/"
...
iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCXkEjMwAKCRDlMfrJqhPK
R1A+AJsF7lBRYZnGwxThWaCl/B9VckPBqwCdFtBLn9t9rverc3giGdGji4wqB5Y=
=JwD2
-----END PGP SIGNATURE-----
