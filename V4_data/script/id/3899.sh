...
#
# TESTED Editions: v1.10 (2014).
#
# Middlewares used by this software : .
#
#
# CHANGELOG
# [Dadu042] (2020-02-10 10:45)
#   Initial script.
#
#
# KNOWN ISSUES:
#  - Wine x86 3.0.3: multiple log lines ('0009:fixme:dxgi:dxgi_swapchain_Present Unimplemented sync interval 1').
#
# KNOWN ISSUES (FIXED):
#  - Wine amd64 4.0.3: X
...
PREFIX="Giana_Return"
EDITOR=""
GAME_URL="http://www.gianas-return.de"
AUTHOR="Dadu042"
STEAM_ID=""
GAME_VMS="128"
SHORTCUT_FILENAME="gia*.exe"
...
if [ "$INSTALL_METHOD" == "STEAM" ]; then
        ...
        POL_Download "http://www.retroguru.com/gianas-return/gianas-return-v.latest-win32.zip"

	# mv MWLL-Installer.exe GameInstaller.exe

        POL_SetupWindow_wait_next_signal "$(eval_gettext 'Extracting the archive...')" "$TITLE"
        POL_System_unzip "gianas-return-v.latest-win32.zip" -d "$WINEPREFIX/drive_c/game/"
...
iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCXkEuEwAKCRDlMfrJqhPK
R5tJAKCg8FMo2eBVV7NoMbt67BDBW5f2JgCfa4jkIxylfWvMc7/3XexaQgHmDDc=
=kr6G
-----END PGP SIGNATURE-----
