...
#
# TESTED Editions: v1.10 2016.
#
# Middlewares used by this software : .
#
#
# CHANGELOG
# [Dadu042] (2020-02-10 10:55)
#   Initial script.
#
#
# KNOWN ISSUES:
#  - Wine x86 3.0.3, 4.0.3: multiple log lines. Tried: GDI, disable GLSL.
#
# KNOWN ISSUES (FIXED):
#  - Wine amd64 4.0.3: X
...
TITLE="Another Metroid 2 Remake (by Dr M)"
PREFIX="Another_Metroid2_DrM"
EDITOR="DoctorM64"
GAME_URL="http://metroid2remake.blogspot.com"
AUTHOR="Dadu042"
STEAM_ID=""
GAME_VMS="128"
SHORTCUT_FILENAME="AM2R.exe"
...
if [ "$INSTALL_METHOD" == "STEAM" ]; then
        ...
        POL_Download "https://archive.org/download/am2r1.1/am2r-another-metroid-2-remake-1-1.zip"

	# mv MWLL-Installer.exe GameInstaller.exe

        POL_SetupWindow_wait_next_signal "$(eval_gettext 'Extracting the archive...')" "$TITLE"
        POL_System_unzip "am2r-another-metroid-2-remake-1-1.zip" -d "$WINEPREFIX/drive_c/game/"
...
iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCXkEwIQAKCRDlMfrJqhPK
R9o9AJ9pePKTOkyV2LmwzuGqILcv1LifTwCfQ+1/4XVjXgAHQrhqQHWXl4fzgZ0=
=jIRS
-----END PGP SIGNATURE-----
