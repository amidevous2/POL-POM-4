...
#
# TESTED Editions: - retail CD-ROM (v1.0) + patch v1.03.
#
# Middlewares used by this software : DirectX 8, Bink.
#
# CHANGELOG
# [Dadu042] (2020-02-16 01:00)
#   Initial script.
#
#
# KNOWN ISSUES:
#  - Wine amd64 4.0.3 (game v1.00): no intro video, mouse cursor is freeze on main menu. Fix: patch v1.03
#
# KNOWN ISSUES (FIXED):
#  - Wine amd64 3.0.3: X
...
TITLE="Warlords Battlecry II"
PREFIX="Warlords_Battlecry_II"
EDITOR="Strategic Studies Group"
GAME_URL="https://en.wikipedia.org/wiki/Warlords_Battlecry_II"
AUTHOR="Dadu042"
STEAM_ID=""
GAME_VMS="128"
SHORTCUT_FILENAME="War*.exe"
...
if [ "$INSTALL_METHOD" == "STEAM" ]; then
        ...
        POL_SetupWindow_check_cdrom "Battlecry II.exe"
...
iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCXkmmVgAKCRDlMfrJqhPK
RxAbAJwPMyBqxk6j+0dnwn5d1IUYEAgjVgCePZcvMEd/vE23r7SbYDWdwFLbYaY=
=HOa2
-----END PGP SIGNATURE-----
