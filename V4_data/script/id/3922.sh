...
#
# TESTED Editions: - retail CD-ROM (folders date: 2002-10)
#
# Middlewares used by this software : DirectX 9, Dotnet.
#
# CHANGELOG
# [Dadu042] (2020-02-16 21:50)
#   Initial script.
#
#
# KNOWN ISSUES:
#  - Wine amd64 3.0.3, 4.0.3: 'MsiSetTargetPath ...   Can't set movies folder <OK>'. Also the game fail to see the CD #2. Tried: riched30.
#  - Wine amd64 3.0.3, 4.0.3: the first window of the installer does open several times. Worarkoud: come back to the first one then continue.
#
# KNOWN ISSUES (FIXED):
#  - Wine amd64 3.0.3: X
...
PREFIX="Iron_Storm"
EDITOR="4X Studios"
GAME_URL="https://en.wikipedia.org/wiki/Iron_Storm_(2002_video_game)"
AUTHOR="Dadu042"
STEAM_ID=""
GAME_VMS="128"
SHORTCUT_FILENAME="Iron*.exe"
...
if [ "$INSTALL_METHOD" == "STEAM" ]; then
        ...
        POL_SetupWindow_check_cdrom "Ironstorm.ocd"
        POL_Wine start /unix "$CDROM/IronstormSetup.exe"
...
iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCXkm2cAAKCRDlMfrJqhPK
R2CbAJ457rdcVHlw4o6UyGYf6N/72DaerACeOTNYr0ZHksXVCKvMAGwNM6LFcAU=
=SL5Z
-----END PGP SIGNATURE-----
