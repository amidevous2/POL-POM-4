...
#
# TESTED Editions: v1.7 (2019).
#
# Middlewares used by this software : .
#
#
# CHANGELOG
# [Dadu042] (2020-02-19 21:50)
#   First script. 
#
# KNOWN ISSUES
#  - Wine amd64 3.0.3, 3.20: Error message at the bottom of the screen ('WARNING ... error: could not implicitly convert operands ...'.
#  - Wine amd64 4.0.3, 5.0: Error message at the bottom of the screen ('WARNING ... link with uncompiled/unspecified shader ...'.
#
# KNOWN ISSUES (FIXED):
#  - Wine amd64 3.0.3: X
...
DOCUMENT_FILE="The Player's Handbook.pdf"
...
if [ "$INSTALL_METHOD" == "STEAM" ]; then
        ...
        POL_SetupWindow_message "$(eval_gettext '\n\nNote: this script will download the v1.7 .')" "$TITLE"
        POL_Download "https://www.tagap.net/downloads/TAGAP_3_Setup_v1.7.exe"
   
        mv TAGAP_3_Setup_v1.7.exe GameInstaller.exe
...
iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCXk2qRAAKCRDlMfrJqhPK
RzAyAKCDQ7B9ABVFrNern99kEOefo3EjJgCaAge9IJ7nrCd23nmRI9vmbTDXNR8=
=0HMj
-----END PGP SIGNATURE-----
