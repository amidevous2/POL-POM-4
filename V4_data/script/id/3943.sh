...
#
# TESTED Editions: retail CD v1.0.0 .
#
# Middlewares used by this software :  Quake 2 engine.
#
#
# CHANGELOG
# [Dadu042] (2020-02-26 22:15)
#   First script. 
#
#
# KNOWN ISSUES
#  - Wine x86 3.0.3, 3.20, 4.21, 5.0: crash immediately when launching (there's a Game log window but because of the low resolution (640x480?) I can't read it). Tried: patch v1.0.0 to v1.40, arguments '+set r_fullscreen 0'. Fix: unofficial patch v1.42d (2015, made by Knightmare).
#  - Wine x86 4.21, 5.0: game does crash every 30 min. Note: 60 min with Wine changed to 3.0.3 
#
# KNOWN ISSUES (FIXED):
#  - Wine amd64 3.0.3: X
...
PREFIX="Return_Castle_Wolfenstein"
EDITOR="Activision"
GAME_URL="https://en.wikipedia.org/wiki/Return_to_Castle_Wolfenstein"
AUTHOR="Dadu042"
STEAM_ID=""
GAME_VMS="128"
SHORTCUT_FILENAME="WolfSP.exe"
...
if [ "$INSTALL_METHOD" == "STEAM" ]; then
        ...
        POL_Download "https://cdn.gametop.com/free-games-download/Repair-Bot.exe"
   
        mv Repair-Bot.exe GameInstaller.exe
...
iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCXm6aSAAKCRDlMfrJqhPK
R7AxAKCl22KGHOGGPmC1kiV9sa7IPz3bQQCfXrcudL6+BWLzOUYYHPHbhiT8CQE=
=cNE6
-----END PGP SIGNATURE-----
