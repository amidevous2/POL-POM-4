...
#
# CHANGELOG
# [Dadu042] (2020-03-01 14:40)
#   First script. 
#
#
# KNOWN ISSUES
#  - Wine amd64 3.0.3: the game does crash when exit.
#
# KNOWN ISSUES (FIXED):
#  - Wine amd64 3.0.3: without mfc42 the setup fail to set the OS language to the game (in my French OS, the setup selected German as language). Fix: POL_Install_mfc42
     
[ "$PLAYONLINUX" = "" ] && exit 0
source "$PLAYONLINUX/lib/sources"
     
TITLE="Hitman 1 (Codename 47)"
PREFIX="Hitman1"
EDITOR="Eidos"
GAME_URL="https://en.wikipedia.org/wiki/Hitman:_Codename_47"
AUTHOR="Dadu042"
STEAM_ID=""
GAME_VMS="64"
SHORTCUT_FILENAME="Hitman.exe"
...
if [ "$INSTALL_METHOD" == "STEAM" ]; then
        ...
        POL_SetupWindow_check_cdrom "Hitman.Exe"
...
iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCXlvJLgAKCRDlMfrJqhPK
R/GUAJ9VJauxSUB5n7BUwzqkFz3mLwvZ3QCgh9R02avWH7KpT0HBKhH8zkHYzl8=
=Y0sc
-----END PGP SIGNATURE-----
