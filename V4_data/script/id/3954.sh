...
#
# TESTED Editions: CD-ROM (v3.02.011, 1996).
#
# Middlewares used by this software : DirectX 2.
#
#
# CHANGELOG
# [Dadu042] (2020-03-03 20:00)
#   First script. 
#
#
# KNOWN ISSUES
#  - Wine amd64 3.0.3: no music but sound (Telex) OK. Driver tried: Alsa, Oss, esd.
#  - Wine amd64 3.0.3: the window size is small (640x480 pixels ?). Workaround: decrease the OS desktop resolution...
#
# KNOWN ISSUES (FIXED):
#  - Wine amd64 3.0.3: X.
...
PREFIX="Transport_Tycoon_Deluxe"
EDITOR="MicroProse"
GAME_URL="https://en.wikipedia.org/wiki/Transport_Tycoon"
AUTHOR="Dadu042"
STEAM_ID=""
GAME_VMS="32"
SHORTCUT_FILENAME="GameGFX.exe"
...
if [ "$INSTALL_METHOD" == "STEAM" ]; then
        ...
        POL_SetupWindow_check_cdrom "TTconfig.EXE"
        ...
        POL_Shortcut "TTconfig.EXE" "$TITLE - Config" "" "" "$SOFTWARE_CATEGORIES"
        ...
        POL_Download "https://cdn.gametop.com/free-games-download/Portal-Walk.exe"
...
iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCXl6/ZwAKCRDlMfrJqhPK
RxLcAJ9YP2CRxJcWqn7T0qpX40NMihwWOgCeMyG13ARUZRagezBu4txhXrR21eU=
=OCTW
-----END PGP SIGNATURE-----
