...
#
# TESTED Editions: retail CD-ROM (france, v1.0).
#
# Middlewares used by this software : .
#
#
# CHANGELOG
# [Dadu042] (2020-03-04 20:30)
#   First script. 
#
#
# KNOWN ISSUES
#  - Wine amd64 3.0.3: game does crash when exit.
#  - Wine amd64 3.0.3: playonlinux.log get larger when playing. Better: wine 3.20
#
# KNOWN ISSUES (FIXED):
#  - Wine amd64 3.0.3: X
...
STEAM_ID=""
GAME_VMS="64"
SHORTCUT_FILENAME="medieval.exe"
...
if [ "$INSTALL_METHOD" == "STEAM" ]; then
        ...
        POL_SetupWindow_check_cdrom "data/medieval.rez"
        ...
        POL_Shortcut "gmedit.exe" "$TITLE - Editor" "" "" "$SOFTWARE_CATEGORIES"
        POL_Shortcut_Document "gmedit.hlp" "$DOCUMENT_FILE"       
...
iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCXmAPKAAKCRDlMfrJqhPK
R2TbAJsGaOSKIgLFnIP0MwOh2WQllXaSKgCfc/V5qoqEGr4wmtVlhp8MaVKjM+8=
=YtGF
-----END PGP SIGNATURE-----
