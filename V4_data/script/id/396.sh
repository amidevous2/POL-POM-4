...
echo "[HKEY_CURRENT_USER\\Software\\Wine\\DllOverrides]" > "$WINEPREFIX/drive_c/windows/temp/NFSU_Fix.reg"
echo "\"dinput8\"=\"native\"" >> "$WINEPREFIX/drive_c/windows/temp/NFSU_Fix.reg"
regedit "$WINEPREFIX/drive_c/windows/temp/NFSU_Fix.reg"
...
iEYEABECAAYFAk1cJE4ACgkQ5TH6yaoTyke4YACdHGSCNshTINnaGfmrKYdJBJs3
fzcAoIAY9bwAJCHxnYnfARWDnWLjmm93
=8IC/
-----END PGP SIGNATURE-----
