...
#
# TESTED Editions: v3.0.1 (2016).
# Note: this game's first name was: Spooky's House of Jump Scares.
#
# Middlewares used by this software : .
#
#
# CHANGELOG
# [Dadu042] (2020-03-07 12:00)
#   Initial script.
# [Dadu042] (2020-03-16 12:00)
#   Enable 2nd GPU selection.
#   Add warning about debug log file size.
#   VMS required: 64 -> 128 MB.
#
# KNOWN ISSUES
#  - Wine amd64 3.20: the MIDI music and sound is played, but not the .WAV nor .MP3. Log: lots of Gtreamer issues 'Missing decoder: ID3 tag (application/x-id3)'. Fix ?: install directmusic + (ubuntu 19.10 amd64) sudo apt-get install ubuntu-restricted-extras
#    Installing quartz seems to make the things worse (huge log file).
#
# KNOWN ISSUES (FIXED):
#  - Wine amd64 3.0.3: X.
...
PREFIX="Spookys_JumpScareMansion"
EDITOR="Lag Studios"
GAME_URL="https://lagstudios.webs.com/"
AUTHOR="Dadu042"
STEAM_ID="356670"
GAME_VMS="128"
SHORTCUT_FILENAME="SPOOKY.exe"
...
if [ "$INSTALL_METHOD" == "STEAM" ]; then
        ...
        POL_Download "http://www.derekyu.com/games/spelunky_1_1.zip"
...
iFwEABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCXm/3pwAKCRDlMfrJqhPK
Rww3AJY+WLIaFnGh/UuGKQJnYjszNIWJAKCVtuDQcNGfnEAxDlpwcNnPhQl35w==
=8iH0
-----END PGP SIGNATURE-----
