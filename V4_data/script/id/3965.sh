...
#
# TESTED Editions: Windows demo.
#
# Middlewares used by this software :  .
# 
#
# CHANGELOG
# [Dadu042] (2020-03-08 17:15)
#   First script. 
#
#
# KNOWN ISSUES
#  - Wine x86 3.0.3, 3.20, 5.2: crash when launching.
#    Note: the argument '+set r_fullscreen 0' allows to see the Wine error message.
#
# KNOWN ISSUES (FIXED):
#  - Wine amd64 3.0.3: X
...
PREFIX="Return_Castle_Wolfenstein_demo"
EDITOR="Activision"
GAME_URL="https://en.wikipedia.org/wiki/Return_to_Castle_Wolfenstein"
AUTHOR="Dadu042"
STEAM_ID=""
GAME_VMS="128"
SHORTCUT_FILENAME="WolfSPDemo.exe"
...
DOCUMENT_FILE="SPDemo_readme.htm"
...
if [ "$INSTALL_METHOD" == "STEAM" ]; then
	...
	# Faster download from http://www.wolfenstein-files.de/
        POL_Download "http://www.wolfenstein-files.de/rtcw/demos/wolf_spdemo.exe"
        # POL_Download "https://archive.org/download/WolfSPDemo/Wolf_SPDemo.exe"
     
        mv wolf_spdemo.exe GameInstaller.exe
        ...
        POL_Shortcut "$SHORTCUT_FILENAME" "$TITLE" "" "+set r_fullscreen 0" "$SOFTWARE_CATEGORIES"
...
iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCXmVEAwAKCRDlMfrJqhPK
R/WUAKCVxmTNcwoAXWWr+pmD81DvBNFUUwCfXVrC/q2QUgodjnQk+3qtFUdnhEw=
=tdHt
-----END PGP SIGNATURE-----
