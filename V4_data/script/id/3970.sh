...
#
# CHANGELOG
# [Dadu042] (2020-03-10 22:00)
#   Initial script.
#
# KNOWN ISSUES
#  - Wine x86 v3.0.3, 4.0.3: the music (MIDI) does not play. Tried: quartz, xact, directmusic, dsound, amstream.
#
# KNOWN ISSUES (FIXED):
#  - 
...
TITLE="Double Dragon - Fists of Rage"
PREFIX="Double_Dragon_FistsofRage"
EDITOR="MIG"
GAME_URL=""
AUTHOR="Dadu042"
STEAM_ID=""
GAME_VMS="128"
SHORTCUT_FILENAME="Doub*.exe"
...
if [ "$INSTALL_METHOD" == "STEAM" ]; then
        ...
        POL_Download "https://archive.org/download/DoubleDragonfistsofrage/DoubleDragonfistsofrage.rar"
     
        # mv Portal-Walk.exe GameInstaller.exe
     
        # POL_SetupWindow_wait_next_signal "$(eval_gettext 'Extracting the archive...')" "$TITLE"
        POL_System_unrar x "DoubleDragonfistsofrage.rar" "$WINEPREFIX/drive_c/game/" || POL_Debug_Fatal "unrar is required to unarchive $TITLE (unrar package is not installed on the OS)."
...
iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCXmgQEwAKCRDlMfrJqhPK
RycdAJ9MGHPWEahkW63hbXMJlj3XSZbfLQCeLO9e71j2Fev43UyAXPPfJM1gnH8=
=WWUn
-----END PGP SIGNATURE-----
