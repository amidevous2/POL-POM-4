...
#
# TESTED Editions: v2.5.3850 (2019).
#
...
#
# KNOWN ISSUES
#  - Wine amd64 5.0, 4.21 : ':err:winediag:IcmpCreateFile Failed to use ICMP (network ping)'. I'm not sure if its a real problem. Look at https://forum.winehq.org/viewtopic.php?t=31134
#
# KNOWN ISSUES (FIXED):
#  - Wine amd64 3.0.3: X
...
PREFIX="Advanced_IP_Scanner"
EDITOR="Famatech Corp"
GAME_URL="https://www.advanced-ip-scanner.com/"
AUTHOR="Dadu042"
STEAM_ID=""
GAME_VMS="128"
SHORTCUT_FILENAME="advanced_ip_scanner.exe"
...
if [ "$INSTALL_METHOD" == "STEAM" ]; then
        ...
        # POL_SetupWindow_message "$(eval_gettext '\n\nNote: this script will download v2.5.3850 .')" "$TITLE"
        POL_Download "https://www.advanced-ip-scanner.com/download/Advanced_IP_Scanner_2.5.3850.exe"
  
        mv Advanced_IP_Scanner_2.5.3850.exe GameInstaller.exe
...
iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCXoI8EQAKCRDlMfrJqhPK
R13gAKCCa9eVymNxkAu0Q9drXcBOf/UjwwCfa/Hgzjsww4LS5nbCym/su7okZSM=
=oAcE
-----END PGP SIGNATURE-----
