...
# Distribution used to test : Ubuntu 20.04 64 bits
# Author : Dadu042
# Licence : Retail
# Only For : http://www.playonlinux.com
#
# TESTED Editions: 1.17 'The fake news'.
#
# Middlewares used by this software : Unity, Mono, vcrun2010 and vcrun2015, OpenAL.
#
#
# CHANGELOG
# [Dadu042] (2020-03-13 20:00)
#   Initial script.
# [Dadu042] (2020-06-16 20:00)
#   Wine 5.10 seems to fix the freeze issue after the game is loaded.
#   Arch 32 bits -> 64 bits
#
# KNOWN ISSUES:
#  - Wine x86 4.0.3, 4.21, 5.0, 5.3: The game does freeze on the loading screen, after showing the intro video. Tried: d3dx9. d3dx9_43 + compiler, vcrun2010, vcrun2015.
#    Log: ...
#    0009:fixme:ntdll:EtwEventRegister ({5eec90ab-c022-44b2-a5dd-fd716a222a15}, 0x25c1123, 0x25dc018, 0x25dc030) stub.
#    0009:fixme:ntdll:EtwEventSetInformation (deadbeef, 2, 0x25da7b8, 43) stub
#    0009:fixme:ver:GetCurrentPackageId (0x32ddb4 (nil)): stub
#    002d:fixme:d3d:state_linepattern_w Setting line patterns is not supported in OpenGL core contexts.
#   Issue on differents IGP (Intel HD Graphics 4000, HD 530, Nvidia GTX 950M). Fix: Wine 5.10+
#    
#
#
# KNOWN ISSUES (FIXED):
...
PREFIX="Plague_Inc_Evolved"
EDITOR="Ndemic Creations"
GAME_URL="https://en.wikipedia.org/wiki/Plague_Inc:_Evolved"
AUTHOR="Dadu042"
STEAM_ID="246620"
GAME_VMS="128"
SHORTCUT_FILENAME="PlagueIncEvolved.exe"
...
if [ "$INSTALL_METHOD" == "STEAM" ]; then
        ...
        POL_Shortcut "PlagueIncSC.exe" "$TITLE - Scenario Creator" "" "" "$SOFTWARE_CATEGORIES"
        ...
        POL_Download "https://tele500.abandonware-france.org/fichiers/jeux/1997/setup-00715-Dark_Earth-PCWin.exe"
	# Also hosted on: https://archive.org/details/eternalwar_201612
     
        mv setup-00715-Dark_Earth-PCWin.exe GameInstaller.exe
...
iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCXuktowAKCRDlMfrJqhPK
R1URAKCMqLzauos49JnHtHsJuErayUY39wCfQYOQe49y2x5vIuxQ5qSotR6Kc9w=
=dglr
-----END PGP SIGNATURE-----
