...
#
# TESTED Editions: v2 demo 2017.
#
# Middlewares used by this software : Unity.
#
#
# CHANGELOG
# [Dadu042] (2020-03-15 18:00)
#   Initial script.
#
# KNOWN ISSUES
#  - Wine amd64 5.0, 5.2 : X
#
# KNOWN ISSUES (FIXED):
#  - 
...
TITLE="There's Poop in my Soup: Pooping with Friends"
PREFIX="Theres_poop_in_my_soup"
EDITOR="K Bros Games"
GAME_URL=""
AUTHOR="Dadu042"
STEAM_ID="449540"
GAME_VMS="128"
SHORTCUT_FILENAME="There*.exe"
...
if [ "$INSTALL_METHOD" == "STEAM" ]; then
        ...
        POL_Download "https://webgames.host/uploads/2017/04/tpims-poopingwithfriends.zip"
        # Also hosted on: https://archive.org/details/eternalwar_201612
      
        # mv Alter-Army.exe GameInstaller.exe
        ...
        POL_System_unzip "tpims-poopingwithfriends.zip" -d "$WINEPREFIX/drive_c/game/"
...
iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCXm5z0AAKCRDlMfrJqhPK
R1+dAJ4gQNG+5a5RJsi21upAsxs2OADv6ACfceS49Bot7qyQ+8me22T8MIvLG7Y=
=j4k/
-----END PGP SIGNATURE-----
