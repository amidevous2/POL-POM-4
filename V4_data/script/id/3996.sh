...
#
# TESTED Editions: 2004 demo
#
# Middlewares used by this software : Crytek engine, vcrun2003.
#
#
# CHANGELOG
# [Dadu042] (2020-03-20 20:30)
#   Initial script. Colors (shaders) rendering issues.
# [Dadu042] (2020-03-27 20:30)
#   Fix for download method.
#
# KNOWN ISSUES
#  - Wine amd64 3.0.3, 4.21, 5.0, 5.2: visual rendering is bad (background is in single color: blue). Tried: d3dx9_43 + compiler_43, directx9, Override XRenderOGL.dll and XrenderD3D9.dll 
#
#
#
# KNOWN ISSUES (FIXED):
...
PREFIX="Far_Cry_demo"
EDITOR="Ubisoft"
GAME_URL="https://en.wikipedia.org/wiki/Far_Cry"
AUTHOR="Dadu042"
STEAM_ID=""
GAME_VMS="128"
SHORTCUT_FILENAME="FarCry.exe"
...
if [ "$INSTALL_METHOD" == "STEAM" ]; then
        ...
        POL_Download "http://download.nvidia.com/downloads/nZone/demos/Far_Cry_SP_Demo.zip"
...
iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCXn5fzwAKCRDlMfrJqhPK
R9OOAJ4lnJkfoIUGYOjOZ3LGPO56fgN+KACePNrr2RP6eGKBJgiMFzCEjMJf280=
=E7RC
-----END PGP SIGNATURE-----
