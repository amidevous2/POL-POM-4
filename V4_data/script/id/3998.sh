...
#
# TESTED Editions: Gametop.com release (april 2019 ).
#
# Middlewares used by this software : .
#
#
# CHANGELOG
# [Dadu042] (2020-03-24 22:30)
#   Initial script.
#
# KNOWN ISSUES
#  - Wine amd64 5.0: X.
...
TITLE="Moai V: New Generation"
PREFIX="moai5"
EDITOR="Alawar Entertainment, Toyman Interactive"
GAME_URL="https://www.myplaycity.com/moai_v_new_generation/"
AUTHOR="Dadu042"
STEAM_ID=""
GAME_VMS="128"
...
if [ "$INSTALL_METHOD" == "STEAM" ]; then
        ...
        POL_Download "http://files.myplaycity.com/files_downloader_temp/moaivnewgeneration_setup.exe"
        # Also hosted on: https://archive.org/details/eternalwar_201612
       
        mv moaivnewgeneration_setup.exe GameInstaller.exe
...
iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCXnqRLwAKCRDlMfrJqhPK
R1sxAJwJWguAFb6SAERxwQncy+AaQRzB1wCdEnLk0Yc/Hr4UeDjSzhx28TgF8M8=
=GNAe
-----END PGP SIGNATURE-----
