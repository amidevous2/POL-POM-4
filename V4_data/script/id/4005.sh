...
#
# TESTED Editions: 2019-12 (.EXE date).
#
# Middlewares used by this software : Unreal engine 4.
#
#
# CHANGELOG
...
#
# KNOWN ISSUES
#  - Wine amd64 4.21, 5.0: Display is too dark to be playable (Unreal of d3dx11 issue. GPU used: Intel HD 4400). Fix: wine 5.2 (dark but more clear).
#
#
#
# KNOWN ISSUES (FIXED):
...
TITLE="Spacemecanics"
PREFIX="Spacemecanics"
EDITOR="Students project"
GAME_URL="https://globalgamejam.org/2020/games/spacemecanics-4"
AUTHOR="Dadu042"
STEAM_ID=""
GAME_VMS="128"
SHORTCUT_FILENAME="Spacecook.exe"
...
if [ "$INSTALL_METHOD" == "STEAM" ]; then
        ...
        POL_Download "https://ggj.s3.amazonaws.com/games/2020/02/271998/exec/mrMbY/SpaceMecanics.zip"
        ...
        POL_System_unzip "SpaceMecanics.zip" -d "$WINEPREFIX/drive_c/game/"
...
iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCXn3ZNwAKCRDlMfrJqhPK
R23sAKCLwksU+yJC88Y+UVxfsHKfj6UQDwCghxsoGrd+RYE9BE95qBgdm/+SfN4=
=ZCua
-----END PGP SIGNATURE-----
