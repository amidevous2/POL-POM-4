...
#
# TESTED Editions: - demo v1.0 2003, 
#                  - retail 2 x CD-ROM USA (+ patch v1.02 + NoCD for v1.02).
#
# Middlewares used by this software : DirectX 9.
#
#
# CHANGELOG
# [Dadu042] (2020-03-30 23-00)
#   Initial script.
#
# KNOWN ISSUES :
#  - Wine x86 3.0.3, 3.20, 5.0, 5.5: 'CS: No disc inserted <Repeat><Cancel>'. Tried: Tron update patch v1.2. Fix: NoCD for v1.02
#
# KNOWN ISSUES (demo v1.1)
#  - Wine x86 3.0.3, 3.20, 2.22: X
#
# KNOWN ISSUES (FIXED):
#  - Wine x86 3.0.3, 3.20, 5.0: demo SP does crash when launching. Fix: vcrun6 (to add MSVCIRT.DLL).
# 
...
PREFIX="Tron20"
EDITOR="Monolith"
GAME_URL="https://en.wikipedia.org/wiki/Tron_2.0"
AUTHOR="Dadu042"
STEAM_ID="327740"
GAME_VMS="256"
SHORTCUT_FILENAME="TRON.exe"
...
iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCXodIxwAKCRDlMfrJqhPK
R0ABAJ9F6Ae9BXqRWRYnunZ/7GHaUGhVeQCgmBvnkSa0pho62TVZDNsC9BfKFAU=
=u2es
-----END PGP SIGNATURE-----
