...
#
# TESTED Editions: v1.01 (2008) .
#
# Middlewares used by this software : .
#
#
# CHANGELOG
# [Dadu042] (2020-04-01 23-00)
#   Initial script.
#
...
TITLE="Chuzzle Christmas Edition"
PREFIX="Chuzzle_Christmas_Edition"
EDITOR="Popcap"
GAME_URL=""
AUTHOR="Dadu042"
STEAM_ID=""
GAME_VMS="128"
SHORTCUT_FILENAME="C*.exe"
...
if [ "$INSTALL_METHOD" == "STEAM" ]; then
        ...
        POL_Download "https://ia801409.us.archive.org/12/items/chuzzlechristmasedition_202003/Chuzzle%20-%20Christmas%20Edition.zip"
       
        # mv Mystery-of-Unicorn-Castle-the-Beastmaster.exe GameInstaller.exe
        # mv Teacher%20Simulator.rar gameinstaller.rar        
        mv Chuzzle%20-%20Christmas%20Edition.zip gameinstaller.zip
...
iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCXoUKjQAKCRDlMfrJqhPK
RxugAKCCuZaS8AloSnTW2QfuxCjdjv1usgCdHSOCiWgCDO/sVu+ZXSOuQRmqPGo=
=KX3r
-----END PGP SIGNATURE-----
