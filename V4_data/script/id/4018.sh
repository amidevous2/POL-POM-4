...
#
# TESTED Editions:  Version 40.2.12.18 (2020-03)
#                   Version 40.2.16.14 (2020-04)
#                   Version 40.4.10.8 (2020-06)
#                   (downloaded from https://www.webex.com/downloads.html/ )
#
...
#  - Wine x86 5.5: can see other's video and hear them, but can not enable my webcam nor microphone. Bug seems related to Wine: https://forum.winehq.org/viewtopic.php?t=29120
#
# KNOWN ISSUES (FIXED):
...
PREFIX="Cisco_Webex_Meetings"
EDITOR="Cisco"
GAME_URL="https://en.wikipedia.org/wiki/Cisco_Webex"
AUTHOR="Dadu042"
STEAM_ID=""
GAME_VMS="128"
SHORTCUT_FILENAME="ptoneclk.exe"
SOFTWARE_CATEGORIES="VideoConference;"
...
if [ "$INSTALL_METHOD" == "STEAM" ]; then
        ...
        POL_Download "https://akamaicdn.webex.com/client/webexapp.msi"
...
iFwEABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCYBmjcQAKCRDlMfrJqhPK
RwYLAJ0VGCMmsS/GoVqe1oKDARVoX4IDHACWNBNedf64i8Rdy7XVRGmjUN+u3g==
=OdrY
-----END PGP SIGNATURE-----
