...
#
# TESTED Editions: v18.2 (2020).
#                  v18.4.1 (2020-07).
#
# Middlewares used by this software : RPG Maker XP.
#
#
# CHANGELOG
# [Dadu042] (2020-04-19 23-00)
#   Initial script.
# [Dadu042] (2020-09-16 14-00)
#   Wine 5.0 -> 5.0.2
#   Arch: 64bits -> auto (because no music also with 32bits)
#
# KNOWN ISSUES
#  - Wine amd64/x86 5.0, 5.0.2 : No .MID music nor .MP3 music (sounds are OK). Lots of debug lines 'err:gstreamer:mpeg_splitter_init_gst Failed to create mpegaudioparse; are 32-bit GStreamer "good" plugins installed?' (related to the MP3 files). Tried: dsound + directmusic, xact, quartz + directmusic.
#
# KNOWN ISSUES (FIXED):
#  - Wine x86 5.0: X
...
PREFIX="Pokemon_Reborn"
EDITOR=""
GAME_URL="https://www.rebornevo.com/"
AUTHOR="Dadu042"
STEAM_ID=""
GAME_VMS="128"
...
if [ "$INSTALL_METHOD" == "STEAM" ]; then
        ...
        POL_Download "https://cdn.gametop.com/free-games-download/Sky_Track.exe"
        # Also hosted on: https://archive.org/details/eternalwar_201612
          
        mv Sky_Track.exe GameInstaller.exe
...
POL_SetupWindow_message "$(eval_gettext 'WARNING: to avoid to have a big log file, you should type \ninto Debug flags : fixme-all')" "$TITLE"
...
iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCYkOQqAAKCRDlMfrJqhPK
R3pKAJ94EXge11RR+j7MfF4CJNnp4pG3UQCfdlJ1Ff0RycAAKsCRWpE+MohURv4=
=MvAK
-----END PGP SIGNATURE-----
