...
#
# TESTED Editions: 2008 release from https://www.gamepressure.com/download.asp?ID=19780
#
# Middlewares used by this software : DirectX 8 (d3d8.dll).
#
#
# CHANGELOG
# [Dadu042] (2020-05-03 13-00)
#   Initial script.
#
# KNOWN ISSUES :
#  - Wine amd64 4.0.4, 4.21 + Alsa audio: no sound nor music (ok with 3.20).
#
# KNOWN ISSUES (FIXED):
#  - Wine amd64 5.0, 4.21: nothing when launched (CPU 100%).
#  - Wine amd64 4.21 + force OpenGL and GLSL: nothing when launched (CPU OK).
#  - Wine amd64 4.21, 3.20 + disable OpenGL and GLSL: nothing when launched (CPU OK). Tried: install d3dx9 -> splash screen + error message about OpenGL (need it).
# 
...
PREFIX="Postal_2_ShareThePain"
EDITOR=""
GAME_URL="https://www.pcgamingwiki.com/wiki/Postal_2"
AUTHOR="Dadu042"
STEAM_ID=""
GAME_VMS="256"
SHORTCUT_FILENAME="Postal*.exe"
...
iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCXrAjzwAKCRDlMfrJqhPK
R31UAKCXGYmsR2XGXHpPsISxc4Q7L3vvCgCghTZwRY+goBm0hB73jM65e1Blbgc=
=Pcah
-----END PGP SIGNATURE-----
