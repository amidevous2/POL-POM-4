...
#
# TESTED Editions: 1998
#
# Middlewares used by this software : Macromedia (Flash ?) .
#
#
# CHANGELOG
# [Dadu042] (2020-05-07 23-00)
#   Initial script.
#
# KNOWN ISSUES :
#  - Wine x86 4.0.4, 4.21, 5.0: error message '256 colors mode required'. Tried: install gdiplus, flash_player, openGL -> gdi.
#  - Wine x86 4.0.4 + game patch update: same error as above.
#
# KNOWN ISSUES (FIXED):
#  - Wine x86 3.0.3: X
...
# VGA 256 colors -  Placebo code... (Dadu042, 2020-05)
...
iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCXrSGWgAKCRDlMfrJqhPK
R/i0AJ9WWwkbHXnNmy8evTDT6wwMdMUEnwCggAIzTG463yzfSynwTDARR+PLr1s=
=xEkp
-----END PGP SIGNATURE-----
