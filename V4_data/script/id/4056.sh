...
PREFIX="Galaxy_Guardian"
EDITOR=""
GAME_URL="http://www.gamehitzone.com/download-free-games/galaxy-guardian/"
AUTHOR="Dadu042"
STEAM_ID=""
GAME_VMS="128"
SHORTCUT_FILENAME="GalaxyGuardian.exe"
...
POL_SetupWindow_message "Warning: check the pathname of the installation, you might have to change it to (from 'My Documents') to the .playonlinux right prefix." "$TITLE"
...
if [ "$INSTALL_METHOD" == "STEAM" ]; then
        ...
        POL_Download "http://www.gamehitzone.com/dl/GalaxyGuardian.exe"
       
        mv GalaxyGuardian.exe GameInstaller.exe
...
iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCX5AgqQAKCRDlMfrJqhPK
Rz7dAJ0Uw+T5UP7UrYyNB4XIpRDHdqsBpQCeImJkdY4itAkbk+JqhESXHJs4kxw=
=ahsn
-----END PGP SIGNATURE-----
