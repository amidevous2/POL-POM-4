...
#
# TESTED Editions: v1.7 (2018) according the file name (h2pc_setup_1.7.exe) or: 'v0.5.6.0' (2020-03) according the top line on the menu.
#
# Middlewares used by this software : Halo 2's game, Dotnet 4.5.
#
#
# CHANGELOG
# [Dadu042] (2020-05-18 10-00)
#   Initial script.
# [Dadu042] (2020-05-18 11-00)  with game v1.7
#   Remove dotnet461 (because not mandatory, it was only mandatory for 'Durazno.exe').
#
# KNOWN ISSUES :
#  - Wine x86 5.5: X.
#
# KNOWN ISSUES (FIXED):
#  - Wine x86 5.0 + game v1.7: crash as soon as launched. Fix: dotnet40. Now new crash at launching: 'CLR error: 80004005'. Fix: Replace dotnet40 by dotnet461.
#  - Wine x86 5.0 + game v1.7: no sound. Fix: POL_Install_wmpcodecs.
#  - Wine x86 5.0.2, 5.5, 5.16 + game v1.8.1: can not install ('Install failed: data file is corrupted.'). Seems related to powershell according the install log.

[ "$PLAYONLINUX" = "" ] && exit 0
source "$PLAYONLINUX/lib/sources"
          
TITLE="Halo 2: Project Cartographer"
PREFIX="Halo_2_Cartographer"
EDITOR=""
GAME_URL="https://www.cartographer.online/"
AUTHOR="Dadu042"
STEAM_ID=""
GAME_VMS="512"
SHORTCUT_FILENAME="halo2.exe"
...
POL_SetupWindow_message "Warning: do not run the game immediately after installation." "$TITLE"
...
if [ "$INSTALL_METHOD" == "STEAM" ]; then
        ...
        POL_SetupWindow_check_cdrom "FORESTIA.EXE"
        ...
        POL_Download "http://www.algodoo.com/download/Algodoo_2_1_0-Win32.exe"
        
        mv Algodoo_2_1_0-Win32.exe GameInstaller.exe
        ...
        # POL_SetupWindow_menu "$(eval_gettext 'What is the type of the file?.')" "$TITLE" "$(eval_gettext '.EXE')~$(eval_gettext '.ZIP')" "~"
        APP_ANSWER=".EXE"
...
iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCX2W0CAAKCRDlMfrJqhPK
R/F2AJ4zVhchLjc/NKgBXnv12GTwVmI4+gCeIPApfx2nCa0z681CjdesSIRMtiI=
=GBRT
-----END PGP SIGNATURE-----
