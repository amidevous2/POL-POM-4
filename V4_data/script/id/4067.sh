...
#
# TESTED Editions: GOTY from http://nolfrevival.tk/
#
# Middlewares used by this software : DirectX 7 ?.
#
#
# CHANGELOG
# [Dadu042] (2020-04-22 16-00)
#   Initial script.
#   Note: NOLF_POST_INSTALL.bat fail to run, but this does not harm the game (with Wine).
#
# KNOWN ISSUES :
#  - Wine x86 4.0.4, 5.0: X.
#
# KNOWN ISSUES (FIXED):
#  - Wine x86 4.0.4, 5.0: game does crash after the lancher window (after clicking on 'Launch' button). Fix: directmusic
...
TITLE="No One Lives Forever 1 (The Operative) GOTY"
PREFIX="NOLF_1_The_Operative_GOTY"
EDITOR="Monolith Productions"
GAME_URL=""
AUTHOR="Dadu042"
STEAM_ID=""
GAME_VMS="128"
SHORTCUT_FILENAME="NOLF.exe"
...
iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCXslg8QAKCRDlMfrJqhPK
R25pAJ0U2QQDhMZ8LCKyzRF+JKHScZEquACZAQZ5i0jGyYnueAv78rzm1l19Gds=
=Qthx
-----END PGP SIGNATURE-----
