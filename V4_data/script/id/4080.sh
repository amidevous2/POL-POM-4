...
#
# TESTED Editions: 2015 (repackaged in 2020 by GameHitZone.com)
#
...
#
# CHANGELOG
# [Dadu042] (2020-06-01 16-00)
#   Initial script.
#
# KNOWN ISSUES :
#  - Wine x86 5.0: some lines in the debug log. Worse with Wine 4.21
#
# KNOWN ISSUES (FIXED):
#  - Wine amd64 4.21, 5.0, 5.7: fail to run because can not import he library vorbisfile.dll  Fix by running the second .EXE (not the one into /maps/7/).
#
...
PREFIX="Underground_Fight_Club"
EDITOR="Gamehitzone.com"
GAME_URL="http://www.gamehitzone.com/download-free-games/underground-fight-club/"
AUTHOR="Dadu042"
STEAM_ID=""
GAME_VMS="256"
SHORTCUT_FILENAME="UndergroundFightClub\UndergroundFightClub.exe"
...
if [ "$INSTALL_METHOD" == "STEAM" ]; then
        ...
        POL_Download "http://www.gamehitzone.com/dl/UndergroundFightClub.exe"
         
        mv UndergroundFightClub.exe GameInstaller.exe
...
iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCXtUhPgAKCRDlMfrJqhPK
R5dMAKCnzrry1pI4Y5o6yrA5YDVPaSpmXwCdHh9wRvv/EJzC9tQ/4wrB+eZfaus=
=fY1V
-----END PGP SIGNATURE-----
