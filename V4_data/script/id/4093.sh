...
#
# TESTED Editions: v1.9 (the free christmas release, 2005)
#
# Middlewares used by this software : Divx videos.
#
#
#
# CHANGELOG
# [Dadu042] (2009-06-11 11-00)
#   Initial script.
#
#
# KNOWN ISSUES :
#  - Wine x86 4.0.4: on the main menu, it does crash when launching a new single game. Fix: Wine 5.0.1
#  - Wine x86 5.0.1: still some hundred of lines in the debug log: fixme:quartz:Parser_OutputPin_QueryInterface No interface for {56a868a5-0ad4-11ce-b03a-0020af0ba770}! .  Tried: dsound, directmusic. Fix: POL_Install_xvid
#  - Wine x86 5.0.1: Divx videos are not played. Tried: POL_Install_xvid
#
#
# KNOWN ISSUES (FIXED):
...
PREFIX="SWINE"
EDITOR="StormRegion"
GAME_URL="https://en.wikipedia.org/wiki/S.W.I.N.E."
AUTHOR="Dadu042"
STEAM_ID=""
GAME_VMS="16"
SHORTCUT_FILENAME="swine.exe"
...
POL_SetupWindow_message "The installation is finished." "$TITLE"
...
iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCXuJ8IwAKCRDlMfrJqhPK
R/RoAKCGC5WSzcTOnbET15z2505LB1qRSgCfaSdJ18UPX5Dy49oMN8kSqyQ1J60=
=EN+T
-----END PGP SIGNATURE-----
