...
# Distribution used to test : KUbuntu 20.04 64 bits, IGP: Intel HD 530.
# Author : Dadu042
# Licence : Retail
# Only For : http://www.playonlinux.com
#
# TESTED Editions: Gametop.com release (2020).
#
# Middlewares used by this software : vcrun2008.
#
#
# CHANGELOG
# [Dadu042] (2020-06-16)
...
#
# KNOWN ISSUES
#  - Wine x86 5.0.1: the debug log grow fast.
#
# KNOWN ISSUES (FIXED):
#  - Wine x86 4.0.4, 5.0.1: the game only provides the English language, you may change it by editing the file 'languages.ini'
#  - Wine x86 5.0.1: the Config.exe does not save the screen resolution (you may do it manually by editing the file 'AppConfig.ini'). Fix: Wine 4.0.4
#  - 
   
[ "$PLAYONLINUX" = "" ] && exit 0
source "$PLAYONLINUX/lib/sources"
  
TITLE="Save the Furries"
PREFIX="Save_the_Furries"
EDITOR="Microids Indie"
GAME_URL="https://www.gametop.com/download-free-games/save-the-furries/"
AUTHOR="Dadu042"
STEAM_ID=""
GAME_VMS="256"
SHORTCUT_FILENAME="wrapgame.exe"
...
# Wine v4+ are only available since POL/POM v4.3.0
...
if [ "$INSTALL_METHOD" == "STEAM" ]; then
        ...
        POL_Download "https://cdn.gametop.com/free-games-download/Save-the-Furries.exe"
        # Also hosted on: https://archive.org/details/eternalwar_201612
        
        mv Save-the-Furries.exe GameInstaller.exe
...
POL_SetupWindow_message "$(eval_gettext 'WARNING: to avoid to have a huge debug log file, you should type \ninto Debug flags : fixme-all')" "$TITLE"
...
iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCXuiuBgAKCRDlMfrJqhPK
R8+kAJ9ahq7YJXe/jJDV+q2cClMwiGxQbQCeIi/yKT0OspdwsWVa/Ak5ie34gt4=
=3Pdj
-----END PGP SIGNATURE-----
