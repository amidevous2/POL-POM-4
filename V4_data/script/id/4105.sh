...
TITLE="Dungeon Nightmare"
PREFIX="Dungeon_Nightmare"
EDITOR=""
GAME_URL="https://kmonkey.itch.io/dungeon-nightmares"
AUTHOR="Dadu042"
STEAM_ID=""
GAME_VMS="128"
SHORTCUT_FILENAME="Dung*.exe"
...
if [ "$APP_ANSWER" == ".EXE" ]; then
        ...
        POL_Shortcut "$SHORTCUT_FILENAME" "Creatures 3" "" "" "$SOFTWARE_CATEGORIES"
        POL_Shortcut_QuietDebug "$TITLE"
           
        POL_Shortcut "Creatures Exodus/Docking Station/engine.exe" "Creatures 3 - Docking Station" "" "" "$SOFTWARE_CATEGORIES"    
...
iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCXvoABAAKCRDlMfrJqhPK
R3zUAJ9aA64Uxc29Fo0DW8auE7yo8GV8NwCgm2DWsZ5K69kphD87GBhNTJyuvOM=
=Qi3l
-----END PGP SIGNATURE-----
