...
STEAM_ID=""
GAME_VMS="128"
SHORTCUT_FILENAME="squiggles.exe"
SOFTWARE_CATEGORIES="Game;KidsGame;"
...
if [ "$INSTALL_METHOD" == "STEAM" ]; then
        ...
        POL_Download "https://bay12games.com/games/squiggles.zip"
   
        # mv VLoader_CAC.exe GameInstaller.exe
        # mv Teacher%20Simulator.rar gameinstaller.rar
        mv squiggles.zip gameinstaller.zip
...
iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCXwHiowAKCRDlMfrJqhPK
RzifAJ9SbYZQsI7RdXF7o/zSUptFn0+zfgCdH8aiO7jwseAHXjQ9QwXMYJi/3dA=
=VKwp
-----END PGP SIGNATURE-----
