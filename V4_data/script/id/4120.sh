...
#
# CHANGELOG
# [Dadu042] (2020-07-08 17-00)
#   Initial script.
#
# KNOWN ISSUES :
#  - Wine x86 3.0.3, 3.20: no sounds (music OK). Fix: dsound+directmusic.
#  - Wine x86 3.0.3, 3.20, 4.0.4: when player exit the game, it still run in the background, it must be killed as a process (or to close POL).
# 
#
# KNOWN ISSUES (FIXED):
#  - Wine amd64 4.0.4: X
...
TITLE="Gauntlet Revisited"
PREFIX="Gauntlet_Revisited"
EDITOR="Mark Alexander"
GAME_URL=""
AUTHOR="Dadu042"
STEAM_ID=""
GAME_VMS="128"
SHORTCUT_FILENAME="GauntletRevisited.exe"
...
iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCXwX6wQAKCRDlMfrJqhPK
RzgsAKCIU5CS9n6e9tUmvmbyE1VprjsImwCgkXQN2tFG86x3lVPtHHk373igmjY=
=GLHP
-----END PGP SIGNATURE-----
