...
# Distribution used to test : Ubuntu 20.04 64 bits (Linux kernel v5.4), GPU: Intel HD Graphics 4000.
# Author : Dadu042
# Licence : Retail
# Only For : http://www.playonlinux.com
#
# TESTED Editions: - 'roadrash_win.zip' from https://retrofreeware.com/road-rash/
#                  - ISO CD-ROM image from https://retrofreeware.com/road-rash/
#
# Middlewares used by this software : Direct3D 2.
#
#
#
# CHANGELOG
# [Dadu042] (2020-07-11 12-00)
#   Initial script.
# [Dadu042] (2020-07-12 11-00)
#   Disable Download feature.
#   Fix RASH.REG pathname.
#   Wine 3.0.3 -> system (because issue on Ubuntu 18.04: fail to load libudev.so.0)
# [Dadu042] (2020-07-12 12-00)
#   Disable Alsa.
#   Add CD-ROM support.
#
# KNOWN ISSUES :
#  - Wine x86 3.0.3: 'altered or missing file' (it is the videos missing, does nor occurs when game installed from the CD-ROM).
#  - Wine x86 3.0.3, 5.0.1: 'MIDI error'.
#  - Wine x86 3.20, 4.0.4, 5.0.1: 'can not find the CD-ROM' (after importing RASH.REG). Fix: wine 5.0.1 ?
# 
#
# KNOWN ISSUES (FIXED):
#  - Wine x86 3.0.3: 'You must install RoadRash'. Fix: import the registry file RASH.REG
#
...
PREFIX="Road_Rash"
EDITOR=""
GAME_URL="https://en.wikipedia.org/wiki/Road_Rash_(video_game)"
AUTHOR="Dadu042"
STEAM_ID=""
GAME_VMS="128"
SHORTCUT_FILENAME="ROADRASH.EXE"
...
# POL_SetupWindow_InstallMethod "STEAM,CD,LOCAL,DOWNLOAD"
...
if [ "$INSTALL_METHOD" == "STEAM" ]; then
        ...
        POL_SetupWindow_check_cdrom "rashdemo.exe"
        ...
        POL_Shortcut "Rashme.exe" "$TITLE" "" "" "$SOFTWARE_CATEGORIES"
        ...
        POL_Download "https://ia802603.us.archive.org/20/items/Gauntlet_Revisited/GauntletRevisited.zip"
          
        # mv cf25freeSetup.exe GameInstaller.exe
        # mv Teacher%20Simulator.rar gameinstaller.rar        
        mv GauntletRevisited.zip gameinstaller.zip
...
if [ "$APP_ANSWER" == ".EXE" ]; then
       ...
       # Asking then installing local files of the game
        ...
        POL_SetupWindow_message "$(eval_gettext 'Now the script will apply RASH.REG file to the Windows registry.')" "$TITLE"
        POL_Wine regedit "$WINEPREFIX/drive_c/game/roadrash_win/Road Rash/roadrash/RASH.REG"
...
iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCXwrryQAKCRDlMfrJqhPK
RzQ1AJ0Z7NI3Sphsq+JBv6Qx9019D5FmJwCgh9H8GA/5ChvE8KcV6v9hNto4glI=
=kJhn
-----END PGP SIGNATURE-----
