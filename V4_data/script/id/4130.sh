...
#
# KNOWN ISSUES :
#  - Wine amd 64 4.0.4: vertical wrong display in a part of the screen. Fix: disable Vsync in the config.
# 
#
# KNOWN ISSUES (FIXED):
#  - Wine amd64 4.0.4: X
...
PREFIX="Aquaria_demo"
EDITOR="Bit Blot"
GAME_URL="https://en.wikipedia.org/wiki/Aquaria_(video_game)"
AUTHOR="Dadu042"
STEAM_ID=""
GAME_VMS="128"
SHORTCUT_FILENAME="aquaria.exe"
...
if [ "$INSTALL_METHOD" == "STEAM" ]; then
        ...
        POL_Download "http://www.ninj4comic.com/aquaria/AquariaDemo.2007.12.07.exe"
          
        mv AquariaDemo.2007.12.07.exe GameInstaller.exe
        ...
        POL_Shortcut "aqconfig.exe" "$TITLE - Config" "" "" "$SOFTWARE_CATEGORIES"
...
iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCXw7PlwAKCRDlMfrJqhPK
R1R/AJ9ZvJKYL/mM4W+jWgcTpNd+QQ2uHACfViXjuYjCW6Uoai125cQ4eD4StRE=
=gRXk
-----END PGP SIGNATURE-----
