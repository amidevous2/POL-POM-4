...
#
# TESTED Editions: GOG v1.0
#
# Middlewares used by this software : Fmod.
#
#
#
# CHANGELOG
...
#
# KNOWN ISSUES :
#  - Wine amd64 5.0.1: the intro cutscene has no music nor sound. Workaround: Wine 3.0.3, 4.0.4 (however, with all, the game does crash after exiting: 'fixme:avrt:AvSetMmThreadCharacteristicsW (L"Audio",07C8FE6C): stub'). Note: sound+music became OK after coming back to Wine v5.0.1
#  - Wine amd64 5.0.1: ALT+TAB does freeze the game.
#
#
# KNOWN ISSUES (FIXED):
#  - Wine amd64 5.0.1: stall on 'Please wait white Playonlinux is scanning your hardware'. Fix: text string into POL_SetupWindow_menu_list
...
PREFIX="Blades_of_time"
EDITOR="Gaijin Entertainment Corporation"
GAME_URL="https://en.wikipedia.org/wiki/Blades_of_Time"
AUTHOR="Dadu042"
STEAM_ID="208670"
GAME_VMS="512"
SHORTCUT_FILENAME="bladesoftime.exe"
...
iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCYkLHkwAKCRDlMfrJqhPK
R3qxAJ0R4SUOWlIsfcIKGFYvMdjnQQceDQCgl6wzgteVE/35M0xj07lKcqcfNaY=
=cAU2
-----END PGP SIGNATURE-----
