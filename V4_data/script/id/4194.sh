...
# TESTED Editions: GOG
#
# Middlewares used by this software : Microsoft Visual C++ 2015, DotNet v4.7.1, DirectX 11.
#
#
#
# CHANGELOG
# [Dadu042] (2020-08-31 10-00)
#   Initial script.
#
# KNOWN ISSUES :
#  - Wine amd64 4.0.4, 5.0.2 + DXVK_171: huge memory use (4 GB of swap file with 6 GB of RAM) when launching a game session. Tried: d3dx11, DXVK_161
#
# KNOWN ISSUES (FIXED):
#  - Wine amd64 5.0.2, 5.16: 3D rendering is wrong (too dark, and wrong colors). Workaround: DXVK_171 (+ Vulkan driver).
      
[ "$PLAYONLINUX" = "" ] && exit 0
source "$PLAYONLINUX/lib/sources"

TITLE="Frostpunk: The Fall of Winterhome"
PREFIX="Frostpunk_TFoW"
EDITOR="11 bit studios"
GAME_URL="https://en.wikipedia.org/wiki/Frostpunk"
AUTHOR="Dadu042"
STEAM_ID="323190"
GAME_VMS="2048"
SHORTCUT_FILENAME="Frostpunk.exe"
...
iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCX00xPwAKCRDlMfrJqhPK
R+KXAKCtBpq6CTuSor7PPanT4s1rQikaFQCaA4FgNajgizdyWk7l3sP4X7od+UI=
=m2ko
-----END PGP SIGNATURE-----
