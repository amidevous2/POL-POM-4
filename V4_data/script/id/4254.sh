...
#
# TESTED Editions (version_nl.ini): v_NL_2020.04.09.18.48.52
#
# Middlewares used by this software : ASP.Net (Microsoft),  Microsoft Visual C++ 2015-2019.
#
# CHANGELOG
# [Dadu042] (2020-10-27 20-00).
#   Initial script.
# [Dadu042] (2020-10-27 20-00).
#   Disable POL_Install_dotnet461 (because fails to install, on step Dotnet v4.5).
#
# KNOWN ISSUES :
#  - Wine amd64 5.0.2: after running mylauncher.exe, it does download some files, then nothing does happen and none .EXE is created. Perhaps some .Net version may help. Update: tried vcrun2015 and dotnet471.
#  - Wine amd64 5.0 (Crossover): when running NLUpdater.exe (after installation), the icon does appear but nothing more. Fix: vcrun2015
#
# KNOWN ISSUES (FIXED):
#  - Wine amd64 5.0.2: X
...
TITLE="NovaLink's games installer"
PREFIX="NovaLink_installer"
EDITOR="NovaLink"
GAME_URL="https://novalink.games/"
AUTHOR="Dadu042"
STEAM_ID=""
GAME_VMS="512"
SHORTCUT_FILENAME="NLUpdater.exe"
...
if [ "$INSTALL_METHOD" == "STEAM" ]; then
        ...
        POL_Download "https://novalink.games/mylauncher.exe"
           
        mv mylauncher.exe GameInstaller.exe
...
iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCYjIVwQAKCRDlMfrJqhPK
R9yRAJwIcODvNWnPZeydlHWw12JwICZdJQCgniGXAzMHVXaelwgDNtY4/7kY+K8=
=ESNH
-----END PGP SIGNATURE-----
