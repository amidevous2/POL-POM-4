...
#
# KNOWN ISSUES :
#  - Wine amd64 5.20: some game component does crash but the game continue to work.
#
# KNOWN ISSUES (FIXED):
#  - Wine amd64 5.0.2: X
...
TITLE="Mushroom Engine"
PREFIX="Mushroom_Engine"
EDITOR=""
GAME_URL="http://www.hempuli.com"
AUTHOR="Dadu042"
STEAM_ID=""
GAME_VMS="256"
SHORTCUT_FILENAME="The Mushroom Engine.exe"
...
if [ "$INSTALL_METHOD" == "STEAM" ]; then
        ...
        POL_Download "http://www.hempuli.com/MEngine.zip"
           
        # mv DrakkarLobbyInstaller.exe GameInstaller.exe
        # mv X.rar gameinstaller.rar
        mv MEngine.zip gameinstaller.zip
...
iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCX5vPPQAKCRDlMfrJqhPK
R2DLAJ9QjKFfHvSPIrh1bLTxv/sjWMXbtQCgooFhdOb2fA6IbHvCDJa5F1cA4YQ=
=IyfA
-----END PGP SIGNATURE-----
