...
STEAM_ID=""
GAME_VMS="256"
SHORTCUT_FILENAME="DataJack.exe"
...
if [ "$APP_ANSWER" == ".EXE" ]; then
       ...
       # Asking then installing local files of the game
        ...
        POL_Shortcut "fullscreen_launcher.exe" "$TITLE (full screen)" "" "" "$SOFTWARE_CATEGORIES"
...
iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCYDJj+gAKCRDlMfrJqhPK
R7xJAKCybPhk5BLUHLDo44Eq/c7hNmhiaACeIekago0L1Bv6m1tZelM+2jJ0miQ=
=REwA
-----END PGP SIGNATURE-----
