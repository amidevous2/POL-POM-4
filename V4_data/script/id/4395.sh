...
#
# TESTED Editions: 2020-12
#
# Middlewares used by this software : 
#
# CHANGELOG
# [Dadu042] (2021-07-21 10-00).
#   Initial script.
#
# KNOWN ISSUES :
#  - Wine amd64 X: X
...
TITLE="Proletarian Ninja X"
PREFIX="Proletarian_Ninja_X"
EDITOR=""
GAME_URL="https://deepnight.net/games/proletarian-ninja-x/"
AUTHOR="Dadu042"
STEAM_ID=""
GAME_VMS="256"
SHORTCUT_FILENAME="flashProjector.bin"
...
if [ "$INSTALL_METHOD" == "STEAM" ]; then
        ...
        POL_Download "https://deepnight.net/files/games/ld27-proletarianNinjaX/ProletarianNinjaX.zip"
              
        # mv OpenRails-1.3.1-Setup.exe GameInstaller.exe
        ...
        POL_Shortcut "$SHORTCUT_FILENAME" "$TITLE" "" "client.swf" "$SOFTWARE_CATEGORIES"
        POL_Shortcut_QuietDebug "$TITLE"
...
iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCYjBwSQAKCRDlMfrJqhPK
R1CnAJ9bfBWqNJMcOEsJHuhxlNsxYsIBEACfbbd31eYKyQITEXp3LxcTiNAx/kM=
=m7kC
-----END PGP SIGNATURE-----
