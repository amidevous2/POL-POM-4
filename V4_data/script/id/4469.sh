...
TITLE="Mutants from the Deep"
PREFIX="mutants_from_deeep"
EDITOR=""
GAME_URL="https://www.locomalito.com/"
AUTHOR="Dadu042"
STEAM_ID=""
GAME_VMS="256"
SHORTCUT_FILENAME="Mutants_from_the_Deep.exe"
...
if [ "$INSTALL_METHOD" == "STEAM" ]; then
        ...
        POL_Download "https://locomalito.com/juegos/Mutants_from_the_Deep.zip"
                 
        # mv setup-testfiltragev1.exe GameInstaller.exe
        # mv X.rar gameinstaller.rar
        mv Mutants_from_the_Deep.zip gameinstaller.zip
...
iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCYi5DiAAKCRDlMfrJqhPK
R+h8AKCoyXepMJWJqThtpf3ayVkUcQT2PgCeM15SJHlTQFUh4mzkS+GQcOgluc4=
=+qTt
-----END PGP SIGNATURE-----
