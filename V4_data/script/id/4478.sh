...
#
# TESTED Editions: v1.0 demo.
#
# Middlewares used by this software : RPG Maker
#
# CHANGELOG
# [Dadu042] (2022-03-18 10-00). Wine 6.0.1
#   Initial script.
#
# KNOWN ISSUES :
#  - Wine amd64 6.0.1: some blinking blocs and transparency blocs issues.
#  - Wine amd64 6.17: fails to run (crash).
#  - Wine amd64 5.0.4: game does run but without sound nor music.
#
#
# KNOWN ISSUES (FIXED):
#  - Wine amd64 6.0.1: X
...
TITLE="Star Stealing Prince Definitive"
PREFIX="Star_Stealing_Prince_Definitive"
EDITOR=""
GAME_URL=""
AUTHOR="Dadu042"
STEAM_ID=""
GAME_VMS="256"
SHORTCUT_FILENAME="SSP_Definitive*.exe"
...
DOCUMENT_FILE="StarStealing*.pdf"
...
iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCYjRp7gAKCRDlMfrJqhPK
R1o/AJ9pLIYEwoAOZDyjo8s1ez0gkL+45ACgpsPw8X/J9zeVZ7A/JrEGl9061H0=
=4UXl
-----END PGP SIGNATURE-----
