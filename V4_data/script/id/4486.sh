...
#
# TESTED Editions: v0.8 (2019).
#
# Middlewares used by this software : DirectX ?.
#
#
# CHANGELOG
# [Dadu042] (2020-05-06 11-00)
#   Initial script.
# [Dadu042] (2022-03-30 11-00)
#   Wine 5.3 (fails to run) -> 6.0.1
#
# KNOWN ISSUES :
#  - Wine x86 5.7 + xna40: game should run, but it does not...  Tried: dotnet20 + dotnet40, mono481
#  - Wine x86 3.0.3, 3.20, 4.21, 5.0: when launching nothing happens (log: stack overflow). Tried: xna31, dotnet40, override mscorwks. OS win7 -> winxp allow a error window to appear 'missing XNA 4...'
#  - Wine x86 6.0.1 : will not run without XNA40, then game does crash as soon as launched. Tried Wine 7.0.0
#
# KNOWN ISSUES (FIXED):
#  - Wine x86 5.0.1 + dotnet40: wine: Call from 0x7b00dba4 to unimplemented function mscorwks.dll.DllRegisterServerInternal, aborting  . Tried: dotnet461
#
#  C:\Command & Conquer\Twisted Insurrection 0.7\
 
[ "$PLAYONLINUX" = "" ] && exit 0
source "$PLAYONLINUX/lib/sources"
          
TITLE="Twisted Insurrection"
PREFIX="Twisted_Insurrection"
EDITOR=""
GAME_URL="https://www.moddb.com/mods/twisted-insurrection"
AUTHOR="Dadu042"
STEAM_ID=""
GAME_VMS="128"
SHORTCUT_FILENAME="TwistedInsurrection.exe"
...
# POL_Call POL_Function_OverrideDLL "native" "mscoree.dll"
...
if [ "$APP_ANSWER" == ".EXE" ]; then
       ...
       # Asking then installing local files of the game
        ...
        POL_Shortcut "$SHORTCUT_FILENAME" "$TITLE" "" "" "$SOFTWARE_CATEGORIES"
        POL_Shortcut_QuietDebug "$TITLE"# Set base register
...
iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCYkQxhgAKCRDlMfrJqhPK
RzVvAKCIksFcK0C/6rBDO4g1zqEbnvnbHgCfZ/t5l5ffbE5rfkNFzIDu/7/rD5w=
=n6GD
-----END PGP SIGNATURE-----
