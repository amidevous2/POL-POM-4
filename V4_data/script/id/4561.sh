...
#
# TESTED Editions: #82 v2.3 (2023)
#
# Middlewares used by this software : ?
#
# CHANGELOG
# [Dadu042] (2023-05-02 16-00). Wine 6.0.1
#   Initial script.
#
# KNOWN ISSUES :
#  - Wine amd64 6.0.1: X
...
TITLE="Pokemon Prisme"
PREFIX="Pokemon_Prisme"
EDITOR=""
GAME_URL="http://pokemonprisme.fr"
AUTHOR="Dadu042"
STEAM_ID=""
GAME_VMS="256"
SHORTCUT_FILENAME="Pokemon Prisme.exe"
...
if [ "$INSTALL_METHOD" == "STEAM" ]; then
        ...
        POL_Download "http://pokemonprisme.fr/PokemonPrismeInstaller.exe"
        ...
        POL_Wine start /unix "PokemonPrismeInstaller.exe" # "/SILENT"
        POL_Wine_WaitExit "$TITLE"
...
iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCZFDyKgAKCRDlMfrJqhPK
R8CMAJ9IK3rqw8cKzVkBYBEHhI33tkJY2gCfdGAdN+4vjhdwd5z5szLZaesP/mc=
=GnoO
-----END PGP SIGNATURE-----
