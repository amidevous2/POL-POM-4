...
#
# CHANGELOG
# GNU_Raziel (2011-09-07)
#   First script.
# GNU_Raziel (2012-07-21)
#   ?
# [Dadu042] (2019-07-31)
#   BUG: when installing from DVD, window 'Binary not found: steam.exe'.
#   Wine 1.5.9 -> 2.22 (to avoid Freetype and POl's GUI issues).
...
# Starting the script
POL_GetSetupImages "http://files.playonlinux.com/resources/setups/hl2/top.jpg" "http://files.playonlinux.com/resources/setups/hl2/left.jpg" "$TITLE"
...
iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCXUFxawAKCRDlMfrJqhPK
R3GBAJ4rM/cB1UImeFXc6ZAWN7hzJCkH2ACeK+H+x/euRAjMo6hLqh+rHVRAFv4=
=T0Pe
-----END PGP SIGNATURE-----
