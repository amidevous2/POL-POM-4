...
# Wine version used : system, 1.3.23, 1.3.25, 1.3.37, 1.5.9
...
# Starting the script
POL_GetSetupImages "http://files.playonlinux.com/resources/setups/hl2ep2/top.jpg" "http://files.playonlinux.com/resources/setups/hl2ep2/left.jpg" "$TITLE"
...
iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCXiDkNgAKCRDlMfrJqhPK
R+GCAKCNbIVaOn+6quhdispIapXEYUlXxQCfQP9qoXIqgH+Yvym4ny11YNyBHbQ=
=d7E5
-----END PGP SIGNATURE-----
