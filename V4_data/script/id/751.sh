...
# Last revision : (2013-07-23 21-49)
...
# Starting the script
POL_GetSetupImages "http://files.playonlinux.com/resources/setups/AB3/top.jpg" "http://files.playonlinux.com/resources/setups/AB3/left.jpg" "$TITLE"
...
# Making shortcut
if [ "$INSTALL_METHOD" != "STEAM" ]; then
    POL_Shortcut "AlienBreed3Launcher.exe" "$TITLE" "$TITLE.png" ""
fi
...
iEYEABECAAYFAlHu39MACgkQ5TH6yaoTykd1WgCfRh6Rh6CLv3bpogxhhOqbgZzO
Jb8AniMZaQRg6AwPC7QjdBJI0ZfhENWN
=4M56
-----END PGP SIGNATURE-----
