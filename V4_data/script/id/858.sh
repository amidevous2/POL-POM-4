...
#
# TESTED Editions: retail CD-ROM (x2), the game version is 'v1.02' (displayed on the main menu), and I found 'v1.00' (found in readme.rtf once installed), and the date of bo2.exe on the CD is 2002-04-11.
#
# Middlewares used by this software : DirectX 7a .
#
# CHANGELOG
# [GNU_Raziel] (2011-07-07 21-00)
#   Initial script (Wine 4.0.3).
# [Dadu042] (2020-01-04)
#   Brand new script (tested with Wine 4.0.3).
#
# KNOWN ISSUES:
#  - Wine x86 4.0.3: the link to 'BO2 configuration' fail to launch, however the settings are available from the main menu.
#
# KNOWN ISSUES (FIXED):
#  - Wine amd64 4.0.3: X.
...
PREFIX="blood_omen2"
EDITOR="JoWood"
GAME_URL="https://en.wikipedia.org/wiki/Blood_Omen_2"
AUTHOR="Dadu042"
STEAM_ID=""
GAME_VMS="128"
SHORTCUT_FILENAME="bo2.exe"
...
if [ "$INSTALL_METHOD" == "STEAM" ]; then
        ...
        POL_SetupWindow_check_cdrom "bo2.exe"
...
iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCXhCuVAAKCRDlMfrJqhPK
R4AcAKCW9G/dqoMqp+nfxuJ2WazrcjfyHgCgmOxcvR3Zyy9vGi7huechGedsEPk=
=YHm9
-----END PGP SIGNATURE-----
