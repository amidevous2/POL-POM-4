...
TITLE="Metal Slug Collection"
PREFIX="MetalSlugCollection"
...
POL_GetSetupImages "http://files.playonlinux.com/resources/setups/MSC/top.jpg" "http://files.playonlinux.com/resources/setups/MSC/left.jpg" "$TITLE"
...
if [ "$GAME_MEDIAVERSION" == "DVD" ]; then
	...
	POL_SetupWindow_check_cdrom "mslug.ico"
...
POL_SetupWindow_menu_list "$LNG_GAME_VMS" "$TITLE" "64-128-256-320-384-512-640-768-896-1024-1536-1792-2048-3072-4096" "-" "128"
VMS="$APP_ANSWER"
...
# Making shortcut
POL_SetupWindow_auto_shortcut "$PREFIX" "MetalSlug.exe" "$TITLE" "$TITLE.png" ""
...
iEYEABECAAYFAk4j9owACgkQ5TH6yaoTykdhPQCgoiFnBb5pzMiIhOCYtac3Uvx8
4fAAoIpe0RqKUA/burUdkTGsQRgvx1dV
=IsJW
-----END PGP SIGNATURE-----
