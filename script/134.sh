...
if [ "$GAME_MEDIAVERSION" == "CD" ]; then
	...
	wine "steam.exe" -applaunch 13500
...
# Making shortcut
POL_SetupWindow_auto_shortcut "$PREFIX" "PrinceOfPersia.exe" "$TITLE" "Prince of Persia : Warrior Within.xpm" ""
...
iEYEABECAAYFAk4kgF4ACgkQ5TH6yaoTykdoxgCgptDzHveWchbb5aCVAfuBO9DF
BbEAoKngA7ezzJHMGh/CL7/YIf3q1TbB
=R/Br
-----END PGP SIGNATURE-----
