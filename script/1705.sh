#!/bin/bash
# Last revision : (2013-01-09 19:14)
# Creator: petch
...
if [ "$POL_ARCH" = "amd64" ]; then
	POL_Debug_Message "Extracting x86 and x64 dlls"
        install_dx_dlls '*d3dx9*29_x64.cab' "$WINEPREFIX/drive_c/windows/system32" 'd3dx9_29.dll'
        install_dx_dlls '*d3dx9*29_x86.cab' "$WINEPREFIX/drive_c/windows/syswow64" 'd3dx9_29.dll'
else
	POL_Debug_Message "Extracting only x86 dll"
        install_dx_dlls '*d3dx9*29_x86.cab' "$WINEPREFIX/drive_c/windows/system32" 'd3dx9_29.dll'
fi

# Overriding dlls
POL_Debug_Message "Overriding all d3dx9_29 dll"
POL_Wine_OverrideDLL "native, builtin" "d3dx9_29"

cat << "-----END PGP SIGNATURE-----" > /dev/null
-----BEGIN PGP SIGNATURE-----

iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCYEnlPgAKCRDlMfrJqhPK
RwsCAJ4ijlVKjTlf3QpxMNk5oqpIMt8m0ACfVr9uyFqbmx/SjZjI4DqUWsVh+yQ=
=FinF
-----END PGP SIGNATURE-----
