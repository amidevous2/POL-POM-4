#!/bin/bash
# Last revision : (2013-05-30 01:33)
# Creator: petch
...
if [ "$POL_ARCH" = "amd64" ]; then
	POL_Debug_Message "Extracting x86 and x64 dlls"
        install_dx_dlls '*d3dx9*42_x64.cab' "$WINEPREFIX/drive_c/windows/system32" 'd3dx9_42.dll'
        install_dx_dlls '*d3dx9*42_x86.cab' "$WINEPREFIX/drive_c/windows/syswow64" 'd3dx9_42.dll'
else
	POL_Debug_Message "Extracting only x86 dll"
        install_dx_dlls '*d3dx9*42_x86.cab' "$WINEPREFIX/drive_c/windows/system32" 'd3dx9_42.dll'
fi

# Overriding dlls
POL_Debug_Message "Overriding d3dx9_42 dll"
POL_Wine_OverrideDLL "native, builtin" "d3dx9_42"

cat << "-----END PGP SIGNATURE-----" > /dev/null
-----BEGIN PGP SIGNATURE-----

iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCYKI8AwAKCRDlMfrJqhPK
R+FJAJ9rc4zk+BrDGcwtpeLZldNXqxjOhwCeOdk3/mGH5kcEff6t8+fFifXKYxY=
=gJJ6
-----END PGP SIGNATURE-----
