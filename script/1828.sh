...
#
# TESTED Editions: GameLauncherReborn 2.0.9.8 .
#
# Middlewares used by this software : .
#
#
# CHANGELOG
# [Massawi33] (2013-09-19)
#   First script. 
# [Dadu042] (2013-09-19)
#   Wine 1.5.30 -> 2.22 
#   This game now requires Dotnet4.
#
#
# KNOWN ISSUES:
#  - Wine x86 3.0.3, 4.0.3, 5.0: Game asks for Dotnet 3.0. Tried: Dotnet40, Mono312, Mono5.20. Same issue with Dotnet30 and Dotnet30sp1.
#
# KNOWN ISSUES (FIXED):
#  - Wine amd64 4.0.3: X
...
PREFIX="NeedForSpeedWorld"
EDITOR="DoctorM64"
GAME_URL=""
AUTHOR="Dadu042"
STEAM_ID=""
GAME_VMS="128"
SHORTCUT_FILENAME="GameLauncher.exe"
...
if [ "$INSTALL_METHOD" == "STEAM" ]; then
        ...
        POL_Download "http://stuntcarracerwin32.bravesites.com/files/others/StuntCarRacerWin32.zip"

	# mv MWLL-Installer.exe GameInstaller.exe

        POL_SetupWindow_wait_next_signal "$(eval_gettext 'Extracting the archive...')" "$TITLE"
        POL_System_unzip "StuntCarRacerWin32.zip" -d "$WINEPREFIX/drive_c/game/"
...
iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCXkGDewAKCRDlMfrJqhPK
R45/AJ4yo2GmZSdG+2+DOWosUYnllGvryQCdEUY+NNm6927YSgHaUS4dSazuHqo=
=YVjZ
-----END PGP SIGNATURE-----
