#!/bin/bash
# Date : (2013-03-01)
# Last revision : (2013-10-25 18:52)
...
TITLE="Sono Hanabira ni Kuchizuke wo 06 - Kuchibiru to Kiss de Tsubuyaite"
PREFIX="SonoHana_06"
WINEVERSION="1.3.4"
EDITOR="Fuguriya"
...
SONOHANA="$WINEPREFIX/drive_c/$PROGRAMFILES/ふぐり屋/その花びらにくちづけを　唇とキスで呟いて/"
...
then
	...
	POL_Shortcut "HANABIRA6.EXE" "その花びらにくちづけを 06　唇とキスで呟いて"
	# Insert a command to run as a Japanese application
	POL_Shortcut_InsertBeforeWine "その花びらにくちづけを 06　唇とキスで呟いて" "LANG=ja_JP.UTF-8"
...
then
	...
	# Create a shortcut for easy access
	POL_Shortcut "HANABIRA6.EXE" "A Kiss for the Petals 06 - Whisper With A Kiss"
	# Insert a command to run as a Japanese application/fix font issues
	POL_Shortcut_InsertBeforeWine "A Kiss for the Petals 06 - Whisper With A Kiss" "LANG=ja_JP.UTF-8"
fi
...
iEYEABECAAYFAlJqo/8ACgkQ5TH6yaoTykecrwCfR35NkuRBB7set2UrGvTdMYeX
tvgAn2LklPMySQAnbFlfz7mvjnyznMLu
=eCxv
-----END PGP SIGNATURE-----
