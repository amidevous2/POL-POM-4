#!/bin/bash
# Date : (2013-03-01)
# Last revision : (2013-10-25 18:50)
...
SONOHANA="$WINEPREFIX/drive_c/$PROGRAMFILES/ふぐり屋/その花びらにくちづけを　天使の花びら染め/"
...
then
	...
	POL_Shortcut "HANA8.EXE" "その花びらにくちづけを 08　天使の花びら染め"
	# Insert a command to run as a Japanese application
	POL_Shortcut_InsertBeforeWine "その花びらにくちづけを 08　天使の花びら染め" "LANG=ja_JP.UTF-8"
...
iEYEABECAAYFAlJqpDoACgkQ5TH6yaoTykdhoACgidBMW8IO5EIUNeoJEFy7mMUi
pUYAoKgWcAB/9Xbc14xQXjkL+UJUTwEM
=NfbQ
-----END PGP SIGNATURE-----
