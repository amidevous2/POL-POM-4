...
TITLE="PhotoFiltre Studio X"
PREFIX="PhotoFiltreStudioX"
EDITOR="Antonio Da Cruz"
GAME_URL="http://www.photofiltre-studio.com"
AUTHOR="Dadu042"
STEAM_ID=""
WORKING_WINE_VERSION="4.0.2"
GAME_VMS="256"
SHORTCUT_FILENAME="pfstudiox.exe"
SOFTWARE_CATEGORIES="Graphics;RasterGraphics;"
...
if [ "$INSTALL_METHOD" == "STEAM" ]; then
        ...
        POL_Download "http://static.infomaniak.ch/photofiltre/utils/pfsx-setup-en-10.14.0.exe"
        # POL_SetupWindow_message "$(eval_gettext 'Note: we recommend you to uncheck all the checkboxes:\n[x] -> [ ]')" "$TITLE"
        POL_Wine "pfsx-setup-en-10.14.0.exe" # "/SILENT"
        ...
        POL_Shortcut_Document "$TITLE" "PhotoFiltre Studio.htm"
...
iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCXceJggAKCRDlMfrJqhPK
R3bKAKCe9PmMrOCJObXXKIFSJr7YwLgPKACggsnrIuSThpvCEmNOFu32Ag5QbyQ=
=QM5P
-----END PGP SIGNATURE-----
