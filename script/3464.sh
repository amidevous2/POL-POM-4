...
#
# CHANGELOG
# [Dadu042] (2019-11-29 23:16)
#   First script.
#   As of today, the .EXE installer is unable to run with Wine (crash after clicking 'Finish').
#
# KNOWN ISSUES:
#  - Wine amd64 4.0.2: 'Invalid command line' while running the .EXE installer. Cause: POL_Call POL_Install_RegisterFonts ?
...
GAME_URL="https://en.wikipedia.org/wiki/Magic:_The_Gathering_Arena"
AUTHOR="Dadu042"
STEAM_ID=""
...
if [ "$INSTALL_METHOD" == "STEAM" ]; then
        ...
        POL_Download "https://mtgarena.downloads.wizards.com/Live/Windows32/MTGAInstaller.exe"
...
iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCXeGemgAKCRDlMfrJqhPK
RwFzAJ9G7Pw4331fomqJ7nK3jp+wi3jIEQCgkjcay8JkvXvONwp4qsfbCE7Brzs=
=xFKz
-----END PGP SIGNATURE-----
