...
#
# KNOWN ISSUES
# - In full screen mode, picture size does not use the full screen.
...
if [ "$APP_ANSWER" == "$(eval_gettext '.ZIP')" ]; then
        ...
        POL_Wine "steam.exe" steam://install/40720
...
if [ "$INSTALL_METHOD" == "STEAM" ]; then
        POL_Shortcut "steam.exe" "$TITLE" "" "steam://rungameid/40720"
else
        POL_Shortcut "Samorost 2.exe" "$TITLE" "" "" "Game;PuzzleGame;"
...
iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCXSg8IgAKCRDlMfrJqhPK
Ryw2AJ494tDfYR+zXRtLAgAkwWlKCT0qzACeLTNzZM3uyWTMRU4k+g+ADY0qmjU=
=jRuG
-----END PGP SIGNATURE-----
