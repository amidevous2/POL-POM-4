...
#
# TESTED (with success): digital donwload.
#
...
#   First script.
# [Dadu042] (2020-04-01)
#   Wine 4.0.1 -> 4.0.3 (played 20 min, just some short freezes on CPU Intel I3-4130).
#
#
# KNOWN ISSUES:
#   - Keyboard is QWERTY even with French language set (instead of AZERTY). Not a bug, this is a feature lacking in the game.
#
#
...
PREFIX="Jurassic_Park_Game"
EDITOR="Telltale Games"
GAME_URL="https://en.wikipedia.org/wiki/Jurassic_Park:_The_Game"
AUTHOR="Dadu042"
STEAM_ID="798840"
WORKING_WINE_VERSION="4.0.3"
GAME_VMS="512"
SHORTCUT_FILENAME="JurassicPark100.exe"
...
if [ "$INSTALL_METHOD" == "STEAM" ]; then
        ...
        POL_Wine_WaitExit "JurassicPark100_Setup.exe"
...
iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCXoXNFgAKCRDlMfrJqhPK
RzzNAJ9487s0vajOlI/9bGjCwRSP5aGb9gCfYNTC+QqRVWg9yhZdTQf+jiL1hzU=
=WbF6
-----END PGP SIGNATURE-----
