...
#
# TESTED (with success): a local game, 2017, version unknown.
#
# Middlewares used by this software : DirectX 11, Mono.
...
#
# KNOWN ISSUES:
#  - Wine 4.0.1: installer immediately display "Runtime error 229 at ...". OK with Wine 4.11
#  - Wine 4.11: missing texts in the main menu (ie: options -> graphics -> resolutions). Fix: mscorefonts
#
#
...
PREFIX="Suicide_Guy"
EDITOR="Chubby Pixel"
GAME_URL="https://chubbypixel.com"
AUTHOR="Dadu042"
STEAM_ID="303610"
WORKING_WINE_VERSION="4.11"
GAME_VMS="256"
SHORTCUT_FILENAME="SuicideGuy.exe"
...
iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCXWZAUgAKCRDlMfrJqhPK
RyOlAJsHf6LrTz44S3aTmeaPqMBoRRtw5wCfSGkVX68esT51phA5zC6Khb+3sZI=
=g9F0
-----END PGP SIGNATURE-----
