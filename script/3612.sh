...
#
# TESTED (with success): retail DVD v1.04 (found in 'Release_Notes.txt' once installed). 'v1.041' displayed on the main menu.
#
...
#
# KNOWN ISSUES:
# - Wine 4.0.1: game does not run full screen. Fix: Wine 4.0.2
#
...
PREFIX="Lucius"
EDITOR="Shiver Games"
GAME_URL="https://en.wikipedia.org/wiki/Lucius_(video_game)"
AUTHOR="Dadu042"
STEAM_ID="218640"
WORKING_WINE_VERSION="4.0.4"
GAME_VMS="512"
SHORTCUT_FILENAME="Lucius.exe"
...
iFwEABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCX561GwAKCRDlMfrJqhPK
RwtIAJj9BzOaG4SV0CC3EvIy1VD0ayzRAKCTw0oq638hFD2HSks40buXU+wwQA==
=HeFR
-----END PGP SIGNATURE-----
