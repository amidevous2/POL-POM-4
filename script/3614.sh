...
#
# TESTED (with success): v1.6 (found in versions.txt).
#
...
#
# KNOWN ISSUES:
#  - Wine amd64 4.0.2: Menu's dont appear perfectly (missing texts). Fix: install corefonts.
#
...
TITLE="Barbarian Souls"
PREFIX="Barbarian_Souls"
EDITOR="Fabio Cunha"
GAME_URL="https://store.steampowered.com/app/769110/Barbarian_Souls/"
AUTHOR="Dadu042"
STEAM_ID="769110"
WORKING_WINE_VERSION="4.0.2"
GAME_VMS="512"
SHORTCUT_FILENAME="BarbarianSouls.exe"
...
iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCXW53IQAKCRDlMfrJqhPK
R5dFAJ0dLZY5hKXwJ3GQZb7lRtyDGs2YlwCfSZajAkepa4jqHiC5afR5TuHjPgU=
=2WVe
-----END PGP SIGNATURE-----
