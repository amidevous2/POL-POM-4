...
#
# KNOWN ISSUES:
#  - Wine amd64 4.0.2: crash as soon as the Unity window appears. Fix: Wine 4.15.
#  - Wine amd64 4.0.2: desktop mouse cursor appears over the game's mouse cursor.
#
...
TITLE="Graveyard Defender"
PREFIX="Graveyard_Defender"
EDITOR="Kitty Cattus"
GAME_URL="https://store.steampowered.com/app/1143780/Graveyard_Defender/"
AUTHOR="Dadu042"
STEAM_ID="1143780"
WORKING_WINE_VERSION="4.15"
GAME_VMS="256"
SHORTCUT_FILENAME="Graveyard Defender.exe"
...
iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCXYEtkgAKCRDlMfrJqhPK
R83vAJ46yENQA9xO09b7WSNEPu14S4v0oQCfYW07s1/O8hgVmfMWPFzlqBZBpRA=
=X3gX
-----END PGP SIGNATURE-----
