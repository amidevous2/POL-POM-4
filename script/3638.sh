...
# Distribution used to test : XUbuntu 18.04.3 x64
# Author : Dadu042
# Licence : Retail
# Only For : http://www.playonlinux.com
#
# TESTED EDITION: v0.7 (visible on main menu), 2018.
#
...
TITLE="Blood Waves"
PREFIX="Blood_Waves"
EDITOR="Light Road Games"
GAME_URL="https://store.steampowered.com/app/654470/Blood_Waves/"
AUTHOR="Dadu042"
STEAM_ID="654470"
WORKING_WINE_VERSION="4.0.2"
GAME_VMS="256"
SHORTCUT_FILENAME="Blood Waves.exe"
...
POL_SetupWindow_message "$(eval_gettext 'WARNING: to avoid to have a big useless POL/POM log file, you should type \ninto Debug flags : fixme-all,err-all')" "$TITLE"

POL_SetupWindow_Close
exit 0
-----BEGIN PGP SIGNATURE-----

iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCXY8fvgAKCRDlMfrJqhPK
R083AJ99VhvT8tMQHwxP4qnylrjUiNGWKQCbB/RKiuT5ZZLwQqY1ob7eflW3Tws=
=m7vD
-----END PGP SIGNATURE-----
