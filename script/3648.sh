...
#
# TESTED Editions: 2011, v1.21.4 (in main menuu).
#
...
#   First script.
# [Dadu042] (2019-10-07)
#   Wine 4.0.2 -> 3.0.3 (to make it POL 4.2.12 compatible)
#   Disable silent install (because of icons on the desktop)
# [Dadu042] (2019-11-10)
#   Fix download.
#
# KNOWN ISSUES:
#  - Wine amd64 4.0.2: N/A
...
TITLE="Mah Jong Quest"
PREFIX="Mah_Jong_Quest"
EDITOR="Zylom ?"
GAME_URL="https://www.myplaycity.com/mahjong_quest/"
AUTHOR="Dadu042"
STEAM_ID=""
WORKING_WINE_VERSION="3.0.3"
GAME_VMS="256"
SHORTCUT_FILENAME="Mah Jong Quest.exe"
...
if [ "$INSTALL_METHOD" == "STEAM" ]; then
 ...
 #       POL_Shortcut_InsertBeforeWine "$SHORTCUT" "trap 'xrandr -s 0' EXIT"
        ...
        POL_Download "http://files.myplaycity.com/files_downloader_temp/mahjongquest_setup.exe"
        POL_Wine "mahjongquest_setup.exe" # "/SILENT"
        POL_Wine_WaitBefore "$TITLE"
        # POL_Shortcut "$SHORTCUT_FILENAME" "$TITLE" "" "" "$SOFTWARE_CATEGORIES"
        
        POL_Shortcut "MahJongQuestEN.exe" "$TITLE" "" "" "$SOFTWARE_CATEGORIES"
...
iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCXceQmwAKCRDlMfrJqhPK
RyGqAJ4yZBUV8wAp2gH8RpiF4RRmrBoGJgCdGxnuVO3IS9oWeaqL3imI7ATATiY=
=01ts
-----END PGP SIGNATURE-----
