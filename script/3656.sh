...
#
# TESTED Editions: game.exe year is 2011.
#
...
PREFIX="Garden_Defense"
EDITOR="8 Floor Games"
GAME_URL="https://www.myplaycity.com/garden_defense/"
AUTHOR="Dadu042"
STEAM_ID=""
WORKING_WINE_VERSION="3.0.3"
GAME_VMS="256"
SHORTCUT_FILENAME="garden defense.exe"
...
if [ "$INSTALL_METHOD" == "STEAM" ]; then
 ...
 #       POL_Shortcut_InsertBeforeWine "$SHORTCUT" "trap 'xrandr -s 0' EXIT"
        ...
        POL_Download "http://files.myplaycity.com/files_downloader_temp/gardendefense_setup.exe"
        POL_Wine "gardendefense_setup.exe" # "/SILENT"
        POL_Wine_WaitExit "$TITLE"
...
iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCXceP6gAKCRDlMfrJqhPK
RzKVAJwMdNAVAj6CPKuyiY4dnolFCI58cgCgmKneoBEuRNH3yaxtemlhwBs0FUw=
=I9Nw
-----END PGP SIGNATURE-----
