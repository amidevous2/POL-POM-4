...
#
# TESTED Editions: MOCA.EXE = november 2017, .EXE downloaded from the website vrtventures.org.
#
...
#   First script.
# [Dadu042] (2019-11-16)
#   Wine 4.0.2 -> 3.0.3 in order to be POL 4.2.12 compatible.
#   Install from download: feature added.
#   Install from local: disable .ZIP and .RAR
#
# KNOWN ISSUES:
#  - Wine amd64 4.0.1: mouse does move by itself. Fix: wine 4.0.2
#  - Wine amd64 4.0.2: if the file is downloaded automatically, the installer crash before to launch. Perhaps because of the file's size ? (543 MB).
...
TITLE="Kerry James Marshall’s Mastry Exhibition at MOCA Los Angeles"
PREFIX="Kerry_James_Marshall_MOCA"
EDITOR="VR't VENTURES"
GAME_URL="https://www.vrtventures.art/"
AUTHOR="Dadu042"
STEAM_ID=""
WORKING_WINE_VERSION="3.0.3"
GAME_VMS="256"
SHORTCUT_FILENAME="MOCA.exe"
SOFTWARE_CATEGORIES="Education;"
...
# Needed for Wine 4.0.2 (Bionic Commando installation):
...
if [ "$INSTALL_METHOD" == "STEAM" ]; then
        ...
        POL_Download "https://s3.amazonaws.com/vrtventuresmonolith/pc/MOCA_Installer.exe"
        POL_Wine "MOCA_Installer.exe"
...
iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCXc+YrgAKCRDlMfrJqhPK
RxAJAJ4pA9T0DuClmNoM8430V10LtOwqNACfa+jyq+SY+xDq2fi9di4lQq+0CBw=
=E0xE
-----END PGP SIGNATURE-----
