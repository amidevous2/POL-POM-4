...
TITLE="Word Challenge Extreme"
PREFIX="Word_Challenge_Extreme"
EDITOR="Alawar"
GAME_URL=""
AUTHOR="Dadu042"
STEAM_ID=""
...
GAME_VMS="256"
SHORTCUT_FILENAME="Word Challenge Extreme.exe"
...
if [ "$INSTALL_METHOD" == "STEAM" ]; then
        ...
        POL_Download "http://files.myplaycity.com/files_downloader_temp/worldchallenge_setup.exe"
        POL_SetupWindow_message "$(eval_gettext 'Note: we recommend you to uncheck all the checkboxes:\n[x] -> [ ]')" "$TITLE"
        POL_Wine "worldchallenge_setup.exe" # "/SILENT"
...
iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCXceNhwAKCRDlMfrJqhPK
R34TAKCuHzSdEdGva9WH+riwfx6VCPwcvQCfal9wYAal43y8tSIYNxx7Jglm1+s=
=xVk5
-----END PGP SIGNATURE-----
