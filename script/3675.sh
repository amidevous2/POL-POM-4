...
#
# KNOWN ISSUES:
#  - Wine amd64 3.0.3: No music. Fix: 'Sound problem fix' code.
#  - Wine amd64 3.0.3: Game is long to exit (30 sec).
#  - Wine amd64 4.0.2: Errors in the log (but music OK).
...
TITLE="Salamander NG"
PREFIX="Salamander_NG"
EDITOR="Oblio Design"
GAME_URL="http://www.obliodesign.altervista.org"
AUTHOR="Dadu042"
STEAM_ID=""
WORKING_WINE_VERSION="3.0.3"
GAME_VMS="256"
SHORTCUT_FILENAME="0_98C.exe"
...
if [ "$INSTALL_METHOD" == "STEAM" ]; then
        ...
        POL_Download "http://www.obliodesign.altervista.org/gate/Salamander_NG_098c.zip"
        # SETUP_EXE="$APP_ANSWER"
        # cd "$POL_System_TmpDir"
        POL_SetupWindow_wait_next_signal "$(eval_gettext 'Extracting the archive...')" "$TITLE"
        POL_System_unzip "Salamander_NG_098c.zip" -d "$WINEPREFIX/drive_c/"
...
iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCXbIEEgAKCRDlMfrJqhPK
R02BAJ9spArX1fk+IaZYAJvTUCP9r6GV7gCfRMwvYHulxrYpHwgjhF1Bkw+bVOE=
=VjqD
-----END PGP SIGNATURE-----
