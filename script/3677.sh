...
#
# TESTED Editions: - CD-ROM, v1.0 ? (folders date: october 2000). I have not tested the Steam edition (2014).
#                  - GOG v2.1.0.5
#
# Middlewares used by this software : DirectX 6, Phoenix VR, IndeoVideo 5.
#
# CHANGELOG
# [Dadu042] (2019-10-25)
#   First script.
...
#
# KNOWN ISSUES:
#  - Wine amd64 3.0.3, 4.0.2: installer does crash after the 3rd window, it fail the select the right destination pathname (folder), this is because the installer fail to read correctly (to parse) the file 'Install.ini'. Tried: POL_Install_riched30, riched20, msxml3, msxml6, mfc42, mdac28. Workaround: do type 'C:\DRAC'.
#  - GOG edition (v2.1.0.5) + Wine amd64 3.0.3, 3.21, 4.0.2 : display is half vertical (down to the bottom), make it impossible to play. Happened on GPU Intel HD 4400 (1366x768, Ubuntu 18.04). Tried: disable GLSL, OpenGL, ect.
...
PREFIX="Dracula_Resurrection"
EDITOR="Nobilis"
GAME_URL="https://en.wikipedia.org/wiki/Dracula:_Resurrection"
AUTHOR="Dadu042"
STEAM_ID="289800"
WORKING_WINE_VERSION="3.0.3"
GAME_VMS="256"
SHORTCUT_FILENAME="Dracula.exe"
...
if [ "$INSTALL_METHOD" == "STEAM" ]; then
        ...
        POL_SetupWindow_message "$(eval_gettext 'WARNING: you must change the destination pathname to C:\DRAC (type it).')" "$TITLE"
...
iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCXbRwDwAKCRDlMfrJqhPK
R96DAKCMZms22gGrbzdLkYI+k1FJxaqTYgCgq/bXFjpzHj8vY5BH6HIsrNSeIbk=
=mw9o
-----END PGP SIGNATURE-----
