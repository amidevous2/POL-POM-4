...
#
# TESTED Editions: v1.6 (2015 ? 2003 ?) displayed on the main menu (DDV from MyPlayCity.com 2017).
#
...
PREFIX="Electra"
EDITOR="Alawar"
GAME_URL="https://www.myplaycity.com/electra/"
AUTHOR="Dadu042"
STEAM_ID=""
...
if [ "$INSTALL_METHOD" == "STEAM" ]; then
        ...
        POL_Download "http://files.myplaycity.com/files_downloader_temp/electra_setup.exe"
        POL_Wine "electra_setup.exe" # "/SILENT"
...
iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCXceLpQAKCRDlMfrJqhPK
R8qmAJ9Jld7VxVp2+tPY4JKajum+HiU1RACfYKX6+F9w0gC+Hd2vxRmjZXhKyxk=
=EQbx
-----END PGP SIGNATURE-----
