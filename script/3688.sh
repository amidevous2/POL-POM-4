...
#
# TESTED Editions: - NOK: Release 2009-07 (braid.exe)
#                  - OK: Release GOG v2.0.0.3 (2016)
#
...
#
# KNOWN ISSUES:
#  - Release 2009-07 + Wine amd64 3.0.3, 3.21, 4.0.2: game fail to run (nothing appear).
#  - Release GOG v2.0.0.3 (2016) + Wine amd64 3.0.3, 3.21: the window 'Braid Launche' appear (resolution ...), but after clicking 'Launch' the game does crash imediately.
#    0034:fixme:d3dx:d3dx9_effect_init Failed to parse effect, hr 0x8876086c.
#    0034:fixme:d3dcompiler:compile_shader Compilation target "fx_2_0" not yet supported
#    I tried: install d3dx9_36, d3dcompiler_43. Fix: install d3dx9_43
...
PREFIX="Braid"
EDITOR="Number None"
GAME_URL="https://en.wikipedia.org/wiki/Braid_(video_game)"
AUTHOR="Dadu042"
STEAM_ID=""
WORKING_WINE_VERSION="3.0.3"
GAME_VMS="256"
SHORTCUT_FILENAME="Braid.exe"
...
if [ "$INSTALL_METHOD" == "STEAM" ]; then
        ...
        POL_Download "http://files.myplaycity.com/files_downloader_temp/karma_setup.exe.exe"

        POL_SetupWindow_message "$(eval_gettext 'Note: we recommend you to uncheck all the checkboxes:\n[x] -> [ ]')" "$TITLE"

        POL_Wine "karma_setup.exe.exe" # "/SILENT"
...
iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCXbru9QAKCRDlMfrJqhPK
RypuAJ9821t3cluRtN5adAnj/h+RPMoZHwCgpgFSs7WTRW7PnmLODIZ2qWs/CZ0=
=W7Yh
-----END PGP SIGNATURE-----
