...
#
# TESTED Editions: 2017 v2.0 (see Readme.txt) DDV from MyPlayCity.com
#
...
#
# KNOWN ISSUES:
#  - Wine amd64 3.0.3: log quite long (not shorter with Wine 4.0.2).
#
...
if [ "$INSTALL_METHOD" == "STEAM" ]; then
        ...
        POL_Download "http://files.myplaycity.com/files_downloader_temp/brainpuzzle_setup.exe"
        POL_SetupWindow_message "$(eval_gettext 'Note: we recommend you to uncheck all the checkboxes:\n[x] -> [ ]')" "$TITLE"
        POL_Wine "brainpuzzle_setup.exe" # "/SILENT"
...
iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCXcdR8QAKCRDlMfrJqhPK
RzS1AJ0RK2gJSnaKo/aMHhzdhqKjC6lvnQCdG+MqlYv2/W+Eu12+ynDqDkrNLnM=
=DuBd
-----END PGP SIGNATURE-----
