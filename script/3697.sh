...
#
# TESTED Editions: v1.2 (main screen) 2010 (in Readme.txt) DDV from MyPlayCity.com
#
# Middlewares used by this software : Unity (3D).
#
# CHANGELOG
# [Dadu042] (2019-11-06)
#   First script.
# [Dadu042] (2019-11-09)
#   Disable silent install (because of many shortcuts).
# [Dadu042] (2019-12-28)
#   POL_RequiredVersion 4.2.12 -> 4.0.0
#
# KNOWN ISSUES:
#  - Wine amd64 3.0.3: no music nor sound. Fix: alsa
#  - Wine amd64 3.21: slow mouse cursor on main menu.
#
...
TITLE="Turtix"
PREFIX="Turtix"
EDITOR="Alawar" # developped by http://inimages.pl/
GAME_URL="http://inimages.pl/"
AUTHOR="Dadu042"
STEAM_ID=""
...
if [ "$INSTALL_METHOD" == "STEAM" ]; then
        ...
        POL_Download "http://files.myplaycity.com/files_downloader_temp/turtix_setup.exe"
        POL_SetupWindow_message "$(eval_gettext 'Note: we recommend you to uncheck all the checkboxes:\n[x] -> [ ]')" "$TITLE"
        POL_Wine "turtix_setup.exe"  # "/SILENT"
...
iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCXgdKBwAKCRDlMfrJqhPK
R+WbAKCK3kgzKsnnHk4pj1Bi+DPN+/gW2wCfe+yG/InSlF9OvQnk0Pg3MhYe8ek=
=uKZW
-----END PGP SIGNATURE-----
