...
#
# TESTED Editions: v1.0 ? (nothing displayed on the main menu).
#
...
#
# KNOWN ISSUES:
#  - Wine amd64 4.0.2: installing d3dx11 makes the game slower (because of better 3D rendering).
#
...
GAME_VMS="256"
SHORTCUT_FILENAME="CemeteryWarrior4.exe"
...
if [ "$INSTALL_METHOD" == "STEAM" ]; then
        ...
        POL_Download "http://falcogames.com/rk-distributives/CemeteryWarrior4Setup.exe"
        # POL_SetupWindow_message "$(eval_gettext 'Note: we recommend you to uncheck all the checkboxes:\n[x] -> [ ]')" "$TITLE"
        POL_Wine "CemeteryWarrior4Setup.exe" # "/SILENT"
...
iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCXchuyAAKCRDlMfrJqhPK
R1eTAKCXs0smCycQa9y1UJghfncSThbONQCeMR28Ts8/nDr8Di+mCa3mpHiulmw=
=Irpu
-----END PGP SIGNATURE-----
