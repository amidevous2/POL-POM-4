...
#
# KNOWN ISSUES:
#  - Wine amd64 3.0.3, 4.20: mouse cursor is 'sticky' (main screen). Fix: main menu -> Graphics (with keyboard) -> set full screen.
#  - Wine amd64 4.0.2, 3.0.3, 4.20: no sound nor music. Tried: alsa on/off, directmusic, xact, quartz, dsound
#  - Wine amd64 4.0.2: jerkiness. Fix: Wine 4.20
#
...
PREFIX="Strike_Ball"
EDITOR="Alawar"
GAME_URL="https://www.myplaycity.com/strike_ball/"
AUTHOR="Dadu042"
STEAM_ID=""
...
if [ "$INSTALL_METHOD" == "STEAM" ]; then
        ...
        POL_Download "http://files.myplaycity.com/files_downloader_temp/strikeball_setup.exe"
        POL_SetupWindow_message "$(eval_gettext 'Note: we recommend you to uncheck all the checkboxes:\n[x] -> [ ]')" "$TITLE"
        POL_Wine "strikeball_setup.exe" # "/SILENT"
...
iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCXuchAgAKCRDlMfrJqhPK
R7tLAJ9Sx7SeXjEfKMXD4Y610jAcn318bgCfT2J2XU4MJUQEhbFNy7Q/Ny1Vkgc=
=V9M2
-----END PGP SIGNATURE-----
