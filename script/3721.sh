...
#
# TESTED Editions: v1.0.1 (found in Gane.ini) 2009.
#
...
# [Dadu042] (2019-11-25)
#   First script.
# [Dadu042] (2020-02-14 23:58)
#   News about the music (in Known issues).
#   POL_RequiredVersion 4.2.12 -> 4.1.0
#   Allow GPU selection.
#
# KNOWN ISSUES:
#  - Wine amd64 3.0.3, 4.0.2: No music. Tried: quartz, directmusic, alsa. Fix: installing dsound+directmusic, but then, the players's moto become to blink a bit. Because the music is only in the menu I prefer to not enable it.
#  - Wine amd64 3.0.3, 4.0.2: Game does crash when exit. Workaround ?: POL_Shortcut_QuietDebug "$TITLE"
#
...
PREFIX="Moto_Racing"
EDITOR="GameTop"
GAME_URL="https://www.gametop.com/download-free-games/motoracing/"
AUTHOR="Dadu042"
STEAM_ID=""
...
if [ "$INSTALL_METHOD" == "STEAM" ]; then
        ...
        POL_Download "https://cdn.gametop.com/free-games-download/Motoracing.exe"
        # POL_SetupWindow_message "$(eval_gettext 'Note: we recommend you to uncheck all the checkboxes:\n[x] -> [ ]')" "$TITLE"
        POL_Wine "Motoracing.exe" # "/SILENT"
...
iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCXkcmnQAKCRDlMfrJqhPK
R7jnAKCkhLItGbVM30KFuQZdmKdF+tGkhwCgmSVXEG83LWCWq09ZXHdm9d60xJo=
=JaUd
-----END PGP SIGNATURE-----
