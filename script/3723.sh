...
#
# TESTED Edition: unofficial DDV (Age of Empires II - Gold Edition).
#
...
PREFIX="Age_of_Empires_II"
EDITOR="Microsoft"
GAME_URL="https://en.wikipedia.org/wiki/Age_of_Empires_II"
AUTHOR="Dadu042"
STEAM_ID=""
WORKING_WINE_VERSION="3.0.3"
GAME_VMS="256"
SHORTCUT_FILENAME="empires2.exe"
...
if [ "$APP_ANSWER" == ".EXE" ]; then
        ...
        POL_Shortcut "age2_x1.exe" "$TITLE x1" "" "" "$SOFTWARE_CATEGORIES"
        POL_Shortcut "$SHORTCUT_FILENAME" "$TITLE" "" "" "$SOFTWARE_CATEGORIES"
        POL_Shortcut "AOKCONFIG.exe" "$TITLE Config" "" "" "$SOFTWARE_CATEGORIES"
        # POL_Shortcut_Document "$TITLE" "README_OR_DIE.txt"
...
iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCXd2vlwAKCRDlMfrJqhPK
Rz81AJ9PmKOMJRoD1rbRb+nUQBSJARwU/wCgomRLJ9QazRDiNhuihhwWa5BX1Qc=
=UcrL
-----END PGP SIGNATURE-----
