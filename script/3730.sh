...
#
# TESTED Editions:  2016 (engine.exe) DDV from MyPlayCity.com
#
...
#
# KNOWN ISSUES:
#  - Wine amd64 3.0.3: does work (tested 10 min), but stranges lines in the log (see below).
#  - Wine amd64 3.0.3, 4.0.2: 'ERROR <Failed to open file: sounds/puzzle_win.ogg.xml (0:0)>' . Tried: msxml4, riched30
#  - Wine amd64 4.0.2 + Alsa: no music nor sounds (while it's OK with Wine 3.0.3) 
#
...
TITLE="Yeti Legend: Mystery of the forest"
PREFIX="yeti_legend"
EDITOR="Alawar"
GAME_URL="https://www.myplaycity.com/yeti_legend/"
AUTHOR="Dadu042"
STEAM_ID=""
...
if [ "$INSTALL_METHOD" == "STEAM" ]; then
        ...
        POL_Download "http://files.myplaycity.com/files_downloader_temp/yetilegend_setup.exe"
        # POL_SetupWindow_message "$(eval_gettext 'Note: we recommend you to uncheck all the checkboxes:\n[x] -> [ ]')" "$TITLE"
        POL_Wine "yetilegend_setup.exe"  "/SILENT"
...
iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCXeBA2gAKCRDlMfrJqhPK
RyIKAJ9uj17/r5At+LQS4iv/Mrt6x4VeTQCffE88STTAAMjPzw+89XQoOvc4dPs=
=Incg
-----END PGP SIGNATURE-----
