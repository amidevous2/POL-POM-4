...
#
# TESTED Editions: v12.18 trial
#
# Middlewares used by this software : OCX.
#
# CHANGELOG
# [Dadu042] (2019-12-06 01:50)
#   First script.
# [Dadu042] (2019-12-08)
#   Details.
#
# KNOWN ISSUES:
#  - Wine amd64 4.0.3: some folders names have squares inside.
#
...
PREFIX="DirectoryOpus"
EDITOR="GPSoftware"
GAME_URL="https://en.wikipedia.org/wiki/Directory_Opus"
AUTHOR="Dadu042"
STEAM_ID=""
WORKING_WINE_VERSION="4.0.3"
GAME_VMS="256"
SHORTCUT_FILENAME="dopus.exe"
SOFTWARE_CATEGORIES="FileManager;"
...
POL_SetupWindow_message "$(eval_gettext 'Note: script tested with Directory Opus v12 only (Light edition, not the Pro).')" "$TITLE"  
...
if [ "$INSTALL_METHOD" == "STEAM" ]; then
	...
	POL_SetupWindow_message "$(eval_gettext 'Note: this will download v12.')" "$TITLE"        
	POL_Download "http://cdn.gpsoft.com.au/Opus12/DOpusInstall.exe"
        POL_Wine "DOpusInstall.exe" # "/SILENT"
...
iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCXevDbQAKCRDlMfrJqhPK
R4m/AJ9fh/Fc/eji+NUfJhcEjH+qjQl4gQCgk2gJYvEWxQYPRLFCBl2Up8STjeA=
=zKUq
-----END PGP SIGNATURE-----
