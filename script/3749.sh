...
TITLE="Viriax"
PREFIX="Viriax"
EDITOR="https://www.locomalito.com/viriax.php"
GAME_URL="Locomalito"
AUTHOR="Dadu042"
STEAM_ID=""
WORKING_WINE_VERSION="3.0.3"
GAME_VMS="256"
SHORTCUT_FILENAME="Viriax.exe"
...
if [ "$INSTALL_METHOD" == "STEAM" ]; then
        ...
        POL_Download "https://www.locomalito.com/juegos/Viriax_1_1.zip"

        POL_SetupWindow_wait_next_signal "$(eval_gettext 'Extracting the archive...')" "$TITLE"
        POL_System_unzip "Viriax_1_1.zip" -d "$WINEPREFIX/drive_c/game/"
...
iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCXfVvkAAKCRDlMfrJqhPK
R44QAJ9ufPpNFgBgHzFWDpXSBk+S0TDg7gCgmML4CH5BO93FlswxQQ+LzbqoL6I=
=TxAO
-----END PGP SIGNATURE-----
