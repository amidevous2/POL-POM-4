...
TITLE="L'abbaye des morts"
PREFIX="abbaye_morts"
EDITOR="https://www.locomalito.com/abbaye_des_morts.php"
GAME_URL="Locomalito"
AUTHOR="Dadu042"
STEAM_ID=""
WORKING_WINE_VERSION="3.0.3"
GAME_VMS="128"
SHORTCUT_FILENAME="Abbaye_des_morts.exe"
...
if [ "$INSTALL_METHOD" == "STEAM" ]; then
        ...
        POL_Download "https://www.locomalito.com/juegos/Abbaye_des_morts_1_2.zip"

        POL_SetupWindow_wait_next_signal "$(eval_gettext 'Extracting the archive...')" "$TITLE"
        POL_System_unzip "Abbaye_des_morts_1_2.zip" -d "$WINEPREFIX/drive_c/game/"
...
iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCXgqPxAAKCRDlMfrJqhPK
R6QjAKCqhkk0y1Z3a8lN6riXW41iLRc7CACfYpGW2AoH/dsZRj1YfIUcCBsa8Ho=
=FaRU
-----END PGP SIGNATURE-----
