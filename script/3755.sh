...
#   Extract fixed.
# [Dadu042] (2019-12-19)
#   POL_RequiredVersion 4.3.4 -> 4.2.12
#
# KNOWN ISSUES:
#
...
GAME_URL="https://en.wikipedia.org/wiki/Beats_of_Rage#OpenBOR"
AUTHOR="Dadu042"
STEAM_ID=""
...
#        7z x "$WINEPREFIX/drive_c/"$filename -o"$WINEPREFIX/drive_c/OpenBOR/"
        ...
        POL_SetupWindow_message "$(eval_gettext 'Game extract failed (missing 7z application).')" "$TITLE"
fi
...
iFwEABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCXftIEgAKCRDlMfrJqhPK
RxMaAJsG9jmnltj2vA/6Ut/dzkU96YQTLACYwaojxOtPnfnx6BbYEHMyVY5tiw==
=l62A
-----END PGP SIGNATURE-----
