...
#
# TESTED Editions: retail CD-ROM (folders date: oct 1999).
#
...
#   First script.
# [Dadu042] (2020-01-17)
#   Add function to download the demo.
#
# KNOWN ISSUES:
...
PREFIX="Armored_Fist_3"
EDITOR=""
GAME_URL="https://en.wikipedia.org/wiki/Armored_Fist_3"
AUTHOR="Dadu042"
STEAM_ID=""
WORKING_WINE_VERSION="4.0.3"
GAME_VMS="256"
SHORTCUT_FILENAME="Af3.exe"
...
if [ "$INSTALL_METHOD" == "STEAM" ]; then
        ...
        POL_SetupWindow_message "$(eval_gettext '\n\nNote: this script can only download the demo.')" "$TITLE"
        POL_Download "https://archive.org/download/ArmoredFist3Demo/armoredfist3demo.zip"
	...
	cd  "$WINEPREFIX/drive_c/game/"
        ...
        POL_Shortcut "af3demo.exe" "$TITLE (Demo)" "" "" "$SOFTWARE_CATEGORIES"
...
iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCXiHUaQAKCRDlMfrJqhPK
RxDZAJ9eiH3fkO2lWgCOWOxUJ+wn0PXePACfVQjZBS8ciT9eKlYr43CB0rjgzPQ=
=D+um
-----END PGP SIGNATURE-----
