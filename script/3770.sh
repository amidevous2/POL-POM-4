...
#
# TESTED Editions: 2x CD-ROM (v1.2.x.x ?).
#
...
#
# KNOWN ISSUES:
#  - Wine amd64 4.0.3: launcher block on the window error 'This software does run on win95, Win98 ...'. Tried: force winxp.
#  - Wine amd64 4.0.3 + game patched to v1.5.0.0: same as above.
#  - Wine amd64 4.0.3 + game patched to v1.5.0.0 + NoCD (not perfectly installed because of a .BAT): same as above.
...
PREFIX="GTR_FIA_GT"
EDITOR="Atari"
GAME_URL="https://en.wikipedia.org/wiki/GTR_%E2%80%93_FIA_GT_Racing_Game"
AUTHOR="Dadu042"
STEAM_ID=""
WORKING_WINE_VERSION="4.0.3"
GAME_VMS="256"
SHORTCUT_FILENAME="GTR.exe"
...
if [ "$INSTALL_METHOD" == "STEAM" ]; then
	...
	POL_Call POL_Function_NoCDWarning
        ...
        POL_SetupWindow_check_cdrom "GTRLaunchIt.exe"
...
iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCXgiDHAAKCRDlMfrJqhPK
R/ezAKCyUB7U5lwAnoYiXxOV3/5eIgqKiQCglcQECHAOmd6tmItK7ueLKTzOYhA=
=fF80
-----END PGP SIGNATURE-----
