...
#
# TESTED Editions: 3x CD-ROM (v1.23 displayed at the top left of the game launcher).
#
# Middlewares used by this software : .
#
# CHANGELOG
# [Dadu042] (2019-12-29 12:00)
#   First script.
#   Not sure if mfc42 is really required.
#   Could not pass the CD S/N recheck screen (mainly because of black background). If I have time I will retry with the game updated to v1.6x
#
# KNOWN ISSUES:
#  - Wine x86 4.0.3, 4.21, 5.0-rc1: does not recognize the CD #1 ('please insert playdisc').
#  - Wine x86 4.0.3 + game v1.23 + NoCD (for v1.23): a kind of main menu seems to appear (black screen with a mouse cursor). Doing Alt+Tab sometimes make it appear.
#
#
# Useful tricks found on Appdb.winehq.org (2019-12-30) :
# - 'After the game starts and intro is gone a black screen is displayed, can hear the music but there is no game menu'
# - System configuration fails and locks up OS.Â  Bypassing that, there is no video upon launching (blank white window).Â  I pressed 'enter' several times to get past all the logos and intro movie.Â  Video still a blank-white screen.Â  App crashed at what I believe to be the title screen (determined by music playing).
# - Could not test anything past what I believed to be the title screen.
#
# Tricks: https://appdb.winehq.org/objectManager.phacp?sClass=version&iId=13952&iTestingId=68482&bShowAll=true
#
#
...
PREFIX="Neverwinter_Nights"
EDITOR="Atari"
GAME_URL="https://en.wikipedia.org/wiki/Neverwinter_Nights"
AUTHOR="Dadu042"
STEAM_ID=""
WORKING_WINE_VERSION="4.0.3"
GAME_VMS="32"
SHORTCUT_FILENAME="nwn.exe"
...
if [ "$INSTALL_METHOD" == "STEAM" ]; then
	...
	POL_Call POL_Function_NoCDWarning
        ...
        POL_SetupWindow_check_cdrom "nwn.ico"
        ...
        POL_Download "http://files.myplaycity.com/files_downloader_temp/godoflight_setup.exe"
        POL_SetupWindow_message "$(eval_gettext 'Note: we recommend you to uncheck all the checkboxes:\n[x] -> [ ]')" "$TITLE"
        POL_Wine "godoflight_setup.exe" # "/SILENT"
...
iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCXgnv3gAKCRDlMfrJqhPK
R4tRAKCGyy1UGjXMhesfqXCXb7/BhxDkCgCfc4BtR0cLfUS/9yF9JSj1jxQAaS8=
=hasP
-----END PGP SIGNATURE-----
