...
#
# TESTED Editions: REBUILT Build (Oct 26 2019) - v1.0.1 (in versionop.txt) .
#
# Middlewares used by this software : Bink, DirectX 8.
#
# CHANGELOG
# [Dadu042] (2020-01-11)
#   Initial script (Wine 5.0-rc3).
# [Dadu042] (2020-01-28)
#   Wine 5.0-rc3 -> 5.0.
# [Dadu042] (2022-03-29)
#   Wine 5.0 -> 5.0.3 (Wine 7.0 is reported OK, but not tested yet by myself).
#
# KNOWN ISSUES:
#  - Wine amd64 4.0.3, 4.21, 3.0.3: the main menu does appear but frozen (and no sound/music nor videos). Tried: vcrun6, GLSL off, dinput8. Fix: Wine 5.0-rc3 (Quartz?  xact?)
#  - Wine amd64 4.0.3, 5.0-rc3: no sound/music nor videos. Tried: dsound, amstream, directmusic.
#  - Wine amd64 5.0-rc3: unhandled exceptions when exiting the game. Tried: vcrun6, amstream. Quartz seems to help but makes troubles (freeze) in the game.
#
# KNOWN ISSUES (FIXED):
#  - Wine amd64 3.0.3: no sound nor music. Tried: alsa, xact. Fix: dsound (it seems to do the same job as Directmusic).


[ "$PLAYONLINUX" = "" ] && exit 0
source "$PLAYONLINUX/lib/sources"
         
TITLE="Lego Bionicle: The Legend of Mata Nui"
PREFIX="lego_bionicle_legend_mata_nui"
EDITOR=""
GAME_URL="https://en.wikipedia.org/wiki/Lego_Bionicle:_The_Legend_of_Mata_Nui"
AUTHOR="Dadu042"
STEAM_ID=""
GAME_VMS="64"
SHORTCUT_FILENAME="LEGOBionicle.exe"
...
iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCYkJENAAKCRDlMfrJqhPK
Rx5IAJ9/aZFqsZSxxueWhBr47kfbzaZAVgCeOYt+/x6+uCs6pd+SAvmvncYJ5dU=
=2Yem
-----END PGP SIGNATURE-----
