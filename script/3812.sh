...
#
# TESTED Editions: 2013's dunedynasty-win32-1.5.7.zip .
#
# Middlewares used by this software : .
#
# CHANGELOG
# [Dadu042] (2020-01-14 09-20)
#   Initial script.
#
# KNOWN ISSUES:
#  - Wine amd64 3.0.3: X
#
# KNOWN ISSUES (FIXED):
#  - Wine amd64 3.0.3: no music (sound OK), because it is disabled by default.
...
PREFIX="dune_dynasty"
EDITOR=""
GAME_URL="http://dunedynasty.sourceforge.net/"
AUTHOR="Dadu042"
STEAM_ID=""
GAME_VMS="64"
SHORTCUT_FILENAME="dunedynasty.exe"
...
if [ "$INSTALL_METHOD" == "STEAM" ]; then
        ...
        POL_Download "https://archive.org/download/DuneDynasty/DuneDynasty.zip"

        POL_SetupWindow_wait_next_signal "$(eval_gettext 'Extracting the archive...')" "$TITLE"
        POL_System_unzip "DuneDynasty.zip" -d "$WINEPREFIX/drive_c/game/"
...
iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCXh2ADwAKCRDlMfrJqhPK
RyI0AJ9SeYA1l8jOrhPt9JSz/Sie7UiSQwCfYOxkM4i2dfs7Sdbf2GFVLOMJ2LA=
=A9Bi
-----END PGP SIGNATURE-----
