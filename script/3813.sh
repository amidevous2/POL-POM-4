...
#
# TESTED Editions: 2006 v1.0 .
#
# Middlewares used by this software : .
#
# CHANGELOG
# [Dadu042] (2020-01-14 09-50)
#   Initial script.
#
# KNOWN ISSUES:
#  - Wine amd64 3.0.3: X
...
PREFIX="pushover"
EDITOR="Ishisoft"
GAME_URL="http://ishisoft.com/archives/126"
AUTHOR="Dadu042"
STEAM_ID=""
GAME_VMS="64"
SHORTCUT_FILENAME="Pushover.exe"
...
if [ "$INSTALL_METHOD" == "STEAM" ]; then
        ...
        POL_Download "http://ishisoft.com/wp-content/uploads/2009/12/ishisoft_pushover.zip"

        POL_SetupWindow_wait_next_signal "$(eval_gettext 'Extracting the archive...')" "$TITLE"
        POL_System_unzip "ishisoft_pushover.zip" -d "$WINEPREFIX/drive_c/game/"
	...
	# POL_Shortcut_QuietDebug "$TITLE"
        ...
        POL_Shortcut "Editor.exe" "$TITLE - Editor" "" "" "$SOFTWARE_CATEGORIES"
...
iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCXh2FSAAKCRDlMfrJqhPK
R9yYAJsELEM1KsLUx3PjC9kybJdI5OdNxwCfQOv6+7Erca8XDO+q+xuNfhAwxEo=
=hWBA
-----END PGP SIGNATURE-----
