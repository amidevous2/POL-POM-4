...
#
# TESTED Editions:  Gex 2 demo .
#
# Middlewares used by this software : ?.
#
# CHANGELOG
# [Dadu042] (2020-01-17 13:10)
#   Initial script.
#
# KNOWN ISSUES:
#  - Wine x86 3.0.3: crash when launched (err:module:import_dll Library glide2x.dll (which is needed by L"C:\\Program Files\\Crystal Dynamics\\gex23dfx_demo\\gex3d.exe") not found).
#                    Tried: disable GLSL, disable opengl (to GDI).
#
#
# KNOWN ISSUES (FIXED):
#  - Wine amd64 4.0.3: X
...
TITLE="Gex: Enter the Gecko DEMO"
PREFIX="gex_enter_the_gecko"
EDITOR=""
GAME_URL="https://en.wikipedia.org/wiki/Gex:_Enter_the_Gecko"
AUTHOR="Dadu042"
STEAM_ID=""
GAME_VMS="32"
SHORTCUT_FILENAME="gex3d.exe"
...
if [ "$INSTALL_METHOD" == "STEAM" ]; then
        ...
        POL_Download "https://archive.org/download/swizzle_demu_GEX2/GEX2.zip"

        POL_SetupWindow_wait_next_signal "$(eval_gettext 'Extracting the archive...')" "$TITLE"
        POL_System_unzip "GEX2.zip" -d "$WINEPREFIX/drive_c/game/"
...
if [ "$APP_ANSWER" == ".EXE" ]; then
	...
	# POL_Shortcut_QuietDebug "$TITLE"
        ...
        POL_SetupWindow_wait_next_signal "$(eval_gettext 'Extracting the archive...')" "$TITLE"
        POL_System_unzip "$APP_ANSWER" -d "$WINEPREFIX/drive_c/app/"
        POL_Shortcut "$SHORTCUT_FILENAME" "$TITLE" "" "" "$SOFTWARE_CATEGORIES"
...
##############################
# Install nGlide 3D wrapper  #
##############################

cd "$POL_System_TmpDir"
POL_Download "http://www.zeus-software.com/files/nglide/nGlide104_setup.exe" "4bcc72be562ad034e5a3690e153ca065"
POL_Wine start /unix "nGlide104_setup.exe"
POL_Wine_WaitExit "$TITLE"
...
iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCXiGzPgAKCRDlMfrJqhPK
R2a9AJ9YEGODhVmmP5wiCHhxrSmcwN+oAQCeIcg4thBTcB8U7f9zT+MWgsLo15M=
=Ihmt
-----END PGP SIGNATURE-----
