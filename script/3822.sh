...
#
# TESTED Editions: FacadeInstaller1.1b.exe .
#
...
# [Dadu042] (2020-01-17)
#   First script.
#   I'm not sure if vcrun6 is really useful.
#
# KNOWN ISSUES:
#  - Wine amd64 3.0.3, 3.20: no music. Fix: Quartz, but makes the voices repeat (or is it vcrun6 ?).
...
TITLE="Facade"
PREFIX="facade"
EDITOR="Playabl Studios"
GAME_URL="https://www.playablstudios.com/facade"
AUTHOR="Dadu042"
STEAM_ID=""
WORKING_WINE_VERSION="3.20"
GAME_VMS="256"
SHORTCUT_FILENAME="animEngineStarter.exe"
...
if [ "$INSTALL_METHOD" == "STEAM" ]; then
        ...
        POL_Download "https://archive.org/download/Faafade/Facade-Win.rar"

        POL_SetupWindow_wait_next_signal "$(eval_gettext 'Extracting the archive...')" "$TITLE"
        POL_System_unrar x "Facade-Win.rar" "$WINEPREFIX/drive_c/game/" || POL_Debug_Fatal "unrar is required to unarchive $TITLE (unrar package is not installed on the OS)."
...
iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCXiHoMgAKCRDlMfrJqhPK
R9mHAKCaXCU5mTTj3l0NNX9k6HqVyDq7fACgjOJ9I6C7raPPCWdeHAiMcFWm2Mo=
=W3M3
-----END PGP SIGNATURE-----
