...
TITLE="AceSpeeder2 Origin"
PREFIX="acespeeder2origin"
EDITOR="Takahiro Nakatani (Rangraph)"
GAME_URL="http://www.raingraph.com/as2-origin"
AUTHOR="Dadu042"
STEAM_ID=""
GAME_VMS="32"
SHORTCUT_FILENAME="acespeed*.exe"
...
if [ "$INSTALL_METHOD" == "STEAM" ]; then
        ...
        POL_Download "http://ftp.vector.co.jp/66/68/3478/acespeeder2.zip"

        POL_SetupWindow_wait_next_signal "$(eval_gettext 'Extracting the archive...')" "$TITLE"
        # POL_System_unzip "acespeeder2.zip" -d "$WINEPREFIX/drive_c/game/"
...
iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCXiSklQAKCRDlMfrJqhPK
R7zEAJwNsi67Uup9LA/fvLr/+qyn51bujQCdHNDnXiY3bJZWK2bQfIcOnKPvdzw=
=JT2X
-----END PGP SIGNATURE-----
