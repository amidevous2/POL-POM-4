...
#
# TESTED Editions: v1.02 2014.
#
# Middlewares used by this software : ?.
#
# CHANGELOG
# [Dadu042] (2020-01-23 13:30)
#   Initial script.
#
#
# KNOWN ISSUES:
...
TITLE="Starbike Remake"
PREFIX="starbike_remake"
EDITOR=""
GAME_URL="https://starbike.wordpress.com/"
AUTHOR="Dadu042"
STEAM_ID=""
GAME_VMS="32"
SHORTCUT_FILENAME="Star*.exe"
...
if [ "$INSTALL_METHOD" == "STEAM" ]; then
        ...
        POL_Download "http://tardis.dk/retro/starbike/starbike_v1.2.zip"
 
        POL_SetupWindow_wait_next_signal "$(eval_gettext 'Extracting the archive...')" "$TITLE"
        POL_System_unzip "starbike_v1.2.zip" -d "$WINEPREFIX/drive_c/game/"
...
iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCXimO0AAKCRDlMfrJqhPK
RyKkAKCbLEcwc2lMgjlg0wGe/1uboKy5YwCbBJQY/E8S7TL6W/gQqUWrZbMFyck=
=MSfB
-----END PGP SIGNATURE-----
