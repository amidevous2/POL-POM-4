...
#
# TESTED Editions: v1.06 (CD-ROM v1.0 FR + patch v1.6 FR).
#
# Middlewares used by this software : ?.
#
# CHANGELOG
# [Dadu042] (2020-01-24 17:20)
#   Initial script.
#
#
# KNOWN ISSUES:
#  - Wine x86 3.0.3, 4.0.3, 5.0: The installer does launch (with music) but says it can not localize the files on the CD-ROM (it's a mounted ISO file).
#
# KNOWN ISSUES (FIXED):
#  - Wine amd64 4.0.3: X
...
GAME_URL="https://en.wikipedia.org/wiki/Dune_2000"
AUTHOR="Dadu042"
STEAM_ID=""
GAME_VMS="32"
SHORTCUT_FILENAME="Dun*.exe"
...
iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCXisgFgAKCRDlMfrJqhPK
R68IAJ9LgMN32osqsNG1FkwqZ8YtVFWlJQCfbXzVjXLIdUipm/e7sl+IWQeDg9w=
=4DA6
-----END PGP SIGNATURE-----
