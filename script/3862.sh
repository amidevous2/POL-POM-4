...
#
# TESTED Editions: CD-ROM 2004.
#
# Middlewares used by this software : .
#
# CHANGELOG
# [Dadu042] (2020-01-26 23:30)
#   Initial script.
#
#
# KNOWN ISSUES:
#  - Wine amd64 3.0.3, 4.0.3, 5.0: lots of log lines '0037:fixme:d3d:state_zenable W buffer is not well handled'. Tried: dx3d9_43 + compiler.
#
# KNOWN ISSUES (FIXED):
#  - Wine amd64 4.0.3: game does not recognize the CD-ROM (NoCD required). 
...
PREFIX="house_dead_3"
EDITOR="Sega"
GAME_URL="https://en.wikipedia.org/wiki/The_House_of_the_Dead_III"
AUTHOR="Dadu042"
STEAM_ID=""
GAME_VMS="128"
SHORTCUT_FILENAME="hod3launch.exe"
...
if [ "$INSTALL_METHOD" == "STEAM" ]; then
        ...
        POL_SetupWindow_check_cdrom "hod3pc.exe"
...
iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCXi4eAwAKCRDlMfrJqhPK
R1p4AJ97bPkfzoPaErLxWAG+Nrg/+0yXBgCfU0cnuR4Zrdgbmll7rHHOgC6AC6w=
=i4LZ
-----END PGP SIGNATURE-----
