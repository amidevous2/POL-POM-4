...
#
# TESTED Editions: 2012
#
# Middlewares used by this software : SDL.
#
# CHANGELOG
# [Dadu042] (2020-02-01 19:40)
#   Initial script.
#
#
# KNOWN ISSUES:
#  - Wine amd64 3.0.3: does crash when exit (while POL_Shortcut_QuietDebug should have help...).
#
# KNOWN ISSUES (FIXED):
#  - Wine amd64 4.0.3: X
...
TITLE="Super Pac-Mania (remake by MaD)"
PREFIX="Super_Pac-Mania_remake_by_MaD"
EDITOR="MaD Videogames"
GAME_URL="https://mad-videogames.webnode.es"
AUTHOR="Dadu042"
STEAM_ID=""
GAME_VMS="128"
SHORTCUT_FILENAME="Super*.exe"
...
if [ "$INSTALL_METHOD" == "STEAM" ]; then
        ...
        POL_Download "http://computeremuzone.com/contador.php?f_ad=SuperPacmania.exe&f=956&sis=win"
	cp "contador.php?f_ad=SuperPacmania.exe&f=956&sis=win" GameInstaller.exe
...
iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCXjXhvQAKCRDlMfrJqhPK
RxBkAJ9vdYFcYkAAYKbKe9JX1vl7AeLkQgCfd78QodbOsqybTA3MlvVMIj3oG/o=
=vYW1
-----END PGP SIGNATURE-----
