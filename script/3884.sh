...
#
# TESTED Editions: 2007 (.EXE).
#
# Middlewares used by this software : .
#
#
# CHANGELOG
# [Dadu042] (2020-02-02 12:45)
#   Initial script.
#
#
# KNOWN ISSUES:
#  - Wine x86 3.0.3, 3.20: black screen and freeze (log: 'winedbg: Internal crash'). Fix: Wine 4.0.3
#
# KNOWN ISSUES (FIXED):
#  - Wine amd64 4.0.3: X
...
TITLE="Demolition Gunner: In seek and destroy"
PREFIX="Demolition_Gunner_seek"
EDITOR="Astro Port"
GAME_URL="http://www.interq.or.jp/saturn/takuhama/dhc.html"
AUTHOR="Dadu042"
STEAM_ID=""
GAME_VMS="128"
SHORTCUT_FILENAME="Dem*.exe"
...
if [ "$INSTALL_METHOD" == "STEAM" ]; then
        ...
        POL_Download "http://ftp.vector.co.jp/43/52/3472/DG_ISAD_v2.zip"
	# mv MWLL-Installer.exe GameInstaller.exe

        POL_SetupWindow_wait_next_signal "$(eval_gettext 'Extracting the archive...')" "$TITLE"
        POL_System_unzip "DG_ISAD_v2.zip" -d "$WINEPREFIX/drive_c/game/"
...
iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCXjrAtQAKCRDlMfrJqhPK
R1w9AKCVNefJTpAkAfnwpFXzbA14HnnmCACgrlxUe3vetZvBIu8ws2S+Z/zK7Vc=
=wE+e
-----END PGP SIGNATURE-----
