...
#
# TESTED Editions: CD-ROM v1.17 (2003)
#
# Middlewares used by this software : .
#
# CHANGELOG
# [Dadu042] (2020-02-08 15:01)
#   Initial script.
#
#
# KNOWN ISSUES:
#  - Wine amd64 3.0.3, 3.20, 4.0.3: lots of (identical) log lines (fixme:d3d:wined3d_sampler_desc_from_sampler_states Unrecognized or unsupported WINED3D_SAMP_MAG_FILTER 0x4.). Tried: install d3dx9.
#
# KNOWN ISSUES (FIXED):
#  - Wine amd64 4.0.3: X
...
GAME_URL="https://en.wikipedia.org/wiki/Arx_Fatalis"
AUTHOR="Dadu042"
STEAM_ID=""
GAME_VMS="32"
SHORTCUT_FILENAME="Arx*.exe"
...
if [ "$INSTALL_METHOD" == "STEAM" ]; then
        ...
        POL_SetupWindow_check_cdrom "Athena.dll"
...
iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCXj8JRwAKCRDlMfrJqhPK
R2TDAJ48MnGu9fyETIAWMsSIyLkjsRcVHQCgjskJW5kBaQYBSLLxZ3NzSZWuGYk=
=8OTR
-----END PGP SIGNATURE-----
