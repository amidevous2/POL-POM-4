...
#
# TESTED Editions: v1.07 2012.
#
# Middlewares used by this software : RPG Maker.
#
#
# CHANGELOG
# [Dadu042] (2020-02-09 22:50)
#   Initial script.
#
#
# KNOWN ISSUES:
...
#
# KNOWN ISSUES (FIXED):
#  - Wine x86 3.0.3: no text. Fix: cp "$WINEPREFIX/drive_c/game/l_10646.ttf" "$WINEPREFIX/drive_c/windows/Fonts/"
   
[ "$PLAYONLINUX" = "" ] && exit 0
source "$PLAYONLINUX/lib/sources"
   
TITLE="The Reconstruction"
PREFIX="The_Reconstruction"
EDITOR="Deltree"
GAME_URL="https://www.rpgmakerweb.com/download/additional/free-game-bundles/free-game-bundle-1"
AUTHOR="Dadu042"
STEAM_ID=""
GAME_VMS="128"
...
# To avoid lots of lines in the debug log:
...
if [ "$INSTALL_METHOD" == "STEAM" ]; then
        ...
        POL_Download "https://s3.amazonaws.com/prodcartassets/31416/the-reconstruction.zip"
 

 
        POL_SetupWindow_wait_next_signal "$(eval_gettext 'Extracting the archive...')" "$TITLE"
        POL_System_unzip "the-reconstruction.zip" -d "$WINEPREFIX/drive_c/game/"

	rm "the-reconstruction.zip"
        
	# Extract without sub-folder.
        # unzip -j "legionwood-tale-of-the-two-swords.zip" -d "$WINEPREFIX/drive_c/" || POL_Debug_Fatal "$(eval_gettext 'Error while extracting archive')"

        # mv "Legionwood_Final.v2.exe" "GameInstaller.exe"
	# mkdir Game
	...
	cp "$WINEPREFIX/drive_c/game/l_10646.ttf" "$WINEPREFIX/drive_c/windows/Fonts/"
...
if [ "$APP_ANSWER" == ".EXE" ]; then
        ...
        POL_Wine start /unix "$SETUP_EXE" "$WINEPREFIX/drive_c/game/"
        POL_Wine_WaitExit "$TITLE"
...
iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCXkMdXQAKCRDlMfrJqhPK
R9PdAJ9qpREHa6HKeJJWwNvWit1RsGUG+ACfV3xSubm6UhKoHhtV0YLPda3APDU=
=61Lm
-----END PGP SIGNATURE-----
