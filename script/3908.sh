...
# Distribution used to test : Ubuntu 19.04 64 bits
# Author : Dadu042
# Licence : Retail
...
#
# CHANGELOG
# [Dadu042] (2020-02-12 12:50)
#   First script. 
#
#
# KNOWN ISSUES
#  - Wine x86 3.0.3: on the main menu, gamepad does move the arrow but impossible to find a 'OK' button. Tried: install xinput.
#  - Wine x86 4.0.3: game launching does crash after the intro logo (Migami).
#
# KNOWN ISSUES (FIXED):
#  - Wine x86 3.0.3: on the main screen, the cursor does now move with Up and Down keys. Workaround: do ALT+TAB in order to back to the game window.
...
TITLE="Castlevania The Lecarde Chronicles 2"
PREFIX="Castlevania_Lecarde_Chronicles_2"
EDITOR="Mig Perez and team"
GAME_URL="http://the-mig-page.wifeo.com/"
AUTHOR="Dadu042"
STEAM_ID=""
GAME_VMS="128"
SHORTCUT_FILENAME="Castlevania The Lecarde Chronicles 2 up.exe"
...
if [ "$INSTALL_METHOD" == "STEAM" ]; then
        ...
        POL_Download "http://harpooned.org/files/Harpooned_Setup.exe"

	mv Harpooned_Setup.exe GameInstaller.exe
...
if [ "$APP_ANSWER" == ".EXE" ]; then
        ...
        POL_Shortcut "Castlevania The Lecarde Chronicles 2 upc.exe" "$TITLE - alternate video mode" "" "" "$SOFTWARE_CATEGORIES"
...
iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCY591LAAKCRDlMfrJqhPK
R4OiAKCJfOEcFRsQdFTSBdSX7mBYzXF9iQCgi1AVFKE1HAj/5il1ayo12STDsMk=
=XaW5
-----END PGP SIGNATURE-----
