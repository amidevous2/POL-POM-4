...
#
# TESTED Editions: v1.1 (2013 ?).
#
# Middlewares used by this software : .
#
#
# CHANGELOG
# [Dadu042] (2020-02-14 19:50)
#   First script. 
#
#
# KNOWN ISSUES
#  - Wine x86 3.0.3, 4.3.0: no music ('fixme:mcimidi:MIDI_player NIY: MIDI ...'). Tried: directmusic, xact, amstream, quartz.
#
# KNOWN ISSUES (FIXED):
#  - Wine amd64 3.0.3: X
...
TITLE="Sonic Chaos Strikes Again"
PREFIX="Sonic_Chaos_Strikes_Again"
EDITOR="MagicGraf"
GAME_URL="http://www.caiman.us/scripts/fw/f668.html"
AUTHOR="Dadu042"
STEAM_ID=""
GAME_VMS="128"
SHORTCUT_FILENAME="SCSA.exe"
...
if [ "$INSTALL_METHOD" == "STEAM" ]; then
        ...
        POL_Download "https://archive.org/download/SonicChaosStrikesAgain/SCSA.zip"

	mv Megapony%20v1.1.exe Mega_Pony.exe
	# mv Megapony%20v1.1.exe GameInstaller.exe
        ...
        POL_System_unzip "SCSA.zip" -d "$WINEPREFIX/drive_c/game/"
...
iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCXkb0VAAKCRDlMfrJqhPK
R0HSAJ9N3yMwM+DU/yus6BSv4bl3bS+38ACgjB4BMlbR4rJsJTL0YVJefy9UVTw=
=6U1C
-----END PGP SIGNATURE-----
