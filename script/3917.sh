...
#
# KNOWN ISSUES
#  - Wine x86 3.0.3: Alt+tab leads to a black screen.
#
# KNOWN ISSUES (FIXED):
#  - Wine amd64 3.0.3: X
...
PREFIX="Pixel_Art"
EDITOR="GameTop"
GAME_URL="https://www.gametop.com/download-free-games/pixel-art/"
AUTHOR="Dadu042"
STEAM_ID=""
GAME_VMS="128"
...
if [ "$INSTALL_METHOD" == "STEAM" ]; then
        ...
        POL_Download "https://cdn.gametop.com/free-games-download/Pixel-Art.exe"
 
        mv Pixel-Art.exe GameInstaller.exe
...
iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCXkeB/QAKCRDlMfrJqhPK
R8EDAJ0XKJNIqD3UbkHmpeSiQoQZwBX7HQCfS90YBmK5HDeINEdMOe+0AHrRYgs=
=tA1m
-----END PGP SIGNATURE-----
