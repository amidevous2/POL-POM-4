...
# Distribution used to test : Ubuntu 19.14 64 bits
# Author : Dadu042
# Licence : Retail
# Only For : http://www.playonlinux.com
#
# TESTED Editions: v1.2 (2015) .
#
# Middlewares used by this software : .
#
#
# CHANGELOG
# [Dadu042] (2020-02-23 12:40)
#   First script. 
#
#
# KNOWN ISSUES
#  - Wine amd64 3.0.3, 5.0, 4.03, 4,21, 5.2: after the launcher, this error window appears 'Ecco data not found!'. Tried: mfc42
#
# KNOWN ISSUES (FIXED):
#  - Wine amd64 3.0.3: X
...
TITLE="Ecco (remake by Caverns of Hope)"
PREFIX="Ecco_remake_Caverns"
EDITOR="Sega, Caverns of Hope"
GAME_URL=""
AUTHOR="Dadu042"
STEAM_ID=""
GAME_VMS="32"
SHORTCUT_FILENAME="Ecco PC Launcher.exe"
...
if [ "$INSTALL_METHOD" == "STEAM" ]; then
        ...
        POL_Download "http://skylandsthegame.com/Skylands.rar"
  
        # mv Cartoon-Hot-Racer-3D.exe GameInstaller.exe
  
        POL_SetupWindow_wait_next_signal "$(eval_gettext 'Extracting the archive...')" "$TITLE"
        POL_System_unrar x "Skylands.rar" "$WINEPREFIX/drive_c/game/" || POL_Debug_Fatal "unrar is required to unarchive $TITLE (unrar package is not installed on the OS)."
        # POL_System_unzip "netscan_portable.zip" -d "$WINEPREFIX/drive_c/app/"
...
iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCXlPMlQAKCRDlMfrJqhPK
RzUZAJ9aISeB0e7gCakmdc+yFh97uvVoZwCffFgzvAypbWjI6zT+JynltlkDSA8=
=R+UL
-----END PGP SIGNATURE-----
