...
#
# TESTED Editions: DDV from gametop.com .
#
# Middlewares used by this software : Unity.
#
#
# CHANGELOG
# [Dadu042] (2020-02-24 22:50)
#   First script. 
#
#
# KNOWN ISSUES
#  - Wine x86 3.0.3: the intro video deos launch then the game crash. Fix: quartz (sound of the video is OK, not the picture, however this let the game main menu appear).
#
# KNOWN ISSUES (FIXED):
#  - Wine amd64 3.0.3: X
...
TITLE="Battlecruiser Millennium"
PREFIX="Battlecruiser_Millennium"
EDITOR="3000 AD"
GAME_URL="https://en.wikipedia.org/wiki/Battlecruiser_3000AD#Battlecruiser_Millennium"
AUTHOR="Dadu042"
STEAM_ID=""
GAME_VMS="128"
SHORTCUT_FILENAME="bcm.exe"
...
if [ "$INSTALL_METHOD" == "STEAM" ]; then
        ...
        POL_Download "https://cdn.gametop.com/free-games-download/Border-of-Insanity.exe"
   
        mv Border-of-Insanity.exe GameInstaller.exe
...
iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCXlRNCAAKCRDlMfrJqhPK
R3MMAKCpiFGsBEIZAeRp2UXyq7QnED5EtACgkqZcla25nHyDMa1XzhjhmTHrLqU=
=xLnE
-----END PGP SIGNATURE-----
