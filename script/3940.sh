...
#
# TESTED Editions: 2018's DDV from gametop.com (it's a 2015 game).
#
...
PREFIX="Proto_Raider"
EDITOR="Puzzle Lab"
GAME_URL="https://www.gametop.com/download-free-games/proto-raider/"
AUTHOR="Dadu042"
STEAM_ID=""
GAME_VMS="128"
SHORTCUT_FILENAME="ProtoRaider.exe"
...
if [ "$INSTALL_METHOD" == "STEAM" ]; then
        ...
        POL_Download "https://cdn.gametop.com/free-games-download/Proto-Raider.exe"
   
        mv Proto-Raider.exe GameInstaller.exe
...
iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCXlZ6owAKCRDlMfrJqhPK
R5+IAJ9zLuVeWEwgw+lFhgtHO+hR34IMIwCeKIo9TXDjnsoLWoaXv31Tq6G9u8g=
=Z7bi
-----END PGP SIGNATURE-----
