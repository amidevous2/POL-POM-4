...
#
# TESTED Editions: 2020 (.EXE: 2020-02-15).
#
# Middlewares used by this software : vcrun2013, LÖVE (2D game framework).
#
#
# CHANGELOG
# [Dadu042] (2020-03-05 12:30)
#   First script. 
#
#
# KNOWN ISSUES
#  - Wine amd64 4.21, 5.0, 5.2: the game window does open but nothing more. The file 'readme.txt' must be opened with the Notepad but drag and drop does not work. Workaround: CTRL+O then find the .txt file (in Ant_yet_it_hurts/drive_c/users/YourUsername/Application Data/And yet it hurt/Game/ ).
#  - Wine amd64 5.0: after creating a player ID, the game ask to open a new .TXT file, but the window does not appear. Workaround: CTRL+O.
#  - Wine amd64 4.21, 5.0, 5.2: the font 'courrier' (not proportional) is not used, so the columns are not correctly displayed. Tried: corefonts, registerfonts, vcrun2013.
#  - Wine amd64 3.0.3: crash when launching.
#  - Wine amd64 3.20: black window when launched.
#
# KNOWN ISSUES (FIXED):
#  - Wine amd64 3.0.3: X.
...
TITLE="And yet it hurt"
PREFIX="And_yet_it_hurt"
EDITOR="Sheepolution"
GAME_URL="https://sheepolution.itch.io/and-yet-it-hurt"
AUTHOR="Dadu042"
STEAM_ID=""
GAME_VMS="64"
SHORTCUT_FILENAME="And*.exe"
...
if [ "$INSTALL_METHOD" == "STEAM" ]; then
        ...
        POL_Download "https://dl.fgamearchives.com/archives/win/2662/infinos_ver.1.1.zip"
    
        # mv Portal-Walk.exe GameInstaller.exe
        ...
        POL_System_unzip "infinos_ver.1.1.zip" -d "$WINEPREFIX/drive_c/game/"
...
iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCXmD/NQAKCRDlMfrJqhPK
R5m3AJ9a6XcsK46JCFk64uPpFv9u4xMczACeM9rl4d8nVwcRWMpvUp7eqQZBExA=
=tyP3
-----END PGP SIGNATURE-----
