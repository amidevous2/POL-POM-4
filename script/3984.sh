...
#
# TESTED Editions: - acespeeder3win.zip (2016 trial unregistered)
#                  - AceSpeeder3g.zip (2016 trial unregistered, HD graphics)
#
# Middlewares used by this software : Unity.
#
# CHANGELOG
# [Dadu042] (2020-03-18 16:50)
#   Initial script.
#
#
# KNOWN ISSUES:
...
GAME_URL="http://www.raingraph.com/"
AUTHOR="Dadu042"
STEAM_ID=""
GAME_VMS="128"
...
if [ "$INSTALL_METHOD" == "STEAM" ]; then
        ...
        POL_Download "http://ftp.vector.co.jp/67/32/3479/acespeeder3win.zip"

        POL_SetupWindow_wait_next_signal "$(eval_gettext 'Extracting the archive...')" "$TITLE"
        POL_System_unzip "acespeeder3win.zip" -d "$WINEPREFIX/drive_c/game/"
...
iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCXnJIUgAKCRDlMfrJqhPK
R8bfAJ9sujjKyPN+61Wl2RJfibFnQPWDJgCgskR8xVaFgbTPYss/JiiewrxxHTc=
=vdqK
-----END PGP SIGNATURE-----
