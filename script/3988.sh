...
#
# TESTED Editions: v1.3 (2007 ?).
#
# Middlewares used by this software : .
#
#
# CHANGELOG
# [Dadu042] (2020-03-19 04:00)
#   Initial script.
#
# KNOWN ISSUES
...
if [ "$INSTALL_METHOD" == "STEAM" ]; then
        ...
        POL_Download "http://downloads.sigma-team.net/chakstemple.exe"
        # Also hosted on: https://archive.org/details/eternalwar_201612
      
        mv chakstemple.exe GameInstaller.exe
...
iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCXnLu/wAKCRDlMfrJqhPK
R/WIAJ0ZNSKgVwnHqb3BNxJrouWkAYr9SwCfYAP0CLhharbmcf9qImFE0/GLZgk=
=veWB
-----END PGP SIGNATURE-----
