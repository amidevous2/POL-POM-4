...
TITLE="Doctor Who – Adventure Game"
PREFIX="Doctor_Who_Adventure_Game"
EDITOR="Tardis ?"
GAME_URL="http://tardis.dk/wordpress/?page_id=1642"
AUTHOR="Dadu042"
STEAM_ID=""
GAME_VMS="32"
SHORTCUT_FILENAME="DoctorWho.exe"
...
if [ "$INSTALL_METHOD" == "STEAM" ]; then
        ...
        POL_Download "http://tardis.dk/retro/drwho/DoctorWhoGraphicalAdventure_v1.0.zip"
 
        POL_SetupWindow_wait_next_signal "$(eval_gettext 'Extracting the archive...')" "$TITLE"
        POL_System_unzip "DoctorWhoGraphicalAdventure_v1.0.zip" -d "$WINEPREFIX/drive_c/game/"
...
iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCXnw4NQAKCRDlMfrJqhPK
R+v6AJ91NJ0g9eyj8rk+zjGy3jH2YfuHkgCfXj0sPywVUd/IMdjumn6ZzTYlFdY=
=wnXW
-----END PGP SIGNATURE-----
