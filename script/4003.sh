...
#
# TESTED Editions: - 2010-08 (100 MB, found on https://digiex.net).
#                  - 2011-03 (125 MB, from https://web.archive.org/web/20181012123126/http://cache-edge.channel4.com/education/privatesdownload.exe ).
#
# Middlewares used by this software : XNA Game Studio v3.1.
#
#
# CHANGELOG
# [Dadu042] (2020-03-26 12:30)
#   Initial script.
#
# KNOWN ISSUES about edition 2010-08 (100 MB, found on https://digiex.net)
#  - Wine amd64 5.3, 4.21, 3.20: crash as soon as launched (0009:err:seh:setup_exception_record stack overflow 960 bytes in thread 0009 eip f7bd3df3 esp 00230f70 stack 0x230000-0x231000-0x330000).
#                                Tried: dotnet40.
#
# KNOWN ISSUES about edition 2010-08 (125 MB, found on https://digiex.net)
#  - Wine amd64 5.3, 4.21, 3.20: crash as soon as launched (0009:err:seh:setup_exception_record stack overflow 944 bytes in thread 0009 eip f7be4dfc esp 00230f80 stack 0x230000-0x231000-0x330000).
#                                Tried: d3dx9_43 + compiler, xact, xinput, xna31, dotnet20sp2. Fix: dotnet20 + xna31.
#  - Wine amd64 5.0: no sound nor music. Tried: sound driver Alsa, xact.
#  - Wine amd64 4.21: music OK (when playing), almost no sounds. Workaround: wine v3.0.3
#
#
#
# KNOWN ISSUES (FIXED):
...
TITLE="Privates"
PREFIX="Privates"
EDITOR="Zombie Cow Studios for Channel 4 - E4"
GAME_URL="http://www.sizefivegames.com/games/privates/"
AUTHOR="Dadu042"
STEAM_ID=""
GAME_VMS="128"
SHORTCUT_FILENAME="Privates.exe"
...
POL_Call POL_Install_dotnetsp2
...
if [ "$INSTALL_METHOD" == "STEAM" ]; then
        ...
        POL_Download "https://web.archive.org/web/20181012123126/http://cache-edge.channel4.com/education/privatesdownload.exe"
        # Also hosted on: https://archive.org/details/eternalwar_201612
      
        mv privatesdownload.exe GameInstaller.exe
      
        # POL_SetupWindow_wait_next_signal "$(eval_gettext 'Extracting the archive...')" "$TITLE"
        # POL_System_unrar x "privatesdownload.rar" "$WINEPREFIX/drive_c/game/" || POL_Debug_Fatal "unrar is required to unarchive $TITLE (unrar package is not installed on the OS)."
        # POL_System_unzip "Far_Cry_SP_Demo.zip" -d "$WINEPREFIX/drive_c/game/"
...
iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCXnz5vwAKCRDlMfrJqhPK
R7LZAJ0ccqNY5EXXinV1xYpi0Xm/O2E3FgCcCDBo0Da/YIbcTJw2y5E548hPOVc=
=lMuU
-----END PGP SIGNATURE-----
