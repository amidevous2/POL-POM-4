...
#
# TESTED Editions: Gametop.com release ( 2018 ? ).
#
# Middlewares used by this software : .
#
#
# CHANGELOG
# [Dadu042] (2020-04-10 19:30)
#   Initial script.
#
# KNOWN ISSUES
#  - Wine amd64 5.0: X.
...
TITLE="Travel to France (Gametop's)"
PREFIX="Travel_to_France"
EDITOR="Alawar Entertainment, Lazy Turtle"
GAME_URL="https://www.gametop.com/download-free-games/travel-to-france/"
AUTHOR="Dadu042"
STEAM_ID=""
GAME_VMS="128"
SHORTCUT_FILENAME="Travel*.exe"
...
if [ "$INSTALL_METHOD" == "STEAM" ]; then
        ...
        POL_Download "https://cdn.gametop.com/free-games-download/Travel-to-France.exe"
        # Also hosted on: https://archive.org/details/eternalwar_201612
        
        mv Travel-to-France.exe GameInstaller.exe
...
iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCX580NQAKCRDlMfrJqhPK
R3jvAJ93hDwdXSM3hX24UdOJp7ls13f/pACbB9OXsAqBPl0D0nAGp38xyXj4DXA=
=iqqT
-----END PGP SIGNATURE-----
