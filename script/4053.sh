...
#   Initial script.
# [Dadu042] (2020-05-11 20-00)
#   Wine 3.0.3 -> 3.20 (ooops)
#
# KNOWN ISSUES :
#  - Wine x86 3.0.3: game does crash before opening. Fix: wine 3.20
#
# KNOWN ISSUES (FIXED):
#  - Wine x86 3.0.3: X
...
PREFIX="TowersOfOz"
EDITOR="My PlayCity"
GAME_URL="https://www.myplaycity.com/towers_of_oz/"
AUTHOR="Dadu042"
STEAM_ID=""
GAME_VMS="128"
...
if [ "$INSTALL_METHOD" == "STEAM" ]; then
        ...
        POL_Download "http://files.myplaycity.com/files_downloader_temp/towersofoz_setup.exe"
       
        mv towersofoz_setup.exe GameInstaller.exe
...
iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCXrnD0AAKCRDlMfrJqhPK
RzQuAJ0YHpdsFPhKnYvb6/XH2jcVSEpgmACdGsCdIvhIZXaiftYC/SKzC6HySUM=
=MRSW
-----END PGP SIGNATURE-----
