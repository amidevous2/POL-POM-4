...
#
# TESTED Editions: v2.1.0 (2013)
#
# Middlewares used by this software : .
#
#
# CHANGELOG
# [Dadu042] (2020-05-15 20-00)
#   Initial script.
# [Dadu042] (2020-05-16 13-00)
#   Add download feature.
#
# KNOWN ISSUES :
#  - Wine x86 5.0: fonts rendering is imperfect (too much smoothing ?). Log: 'Pango-WARNING **: couldn't load font "Verdana Not-Rotated 14px", falling back to "Sans Not-Rotated 14px", expect ugly output.' (total: 5 fonts).  Tried: corefonts (now only one is missing: "Arial Unicode MS Not-Rotated 12px"). Tried: FontSmooth(s).
#  - Wine x86 5.0, 4.21: app does crash when exit.
#
# KNOWN ISSUES (FIXED):
#  - Wine x86 3.0.3: X
...
PREFIX="Algodoo"
EDITOR=""
GAME_URL="http://www.algodoo.com/"
AUTHOR="Dadu042"
STEAM_ID=""
GAME_VMS="128"
SHORTCUT_FILENAME="Algo*.exe"
...
iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCXr/RGAAKCRDlMfrJqhPK
RzAcAJ0TT83xLbOF/2tOD0XAtexCPmkJiQCeJrwcwhlfAFlwZetSzWBMG4ItL24=
=NEGq
-----END PGP SIGNATURE-----
