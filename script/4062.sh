...
#
# TESTED Editions: 2020-05.
#
# Middlewares used by this software : Direct X 9, Bink, nProtect Game Guard.
#
#
# CHANGELOG
# [Dadu042] (2020-05-19 09-00)
#   Initial script.
# [Dadu042] (2020-06-11 09-00)
#   Wine 5.7 -> 5.10
#
# KNOWN ISSUES :
#  - Wine x86 4.21, 5.7: game fail when doing latest updates (at the file 'SND.rez' because the checksum does fail). Fix: Wine 5.10
#  - Wine x86 5.10: game fail to start (Error initialize, after clicking the button 'Game Start').
#
#
# KNOWN ISSUES (FIXED):
#  - Wine amd64 5.0, 5.7: once launched the autoupdate fail ('An error occured during patch.'  'ERROR CODE = -60'). Fix: POL_Install_wininet. However the issue occurs again some minutes later.
     
[ "$PLAYONLINUX" = "" ] && exit 0
source "$PLAYONLINUX/lib/sources"
            
TITLE="Combat Arms Classic - Installer"
PREFIX="Combat_Arms_Classic"
EDITOR="Valofe"
GAME_URL="https://combatarms-c.valofe.com"
AUTHOR="Dadu042"
STEAM_ID=""
GAME_VMS="256"
SHORTCUT_FILENAME="GameInstaller.exe"
...
############################################################################
# Make shortcuts after the installer did run (after the online downloader) #
############################################################################
  
        POL_Shortcut "CombatArmsClassic.exe" "Combat Arms Classic - Game" "" "" "$SOFTWARE_CATEGORIES"
        # POL_Shortcut "GameSetup.exe" "Combat Arms Classic - GameSetup" "" "" "$SOFTWARE_CATEGORIES"
...
iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCXuxH0AAKCRDlMfrJqhPK
R8ORAKColoH3zA5igt6/1vKDymQGszBsuACaAtnGrn31BQhMODqF9iTfeBYn8L0=
=ea4u
-----END PGP SIGNATURE-----
