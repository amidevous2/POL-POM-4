...
#
# TESTED Editions: 2012 (v1.0.2.7795)
#
...
TITLE="Wing Commander Saga: The Darkest Dawn"
PREFIX="Wing_Comm_Saga_Darkest_Dawn"
EDITOR=""
GAME_URL=""
AUTHOR="Dadu042"
STEAM_ID=""
GAME_VMS="256"
SHORTCUT_FILENAME="Wing Commander Saga.exe"
...
if [ "$APP_ANSWER" == ".EXE" ]; then
        ...
        POL_SetupWindow_message "Note: at the end of installation, no need to install OpenAL." "$TITLE"
...
iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCXs1AvQAKCRDlMfrJqhPK
R+fgAJ91aOUK+2TNhaoi+EntAYABxd4GdwCgp34tldy/SpBRjvMKHgpLyaU60Gg=
=Mv4z
-----END PGP SIGNATURE-----
