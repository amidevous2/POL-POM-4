...
#
# TESTED Editions: v5.0.1 (2020)
#
# Middlewares used by this software : MS Visual C++ 2013.
#
#
# CHANGELOG
...
#
# KNOWN ISSUES :
#  - Wine amd64 5.0: GUI seems to work, then crash (traceroute).
#  - Wine amd64 5.5, 5.7: the app does crash when loading.
#  - Wine amd64 5.0: nothing does work (with the network). Tried: wininet, winhttp, gdiplus, vcrun2013.
#
# KNOWN ISSUES (FIXED):
#  - Wine amd64 4.0.4: display is bad (windows and boxes but no text displayed). Fix: Wine 4.21 (however the display is slow).
# 
...
PREFIX="Axence_netTools"
EDITOR="Axence"
GAME_URL="https://axence.net/en/axence-nettools"
AUTHOR="Dadu042"
STEAM_ID=""
GAME_VMS="128"
SHORTCUT_FILENAME="netTools.exe"
...
if [ "$INSTALL_METHOD" == "STEAM" ]; then
        ...
        POL_Download "http://cdn.axence.net/netToolsSetup.exe"
       
        mv netToolsSetup.exe GameInstaller.exe
...
iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCXs1rjAAKCRDlMfrJqhPK
R6OtAJ4ubMvqn6Aw7jOSVDOIKhh6vm1g/ACfR6k40O81zsUAPQjidxnwGLWobzA=
=kEnU
-----END PGP SIGNATURE-----
