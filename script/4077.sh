...
#
# KNOWN ISSUES :
#  - Wine amd64 5.0: 'Supported OpenGL version 3.0 is less than requested version of 3.2 ...'   iGP used: Intel HD 4400. Triedt: directx9, d3dx9_43 + compiler, d3dx10.
#
# KNOWN ISSUES (FIXED):
#  - Wine amd64 4.0.4: X
# 
...
PREFIX="Unnatural_Selection"
EDITOR="BroSloth Studios"
GAME_URL=""
AUTHOR="Dadu042"
STEAM_ID=""
GAME_VMS="128"
SHORTCUT_FILENAME="UnNatural Selection.exe"
...
POL_SetupWindow_message "Warning: you will have to install Visual C++ runtime, then repair it, but do not install Direct X." "$TITLE"
...
iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCXtQDOQAKCRDlMfrJqhPK
R0ZpAJ45sfa3IM4dFAC3LVNvq1wLB5QPcgCgg6naMbrk0f4wZ5TuxrgrGjpAEN4=
=6KpB
-----END PGP SIGNATURE-----
