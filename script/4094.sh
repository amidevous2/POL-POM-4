...
# Distribution used to test : Ubuntu 20.04 64 bits (Linux kernel v5.40),
# Author : Dadu042
# Licence : Retail
...
#
# CHANGELOG
# [Dadu042] (2020-06-11 23-00)
#   Initial script.
#
# KNOWN ISSUES :
#  - Wine x86 5.0.1: When launching a new game session, the game does crash after the last cutscene (the woman japanese sworder). To try: directmusic. Fix: Wine 4.0.4
#
# KNOWN ISSUES (FIXED):
#  - Wine x86 4.0.4, 5.0.1: crash after the launcher window, log: 'Unimplemented function msvcirt.dll'. Fix: vcrun6
#
...
PREFIX="No_One_Lives_Forever_2"
EDITOR="Monolith Productions"
GAME_URL="https://en.wikipedia.org/wiki/No_One_Lives_Forever_2:_A_Spy_in_H.A.R.M.%27s_Way"
AUTHOR="Dadu042"
STEAM_ID=""
GAME_VMS="256"
SHORTCUT_FILENAME="NOLF2.exe"
...
POL_SetupWindow_message "$(eval_gettext '\nThe installation is finished.')" "$TITLE"
...
iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCXuKrNgAKCRDlMfrJqhPK
R5JSAKCXdUf/cGLTFMJrismWDkAsG1fObQCeNeox1ljXewYRwdQzQA///OuJgUA=
=+vh2
-----END PGP SIGNATURE-----
