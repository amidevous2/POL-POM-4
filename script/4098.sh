...
#
# TESTED Editions: - MWLL online installer v0.12 (2020)  -> fail to instal
#                  - MWLL offline installer v0.12 (2020) -> fail to launch the game
#
# Middlewares used by this software : Direct X 9, dotnetfx 4.0, vcrun2005
#
# https://appdb.winehq.org/objectManager.php?sClass=application&iId=18257
#
#
# CHANGELOG
# [Dadu042] (2020-06-18 09-00)
#   Initial script. Not working yet.
# [Dadu042] (2020-06-21 09-00)
#   Updates.
# [Dadu042] (2020-07-14 09-00)
#   Still trying to make it run after the launcher window.
#
# KNOWN ISSUES :
#  - Wine x86 4.0.4, 4.21, 5.0.1: the MWLL launcher fail to upgrade from v3.0.x to v3.2.x ('The remote server returned an error: (404) not found'). Tried: wininet, winhttp, mono481
#    Same issue when running it from a other location (C:\Game\Mods\MWLL\) with Wine 5.10
#  - Wine x86 4.0.4: MWLL does fail to install (MWLL_Launcher.exe is missing).
#
# KNOWN ISSUES (OFFLINE INSTALLER v0.12):
#  - Wine x86 5.0.1: window 'Warning: Stray files detected in your MWLL installation ... <Yes><No>' Clicking Yes does lead to a crash of 'Visual Basic'.
#  - Wine x86 5.0.1 + dotnet461: MWLL Launcher (v0.12.2) after clicking 'Launch' the loading does crash. Tried: wine 5.10.
# 
#
#
# KNOWN ISSUES (FIXED):
#  - Wine x86 4.0.4: after installation, MWLLLauncher.exe (v0.12.0) does crash when its window appear. Fix: Wine 5.0.1
#  - Wine x86 5.0.1: in MWLL Launcher (v0.12.2, it has upgraded itself) after clicking the 'Install' button this lead to a crash (Checking file: ...\PB\pbsv.dll'). Tried: mono481, dotnet40 (worse: error 80004005). Fix: dotnet461
     
[ "$PLAYONLINUX" = "" ] && exit 0
source "$PLAYONLINUX/lib/sources"

TITLE="Mechwarrior: Living Legends"
PREFIX="Mechwarrior_Living_Legends"
EDITOR="The MWLL Community Development Team"
GAME_URL="https://mechlivinglegends.net/"
AUTHOR="Dadu042"
STEAM_ID=""
GAME_VMS="256"
SHORTCUT_FILENAME="MWLLLauncher.exe"
...
DOCUMENT_FILE="UserControlMap.pdf"
...
# POL_SetupWindow_message "Warning: before to quit this script, you will have to:\n#1 run the installer\n#2 download the game\n#3 install the game." "$TITLE"
...
if [ "$INSTALL_METHOD" == "STEAM" ]; then
        ...
        POL_Download "http://file.valofe.com/Valofe_file/ca_classic/live/LocalInstaller/VLoader_CAC.exe"
   
        mv VLoader_CAC.exe GameInstaller.exe
        # mv Teacher%20Simulator.rar gameinstaller.rar
        # mv gping_2.0.zip gameinstaller.zip
...
iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCXw4HdgAKCRDlMfrJqhPK
R2XzAJwOkTwARtxnTu02OfHFkI08QTON0ACfcNsmUPr78nMNIVQ/IiybYioxd+c=
=fspu
-----END PGP SIGNATURE-----
