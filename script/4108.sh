...
#
# TESTED Edition: 2004 according 3D objects files, '2011 GameHitZone' according the main screen (.EXE repackaged in 2017 by GameHitZone.com)
#
...
#
# CHANGELOG
# [Dadu042] (2020-07-01 12-00)
#   Initial script.
# [Dadu042] (2020-07-01 16-00)
#   Disable Alsa audio (not required, sounds level is 0 in the game by default).
#
# KNOWN ISSUES :
#  - Wine x86 4.0.4, 5.0.1: on the last installation window, one of the 2 checkboxes text is missing. Tried: corefonts.
#  - Wine x86 4.0.4, 5.0.1: sounds missing (music OK). Tried: dsound (it inverse the problem), quartz, xact. Fix: Alsa, however there are a lot of these lines:
#                           006e:fixme:gstreamer:GST_QueryInterface No interface for {36b73880-c2c8-11cf-8b46-00805f6cef60}!
#
# KNOWN ISSUES (FIXED):
#  - Wine amd64 4.21, 5.0, 5.7: X
#
...
TITLE="Star Battle"
PREFIX="Star_Battle"
EDITOR="Gamehitzone.com"
GAME_URL="http://www.gamehitzone.com/download-free-games/star-battle/"
AUTHOR="Dadu042"
STEAM_ID=""
GAME_VMS="256"
SHORTCUT_FILENAME="StarBattle.exe"
...
POL_SetupWindow_message "Warning: check the pathname of the installation, you will have to change it (from 'My Documents') to the right folder: C:\GameName" "$TITLE"
...
if [ "$INSTALL_METHOD" == "STEAM" ]; then
        ...
        POL_Download "http://www.gamehitzone.com/dl/StarBattle.exe"
         
        mv StarBattle.exe GameInstaller.exe
...
iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCXvyf+gAKCRDlMfrJqhPK
RyTYAJ9PT0Au2BP/zyY42OXmV9ePI87Y6QCgqn21Kejp91ohbwObLejHsw6RvGg=
=rMmZ
-----END PGP SIGNATURE-----
