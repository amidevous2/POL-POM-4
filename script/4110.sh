...
#
# TESTED Editions: 2002.
#
# Middlewares used by this software : Multimedia Fusion.
#
#
# CHANGELOG
# [Dadu042] (2020-07-02)
...
#
# KNOWN ISSUES:
#  - Wine amd 4.0.4, 5.0.1: no sound nor music. Tried: amstream, devenum, quartz, xact.
#  - Wine 3.0.3: sounds only. 
#    About music, the issue seems related to MIDI, see: https://appdb.winehq.org/objectManager.php?sClass=version&iId=29933
#
# KNOWN ISSUES (FIXED):
#  - Wine x86 4.0.4, 5.0.1: X
#  - 
...
PREFIX="Eternal_Daughter"
EDITOR="Black Eye Software"
GAME_URL="http://www.derekyu.com"
AUTHOR="Dadu042"
STEAM_ID=""
GAME_VMS="128"
SHORTCUT_FILENAME="Eternal Daughter.exe"
...
if [ "$INSTALL_METHOD" == "STEAM" ]; then
        ...
        POL_Download "http://www.derekyu.com/games/ed.zip"
        ...
        POL_System_unzip "ed.zip" -d "$WINEPREFIX/drive_c/game/"
...
iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCXv5ZZwAKCRDlMfrJqhPK
Rze5AKCAeL5YcxQ6FgLISNkA05UpGOLe0wCfdI6qoby3lobLnNT02P/9Invoi60=
=iS+u
-----END PGP SIGNATURE-----
