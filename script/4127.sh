...
# Distribution used to test : XUbuntu 18.04 64 bits (Linux kernel v5.3).
# Author : Dadu042
# Licence : Retail
# Only For : http://www.playonlinux.com
#
# TESTED Editions: v1.0
#
# Middlewares used by this software : QuickTime 6, Macromedia Director.
#
#
#
# CHANGELOG
# [Dadu042] (2020-07-13 12-00)
#   Initial script.
#
# KNOWN ISSUES :
#  - Wine amd64 3.0.3: music plays wrong (jerky). Fix: Wine 4.0.4
# 
#
# KNOWN ISSUES (FIXED):
#  - Wine amd64 4.0.4: X
...
PREFIX="Food_Force"
EDITOR="WFP"
GAME_URL="https://en.wikipedia.org/wiki/Food_Force"
AUTHOR="Dadu042"
STEAM_ID=""
GAME_VMS="128"
SHORTCUT_FILENAME="Start Food Force.exe"
...
POL_SetupWindow_message "Warning: you must install Quicktime when asked, in mode: minimal." "$TITLE"
...
if [ "$INSTALL_METHOD" == "STEAM" ]; then
        ...
        POL_Download "https://archive.org/download/Food_Force/food_force_installer.exe"
          
        mv food_force_installer.exe GameInstaller.exe
        # mv Teacher%20Simulator.rar gameinstaller.rar        
        # mv BUPSHMUPa0-21.zip gameinstaller.zip
...
iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCXwyTTAAKCRDlMfrJqhPK
R4KPAJ9rkkf/UkqDWfHWLwLE78d1Sfp/wQCfbfFmc9hdMEw4IpwxRCDex+LBu3M=
=1cQw
-----END PGP SIGNATURE-----
