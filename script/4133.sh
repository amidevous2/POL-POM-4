...
#
# CHANGELOG
# [Dadu042] (2020-07-16 21-00)
#   Initial script.
# [Dadu042] (2022-03-30 21-00)
#   Wine 3.20 -> 6.0.1
#
# KNOWN ISSUES :
#  - Wine x86 3.20, 4.0.4, 4.21, 5.0.1, 5.12, proton 4.2: crash as soon as launched (debug log: 'hlsl_parser:hlsl_parse Array')
# 
#
# KNOWN ISSUES (FIXED):
#  - Wine amd64 4.0.4: X
...
TITLE="Crysis Mod: Wreckage"
PREFIX="Crysis_Mod_Wreckage"
EDITOR=""
GAME_URL="https://www.moddb.com/mods/wreckage"
AUTHOR="Dadu042"
STEAM_ID=""
GAME_VMS="128"
SHORTCUT_FILENAME="Bin32/Crysis_Wreckage.exe"
...
if [ "$INSTALL_METHOD" == "STEAM" ]; then
        ...
        POL_Download "https://drl.chaosforge.org/file_download/35/doomrl-win-0997.zip"
...
iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCYkQuEwAKCRDlMfrJqhPK
R1FwAJ0VcNVNK4jdTnKNXDHfhPsuk4DfOQCfcRySSa+9cgdW5zrhuovRMrL87ZM=
=HxZ3
-----END PGP SIGNATURE-----
