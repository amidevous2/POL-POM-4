...
if [ "$POL_ARCH" = "amd64" ]; then
        ...
        install_dx_dlls '*d3dx9*41_x64.cab' "$WINEPREFIX/drive_c/windows/system32" 'd3dx9_41.dll'
        install_dx_dlls '*d3dx9*41_x86.cab' "$WINEPREFIX/drive_c/windows/syswow64" 'd3dx9_41.dll'
else
        POL_Debug_Message "Extracting only x86 dll"
        install_dx_dlls '*d3dx9*41_x86.cab' "$WINEPREFIX/drive_c/windows/system32" 'd3dx9_41.dll'
fi
 
# Overriding dlls
POL_Debug_Message "Overriding d3dx9_41 dll"
POL_Wine_OverrideDLL "native, builtin" "d3dx9_41"
cat << "-----END PGP SIGNATURE-----" > /dev/null
-----BEGIN PGP SIGNATURE-----

iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCYKI79QAKCRDlMfrJqhPK
R2uKAKCul1WS4GuOjnhW7xQACqwGfC1BrACdEVoUX+pm3b9i2J0E5YmmS+TJ2H8=
=0hkX
-----END PGP SIGNATURE-----
