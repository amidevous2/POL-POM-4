...
if [ "$POL_ARCH" = "amd64" ]; then
        ...
        install_dx_dlls '*d3dx9*37_x64.cab' "$WINEPREFIX/drive_c/windows/system32" 'd3dx9_37.dll'
        install_dx_dlls '*d3dx9*37_x86.cab' "$WINEPREFIX/drive_c/windows/syswow64" 'd3dx9_37.dll'
else
        POL_Debug_Message "Extracting only x86 dll"
        install_dx_dlls '*d3dx9*37_x86.cab' "$WINEPREFIX/drive_c/windows/system32" 'd3dx9_37.dll'
fi
 
# Overriding dlls
POL_Debug_Message "Overriding d3dx9_37 dll"
POL_Wine_OverrideDLL "native, builtin" "d3dx9_37"
cat << "-----END PGP SIGNATURE-----" > /dev/null
-----BEGIN PGP SIGNATURE-----

iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCYKI7ywAKCRDlMfrJqhPK
RwXXAKCD3Hp+KPV8EZsbxo64TOZlOS/mKACeMomqnMcZcn3mP64xx6XoyOM8KQQ=
=qe2q
-----END PGP SIGNATURE-----
