...
#
# KNOWN ISSUES :
#  - Wine amd64 5.0.1 (+ AMDGPU): looks night instead of day. Fix: install DXVK_161 (DXVK_170 did not fix).
#
#
# KNOWN ISSUES (FIXED):
...
TITLE="Airport Madness 3D V2"
PREFIX="airport_madness_3D_v2"
...
iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCYGuEPQAKCRDlMfrJqhPK
R/poAJ40LB4S7xTuW0LYIjSfVl3XR2UTRwCdEM2nI3KqHaF3V26eH7SHERBR/y8=
=ZSh5
-----END PGP SIGNATURE-----
