...
#
# TESTED Editions: - retail DVD-ROM v1.00 (Multi5), folders latest date: march 2009.
#                  - TO DO: 2012 Czech release  https://archive.org/details/czlevel221dvd  https://en.wikipedia.org/wiki/LeveL
#
# Middlewares used by this software : DRM Tages
#
#
#
# CHANGELOG
# [Dadu042] (2020-07-30 10-00)
#   Initial script.
#
# KNOWN ISSUES :
#  - Wine amd64 5.0.1: game crash (black screen) as soon as launched (after the launcher window), a window 'Crash' does appear after pressing Space key. The resolution does switch to 800x600.
#    Tried: Wine 2.22, 3.0.3, 3.20, 4.0.4, 4.21, 4.21-staging, proton 4.2, 5.13, 5.13-staging
#    Tried: patch to v1.01, NoCD file.
#
#  - Wine amd64 5.0.1: fail to run, error window: 'TAGES Drivers: The drivers require installation (with an administrator account). Do you want to proceed now ?'.
#    I tried to install TAGES v5.5.7.2 32bits (from http://www.tagesprotection.com/main.htm?page=minimum.htm ), but same issue.
#    FIX ? : patch the game to v1.01
#
#    I tried a NoCD (file: dvm.dll) without success (it has to be copied over the DRM, that I can't install). Finally it worked, because it has to be copied in the game's folder, not in Windows folder.
#
#
# KNOWN ISSUES (FIXED):
...
PREFIX="Chronicles_of_Riddick_AoDA"
EDITOR="Atari"
GAME_URL="https://en.wikipedia.org/wiki/The_Chronicles_of_Riddick:_Assault_on_Dark_Athena"
AUTHOR="Dadu042"
STEAM_ID=""
GAME_VMS="128"
SHORTCUT_FILENAME="DarkAthena.exe"
...
if [ "$INSTALL_METHOD" == "STEAM" ]; then
        ...
        POL_SetupWindow_check_cdrom "DarkAthena_Launcher.exe"
...
iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCX6a6sAAKCRDlMfrJqhPK
R3WrAJ0QxGMzlVNVSPAyhsC8/kDkV38sJQCeLTr1G4NDLpB0k5JUQFrhS5pExOM=
=Usze
-----END PGP SIGNATURE-----
