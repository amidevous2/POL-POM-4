...
#
# TESTED Editions: GOG's v1.0 (2020)
#
...
#
# CHANGELOG
# [Dadu042] (2020-08-01 10-00)
#   Initial script.
# [Dadu042] (2020-08-02 10-00)
#   Add corefonts for the texts in the infoboxes.
#
# KNOWN ISSUES :
#  - Wine amd64 5.0.1: no intro (black screen). Slowness. Huge debug log (smaller with Wine 5.8, 5.11).
#  - Wine amd64 5.12: crash when launching (nothing displayed).
#
#
# KNOWN ISSUES (FIXED):
#  - Wine amd64 5.0.1: text missing in the infoboxes. Fix: corefonts
...
PREFIX="COVID_Outbreak"
EDITOR="JUJUBEE SA"
GAME_URL="1287000"
AUTHOR="Dadu042"
STEAM_ID=""
GAME_VMS="512"
SHORTCUT_FILENAME="COVID The Outbreak.exe"
...
POL_SetupWindow_message "$(eval_gettext 'WARNING: This game does not run (as of 2020-07), help needed.\nThe issue: game fail to load after clicking the button <Play> on the launcher window.')" "$TITLE"
...
iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCYBQKMwAKCRDlMfrJqhPK
RwRmAJ9bJszigeFjbLZqlyV8WGtMtt90fACeIg5SmuenClpyzZ01AL360c2noBI=
=268K
-----END PGP SIGNATURE-----
