...
#
# TESTED Editions: GOG v2.5.0.9. Note: there are a linux and a OSX native releases.
#
# Middlewares used by this software : vcrun2013, dotnet4 (Mono), Unity Engine.
#
#
#
# CHANGELOG
# [Dadu042] (2020-08-07 10-00)
#   Initial script.
#
# KNOWN ISSUES :
#  - Wine amd64 5.0.1: doing ALT+TAB does loose user control on the game.
#
#
# KNOWN ISSUES (FIXED):
#  - Wine amd64 5.0.1: requires dotnet 4.0 (SUPERHOT.exe). Fix: run SH.exe instead.
...
GAME_URL="https://www.gog.com/game/superhot"
AUTHOR="Dadu042"
STEAM_ID="322500"
GAME_VMS="512"
SHORTCUT_FILENAME="SUPERHOT.exe"
...
iFwEABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCYkLIpwAKCRDlMfrJqhPK
R9Z4AJjis6SsltarKDdPVf1fv6a8rZH1AJ44t7k6xxRGFjZoSjV/Qo6whm3JDQ==
=+Yfj
-----END PGP SIGNATURE-----
