...
#
# TESTED Editions: 2005 ?
#
# Middlewares used by this software : Bink, ogg.
#
#
#
# CHANGELOG
# [Dadu042] (2020-08-15 08-00)
#   Initial script.
#
# KNOWN ISSUES :
#  - Wine x86 3.0.3: on PCs, folder's names not correctly extracted (by POL_System_unzip) from the ZIP file. Fix: manually rename.
#  - Wine x86 3.0.3: cinematics are not displayed.
#
# KNOWN ISSUES (FIXED):
#  - Wine amd64 5.0.1: X
...
TITLE="Cuban Missile Crisis: Ice Crusade"
PREFIX="cuban-missile-crisis-IC"
EDITOR="1C"
GAME_URL="https://freebies.indiegala.com/cuban-missile-crisis-ice-crusade/"
AUTHOR="Dadu042"
STEAM_ID=""
GAME_VMS="128"
...
if [ "$APP_ANSWER" == ".EXE" ]; then
	...
	# NOK POL_System_unzip "$APP_ANSWER" -d "$WINEPREFIX\drive_c\game\"
...
iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCX04j7AAKCRDlMfrJqhPK
R5zNAJ47r2Swer/GdX1DqZ3lJM1pQciEkQCfSRG3mAoRKq45uQmA9SVOLM08xQw=
=+bDm
-----END PGP SIGNATURE-----
