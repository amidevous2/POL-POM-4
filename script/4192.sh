...
#
# TESTED Editions: GOG v2.1.0.6
#
# Middlewares used by this software : DirectX 9 (v28)
#
#
#
# CHANGELOG
# [Dadu042] (2020-08-24 10-00)
#   Initial script.
#
# KNOWN ISSUES :
#  - Wine amd64 4.0.4, 5.0.2: crash after 10 min of tutorial (when having to click right button to select 'Brigades').
#
# KNOWN ISSUES (FIXED):
#  - Wine amd64 5.0.1: X
...
PREFIX="FullSpectrumWarrior-TM"
EDITOR=""
GAME_URL="https://en.wikipedia.org/wiki/Full_Spectrum_Warrior"
AUTHOR="Dadu042"
STEAM_ID=""
GAME_VMS="256"
SHORTCUT_FILENAME="fsw2.exe"
...
POL_Shortcut "Settings.exe" "$TITLE - Settings" "" "" "$SOFTWARE_CATEGORIES"
...
iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCX0N1cgAKCRDlMfrJqhPK
R1y6AJ0XM6Gv8xjVd1XZELpAfcDtS4nSQgCfXlhbRTSLXUbjdpDqy8XNkpJoKmI=
=Mgud
-----END PGP SIGNATURE-----
