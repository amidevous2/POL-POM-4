...
#
# TESTED Editions: GOG's release (2019, game v1.50)
#
# Middlewares used by this software : Bink video, DirectX 9, DirectInput 8, DotNet v1.1.
#
#
#
# CHANGELOG
...
#
# KNOWN ISSUES :
#  - Wine amd64 4.0.4, 5.0.2, 5.12: the config app (FWPCConfig.exe) does crash when launching ('Invalid IL code in Microsoft.DirectX.Direct3D.Manager:CheckDeviceType').
#                      Tried: d3dx9_43 + compiler, directX9, DXVK_171, dxfullsetup, dotnet40. Workaround: editing manually the file 'fw.config.xml'.
#  - Wine amd64 5.0.2: some audio issues (low voices volume). Fix: force Software audio in the settings file ('fw.config.xml').
#  - Wine amd64 5.0.2: can not set other languages than English. Workaround: overwrite the file 'Data\strings\english.loc' with the language you want.
#
# KNOWN ISSUES (FIXED):
...
TITLE="Warhammer 40000: Fire Warrior"
PREFIX="Warhammer_40000-FW"
EDITOR=""
GAME_URL="https://www.pcgamingwiki.com/wiki/Warhammer_40,000:_Fire_Warrior"
AUTHOR="Dadu042"
STEAM_ID=""
GAME_VMS="256"
SHORTCUT_FILENAME="FireWarrior.exe"
...
if [ "$INSTALL_METHOD" == "STEAM" ]; then
        ...
        POL_Shortcut "FWPCConfig.exe" "$TITLE - Config" "" "" "$SOFTWARE_CATEGORIES"
...
iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCX1JX3gAKCRDlMfrJqhPK
RwTSAJ9vxCFMAWy7BhUu88wusRdbufaQZwCeJDJIgW7CxODRmxPkMgAe2Q45shw=
=vZ0w
-----END PGP SIGNATURE-----
