...
#
# Middlewares used by this software : Ren'Py v6.99 (Python).
#
# CHANGELOG
# [Dadu042] (2020-10-13 10-00). 
#   Initial script, tested with Wine 5.19.
#
# KNOWN ISSUES :
#  - Wine amd64 5.0.2: doing ALT+TAB (when in full screen) does loose access to the game window.
...
TITLE="Date (almost) Anything - Simulator"
PREFIX="Date_almost_Anything"
EDITOR="Skye Q"
GAME_URL="https://huegor.itch.io/date-almost-anything-sim"
AUTHOR="Dadu042"
STEAM_ID=""
GAME_VMS="256"
SHORTCUT_FILENAME="DateAlmostAnythingSim.exe"
...
# POL_Wine_OverrideDLL "native" "urlmon"
...
if [ "$INSTALL_METHOD" == "STEAM" ]; then
        ...
        POL_Download "https://cfpatch.z8games.com/download/CrossFireWest.exe"
           
        mv CrossFireWest.exe GameInstaller.exe
...
iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCX4W6dAAKCRDlMfrJqhPK
Rw/1AJ49T/qbufPcq3D7Yb/2RdfiO+nHGgCggwUuo5nRskfI2yalgmGAMDo7DMc=
=h0rj
-----END PGP SIGNATURE-----
