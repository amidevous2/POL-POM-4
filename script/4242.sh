...
# #1 in a text editor, do search for '1.7.1' (example) replace it to '1.7.2' (example).
...
DXVK_VERSION="dxvk-1.7.2"
      
# Downloading DXVK files
POL_Download_Resource "https://github.com/doitsujin/dxvk/releases/download/v1.7.2/$DXVK_VERSION.tar.gz" "42d92cc21c96ffeccad705388bee09bd"
...
iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCX5XMZgAKCRDlMfrJqhPK
R2XcAKCJvUBmGscHkCHOmdXxSjPSACXBlACdGWRvyv7SWN8wmNelDOehK+LNGOk=
=NVoM
-----END PGP SIGNATURE-----
