...
#
# TESTED Editions: installer '114.1' (2020-10-20)
#
# Middlewares used by this software : 
#
# CHANGELOG
# [Dadu042] (2020-10-19 10-00). 
#   Initial script, inspired by the work of Fabi2607 for Lutris.
#
# KNOWN ISSUES :
#
# KNOWN ISSUES (FIXED):
#  - Wine amd64 5.17: something does crash (POL's error window), then a white rectangle with a black bold border. Workaround: Wine 5.11-staging
#  - Wine amd64 5.0.2, 5.19-staging: something does crash (POL's error window), then a black rectangle window (empty) does appear. Tried: /S, Lutris script hacks.
...
PREFIX="Uplay"
EDITOR="Ubisoft"
GAME_URL="https://uplay.ubisoft.com"
AUTHOR="Dadu042"
STEAM_ID=""
GAME_VMS="256"
SHORTCUT_FILENAME="Uplay.exe"
...
POL_Wine_PrefixCreate "5.11-staging"
...
if [ "$INSTALL_METHOD" == "STEAM" ]; then
        ...
        POL_Download "https://ubistatic3-a.akamaihd.net/orbit/launcher_installer/UplayInstaller.exe"
           
        mv UplayInstaller.exe GameInstaller.exe
        ...
        POL_Shortcut "$SHORTCUT_FILENAME" "$TITLE" "" "/S" "$SOFTWARE_CATEGORIES"
        POL_Shortcut_QuietDebug "$TITLE"
...
cd "$WINEPREFIX/drive_c/users/$USER/Local Settings/Application Data/Ubisoft Game Launcher/"
...
cp settings.xml settings.bak
cat temp.txt >> settings.yml
...
iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCX46YQwAKCRDlMfrJqhPK
RwhoAJ49ppkV9QvyDnN/ldK21ppZ6yOShgCcCd9W4XSkd1rXOJW9yzLhInVP+PA=
=M0og
-----END PGP SIGNATURE-----
