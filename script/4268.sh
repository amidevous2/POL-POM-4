...
#
# TESTED Editions: v2.27.0.123 (2020-11)
#
# Middlewares used by this software : 
#
# CHANGELOG
# [Dadu042] (2020-11-13 20-00).
#   Initial script.
# [Dadu042] (2020-11-14 10-00).
#   Wine 4.0.4 -> 5.0.2
#
# KNOWN ISSUES :
#  - Wine amd64 5.0.2, 5.20, 5.19-staging: can not pass the 'Enter world' stage (I get a window 'Waiting' then after some minutes I get the window 'Server disconnected <Confirm>').
#
# KNOWN ISSUES (FIXED):
#  - Wine amd64 5.0.2: X
...
TITLE="iROSE Unchained"
PREFIX="iROSE_Unchained"
EDITOR="iROSE Unchained"
GAME_URL="http://iroseunchained.com/"
AUTHOR="Dadu042"
STEAM_ID=""
GAME_VMS="256"
...
iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCYGhclAAKCRDlMfrJqhPK
R6/kAJ9/BVlJ6o5BLACOblAgsYJT9xYjkACfRwWptrRxFXjht88MAXGYHmnXaqo=
=ppW4
-----END PGP SIGNATURE-----
