...
#
# TESTED Editions: v2.27.0.281 (2020-11), auto updated to v2.27.0.286
#
# Middlewares used by this software : DirectX 9 or 11.
#
# CHANGELOG
# [Dadu042] (2020-11-14 20-00).
#   Initial script.
#
# KNOWN ISSUES :
#  - Wine amd64 5.0.2: immediate crash after clicking tehe button 'Enter world' (but the music do continue). Seems related to (debug): '[1114/212431:ERROR:renderer_main.cc(207)] Running without renderer sandbox'.  Workaround: Wine 4.0.4, or 5.0.2 + argument '-d3d9'.
#
# KNOWN ISSUES (FIXED):
#  - Wine amd64 5.0.2: X
...
PREFIX="iRosePH"
EDITOR="iRosePH"
GAME_URL="http://www.irosephonline.com/"
AUTHOR="Dadu042"
STEAM_ID=""
GAME_VMS="256"
SHORTCUT_FILENAME="ROSEOnline.exe"
...
if [ "$INSTALL_METHOD" == "STEAM" ]; then
        ...
        POL_Download "https://www.aronium.com/download/Aronium.Setup.exe"
...
if [ "$APP_ANSWER" == ".EXE" ]; then
        ...
        POL_Shortcut "$SHORTCUT_FILENAME" "$TITLE" "" "-d3d9" "$SOFTWARE_CATEGORIES"
        POL_Shortcut_QuietDebug "$TITLE"
...
iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCYGlzIwAKCRDlMfrJqhPK
R3AQAJ9oH0ro11C8c1VSN/LiJlKDpsl4kgCgpCVT/WQPp6Ii89E3RHL0RDcCkZg=
=N9QD
-----END PGP SIGNATURE-----
