...
#
# KNOWN ISSUES :
#  - Wine amd64 6.2: freeze on the game's title screen. Tried: DXVK 1.7.2. Same issue on Crossover v20.0.4 (even with DXVK 1.5 added).
#
# KNOWN ISSUES (FIXED):
#  - Wine amd64: X
...
PREFIX="TheCatandtheCoup"
EDITOR="USC Games"
GAME_URL=""
AUTHOR="Dadu042"
STEAM_ID=""
GAME_VMS="256"
SHORTCUT_FILENAME="TheCatAndTheCoup.exe"
...
iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCYDPLYgAKCRDlMfrJqhPK
R0hCAKCaJpK7amCdJtVJWubGzcfQunZe0wCeIPtGoNg7veWIBtV1cuK+YID6yVc=
=qdsc
-----END PGP SIGNATURE-----
