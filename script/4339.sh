...
#
# CHANGELOG
# [Dadu042] (2021-02-23 10-00).
#   Initial script. 
#
# KNOWN ISSUES :
#  - Wine amd64 5.0.3, 6.0: main screen does work but when trying to play: black screen. 
#  - Wine amd64 5.0.3, 6.0 + DXVK v1.7.2: game does crash as soon as launched. 
#
# KNOWN ISSUES (FIXED):
#  - Wine amd64: X
#  - Wine amd64 3.0: black screen (+ music) after the Unity game logo. Fix: wine 5.0.3
   
[ "$PLAYONLINUX" = "" ] && exit 0
source "$PLAYONLINUX/lib/sources"
   
TITLE="Thunderbird Strike"
PREFIX="Thunderbird_Strike"
EDITOR=""
GAME_URL="https://elizabethlapensee.itch.io/thunderbird-strike"
AUTHOR="Dadu042"
STEAM_ID=""
GAME_VMS="256"
SHORTCUT_FILENAME="strike.exe"
...
if [ "$INSTALL_METHOD" == "STEAM" ]; then
        ...
        POL_Download "http://downloads.digipen.edu/arcade/downloads/02279/InLovingMemory_setup.exe"
...
iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCYDSVfQAKCRDlMfrJqhPK
R+DVAKCKuSWPZLdhOwFvrpuvRPce+KyoWACfbNgZmLlRn/y++eVujB7P5ZVN0BU=
=fecS
-----END PGP SIGNATURE-----
