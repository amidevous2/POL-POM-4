...
#
# TESTED Editions: 1.3.1.4328
#
# Middlewares used by this software : MS XNA 3.1
#
# CHANGELOG
# [Dadu042] (2021-03-01 10-00). Wine 6.2
#   Initial script. OK with Wine X ?
#
# KNOWN ISSUES :
#  - Wine amd64 X: X
#
...
PREFIX="Open_Rails"
EDITOR=""
GAME_URL="http://www.openrails.org"
AUTHOR="Dadu042"
STEAM_ID=""
GAME_VMS="256"
SHORTCUT_FILENAME="OpenRails.exe"
...
if [ "$APP_ANSWER" == ".EXE" ]; then
        ...
        POL_Wine start /unix "$SETUP_EXE" "/q"
        POL_Wine_WaitExit "$TITLE"
...
iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCYD09swAKCRDlMfrJqhPK
RzXuAKCwwSItXeBGQ948s+H1i3JpPvjnaACeI8/cilgwlBpFU3hr/ivKJv4rrxY=
=xEVU
-----END PGP SIGNATURE-----
