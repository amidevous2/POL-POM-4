...
#
# TESTED Editions: v1.1.2.0 (2018-12 )
#
# Middlewares used by this software : 
#
# CHANGELOG
# [Dadu042] (2021-03-01 10-00). Wine 5.0.3
#   Initial script.
#
# KNOWN ISSUES :
#  - Wine amd64 X: X
...
#
# KNOWN ISSUES (FIXED):
#  - Wine amd64 5.0.3, 6.0: crash after the game title ('Loading'), seems related to Audio (OpenAL), tried: forcing audio Alsa. Fix: d3dx9_43
...
PREFIX="Uebergame"
EDITOR=""
GAME_URL="https://duion.com/games/uebergame/main"
AUTHOR="Dadu042"
STEAM_ID=""
GAME_VMS="256"
SHORTCUT_FILENAME="Uebergame.exe"
...
if [ "$INSTALL_METHOD" == "STEAM" ]; then
        ...
        POL_Download "http://www.openrails.org/files/OpenRails-1.3.1-Setup.exe"
...
iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCYD01OgAKCRDlMfrJqhPK
R6MFAJ92cCVBilLk7ajASn3bjl21Lav6gwCeNVtfbXw4Xlkdg+1ygNdoUXbByx4=
=yvhY
-----END PGP SIGNATURE-----
