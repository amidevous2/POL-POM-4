...
#
# CHANGELOG
# [Dadu042] (2022-03-14 10-00). Wine 6.0.1
#   Initial script.
#
# KNOWN ISSUES :
#  - Wine amd64 X: X
...
#
# KNOWN ISSUES (FIXED):
#  - Wine amd64 6.0.1: game can not launch if 'Movies' folder is not renamed to any name.
#  - Wine amd64 6.0.1: game can continue to launch after the 4 "Unreal Engine" logos. Fix: Wine 6.17.
#  - Wine amd64 6.0.1, 6.17: incomplete graphics. Fix: DXVK v1.9.4.
...
STEAM_ID=""
GAME_VMS="256"
SHORTCUT_FILENAME="Sentient.exe"
...
iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCYjBk5AAKCRDlMfrJqhPK
R85EAJ46zimLlg3foUpFavyp1Lpf5chw2wCgrev40CLScwLzy+Mq8L5Ut88eT3k=
=FBqj
-----END PGP SIGNATURE-----
