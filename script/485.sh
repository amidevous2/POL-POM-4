...
POL_SetupWindow_presentation "$TITLE" "Ubisoft" "http://www.princeofpersiagame.com" "Berillions & GNU_Raziel" "$PREFIX"
...
if [ "$GAME_MEDIAVERSION" == "DVD" ]; then
	...
	wine "steam.exe" -applaunch 13530
...
# Making shortcut
POL_SetupWindow_auto_shortcut "$PREFIX" "PrinceOfPersia.exe" "$TITLE" "Prince of Persia : The Two Thrones.xpm" ""
...
iEYEABECAAYFAk4kgJwACgkQ5TH6yaoTyke7zQCeK2ZMhKdoPTxFr47jHnFfS38k
+IoAn0NE0qpIT39V0X9MyndiMeek7kGc
=5fw7
-----END PGP SIGNATURE-----
