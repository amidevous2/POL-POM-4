...
#
# TESTED Editions: DVD v1.1 ? (hits collection 2008)
#
...
# Dadu042 (2019-08-01)
#   Wine 1.1.35 -> 2.22 Because on Xubuntu (18.04 x64), once the retail DVD installed Wine crashed before to show anything (same with Wine 1.9.24).
#   Fix link to Wikipedia picture.
#   Add (right click) link to readme.html
#   Add a link to HardwareSetup.exe
#   Half standardize the NoCD warning.
# Dadu042 (2019-08-01)
#   Wine 2.22 -> 3.0.3
# Dadu042 (2020-06-03) 
#   New script (allow install from local .EXE)
#   32 bits -> 64 bits
#   Wine 3.0.3 -> 4.0.4
#
# KNOWN ISSUES :
...
#
# KNOWN ISSUES (FIXED):
#  - AMD GPU (Vega 11) + Wine amd64 3.0.3, 4.0.4, 4.21, 5.0: crash when launched 'd3dcompiler:compile_shader Compilation target "fx_2_0" not yet supported'
#    Tried: d3dx9_43 + compiler. Fix: install component 'directx9'.
#
...
PREFIX="TocaRaceDriver3"
EDITOR="Codemasters"
GAME_URL="https://en.wikipedia.org/wiki/TOCA_Race_Driver_3"
AUTHOR="Codemasters"
STEAM_ID=""
GAME_VMS="256"
SHORTCUT_FILENAME="RD3.exe"
...
if [ "$INSTALL_METHOD" == "STEAM" ]; then
        ...
        POL_SetupWindow_check_cdrom "RD3.ico"
        ...
        POL_Shortcut "HardwareSetup.exe" "$TITLE (Hardware setup)" "" "" "$SOFTWARE_CATEGORIES"
...
iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCXtjMfAAKCRDlMfrJqhPK
R5aYAJ9JXK4JYUE60CSF3oDOWpdggO899gCeP2/V8JKl58f/qURZn+297FqLnRI=
=4+lX
-----END PGP SIGNATURE-----
