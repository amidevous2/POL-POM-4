...
if [ "$GAME_MEDIAVERSION" == "DVD" ]; then
	...
	POL_SetupWindow_check_cdrom "Sims3EP01Setup.exe"
	wine start /unix "$CDROM/Sims3EP01Setup.exe"
...
#making shortcut
POL_SetupWindow_auto_shortcut "$PREFIX" "TS3EP01.exe" "$TITLE" "" ""
...
iEYEABECAAYFAk6HCWYACgkQ5TH6yaoTykcJ2QCfV9Bcf7qAFkc/+aIQ2BLKwCnf
3OQAn3uv0j23FoIfHiY9BV+n93t1A6MF
=2oC0
-----END PGP SIGNATURE-----
