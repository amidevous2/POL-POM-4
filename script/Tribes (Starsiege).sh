...
#
# TESTED Editions: Tribes free version released in 2004 (v1.8).
#
...
#
# KNOWN ISSUES:
#  - Wine x86 3.0.3: impossible to connect to some server (all down ?) even after patching to v1.11
#  - Wine x86 4.0.3: display is jerky.
#
# KNOWN ISSUES (FIXED):
...
TITLE="Tribes (Starsiege: Tribes)"
PREFIX="tribes1"
EDITOR="Dynamix"
GAME_URL="https://en.wikipedia.org/wiki/Starsiege:_Tribes"
AUTHOR="Dadu042"
STEAM_ID=""
GAME_VMS="64"
SHORTCUT_FILENAME="Tribes.exe"
...
if [ "$APP_ANSWER" == ".EXE" ]; then
        ...
        POL_Shortcut "InfiniteSpawn.exe" "$TITLE InfiniteSpawn (local server)" "" "" "$SOFTWARE_CATEGORIES"
...
iF0EABECAB0WIQRFtWEU2eoWQNaBNczlMfrJqhPKRwUCXhYw5AAKCRDlMfrJqhPK
R6LDAJ4+f+HtApCaXRO3iVyG3JSEra7jYgCffZ/a8h8M7XvvUxCC95F+vJRWEvk=
=rR2O
-----END PGP SIGNATURE-----
